...
** INPUT DATABASES	Z:\_I2D2\_I2D2\Philippines\1999\Original\LFS JAN1999.dta
** RESPONSIBLE	Cristián Jara
** Created	4/4/2012
** Modified	2/6/2017
** NUMBER OF HOUSEHOLDS	38830
** NUMBER OF INDIVIDUALS	200902
** EXPANDED POPULATION	73940846.2
**                                                                                                  **
******************************************************************************************************
*****************************************************************************************************/
...
** DIRECTORY
	local path "D:\__I2D2\Philippines\1999\LFS"


** LOG FILE
	log using "`path'\Processed\PHL_1999_I2D2_LFS.log", replace
...
** DATABASE ASSEMBLENT
	...
	use "`path'\Original\LFS JAN1999.dta"
...
** LABOR STATUS
	gen byte lstatus=.
	replace lstatus=1 if work==1
	replace lstatus=2 if work==2 & lokw==1
	replace lstatus=3 if work==2 & lokw==2
...
** REASONS NOT IN THE LABOR FORCE
	...
	replace nlfreason=3 if wnot==6 & age>10
...
** DELETE MISSING VARIABLES
	...
	saveold "`path'\Processed\PHL_1999_I2D2_LFS.dta", replace
	saveold "D:\__CURRENT\PHL_1999_I2D2_LFS.dta", replace
