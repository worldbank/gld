...
** INPUT DATABASES	Z:\_I2D2\_I2D2\Philippines\2001\Original\LFS JAN2001.dta
** RESPONSIBLE	Cristian Jara
** Created	3/30/2012
** Modified	2/6/2017
** NUMBER OF HOUSEHOLDS	39644
** NUMBER OF INDIVIDUALS	207092
** EXPANDED POPULATION	77007129
**                                                                                                  **
******************************************************************************************************
*****************************************************************************************************/
...
** DIRECTORY
	local path "D:\__I2D2\Philippines\2001\LFS"


** LOG FILE
	log using "`path'\Processed\PHL_2001_I2D2_LFS.log", replace
...
** DATABASE ASSEMBLENT
	...
	use "`path'\Original\LFS JAN2001.dta"
...
** HOUSEHOLD IDENTIFICATION NUMBER
	drop if psu==.
	egen idh=concat( psu stratum hcn)
	sort idh
...
** INDIVIDUAL IDENTIFICATION NUMBER
	sort idh
	by idh: gen idd=_n
	egen idp=concat(idh idd)
	label var idp "Individual id"


** HOUSEHOLD WEIGHTS
	gen double wgt= rfadj/10000
...
** HOUSEHOLD SIZE
	sort idh
	by idh: egen hhsize= count(idd) if c03_rel>=1 & c03_rel<9
...
** EDUCATIONAL LEVEL 1
	...
	replace edulevel1=7 if c07_grade==5 | (c07>=60 & c07<=78)
...
** LABOR STATUS
	gen byte lstatus=3
	replace lstatus=1 if c11_work==1 | c12_job==1
	replace lstatus=2 if c35_lookw==1
...
** REASONS NOT IN THE LABOR FORCE
	...
	replace nlfreason=3 if c39_wynot==6 & age>10
...
** INDUSTRY CLASSIFICATION
	gen byte industry=.
	replace industry=1 if c16_pkb>0 & c16_pkb<7
	...
	replace industry=10 if c16_pkb>94 & c16_pkb<100
	replace industry=10 if industry==. & c16_pkb!=.
...
** OCCUPATION CLASSIFICATION
	gen byte occup=floor(c14/10)
	recode occup 0=10
	replace occup=99 if c14_procc==9
...
** DELETE MISSING VARIABLES
	...
	saveold "`path'\Processed\PHL_2001_I2D2_LFS.dta", replace
	saveold "D:\__CURRENT\PHL_2001_I2D2_LFS.dta", replace
