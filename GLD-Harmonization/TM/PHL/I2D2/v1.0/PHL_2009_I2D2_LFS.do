...
** Created	10/2/2015
** Modified	2/22/2017
** NUMBER OF HOUSEHOLDS	42063
** NUMBER OF INDIVIDUALS	202132
** EXPANDED POPULATION	91340347
**                                                                                                  **
******************************************************************************************************
*****************************************************************************************************/
...
** DIRECTORY
	local path "D:\__I2D2\Philippines\2009\LFS"


** LOG FILE
	log using "`path'\Processed\PHL_2009_I2D2_LFS.log", replace
...
** DATABASE ASSEMBLENT
	...
	use "`path'\Original\LFS JAN2009.dta"
...
** DELETE MISSING VARIABLES
	...
	saveold "`path'\Processed\PHL_2009_I2D2_LFS.dta", replace
	saveold "D:\__CURRENT\PHL_2009_I2D2_LFS.dta", replace
