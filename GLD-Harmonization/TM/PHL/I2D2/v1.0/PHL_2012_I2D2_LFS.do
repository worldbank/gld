...
** Created	6/21/2013
** Modified	2/23/2017
** NUMBER OF HOUSEHOLDS	43182
** NUMBER OF INDIVIDUALS	204725
** EXPANDED POPULATION	96704713
**                                                                                                  **
******************************************************************************************************
*****************************************************************************************************/
...
** DIRECTORY
	local path "D:\__I2D2\Philippines\2012\LFS"


** LOG FILE
	log using "`path'\Processed\PHL_2012_I2D2_LFS.log", replace
...
** DATABASE ASSEMBLENT
	...
	use "`path'\Original\LFS JAN, APR 2012\LFS JAN 2012.dta"
...
** YEARS OF EDUCATION COMPLETED
	gen byte educy=.
	replace educy=0 if j12c09_grade>=0 & j12c09_grade<=270
	replace educy=7 if  j12c09_grade>=280 &   j12c09_grade<=340
...
** DELETE MISSING VARIABLES
	...
	saveold "`path'\Processed\PHL_2012_I2D2_LFS.dta", replace
	saveold "D:\__CURRENT\PHL_2012_I2D2_LFS.dta", replace
