...
** INPUT DATABASES	/Users/ariannazapanta/Documents/LFS/LFS JAN2015.dta
** RESPONSIBLE	Arianna Zapanta
** Created	1/17/2021
** Modified	
** NUMBER OF HOUSEHOLDS	43794 
** NUMBER OF INDIVIDUALS	204568 
** EXPANDED POPULATION	99967107 
**                                                                                                  **
******************************************************************************************************
*****************************************************************************************************/
...
** LOG FILE
	log using "`path'/Processed/PHL_2015_I2D2_LFS.log", replace
...
** INDUSTRY CLASSIFICATION
	...
	replace industry=3 if (c18_pkb>=10 & c18_pkb<=33) 
	replace industry=4 if (c18_pkb>=35 & c18_pkb<=39) 
	replace industry=5 if (c18_pkb>=41 & c18_pkb<=43)
	replace industry=6 if (c18_pkb>=45 & c18_pkb<=47) |  (c18_pkb>=55 & c18_pkb<=56)
	replace industry=7 if (c18_pkb>=49 & c18_pkb<=53)| (c18_pkb>=58 & c18_pkb<=63)
	replace industry=8 if (c18_pkb>=64 & c18_pkb<=82) 
	replace industry=9 if (c18_pkb>=84 & c18_pkb<=93) 
	replace industry=10 if  (c18_pkb>=94 & c18_pkb<=99)
...
** OCCUPATION CLASSIFICATION - SECOND JOB
	...
	recode occup_2 0=10
	replace occup_2=99 if j02_otoc==9
...
** DELETE MISSING VARIABLES
	...
	saveold "`path'/Processed/PHL_2015_I2D2_LFS.dta", replace
