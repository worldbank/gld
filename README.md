...
To explore survey coverage and variable availability across the database, visit the [GLD Survey Platform](https://datanalytics.worldbank.org/gld-platform/) — an interactive tool that lets you browse harmonized surveys by country and year, check which variables are available, and look up occupation and industry coding details.
...
## License
This project is licensed under the [MIT License](LICENSE) together with the [World Bank IGO Rider](WB-IGO-RIDER.md). The Rider is purely procedural: it reserves all privileges and immunities enjoyed by the World Bank, without adding restrictions to the MIT permissions. Please review both files before using, distributing or contributing.
