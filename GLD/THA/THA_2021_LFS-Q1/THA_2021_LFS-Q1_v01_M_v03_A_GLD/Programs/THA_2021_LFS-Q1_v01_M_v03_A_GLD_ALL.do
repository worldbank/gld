...
global path_in "Y:\GLD-Harmonization\510859_AS\THA\THA_2021_LFS-Q1\THA_2021_LFS-Q1_v01_M\Data\Stata"

global path_output "Y:\GLD-Harmonization\510859_AS\THA\THA_2021_LFS-Q1\THA_2021_LFS-Q1_v01_M_V03_A_GLD\Data\Harmonized"
...
*<_wage_no_compen_>
	gen double wage_no_compen = APPROX
	replace wage_no_compen = . if inlist(APPROX, 999998, 999999)
	replace wage_no_compen = . if wage_no_compen == 0 | lstatus != 1
...
save "$path_output\THA_2021_LFS-Q1_v01_M_V03_A_GLD_ALL.dta", replace
