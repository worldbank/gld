...
<_Program name_>				CRI_2012_ECE_V01_M_V01_A_GLD_ALL.do </_Program name_>
<_Application_>					StataNow 19 </_Application_>
<_Author(s)_>					World Bank Jobs Group (gld@worldbank.org) </_Author(s)_>
<_Date created_>				2026-08-06 </_Date created_>
...
<_Study ID_>					CR-INEC-ECE-2012 </_Study ID_>
...
<_Sample size (HH)_> 				29,932 </_Sample size (HH)_>
<_Sample size (IND)_> 				101,571 </_Sample size (IND)_>
...
use "`path_in_stata'/I Trimestre 2012.dta", clear
append using "`path_in_stata'/II Trimestre 2012.dta" "`path_in_stata'/III Trimestre 2012.dta" "`path_in_stata'/IV Trimestre 2012.dta"
...
*<_survey_>
gen str18 survey = "Labor Force Survey"
...
*<_int_month_>
* Note: Exact interview month is not released; quarter is retained in wave.
gen double int_month = .
label var int_month "int_month"
*</_int_month_>


*<_hhid_>
* Note: Quarter-specific fixed-width ID, with no separators.
...
*<_weight_>
* Note: Annual stacked-file weight uses each quarter's observation share.
...
*<_weight_m_>
gen double weight_m = .
label var weight_m "weight_m"
*</_weight_m_>


*<_weight_q_>
gen double weight_q = Factor_ponderacion
label var weight_q "Quarterly survey sampling weight"
*</_weight_q_>


*<_psu_>
gen double psu = Consecutivo
...
*<_strata_>
gen double strata = Region*10 + Zona
label var strata "Sampling stratum"
*</_strata_>


*<_wave_>
gen str2 wave = "Q" + string(ID_TRIMESTRE,"%1.0f")
label var wave "Survey wave"
*</_wave_>


*<_panel_>
* Note: No explicit raw panel identifier is released.
gen str1 panel = ""
...
*<_visit_no_>
* Note: No explicit visit sequence is released.
gen double visit_no = .
label var visit_no "visit_no"
*</_visit_no_>
...
label var subnatidsurvey "Lowest representative domain"
*</_subnatidsurvey_>
...
*<_age_>
* Note: Codes 98 and 99 describe unknown exact ages and remain missing.
gen int age = Edad if inrange(Edad,0,97)
label var age "Age"
*</_age_>
...
*<_relationharm_>
* Note: Select oldest listed head; otherwise oldest spouse; otherwise oldest member; pid breaks ties.
...
gen byte __head_priority = cond(inlist(Relacion_parentesco,1,13),3,cond(inlist(Relacion_parentesco,2,16,17),2,1))
gen int __head_age = cond(inrange(Edad,0,97),Edad,-1)
gsort hhid -__head_priority -__head_age pid
by hhid: gen byte __chosen_head = _n == 1
replace relationharm = 5 if relationharm == 1 & !__chosen_head
replace relationharm = 1 if __chosen_head
sort hhid pid
drop __head_priority __head_age __chosen_head
...
label var relationcs "Detailed relationship"
*</_relationcs_>
...
label var ed_mod_age "Education module minimum age"
*</_ed_mod_age_>
...
*<_educy_>
gen int educy = Amos_educacion if inrange(Amos_educacion,0,30)
label var educy "Years of education"
*</_educy_>


*<_educat7_>
* Note: Approved ambiguous pathway and unknown-grade codes remain unmapped.
gen byte educat7 = .
...
replace educat7 = 7 if inrange(Educacion_nivel_grado,51,59) | inrange(Educacion_nivel_grado,71,74) | inrange(Educacion_nivel_grado,81,86)
label var educat7 "Level of education 7 categories"
...
replace vocational_field_orig = string(EducacionNoregular_codigo,"%02.0f") if vocational == 1 & EducacionNoregular_codigo != 99
label var vocational_field_orig "Original training field"
*</_vocational_field_orig_>
...
label var minlaborage "Labor module minimum age"
*</_minlaborage_>
...
*<_nlfreason_>
gen byte nlfreason = .
replace nlfreason = 1 if lstatus == 3 & Motivo_nobusco == 11
replace nlfreason = 2 if lstatus == 3 & Motivo_nobusco == 12
replace nlfreason = 4 if lstatus == 3 & Motivo_nobusco == 10
...
*<_industry_orig_>
gen double industry_orig = Cod_rama_publicacion if lstatus == 1
...
replace industrycat_isic = string(Cod_rama_publicacion,"%04.0f") if lstatus == 1 & inrange(Cod_rama_publicacion,1,9999)
label var industrycat_isic "ISIC code"
*</_industrycat_isic_>


*<_industrycat10_>
* Note: ISIC Rev.4; divisions 55-56 map to Commerce.
gen byte industrycat10 = .
gen byte __div = real(substr(industrycat_isic,1,2))
...
replace industrycat10 = 6 if inrange(__div,45,47) | inrange(__div,55,56)
replace industrycat10 = 7 if inrange(__div,49,53) | inrange(__div,58,63)
replace industrycat10 = 8 if inrange(__div,64,82)
replace industrycat10 = 9 if __div == 84
replace industrycat10 = 10 if inrange(__div,85,99)
drop __div
label var industrycat10 "Industry classification 10 categories"
...
*<_occup_orig_>
gen double occup_orig = Cod_ocupacion if lstatus == 1
label var occup_orig "Original occupation code"
*</_occup_orig_>


*<_occup_isco_>
* Note: Approved hierarchical ISCO-08 fallback; exact source codes remain in occup_orig.
gen str4 occup_isco = ""
replace occup_isco = string(Cod_ocupacion,"%04.0f") if lstatus == 1 & inrange(Cod_ocupacion,0,9999)
replace occup_isco = "3310" if occup_isco == "3316"
replace occup_isco = "5100" if occup_isco == "5170"
replace occup_isco = "3000" if inlist(occup_isco,"3610","3711","3712","3714","3715","3716","3719")
replace occup_isco = "9000" if occup_isco == "9800"
...
*<_occup_>
gen byte occup = real(substr(occup_isco,1,1)) if occup_isco != ""
replace occup = 10 if occup == 0
label var occup "Occupation major group"
...
label var unitwage "Primary-job wage unit"
	label values unitwage lblunitwage
*</_unitwage_>


*<_whours_>
gen double whours = Horas_efectivas_principal if lstatus == 1 & inrange(Horas_efectivas_principal,1,168)
label var whours "Primary-job weekly hours"
*</_whours_>
...
label var healthins "Health insurance through job"
...
*<_socialsec_>
gen byte socialsec = .
replace socialsec = 1 if lstatus == 1 & E10A == 1
replace socialsec = 0 if lstatus == 1 & E10A == 2
replace socialsec = 1 if lstatus == 1 & missing(socialsec) & D14_1 == 1
replace socialsec = 0 if lstatus == 1 & missing(socialsec) & D14_1 == 2
label var socialsec "Social security through job"
...
replace firmsize_l = Cantidad_personas if lstatus == 1 & inrange(Cantidad_personas,1,9)
replace firmsize_l = 10 if lstatus == 1 & Cantidad_personas == 10
replace firmsize_l = 20 if lstatus == 1 & Cantidad_personas == 11
replace firmsize_l = 30 if lstatus == 1 & Cantidad_personas == 12
replace firmsize_l = 100 if lstatus == 1 & Cantidad_personas == 13
...
replace firmsize_u = Cantidad_personas if lstatus == 1 & inrange(Cantidad_personas,1,9)
replace firmsize_u = 19 if lstatus == 1 & Cantidad_personas == 10
replace firmsize_u = 29 if lstatus == 1 & Cantidad_personas == 11
replace firmsize_u = 99 if lstatus == 1 & Cantidad_personas == 12
...
replace empstat_2 = . if lstatus != 1 | Empleo_secundario != 1
...
*<_ocusec_2_>
gen byte ocusec_2 = .
replace ocusec_2 = 1 if empstat_2 < . & Sector_institucional_secundario == 1
replace ocusec_2 = 2 if empstat_2 < . & Sector_institucional_secundario == 2
...
*<_industry_orig_2_>
gen double industry_orig_2 = Cod_actividad_sec if empstat_2 < .
label var industry_orig_2 "Original industry code secondary job"
*</_industry_orig_2_>


*<_industrycat_isic_2_>
gen str4 industrycat_isic_2 = ""
replace industrycat_isic_2 = string(Cod_actividad_sec,"%04.0f") if empstat_2 < . & inrange(Cod_actividad_sec,1,9999)
label var industrycat_isic_2 "ISIC code secondary job"
*</_industrycat_isic_2_>
...
gen byte __div = real(substr(industrycat_isic_2,1,2))
replace industrycat10_2 = 1 if inrange(__div,1,3)
replace industrycat10_2 = 2 if inrange(__div,5,9)
replace industrycat10_2 = 3 if inrange(__div,10,33)
replace industrycat10_2 = 4 if inrange(__div,35,39)
replace industrycat10_2 = 5 if inrange(__div,41,43)
replace industrycat10_2 = 6 if inrange(__div,45,47) | inrange(__div,55,56)
replace industrycat10_2 = 7 if inrange(__div,49,53) | inrange(__div,58,63)
replace industrycat10_2 = 8 if inrange(__div,64,82)
replace industrycat10_2 = 9 if __div == 84
replace industrycat10_2 = 10 if inrange(__div,85,99)
drop __div
label var industrycat10_2 "Industry classification 10 categories"
...
*<_occup_orig_2_>
gen double occup_orig_2 = Cod_ocupacion_sec if empstat_2 < .
label var occup_orig_2 "Original occupation code secondary job"
*</_occup_orig_2_>


*<_occup_isco_2_>
* Note: Approved hierarchical ISCO-08 fallback; exact source codes remain in occup_orig_2.
gen str4 occup_isco_2 = ""
replace occup_isco_2 = string(Cod_ocupacion_sec,"%04.0f") if empstat_2 < . & inrange(Cod_ocupacion_sec,0,9999)
replace occup_isco_2 = "3310" if occup_isco_2 == "3316"
replace occup_isco_2 = "5100" if occup_isco_2 == "5170"
replace occup_isco_2 = "3000" if inlist(occup_isco_2,"3610","3711","3712","3714","3715","3716","3719")
replace occup_isco_2 = "9000" if occup_isco_2 == "9800"
replace occup_isco_2 = "2630" if occup_isco_2 == "2639"
replace occup_isco_2 = "3150" if occup_isco_2 == "3156"
label var occup_isco_2 "ISCO code secondary job"
*</_occup_isco_2_>


*<_occup_2_>
gen byte occup_2 = real(substr(occup_isco_2,1,1)) if occup_isco_2 != ""
replace occup_2 = 10 if occup_2 == 0
label var occup_2 "Occupation major group secondary job"
...
label var unitwage_2 "Secondary-job wage unit"
...
*<_whours_2_>
gen double whours_2 = Horas_efectivas_secs if empstat_2 < . & inrange(Horas_efectivas_secs,1,168)
label var whours_2 "Secondary-job weekly hours"
*</_whours_2_>
...
gen double t_wage_nocompen_others = Ingreso_otros*12 if lstatus == 1 & Ingreso_otros < 99999999
label var t_wage_nocompen_others "Annual wage other jobs excluding compensation"
*</_t_wage_nocompen_others_>
...
*<_njobs_>
* Note: Code 3 represents three or more jobs.
gen byte njobs = .
...
*<_laborincome_>
	* External CRI ECE decision: GLD Labor Manual permits the available annualized total regardless of reference period.
