...
<_Program name_>				CRI_2022_ECE_V01_M_V01_A_GLD_ALL.do </_Program name_>
<_Application_>					StataNow 19 </_Application_>
<_Author(s)_>					World Bank Jobs Group (gld@worldbank.org) </_Author(s)_>
<_Date created_>				2026-08-16 </_Date created_>
...
<_Study ID_>					CR-INEC-ECE-2022 </_Study ID_>
...
<_Sample size (HH)_> 				30,836 </_Sample size (HH)_>
<_Sample size (IND)_> 				92,801 </_Sample size (IND)_>
...
use "`path_in_stata'/I Trimestre 2022.dta", clear
append using "`path_in_stata'/II Trimestre 2022.dta" "`path_in_stata'/III Trimestre 2022.dta" "`path_in_stata'/IV Trimestre 2022.dta"
...
*50 duplicates (drop them)
duplicates tag ID_TRIMESTRE pid, gen(tag)
drop if tag == 1
