/*==============================================================================
* 02: List all the harmonized datasets
*==============================================================================*/
...
foreach year of global years {
    foreach ver1 in `versions_mas' {
        foreach ver2 in `versions_alt' {
            local dir_full "${server}\\${country}\\${country}_`year'_${survey_i}\\${country}_`year'_${survey_i}_`ver1'_M_`ver2'_A_GLD\Data\Harmonized"
...
* Diagnostic: verify that the selected annual files can be appended.
* This command preserves and restores the filelist in memory.
