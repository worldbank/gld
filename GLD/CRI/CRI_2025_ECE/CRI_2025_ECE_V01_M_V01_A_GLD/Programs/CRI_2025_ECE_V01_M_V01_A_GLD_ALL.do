...
<_Program name_>				CRI_2025_ECE_V01_M_V01_A_GLD_ALL.do </_Program name_>
<_Application_>					StataNow 19 </_Application_>
<_Author(s)_>					World Bank Jobs Group (gld@worldbank.org) </_Author(s)_>
<_Date created_>				2026-08-19 </_Date created_>
...
<_Study ID_>					CR-INEC-ECE-2025 </_Study ID_>
...
<_Sample size (HH)_> 				31,402 </_Sample size (HH)_>
<_Sample size (IND)_> 				87,232 </_Sample size (IND)_>
...
use "`path_in_stata'/I Trimestre 2025.dta", clear
append using "`path_in_stata'/II Trimestre 2025.dta" "`path_in_stata'/III Trimestre 2025.dta" "`path_in_stata'/IV Trimestre 2025.dta"
...
*<_occup_isco_>
	...
	replace occup_isco = "3000" if occup_isco == "3713"
	...
	replace occup_isco = "5100" if occup_isco == "5168"
...
*<_wage_no_compen_>
gen double wage_no_compen = Ingreso_principal 
...
replace occup_isco_2 = "3000" if occup_isco_2 == "3715"
