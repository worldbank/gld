...
<_Program name_>				CRI_2014_ECE_V01_M_V01_A_GLD_ALL.do </_Program name_>
<_Application_>					StataNow 19 </_Application_>
<_Author(s)_>					World Bank Jobs Group (gld@worldbank.org) </_Author(s)_>
<_Date created_>				2026-08-08 </_Date created_>
...
<_Study ID_>					CR-INEC-ECE-2014 </_Study ID_>
...
<_Sample size (HH)_> 				32,077 </_Sample size (HH)_>
<_Sample size (IND)_> 				105,891 </_Sample size (IND)_>
...
use "`path_in_stata'/I Trimestre 2014.dta", clear
append using "`path_in_stata'/II Trimestre 2014.dta" "`path_in_stata'/III Trimestre 2014.dta" "`path_in_stata'/IV Trimestre 2014.dta"
...
*<_eye_dsablty_>
	gen eye_dsablty = .
	label define dsablty 1 "No ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Å“ no difficulty" 2 "Yes ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Å“ some difficulty" 3 "Yes ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Å“ a lot of difficulty" 4 "Cannot do at all"
...
*<_hear_dsablty_>
	gen hear_dsablty = .
	label define dsablty 1 "No ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Å“ no difficulty" 2 "Yes ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Å“ some difficulty" 3 "Yes ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Å“ a lot of difficulty" 4 "Cannot do at all", replace
...
*<_migrated_reason_>
	...
	label de lblmigrated_reason 1 "Family reasons" 2 "Educational reasons" 3 "Employment" 4 "Forced (political reasons, natural disaster, ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¦)" 5 "Other reasons"
...
*<_wage_total_2_>
gen double wage_total_2 = Ingreso_bruto_secundario * 12
replace wage_total_2 = . if Empleo_secundario != 1 | missing(Ingreso_bruto_secundario) | Ingreso_bruto_secundario >= 99999999
