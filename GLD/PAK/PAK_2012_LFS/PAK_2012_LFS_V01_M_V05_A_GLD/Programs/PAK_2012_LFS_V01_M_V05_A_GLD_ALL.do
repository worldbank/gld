...
/* -----------------------------------------------------------------------
<_Program name_>				PAK_2012_LFS_V01_M_V05_A_GLD_ALL.do </_Program name_>
...
* Date: [2023-02-02] File: [PAK_2012_LFS_V01_M_V02_A_GLD_ALL.do] - [Directories & setting up format update; revise all "original" variables i.e. industrycat_orig; comment title format update]
* Date: [2023-03-30] File: [PAK_2012_LFS_V01_M_V03_A_GLD_ALL.do] - [Removed "byte" for firmsize variable coding]
* Date: [2025-01-01] File: [PAK_2012_LFS_V01_M_V04_A_GLD_ALL.do] - [Update lstatus]
* Date: [2026-01-20] File: [PAK_2012_LFS_V01_M_V03_A_GLD_ALL.do] - [Correct industrycat10_2 industrycat4_2, subnatid1]
...
* harmonized output in a single file
	...
	use "`path_in_stata'\lfs2012-13.dta", clear
...
*<_subnatid1_>
	...
	label de lblsubnatid1 1 "1 - Khyber/Pakhtoonkhua" 2 "2 - Punjab" 3 "3 - Sindh" 4 "4 - Balochistan" 5 "5 - Federally Administered Tribal Areas" 6 "6 - Islamabad" 7 "7 - Gilgit-Baltistian" 8 "8 - AJ & Kashmir", replace
...
*<_subnatid2_>
	...
	merge m:m city_code using "`path_in_stata'\PAK_city_code_2012.dta"
	drop if _merge!=3
...
-----------+---------------------------------+----------
         ...
         4 |         0          0      5,730 |     5,730 
         5 |       564      5,488          0 |     6,052 
         6 |     1,132      4,437          0 |     5,569 
         7 |     1,942      3,811          0 |     5,753 
         8 |     2,786      3,266          0 |     6,052 
         9 |     2,618      2,013          0 |     4,631 
        10 |     4,259      1,571          0 |     5,830 
        11 |     2,769        746          0 |     3,515 
        12 |     4,578      1,331          0 |     5,909 
        13 |     3,431        824          0 |     4,255 
        14 |     3,760      1,120          0 |     4,880 
        15 |     3,255      1,044          0 |     4,299 
...
*<_educat_isced_>
	...
	replace educat_isced=. if s4_q9==34
...
/*<_lstatus_note_>
	...
	*** Unemployed ***
	Union of active search (yes to s9_q1) and passive search (s9_q4 < 7) 
...
*<_unitwage_>
	...
	replace unitwage=10 if wage_no_compen>s7_q3&!mi(wage_no_compen)
