...
/* -----------------------------------------------------------------------
<_Program name_>				PAK_2018_LFS_V01_M_V05_A_GLD_ALL.do </_Program name_>
...
* Date: [2023-02-6] File: [PAK_2018_LFS_V01_M_V02_A_GLD_ALL.do] - [Directories & setting up format update; revise all "original" variables i.e. industrycat_orig; comment title format update]
* Date: [2023-03-30] File: [PAK_2018_LFS_V01_M_V03_A_GLD_ALL.do] - [Removed "byte" for firmsize variable coding]
* Date: [202Y-MM-DD] File: [PAK_2018_LFS_V01_M_V04_A_GLD_ALL.do] - []
* Date: [2026-01-20] File: [PAK_2018_LFS_V01_M_V05_A_GLD_ALL.do] - [Correct industrycat10_2, industrycat4_2]
...
* harmonized output in a single file
	...
	use "`path_in_stata'\LFS 2018-19.dta", clear
...
/*<_relationharm_note_>
68 observations have missing values for relationship. 
So their households also miss household heads.
*<_relationharm_note_>*/
...
-----------+---------------------------------+----------
         ...
         3 |         0          0      8,196 |     8,196 
         4 |         0          0      8,375 |     8,375 
         5 |     1,047      7,651          0 |     8,698 
         6 |     1,982      6,158          0 |     8,140 
         7 |     3,058      5,273          0 |     8,331 
         8 |     4,514      4,525          0 |     9,039 
         9 |     3,941      2,469          0 |     6,410 
        10 |     6,039      2,449          0 |     8,488 
        11 |     3,801      1,008          0 |     4,809 
        12 |     5,834      1,715          0 |     7,549 
        13 |     4,278      1,114          0 |     5,392 
        14 |     4,974      1,428          0 |     6,402 
        15 |     4,182      1,199          0 |     5,381 
...
*<_nlfreason_>
	...
	recode nlfreason (5=1) (6=2) (7=3) (11=4) (1/4 8/10 12/13=5)
...
Unemployment duration in 2018 is a specific number of weeks/months/years. So the 
