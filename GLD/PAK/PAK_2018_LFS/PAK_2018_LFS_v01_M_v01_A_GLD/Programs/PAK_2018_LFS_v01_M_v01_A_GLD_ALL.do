...
/* -----------------------------------------------------------------------
<_Program name_>				PAK_2018_LFS_v01_M_v01_A_GLD_ALL.do </_Program name_>
...
* harmonized output in a single file
	...
	use "`input'\LFS 2018-19.dta", clear
...
*<_migrated_years_>
	gen int migrated_years=2018 if S04C15==2
	replace migrated_years=2017 if S04C15==3
	replace migrated_years=2016 if S04C15==4
	replace migrated_years=2015 if S04C15==5
	replace migrated_years=2014 if S04C15==6
	replace migrated_years=2013 if S04C15==7
	replace migrated_years=2008 if S04C15==8	
	replace migrated_years=. if S04C15==1
...
*<_lstatus_>
	gen byte lstatus=.
	replace lstatus=1 if inlist(1, S05C01, S05C02, S05C03) | inlist(S05C04,1,2)
	replace lstatus=2 if S09C01==1 | inrange(S09C04,1,6) | inrange(S09C05,1,5) 
...
save "`output'\PAK_2018_LFS_v01_M_v01_A_GLD_ALL.dta", replace
