...
/* -----------------------------------------------------------------------
<_Program name_>				PAK_2010_LFS_V01_M_V03_A_GLD_ALL.do </_Program name_>
...
<_Study ID_>					PAK_2010_LFS_v01_M </_Study ID_>
<_Data collection from (M/Y)_>	[July/2010] </_Data collection from (M/Y)_>
...
* Date: [2023-02-02] File: [PAK_2010_LFS_V01_M_V02_A_GLD_ALL.do] - [Directories & setting up format update; revise all "original" variables i.e. industrycat_orig; comment title format update]
* Date: [2023-03-30] File: [PAK_2010_LFS_V01_M_V03_A_GLD_ALL.do] - [Removed "byte" for firmsize variable coding]
* Date: [2026-01-20] File: [PAK_2008_LFS_V01_M_V04_A_GLD_ALL.do] - [Update industrycat10_2, industrycat4_2]
...
* harmonized output in a single file
	...
	use "`path_in_stata'\lfs2010-11.dta", clear
...
*<_psu_>
	gen str3 psu=substr(PrCode,5,3)
	label var psu "Primary sampling units"
*</_psu_>


*<_ssu_>
	gen str2 ssu=substr(PrCode, 8, 2)
	label var ssu "Secondary sampling units"
*</_ssu_>


*<_strata_>
	gen str2 stratum=substr(PrCode,3,2)
...
*<_urban_>
	gen str1 urban=substr(PrCode,2,1)
...
-----------+---------------------------------+----------
         ...
         5 |       395      8,174          0 |     8,569 
         6 |       968      7,230          0 |     8,198 
         7 |     1,902      6,331          0 |     8,233 
         8 |     3,556      5,245          0 |     8,801 
         9 |     3,610      2,830          0 |     6,440 
        10 |     6,838      2,364          0 |     9,202 
        11 |     4,146        943          0 |     5,089 
        12 |     6,758      2,048          0 |     8,806 
        13 |     4,936      1,163          0 |     6,099 
        14 |     5,175      1,547          0 |     6,722 
        15 |     5,107      1,634          0 |     6,741 
...
Unemployed if seeking (Sec9_9_1==1) and available [inrange(Sec9_9_4, 1, 6)]
