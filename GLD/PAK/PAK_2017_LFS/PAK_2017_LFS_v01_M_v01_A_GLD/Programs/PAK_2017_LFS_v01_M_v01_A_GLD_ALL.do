...
/* -----------------------------------------------------------------------
<_Program name_>				PAK_2017_LFS_v01_M_v01_A_GLD_ALL.do </_Program name_>
...
*<_migrated_years_>
	gen int migrated_years=2017 if S04C15==2
	replace migrated_years=2016 if S04C15==3
	replace migrated_years=2015 if S04C15==4
	replace migrated_years=2014 if S04C15==5
	replace migrated_years=2013 if S04C15==6
	replace migrated_years=2012 if S04C15==7
	replace migrated_years=2007 if S04C15==8	
...
save "`output'\PAK_2017_LFS_v01_M_v01_A_GLD_ALL.dta", replace
