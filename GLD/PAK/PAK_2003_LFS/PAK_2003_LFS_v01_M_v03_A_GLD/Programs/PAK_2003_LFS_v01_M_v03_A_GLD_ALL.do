...
/* -----------------------------------------------------------------------
<_Program name_>				PAK_2003_LFS_V01_M_V03_A_GLD_ALL.do </_Program name_>
...
<_Study ID_>					PAK_2003_LFS_v01_M </_Study ID_>
<_Data collection from (M/Y)_>	[July/2003] </_Data collection from (M/Y)_>
<_Data collection to (M/Y)_>	[June/2004] </_Data collection to (M/Y)_>
<_Source of dataset_> 			Pakistan Bureau of Statistics </_Source of dataset_>
								https://www.pbs.gov.pk/content/microdata
<_Sample size (HH)_> 			20,440 </_Sample size (HH)_>
<_Sample size (IND)_> 			139,123 </_Sample size (IND)_>
...
* Date: [2023-02-02] File: [PAK_2003_LFS_V01_M_V02_A_GLD_ALL.do] - [Directories & setting up format update; revise all "original" variables i.e. industrycat_orig; comment title format update]
* Date: [2023-03-29] File: [PAK_2003_LFS_V01_M_V03_A_GLD_ALL.do] - [Removed "byte" for firmsize variable coding]
</_Version Control_>
...
* harmonized output in a single file
	...
	use "`path_in_stata'\lfs2003_04.dta", clear
	drop blank*
...
*<_hhid_>
	tostring processingcod, gen(process_code)
...
*<_subnatid1_>
	...
	label de lblsubnatid1 1 "1-Punjab" 2 "2-Sindh" 3 "3-N.W.F.P" 4 "4-Balochistan" 5 "5-Azad Jammu and Kashmir" 6 "6-Northern Area" 7 "7-FATA"
