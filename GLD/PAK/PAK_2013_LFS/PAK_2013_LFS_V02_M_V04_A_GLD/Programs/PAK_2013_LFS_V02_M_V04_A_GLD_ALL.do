...
/* -----------------------------------------------------------------------
<_Program name_>				PAK_2013_LFS_V02_M_V02_A_GLD_ALL.do </_Program name_>
...
<_Study ID_>					PAK_2013_LFS_v01_M </_Study ID_>
<_Data collection from (M/Y)_>	[July/2013] </_Data collection from (M/Y)_>
...
<_Sample size (HH)_> 			43,792</_Sample size (HH)_>
<_Sample size (IND)_> 			278,433 </_Sample size (IND)_>
...
* Date: [2022-09-22] File: [PAK_2013_LFS_V01_M_V02_A_GLD_ALL.do] - [Recode firm size using the four categories from 2012]
* Date: [2023-02-11] File: [PAK_2013_LFS_V02_M_V01_A_GLD_ALL.do] - [Using updated dataset (V02_M); directories & setting up format update; revise all "original" variables i.e. industrycat_orig; comment title format update; modified "educat7"]
* Date: [2023-03-30] File: [PAK_2013_LFS_V02_M_V02_A_GLD_ALL.do] - [Removed "byte" for firmsize variable coding]
*                          [PAK_2013_LFS_V02_M_V03_A_GLD_ALL.do]
* Date: [2026-01-20] File: [PAK_2013_LFS_V02_M_V04_A_GLD_ALL.do] - [Correct empstat_2]
...
* harmonized output in a single file
	...
	use "`path_in_stata'\lfs2013-14.dta", clear
...
*<_subnatid2_>
	...
	preserve
	use "`path_in_stata'\PAK_city_code_2013.dta", clear
...
*<_educat7_>
	...
	recode educat7 (3=2) (4=3) (5/6=4) (8/15=7) (0 16=.)
...
/*<_lstatus_note_>
	...
	*** Unemployed ***
	Union of active search (yes to SEC9_COL1) and passive search (SEC9_COL4 < 7) 
...
*<_lstatus_>
	...
	*Code for unemployed
	gen active = SEC9_COL1 == 1
    gen passive = inrange(SEC9_COL4,1,6)
...
*<_empstat_2_>
	...
	replace empstat_2=1 if SEC5_COL19<=4 
	replace empstat_2=2 if SEC5_COL19==11 | SEC5_COL19==12 
	replace empstat_2=3 if SEC5_COL19==5
	replace empstat_2=4 if (SEC5_COL19>=6 & SEC5_COL19<=10) | SEC5_COL19==13
	replace empstat_2=5 if SEC5_COL19==14
	replace empstat_2=. if !inrange(SEC5_COL19, 1, 14)
	label var empstat_2 "Employment status during past week secondary job 7 day recall"
	la de lblempstat_2 1 "Paid employee" 2 "Non-paid employee" 3 "Employer" 4 "Self-employed" 5 "Other, workers not classifiable by status", replace
...
*<_industrycat10_2_>
	gen byte industrycat10_2=floor(SEC5_COL21/100)
