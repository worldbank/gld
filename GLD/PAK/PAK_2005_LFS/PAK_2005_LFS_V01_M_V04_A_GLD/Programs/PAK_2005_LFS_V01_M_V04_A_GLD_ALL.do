...
/* -----------------------------------------------------------------------
<_Program name_>				PAK_2005_LFS_V01_M_V04_A_GLD_ALL.do </_Program name_>
<_Application_>					Stata MP 16.1 <_Application_>
<_Author(s)_>					Wolrd Bank Job's Group </_Author(s)_>
<_Date created_>				2022-07-18 </_Date created_>
-------------------------------------------------------------------------
<_Country_>						Pakistan(PAK) </_Country_>
<_Survey Title_>				Labour Force Survey </_Survey Title_>
<_Survey Year_>					2005 </_Survey Year_>
<_Study ID_>					PAK_2005_LFS_v01_M </_Study ID_>
<_Data collection from (M/Y)_>	[July/2005] </_Data collection from (M/Y)_>
...
* Date: [2023-02-02] File: [PAK_2005_LFS_V01_M_V02_A_GLD_ALL.do] - [Directories & setting up format update; revise all "original" variables i.e. industrycat_orig; comment title format update]
* Date: [2023-03-29] File: [PAK_2005_LFS_V01_M_V03_A_GLD_ALL.do] - [Removed "byte" for firmsize variable coding]
* Date: [2026-01-20] File: [PAK_2005_LFS_V01_M_V04_A_GLD_ALL.do] - [Correct ocusec_2]
...
* harmonized output in a single file
	...
	use "`path_in_stata'\lfs_0506.dta", clear
...
*<_relationharm_>
	...
	* Check if hh head count is equal to one
	...
	replace relationharm=5 if q_4_1!=1 & tot_head==2 & relationharm==1
	drop tot_head head
...
*<_ocusec_2_>
	gen byte ocusec_2=q_5_20
	recode ocusec_2 (1/3=1) (4 6=3) (5/9=2) (10=4)
	replace ocusec_2=. if q_5_17!=1
	replace ocusec_2 = . if !mi(ocusec_2) & !inrange(q_5_20, 1, 10)
