...
<_Program name_>				[PAK_2024_LFS_V01_M_V01_A_GLD] </_Program name_>
<_Application_>					[Stata 18] <_Application_>
<_Author(s)_>					World Bank Jobs Group (gld@worldbank.org) </_Author(s)_>
<_Date created_>				2026-02-26 </_Date created_>

-------------------------------------------------------------------------

<_Country_>					[Islamic Republic of Pakistan (PAK)] </_Country_>
<_Survey Title_>				[LFS] </_Survey Title_>
<_Survey Year_>					[2024] </_Survey Year_>
<_Study ID_>					[n/a] </_Study ID_>
<_Data collection from_>			[July/2024] </_Data collection from_>
<_Data collection to_>				[June/2024] </_Data collection to_>
<_Source of dataset_> 				[Pakistan Bureau of Statistics] </_Source of dataset_>
<_Sample size (HH)_> 				[53,974] </_Sample size (HH)_>
<_Sample size (IND)_> 				[ 325,445 ] </_Sample size (IND)_>
<_Sampling method_> 				[Stratified two-stage cluster sampling method] </_Sampling method_>
<_Geographic coverage_> 			[National] </_Geographic coverage_>
<_Currency_> 					[Pakistan Rupee] </_Currency_>

-----------------------------------------------------------------------

<_ICLS Version_>				[ICSL-19] </_ICLS Version_>
...
* Special case: override paths for wb582018
if "`c(username)'" == "wb582018" {
    local myroot "C:/Users/`c(username)'/OneDrive - WBG/GLD - `country'"
    local path_in_stata    "`myroot'/`level_1'/`level_2_mast'/Data/Stata"
    local path_in_other    "`myroot'/`level_1'/`level_2_mast'/Data/Original"
    local path_output      "`myroot'/`level_1'/`level_2_harm'/Data/Harmonized"
}
...
* Prepare district migration lookup
preserve
	use "`path_in_stata'/append_lfs_districts.dta", clear
	rename LFS24_Distcodes city_code
	rename LFS24_Distnames city_name
	drop samecode sametext
	rename *, lower
	save "`path_in_stata'/PAK_migration_code_2024.dta", replace
restore
...
/* <_hhid_note>
	...
	tostring hhno, replace format(%02.0f)
	egen  hhid = concat(pcode hhno)
...
*<_pid_>
	gen sno_str = sno
	tostring sno_str, replace format(%02.0f)
	egen pid = concat(hhid sno)
...
/* <_subnatid1_note>
	...
	gen subnatid1 = ""
	replace subnatid1 = "1 - Khyber/Pakhtoonkhua" if province==1
	replace subnatid1 = "2 - Punjab" if province==2
	replace subnatid1 = "3 - Sindh" if province==3
...
* LFS Report breaks down information by province & urban/rural
	gen subnatidsurvey = ""
...
*<_hsize_>
	gen member_count=1 if s4c3<8
	replace member_count=0 if mi(member_count)
	bys hhid: egen byte hsize=sum(member_count)
	* From the logic of s4c3 it emerges that there are servants in there (47)
	* These are not part of the household but rather form their own household 
	* (by definition they are not an economic unit with the others)
	
	* Then there is the question of the non-relatives (37 cases)
	* One may think these are relatives of the servant, but there is never a 
	* household with a servant and a non-relative. 
	* gen test = s4c3 == 8
	* bys hhid : egen maxer = max(test)
	* tab s4c3 maxer
	
	* Realising this, one option would be to drop them from the sample
	* However, this is just 47 in a sample of 325K, leave them in.
*</_hsize_>
...
*<_relationharm_>
	gen relationharm =s4c3
	recode relationharm 4=3 5=4 6 7=5 8 9=6
	label var relationharm "Relationship to the head of household - Harmonized"
	la de lblrelationharm  1 "Head of household" 2 "Spouse" 3 "Children" 4 "Parents" 5 "Other relatives" 6 "Other and non-relatives"
	label values relationharm  lblrelationharm
* There is one and only one head per household
	bys hhid : egen lowest_rel = min(s4c3)
	bys hhid : egen tot_heads  = total(s4c3 == 1)
	assert lowest_rel == 1
	assert tot_heads == 1
*</_relationharm_>
...
*<_migrated_binary_>
	gen migrated_binary = cond(s4c15==1,0,1)
...
/* <_migrated_years_note>
   ...
   code 7 for 5 to 10 years,
   code 8 for 11 or more years

   Code 0.5 for less than a year, half-point for 5-10 window (e.g., 7.5)
   and code 11 as a lower bound for the 11+ option  
</_migrated_years_note> */
...
*<_migrated_years_>
   ...
   replace migrated_years=7.5 if s4c15==7
   replace migrated_years=11 if s4c15==8
...
/* <_migrated_from_cat_note>
   The variable s4c16 gives us the code of where they are coming from. 
   Unfortunately we do not have the information of where they live currently. 
   However, we know from the pcode that the first digit of s4c16 (if under 1000)
   is the province. We can use that to establish at least some information 
</_migrated_from_cat_note> */
		gen helper_mfc_1 = string(floor(s4c16/100)) if s4c16 < 1000
	gen helper_mfc_2 = substr(pcode,1,1)
	
	gen migrated_from_cat = .
	
	replace migrated_from_cat = 3 if helper_mfc_1 == helper_mfc_2
	replace migrated_from_cat = 4 if helper_mfc_1 != helper_mfc_2 & migrated_binary == 1 & s4c16 < 1000
	replace migrated_from_cat = 5 if s4c16 > 999 & !mi(s4c16)
...
*<_migrated_from_country_>
	merge m:1 city_code using "`path_in_stata'/PAK_country_code_2020.dta"
	drop if _merge == 2
	drop _merge
...
*<_migrated_reason_>
	...
	recode migrated_reason (1/4 6=3) (5=2) (8/11=1) (14/16 = 4) (7 12/13 17=5) 
...
*<_school_>
	gen byte school = .
	replace school=0 if s4c10<=3
	replace school=1 if s4c10>3 & s4c10!=.
...
*<_literacy_>
	gen byte literacy = .
	replace literacy=1 if s4c81==1 & s4c82==1		//NB: Original variable has a strange data label but underlying numeric variable (1 for yes) seems correct
...
*<_educat_orig_>
	gen educat_orig = s4c9
	label var educat_orig "Original survey education code"
*</_educat_orig_>


*<_educat_isced_>
	gen educat_isced = s4c9
	replace educat_isced=. if !inrange(s4c9, 1, 16)
	recode educat_isced 1=. 2/3=20 3=100 4/6=244 7=344 8/12=660 13/14=760 1516=860
...
*<_vocational_type_>
	gen vocational_type = s4c11
	recode vocational_type (1=1) (2=2)
	replace vocational_type=. if !inrange(vocational_type, 1, 2)
...
*<_vocational_length_l_>
	gen vocational_length_l = s4c13
	replace vocational_length_l=vocational_length_l/4.2
	label var vocational_length_l "Length of training in months, lower limit"
*</_vocational_length_l_>


*<_vocational_length_u_>
	gen vocational_length_u = s4c13
	replace vocational_length_u=vocational_length_u/4.2
...
*<_vocational_field_orig_>
	gen code = s4c12                  
	merge m:1 code using "`path_in_stata'/PAK_training_code.dta"
	drop if _merge == 2
	gen vocational_field_orig = code    
	labmask vocational_field_orig, values(training_field)
	decode vocational_field_orig, gen(vocational_field_str)
	replace vocational_field_str = string(code) + " - " + vocational_field_str
	drop vocational_field_orig code _merge
	rename vocational_field_str vocational_field_orig
	replace vocational_field_orig="" if vocational_field_orig==". - "
	label var vocational_field_orig "Original field of training"
*</_vocational_field_orig_>
...
gen byte lstatus = .
	...
	* 2. Had a job but did not work last week (5.4 = 1), AND either:
	*    (a) will return within 3 months (5.6 = 1), OR
	*    (b) continues to receive income during absence (5.7 = 1)
	replace lstatus = 1 if s5c4 == 1 & (s5c6 == 1 | s5c7 == 1) & missing(lstatus)

	* 3. Work (from 5.2 or 5.3) is not agriculture/livestock/fishing (5.9 = 4)
	replace lstatus = 1 if s5c9 == 4 & missing(lstatus)
	...
	* AND available to start within 2 weeks (9.6 = 1)
	replace lstatus = 2 if s9c1 == 1 & s9c6 == 1 & missing(lstatus)

	* Future starters: waiting to start a new job (5.5 = 1)
	* However this is conflated here with whether in agriculture/livestock/fishing
	* end the labels do not match the questionnaire (starts with 0, misses code 5)
	* Hence we accept not to do this here, few cases commonly anyway

	* --- NOT IN LABOR FORCE ---
	replace lstatus = 3 if missing(lstatus) & age >= minlaborage

	* Set missing below minimum working age
	replace lstatus = . if age < minlaborage
	
	label var lstatus "Labor status 7 day recall"
	la de lbllstatus 1 "Employed" 2 "Unemployed" 3 "Not in labor force"
...
Attention: Change in qnr in the question on "available" to work. This only has 2 answer options (yes/no) compared to the previous 4 options. Code modified accordingly for 2024-25
</_potential_lf_>*/
...
*<_potential_lf_>
	...
	replace potential_lf=1 if (s9c1==2 & s9c6==1) | (s9c1==1 & s9c6==2)
...
*<_underemployment_>
	...
	replace underemployment=1 if s6c2==1
	replace underemployment=0 if s6c2==2
...
*<_nlfreason_>
	gen byte nlfreason = .
	gen nlfreason_1 = s9c9 if lstatus==3 
	recode nlfreason_1 (7=1) (9=2) (10/11=3) (1/6 12/13 = 5) (8=4)
	gen nlfreason_2 = s9c5 if lstatus==3
	recode nlfreason_2 (9=1) (10=2) (12=4) (1/8 11 13/14=5)
	replace nlfreason=nlfreason_1
...
*<_unempldur_l_>
	...
	replace unempldur_l=s9c3 if lstatus==2
	recode unempldur_l (1=0) (2=1) (3=3) (4=6) (5=12)
	replace unempldur_l=. if lstatus==1
...
*<_unempldur_u_>
	...
	replace unempldur_u=s9c3 if lstatus==2
	recode unempldur_u (1=0) (2=3) (3=6) (4=12) (5=.)
	replace unempldur_u=. if lstatus==1
...
{
*<_empstat_>
	gen byte empstat = s5c11
	recode empstat (3 5=1) (4=2) (1=3) (2=4) (6=5)
	replace empstat=. if !inrange(s5c11, 1, 6)
...
*<_ocusec_>
	gen byte ocusec = s5c15
	recode ocusec (1/3=1) (4=3) (5/10=2) (11=4)
...
*<_industry_orig_>
	gen industry_orig = string(s5c13, "%04.0f")
...
*the codes were incorrect.
	...
	replace industrycat10=6  if inrange(industrycat_isic, "4500","4799") | inrange(industrycat_isic, "5500","5699")
	replace industrycat10=7  if inrange(industrycat_isic, "4900","5399") | inrange(industrycat_isic, "5800","6399")
...
*<_occup_isco_>
	...
	* One wayward code (detected through running the below code that now checks 
	* out). Only one instance, take it to the next existing level
...
*<_wage_no_compen_>
	gen last_week  = s7c33
	gen last_month = s7c43
	gen last_year  = s7c9

	* Treat zero or negative values as missing
	replace last_week  = . if last_week  <= 0
	replace last_month = . if last_month <= 0
	replace last_year  = . if last_year  <= 0

	* For the handful of cases with overlap, prioritize monthly over weekly
	replace last_week  = . if !mi(last_week)  & !mi(last_month)

	* Combine into single wage variable (no unit conversion — values kept as reported)
	egen double wage_no_compen = rowtotal(last_week last_month last_year), missing

	* Unpaid workers should have missing wage, not zero
	replace wage_no_compen = . if empstat == 2
	replace wage_no_compen = . if lstatus != 1

	label var wage_no_compen "Last wage payment primary job 7 day recall"
	drop last_week last_month last_year
*</_wage_no_compen_>

*<_unitwage_>
/* <_unitwage_note>
	Unitwage refers to the unit used to record wage_no_compen, *not* the unit of
	general wage payment. wage_no_compen holds the value as reported by the
	respondent: weekly amount for weekly reporters, monthly for monthly, annual
	for annual. unitwage identifies which unit applies to each observation.
</_unitwage_note> */

	gen byte unitwage = .
	replace unitwage = 2 if !mi(s7c33) & s7c33 > 0 & lstatus == 1	// weekly reporters
	replace unitwage = 5 if !mi(s7c43) & s7c43 > 0 & lstatus == 1	// monthly reporters (overwrites weekly for overlaps)
	replace unitwage = 8 if !mi(s7c9)  & s7c9  > 0 & lstatus == 1 & mi(s7c43) & mi(s7c33)	// annual, only if no other period reported

	replace unitwage = . if empstat == 2
	replace unitwage = . if lstatus != 1

	label var unitwage "Last wages' time unit primary job 7 day recall"
	la de lblunitwage 1 "Daily" 2 "Weekly" 3 "Every two weeks" 4 "Bimonthly" ///
		5 "Monthly" 6 "Trimester" 7 "Biannual" 8 "Annually" 9 "Hourly" 10 "Other"
...
*no restriction
	gen whours=.
	replace whours = s5c24 if lstatus ==1
...
*<_contract_>
	gen byte contract = .
	replace contract=s7c1 if lstatus==1
	recode contract 1/6=1  7=0
...
*<_socialsec_>
	...
	replace socialsec=1 if s7c61==1 | s7c64==4
...
*<_union_>
	gen byte union = .
	replace union=1 if s5c20==1
	replace union=0 if s5c20==2 | s5c20==3
...
{
*<_empstat_2_>
	gen byte empstat_2 = s5c26
	recode empstat_2 (3 5=1) (4=2) (1=3) (2=4) (6=5) (0=.)
	replace empstat_2=. if s5c25!=1
...
*<_ocusec_2_>
	gen byte ocusec_2 = s5c30
	recode ocusec_2 (1/3=1) (4=3) (5/10=2) (11=4)
	replace ocusec_2=. if s5c25!=1
...
*<_industry_orig_2_>
	gen industry_orig_2 = string(s5c28, "%04.0f")
	replace industry_orig_2="" if lstatus!=1
	replace industry_orig_2="" if industry_orig=="."
...
*<_industrycat_isic_2_>
	...
	replace industrycat_isic_2="0320" if industry_orig_2=="320"
	*we approximate to the higher level.
	replace industrycat_isic_2="6120" if industry_orig_2=="6121"
	* Check that no errors --> using our universe check function, count should be 0 (no obs wrong)
	*https://github.com/worldbank/gld/tree/main/Support/Z%20-%20GLD%20Ecosystem%20Tools/ISIC%20ISCO%20universe%20check
	preserve 
...
*<_industrycat10_2_>
	...
	replace industrycat10_2=6  if inrange(industrycat_isic_2, "4500","4799") | inrange(industrycat_isic_2, "5500","5699")
	replace industrycat10_2=7  if inrange(industrycat_isic_2, "4900","5399") | inrange(industrycat_isic_2, "5800","6399")
	replace industrycat10_2=8  if inrange(industrycat_isic_2, "6400","8299")
	replace industrycat10_2=9  if inrange(industrycat_isic_2, "8400","8499")
...
*<_occup_orig_2_>
	gen occup_orig_2 = string(s5c27, "%04.0f")
	replace occup_orig_2 = "" if lstatus != 1
	replace occup_orig_2 = "" if industry_orig == "."
...
*<_occup_isco_2_>
	...
	* One wayward code (detected through running the below code that now checks 
	* out). Only one instance, take it to the next existing level
	replace occup_isco_2= "4100" if occup_isco_2 == "4140"
	replace occup_isco_2= "2300" if occup_isco_2 == "2333"
	replace occup_isco_2= "9500" if occup_isco_2 == "9516"
	* Check that no errors --> using our universe check function, count should be 0 (no obs wrong)
	* https://github.com/worldbank/gld/tree/main/Support/Z%20-%20GLD%20Ecosystem%20Tools/ISIC%20ISCO%20universe%20check
	preserve 
...
*<_occup_2_>
	gen byte occup_2 = .
	replace occup_2 = 1 if inrange(occup_isco_2, "1000", "1999")
	replace occup_2 = 2 if inrange(occup_isco_2, "2000", "2999")
	replace occup_2 = 3 if inrange(occup_isco_2, "3000", "3999")
	replace occup_2 = 4 if inrange(occup_isco_2, "4000", "4999")
	replace occup_2 = 5 if inrange(occup_isco_2, "5000", "5999")
	replace occup_2 = 6 if inrange(occup_isco_2, "6000", "6999")
	replace occup_2 = 7 if inrange(occup_isco_2, "7000", "7999")
	replace occup_2 = 8 if inrange(occup_isco_2, "8000", "8999")
	replace occup_2 = 9 if inrange(occup_isco_2, "9000", "9999")
	replace occup_2 = 10 if inrange(occup_isco_2, "0000", "0999")
...
*<_firmsize_l_2_>
	gen firmsize_l_2 = s5c33
	replace firmsize_l_2=. if s5c25!=1 | s5c33==0
	label var firmsize_l_2 "Firm size (lower bracket) secondary job 7 day recall"
*</_firmsize_l_2_>


*<_firmsize_u_2_>
	gen firmsize_u_2 = s5c33
	replace firmsize_l_2=. if s5c25!=1 | s5c33==0
...
*<_njobs_>
	gen njobs = .
	replace njobs=1 if s5c25==2
	replace njobs=2 if s5c25==1 & s5c36==2
	replace njobs=3 if s5c25==1 & s5c36==1
