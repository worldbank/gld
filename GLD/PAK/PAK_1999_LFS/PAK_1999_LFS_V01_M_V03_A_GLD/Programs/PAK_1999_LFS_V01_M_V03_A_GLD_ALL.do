...
/* -----------------------------------------------------------------------
<_Program name_>				PAK_1999_LFS_V01_M_V03_A_GLD_ALL.do </_Program name_>
<_Application_>					path_in_stata MP 16.1 <_Application_>
<_Author(s)_>					Wolrd Bank Job's Group </_Author(s)_>
<_Date created_>				2022-07-25 </_Date created_>
-------------------------------------------------------------------------
...
<_Data collection from (M/Y)_>	[July/1999] </_Data collection from (M/Y)_>
<_Data collection to (M/Y)_>	[June/2000] </_Data collection to (M/Y)_>
<_Source of dataset_> 			Pakistan Bureau of Statistics </_Source of dataset_>
								https://www.pbs.gov.pk/content/microdata
<_Sample size (HH)_> 			17,444 </_Sample size (HH)_>
<_Sample size (IND)_> 			111,473 </_Sample size (IND)_>
...
* Date: [2023-01-31] File: [PAK_1999_LFS_V01_M_V02_A_GLD_ALL.do] - [Directories & setting up format update; revise all "original" variables i.e. industrycat_orig; comment title format update]
* Date: [2023-03-29] File: [PAK_1999_LFS_V01_M_V03_A_GLD_ALL.do] - [Removed byte for all firmsize-related variable coding]
...
* harmonized output in a single file
	...
	use "`path_in_stata'\lfs_9900.dta", clear
...
*<_psu_>
	gen str3 psu=substr(process_code,5,3)
...
*<_ssu_>
	gen str2 ssu=substr(process_code, 8, 2)
	label var ssu "Secondary sampling units"
*</_ssu_>


*<_strata_>
	gen str2 stratum=substr(process_code,3,2)
...
*<_urban_>
	gen str1 urban=substr(process_code,2,1)
...
*<_subnatid1_>
	...
	label de lblsubnatid1 1 "1-Punjab" 2 "2-Sindh" 3 "3-N.W.F.P" 4 "4-Balochistan" 
...
*<_subnatid2_>
	gen city_code=substr(process_code, 1, 4)
	destring city_code, replace
	merge m:1 city_code using "`path_in_stata'\PAK_city_code.dta"
	drop if _merge!=3
...
*<_relationharm_>
	...
	gen neg_age=-(age)
	sort hhid male neg_age serialno
...
*<_migrated_binary_>
	gen migrated_binary=cond(howlonglv==1, 0, 1)
...
/*<_migrated_years_note_>
   ...
   code 3 for 1 to 4 years,
   code 4 for 5 to 9 years,
   code 5 for 10 or more years
   Code 0.5 for less than a year, half-point for 1-4 and 5-9 windows (e.g., 2.5 and 7)
...
*<_migrated_years_>
   gen migrated_years=.
   replace migrated_years=0.5 if howlonglv==2
   replace migrated_years=2.5 if howlonglv==3
   replace migrated_years=7 if howlonglv==4
   replace migrated_years=10 if howlonglv==5
...
*<_migrated_from_urban_>
	gen migrated_from_urban=prevres
...
*<_migrated_reason_>
	gen migrated_reason=reason_mig
	recode migrated_reason (6/7=1) (3=2) (1/2=3) (4/5 8/9=5) 
...
*<_school_>
	gen byte school=.
	replace school=0 if curenrol==1
	replace school=1 if curenrol>1 & curenrol!=.
...
*<_educy_>
	gen byte educy=.
	replace educy=0 if edulevel<=3
	replace educy=5 if edulevel==4
	replace educy=8 if edulevel==5
	replace educy=10 if edulevel==6
	replace educy=12 if edulevel==7
	replace educy=16 if edulevel==8
	replace educy=17 if edulevel==9
	replace educy=16 if edulevel==10
	replace educy=16 if edulevel==11
	replace educy=17 if edulevel==12
...
*<_educat7_>
	gen byte educat7=edulevel
	recode educat7 (3=2) (4=3) (5/6=4) (8/12=7) 
	replace educat7=5 if edulevel==7&curenrol==1
	replace educat7=7 if edulevel==7&inrange(curenrol,8,12) 
...
*<_educat_orig_>
	gen educat_orig=edulevel
	label var educat_orig "Original survey education code"
*</_educat_orig_>


*<_educat_isced_>
	gen educat_isced=edulevel
	recode educat_isced 1=. 2/3=20 3=100 4/6=244 7=344 8/11=660 12=760 
...
*<_vocational_type_>
	...
	replace vocational_type=. if age<10
...
*<_vocational_field_orig_>
	gen vocational_field_orig=train_code
...
*<_vocational_financed_>
	...
	replace vocational_financed=. if age<10
...
1)available but not searching or [inlist(q28,3,7) & !inrange(q26, 1, 5)]
2)searching but not immediately available to work or [q26==6 & !inrange(q26, 3, 7)]
</_potential_lf_note_>*/
...
*<_potential_lf_>
	...
	replace potential_lf=1 if [inrange(q28,3,7) & !inrange(q26,1,5)] | [q26==6 & inrange(q28,1,2)]
	replace potential_lf=0 if [inrange(q28,1,2) & inrange(q26,1,5)] | [inrange(q28,3,7) & q26==6]
...
*<_underemployment_>
	...
	replace underemployment=1 if q20==1
	replace underemployment=0 if q20==2
...
*<_nlfreason_>
	recode q39 (4 5=1) (6=2) (7 10=3) (1 11=4) (8 9 12=5) (0=.), gen(nlfreason)
...
*<_empstat_>
	gen byte empstat=.
	replace empstat=1 if q09<=4 
	replace empstat=2 if q09==11|q09==12
	replace empstat=3 if q09==5
	replace empstat=4 if (q09>=6 & q09<=10)
	replace empstat=5 if q09==13
	replace empstat=. if !inrange(q09, 1, 13)
...
*<_industry_orig_>
	gen industry_orig=q08
	label var industry_orig "Original survey industry code, main job 7 day recall"
*</_industry_orig_>


*<_industrycat_isic_>
	gen industrycat_isic=q08
...
*<_wage_no_compen_>
	...
	foreach v of varlist last_*{
		replace `v'=0 if q23>0&q24>0 &!mi(q23)&!mi(q24)
...
*<_unitwage_>
	gen byte unitwage=.
	replace unitwage=2 if wage_no_compen==q23
	replace unitwage=5 if wage_no_compen==q24
	replace unitwage=10 if wage_no_compen>q24&!mi(wage_no_compen)
...
q18t ; q18_1 ; q18_2 ; q18_3

Except q18t the other three variables only have 0-7, 8 categories in total, which does not make sense in terms of "working hours", as this working hours is supposed to be continuous integers.
...
*<_industrycat10_2_>
	...
	replace industrycat10_2=. if q16!=1
...
*<_njobs_>
	gen njobs=.
	replace njobs=1 if q16==2
	replace njobs=2 if q16==1
