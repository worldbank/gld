...
/* -----------------------------------------------------------------------
<_Program name_>				PAK_2020_LFS_V01_M_V07_A_GLD_ALL.do </_Program name_>
<_Application_>					Stata MP 16.1 <_Application_>
<_Author(s)_>					Wolrd Bank Job's Group </_Author(s)_>
<_Date created_>				2022-06-23 </_Date created_>
-------------------------------------------------------------------------
...
* Date: [2023-02-11] File: [PAK_2020_LFS_V01_M_V02_A_GLD_ALL.do] - [Directories & setting up format update; revise all "original" variables i.e. industrycat_orig; comment title format update]
* Date: [2023-03-30] File: [PAK_2020_LFS_V01_M_V03_A_GLD_ALL.do] - [Removed "byte" for firmsize variable coding]
* Date: [202Y-MM-DD] File: [PAK_2020_LFS_V01_M_V04_A_GLD_ALL.do] - []
* Date: [2026-01-20] File: [PAK_2020_LFS_V01_M_V05_A_GLD_ALL.do] - [Correct industrycat10_2, industrycat4_2]

* Date: 2026-02-18 - update industry_orig, lstatus, migrated_from_cat, migrated_from_code, occup_orig, occup_orig_2, potential_lf, subnatid2, unitwage, vocational, vocational_field_orig, vocational_financed, vocational_length_l, vocational_length_u, vocational_type, wage_no_compen

* Date: 2026-03-11 - update lstatus
...
* harmonized output in a single file
	...
	use "`path_in_stata'/LFS2020-21.dta", clear
...
*<_pid_>
	...
	egen str13 pid=concat(hhid person_id), p("0")
...
*<_strata_>
	gen str2 stratum=substr(PCode,2,2)
...
*<_subnatid2_>
	gen helper_s2 = substr(PCode, 1, 3)
	
	*Apply the District strings as value labels to subnatid2
	replace District="MARDAN" if District=="Mardan"
	replace District="SARGODHA" if District=="Sargodha"
	replace District="RAJANPUR" if District=="Rajanpur"
	replace District="SARGODHA" if District=="Sargodha"
	replace District="KARACHI WEST" if District=="WEST" & helper_s2=="351"
	replace District="KARACHI EAST" if District=="EAST" & helper_s2=="354"
	*Incorrect District: subnatid2 code 322 should be Ghotki district, not Sukkur
	replace District="GHOTKI" if District=="SUKKUR" & helper_s2=="322"
	
	gen subnatid2 = helper_s2 + " - " + District
...
*<_migrated_from_cat_>
	* Get district and province info of current residence
	gen h_curr_p = substr(PCode,1,1)
	gen h_curr_d = substr(PCode,1,3)
	
	* Extract last province from last district code
	gen h_last_p = substr(S4C16,1,1)
	
	* Denote if last district code is outside of country
	gen h_last_ex = length(S4C16) == 4
	
	gen migrated_from_cat = .
	replace migrated_from_cat = 2 if h_curr_d == S4C16
	replace migrated_from_cat = 3 if h_curr_p == h_last_p & mi(migrated_from_cat)
	replace migrated_from_cat = 4 if h_curr_p != h_last_p & migrated_binary == 1 & h_last_ex == 0
	replace migrated_from_cat = 5 if h_last_ex == 1
	replace migrated_from_cat = . if migrated_binary != 1
	label de lblmigrated_from_cat 1 "From same admin3 area" 2 "From same admin2 area" 3 "From same admin1 area" 4 "From other admin1 area" 5 "From other country", replace
...
*<_migrated_from_code_>
	...
	merge m:1 city_code using "`path_in_stata'/PAK_migration_code_2020.dta"
...
*<_migrated_from_country_>
	merge m:1 city_code using "`path_in_stata'/PAK_country_code_2020.dta", gen(_merge_c)
	drop if _merge_c==2
...
*<_literacy_>
	gen byte literacy=.
	replace literacy=1 if S4C81==1 & S4C82==1
...
*<_educat_isced_>
	...
	replace educat_isced=. if !inrange(S4C9, 1, 15)
...
*<_vocational_>
	...
	recode vocational (10/20=1) (21=0)
...
*<_vocational_length_l_>
	*Lower and upper limit same since lenght indicated in weeks
	gen vocational_length_l = S4C13
	replace vocational_length_l=vocational_length_l/4.33
	label var vocational_length_l "Length of training (months), lower limit"
*</_vocational_length_l_>


*<_vocational_length_u_>
	gen vocational_length_u = S4C13
	replace vocational_length_u=vocational_length_u/4.33
	label var vocational_length_u "Length of training (month), upper limit"
*</_vocational_length_u_>
...
*<_vocational_field_orig_>
	...
	merge m:1 code using "`path_in_stata'/PAK_training_code_2020.dta"
	drop if _merge == 2
...
*<_vocational_financed_>
	* Question asks not how training financed but who provided it, set to "."
...
/*<_lstatus_note_>
	...
	*** Employed *** 
	if work for profit or in a farm business;
	A person is employed if any of the following hold:
	  - S5C1 == 1: did paid work in reference period
	  - S5C2 == 1: had a job but was absent
	  - S5C3 == 1 AND ( S5C5 == 1 OR ( S5C5 in 2-4 AND S5C6 == 1 ) ):
	    not at work but out for 3 months or fewer or still being paid

	*** Unemployed ***
	Union of active search (yes to S9C1) and passive search (yes to S9C4) or (1 or 2 to S9C6)
...
*<_lstatus_>
	gen byte lstatus = .
	replace lstatus = 1 if S5C1 == 1 | S5C2 == 1 | ( S5C3 == 1 & ( S5C5 == 1 | ( inrange(S5C5, 2, 4) & S5C6 == 1 ) ) )
	replace lstatus = 2 if lstatus != 1 & S9C1 == 1 & inlist(S9C6,1,2)
...
2) searching but not  available to work
...
*<_potential_lf_>
	...
	replace potential_lf = 1 if S9C1==2 & inrange(S9C6, 1, 2)
	replace potential_lf = 1 if S9C1==1 & inrange(S9C6, 3, 4)
...
*<_nlfreason_>
	gen byte nlfreason=S9C5
	recode nlfreason (9=1) (10=2) (12=4) (1/8 11 13/14=5)
...
Unemployment duration in 2020 is a specific number of weeks/months/years. So the 
...
*<_unempldur_l_>
	gen byte unempldur_l=S9C3
	recode unempldur_l (1=0) (2=1) (3=3) (4=6) (5=1)
...
*<_unempldur_u_>
	gen byte unempldur_u=S9C3
	recode unempldur_u (1=1) (2=3) (3=6) (4=12) (5=.)
...
*<_empstat_>
	gen byte empstat=.
	replace empstat=1 if S5C7<=4 
	replace empstat=2 if S5C7==11 | S5C7==12
	replace empstat=3 if S5C7==5  
	replace empstat=4 if (S5C7>=6 & S5C7<=10) | S5C7==13
	replace empstat=5 if S5C7==14
	replace empstat=. if !inrange(S5C7, 1, 14)
...
*<_unitwage_>
	gen byte unitwage = .
	replace unitwage  = 2  if wage_no_compen == S7C33
	replace unitwage  = 5  if wage_no_compen == S7C43
	replace unitwage  = 10 if wage_no_compen >  S7C33 & !mi(wage_no_compen)
...
{
*<_empstat_2_>
	gen byte empstat_2=S5C18
	recode empstat_2 (1/4=1) (11/12=2) (5=3) (6/10 13=4) (14=5)
	replace empstat_2=. if S5C17!=1
...
*<_ocusec_2_>
	gen byte ocusec_2=S5C21
	recode ocusec_2 (1/3=1) (4 6=3) (5/9=2) (10=4)
	replace ocusec_2=. if S5C17!=1
...
*<_industrycat_isic_2_>
	...
	gen industrycat_isic_2=S5C20
	tostring industrycat_isic_2, replace format(%04.0f)
	replace industrycat_isic_2="" if S5C17!=1 | mi(S5C20) | industrycat_isic_2=="."
...
*<_occup_orig_2_>
	gen occup_orig_2 = S5C19
	replace occup_orig_2 = "" if S5C17 != 1
	label var occup_orig_2 "Original occupation record secondary job 7 day recall"
*</_occup_orig_2_>


*<_occup_isco_2_>
	gen occup_isco_2=S5C19
	destring occup_isco_2, replace
	tostring occup_isco_2, replace format(%04.0f)
	replace occup_isco_2="" if S5C17!=1 | mi(S5C19) | occup_isco_2=="."
...
*<_occup_skill_2_>
	...
	replace occup_skill_2=. if skill_level_2==0 | S5C17!=1
...
*<_firmsize_l_2_>
	gen firmsize_l_2=S5C23
	replace firmsize_l_2=. if S5C17!=1
	label var firmsize_l_2 "Firm size (lower bracket) secondary job 7 day recall"
*</_firmsize_l_2_>


*<_firmsize_u_2_>
	gen firmsize_u_2=S5C23
	replace firmsize_l_2=. if S5C17!=1
...
*<_njobs_>
	gen njobs=.
	replace njobs=1 if S5C17==2
	replace njobs=2 if S5C17==1 & S5C26==3
	replace njobs=3 if S5C17==1 & S5C26==1
	replace njobs=4 if S5C17==1 & S5C26==2
