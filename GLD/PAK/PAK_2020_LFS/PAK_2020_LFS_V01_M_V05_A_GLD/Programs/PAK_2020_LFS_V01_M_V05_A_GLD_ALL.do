...
/* -----------------------------------------------------------------------
<_Program name_>				PAK_2020_LFS_V01_M_V05_A_GLD_ALL.do </_Program name_>
...
*<_subnatid2_>
	...
	merge m:m city_name using "`path_in_stata'\PAK_subnatid2_code_2020.dta"
	drop if _merge!=3
...
*<_vocational_financed_>
	gen vocational_financed=S4C14
	recode vocational_financed (2=4) (1=2) (3=5)
...
*<_lstatus_>
	...
	* Code unemployed
    gen active = S9C1 == 1
    gen passive = S9C4 == 1 | inlist(S9C6,1,2)
...
*<_wage_no_compen_>
	...
	foreach v of varlist last_*{
		replace `v'=0 if S7C33>0 & S7C43>0 & !mi(S7C33) & !mi(S7C43)
