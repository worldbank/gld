...
<_Program name_>				BLZ_1994_LFS_V01_M_V01_A_GLD.do </_Program name_>
...
<_Sample size (HH)_> 			2,882 </_Sample size (HH)_>
<_Sample size (IND)_> 			13,660 </_Sample size (IND)_>
...
* harmonized output in a single file
	...
	use "`path_in_stata'\bel94_base.dta", clear
	rename qid id
	format id %15.0g
	rename p00 com
	sort id com

	merge id com using "`path_in_stata'\bel94_cedlas.dta"
	tab _merge
	rename id qid
	rename com p00
	drop _merge
