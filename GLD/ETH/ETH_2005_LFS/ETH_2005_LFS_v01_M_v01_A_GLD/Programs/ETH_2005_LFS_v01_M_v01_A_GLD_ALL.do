...
*<_subnatid2_>
	...
	gen subnatid2=""
	replace subnatid2="1.1 - N.W.Tigray" if code=="1.1"
	replace subnatid2="1.2 - C.Tigray" if code=="1.2"
	replace subnatid2="1.3 - E.Tigray" if code=="1.3"
	replace subnatid2="1.4 - S.Tigray" if code=="1.4"
	replace subnatid2="1.5 - W.Tigray" if code=="1.5"	
	replace subnatid2="1.6 - Mekele" if code=="1.6"
	replace subnatid2="2.1 - Afar-Zone1" if code=="2.1"
	replace subnatid2="2.3 - Afar-Zone3" if code=="2.3"
	replace subnatid2="3.1 - N.Gonder" if code=="3.1"
	replace subnatid2="3.2 - S.Gonder" if code=="3.2"
	replace subnatid2="3.3 - N.Wollo" if code=="3.3"
	replace subnatid2="3.4 - S.Wollo" if code=="3.4"
	replace subnatid2="3.5 - N.Shewa" if code=="3.5"
	replace subnatid2="3.6 - East Gojam" if code=="3.6"
	replace subnatid2="3.7 - W.Gojam" if code=="3.7"
	replace subnatid2="3.8 - Waghimra" if code=="3.8"
	replace subnatid2="3.9 - Awi" if code=="3.9"
	replace subnatid2="3.10 - Oromiya" if code=="3.10"
	replace subnatid2="3.11 - Bahir Dar" if code=="3.11"	
	replace subnatid2="4.1 - W.Wellega" if code=="4.1"
	replace subnatid2="4.2 - E.Wellega" if code=="4.2"
	replace subnatid2="4.3 - Ilubabor" if code=="4.3"
	replace subnatid2="4.4 - Jimma" if code=="4.4"
	replace subnatid2="4.5 - W.Shewa" if code=="4.5"
	replace subnatid2="4.6 - N.Shewa" if code=="4.6"
	replace subnatid2="4.7 - E.Shewa" if code=="4.7"
	replace subnatid2="4.8 - Arsi" if code=="4.8"
	replace subnatid2="4.9 - W.Harerge" if code=="4.9"
	replace subnatid2="4.10 - E.Harerge" if code=="4.10"
	replace subnatid2="4.11 - Bale" if code=="4.11"
	replace subnatid2="4.12 - Borena" if code=="4.12"
	replace subnatid2="4.13 - S.W.Shewa" if code=="4.13"
	replace subnatid2="4.14 - Gujji" if code=="4.14"
	replace subnatid2="4.15 - Adama/Nazret" if code=="4.15"
	replace subnatid2="4.16 - Jimma" if code=="4.16"
	replace subnatid2="5.1 - Shinile" if code=="5.1"
	replace subnatid2="5.2 - Jijiga" if code=="5.2"
	replace subnatid2="5.9 - Liben" if code=="5.9"
	replace subnatid2="6.2 - Metekel" if code=="6.2"
	replace subnatid2="6.3 - Asosa" if code=="6.3"
	replace subnatid2="6.4 - Kemashi" if code=="6.4"
	replace subnatid2="7.1 - Guraghe" if code=="7.1"
	replace subnatid2="7.2 - Hadiya" if code=="7.2"
	replace subnatid2="7.3 - Kembata Temb" if code=="7.3"
	replace subnatid2="7.4 - Sidama" if code=="7.4"
	replace subnatid2="7.5 - Gedeo" if code=="7.5"
	replace subnatid2="7.6 - Wolayta" if code=="7.6"
	replace subnatid2="7.7 - South Omo" if code=="7.7"
	replace subnatid2="7.8 - Shaka" if code=="7.8"
	replace subnatid2="7.9 - Kaffa" if code=="7.9"
	replace subnatid2="7.10 - Gamo Gofa" if code=="7.10"
	replace subnatid2="7.11 - Benh Maji" if code=="7.11"
	replace subnatid2="7.12 - Yem Special" if code=="7.12"
	replace subnatid2="7.13 - Amaro Special" if code=="7.13"
	replace subnatid2="7.14 - Burji Special" if code=="7.14"
	replace subnatid2="7.15 - Konso Special" if code=="7.15"
	replace subnatid2="7.16 - Dirashe" if code=="7.16"
	replace subnatid2="7.17 - Dawro" if code=="7.17"
	replace subnatid2="7.18 - Basketo" if code=="7.18"
	replace subnatid2="7.19 - Konta Special" if code=="7.19"
	replace subnatid2="7.20 - Siltie" if code=="7.20"
	replace subnatid2="7.21 - Alaba Special" if code=="7.21"
	replace subnatid2="12.1 - Gambela-Zone1" if code=="12.1"
	replace subnatid2="13.1 - Hareri" if code=="13.1"
	replace subnatid2="14.1 - Addis Ababa-Zone1" if code=="14.1"
	replace subnatid2="14.2 - Addis Ababa-Zone2" if code=="14.2"
	replace subnatid2="14.3 - Addis Ababa-Zone3" if code=="14.3"
	replace subnatid2="14.4 - Addis Ababa-Zone4" if code=="14.4"
	replace subnatid2="14.5 - Addis Ababa-Zone5" if code=="14.5"
	replace subnatid2="14.6 - Addis Ababa-Zone6" if code=="14.6"
	replace subnatid2="14.7 - Addis Ababa-Zone7" if code=="14.7"
	replace subnatid2="14.8 - Addis Ababa-Zone8" if code=="14.8"
	replace subnatid2="14.9 - Addis Ababa-Zone9" if code=="14.9"
	replace subnatid2="14.10 - Addis Ababa-Zone10" if code=="14.10"
	replace subnatid2="15.1 - Dire Dawa-Zone1" if code=="15.1"
...
*<_nlfreason_>
	gen byte nlfreason=LF61
	recode nlfreason (2=1) (1=2) (7=3) (3=4) (1 4/6 8=5) (0 9=.)
...
*<_ocusec_>
	gen byte ocusec=LF39
	recode ocusec (2=4) (4=1) (3 5/12=2) (99=.)
...
*<_industrycat_isic_>
	gen lf38=LF38
	tostring lf38, format(%04.0f) replace
	gen industrycat_isic=substr(lf38,1,3)
...
*<_occup_isco_>
	...
	replace occup_isco="" if occup_isco=="5700"|occup_isco=="9900"
...
*<_wage_no_compen_>
	gen double wage_no_compen=LF45
...
*<_firmsize_l_>
	gen byte firmsize_l=LF46A
	replace firmsize_l=10 if LF46A==1
	replace firmsize_l=0 if LF46A==2
	replace firmsize_l=. if LF46A==3|LF46A==9
...
*<_firmsize_u_>
	gen byte firmsize_u=LF46A
	replace firmsize_l=. if LF46A==1
	replace firmsize_l=9 if LF46A==2
	replace firmsize_l=. if LF46A==3|LF46A==9
...
*<_nlfreason_year_>
	gen byte nlfreason_year=LF73
	recode nlfreason_year (2=1) (1=2) (3=4) (7=3) (0 4/6 8=5)
...
*<_empstat_year_>
	gen byte empstat_year=LF74
	recode empstat_year (2/7 11=1) (9=2) (10=3) (8=4) (12=5) (99=.)
...
*<_ocusec_year_>
	gen byte ocusec_year=LF74
	recode ocusec_year (2/7 11=1) (9=2) (10=3) (8=4) (12=5) (99=.)
...
*<_njobs_>
	gen njobs=.
	replace njobs=1 if lstatus==1 & LF50!=1
	replace njobs=2 if LF50==1
