...
/* -----------------------------------------------------------------------
<_Program name_> 				ARM_2020_LFS_V01_M_V03_A_GLD_ALL.do </_Program name_>
...
<_Study ID_>					ARM_2020_LFS_v01_M </_Study ID_>
...
<_Source of dataset_> 			The Armenian 2020 to 2021 data is downloaded from 
...
<_Sample size (HH)_> 			7,781 </_Sample size (HH)_>
<_Sample size (IND)_> 		    27,986 </_Sample size (IND)_>
...
use "`path_in_stata'/ARM_LFS_2020_raw.dta", clear
...
6 households (24 observations) in the raw data set do not have household heads. 
Their household IDs are:

003430 004285 005503 
006281 006305 012044
...
*<_lstatus_note>*/
	...
	replace lstatus=3 if !mi(J1_6group)&lstatus==.
...
*<_nlfreason_>
	gen byte nlfreason=J1_6group
	recode nlfreason (4/6=5)
