...
Considering that the pid we have does no uniquely identify household members, 
here we used g12 for hsize.  
...
*<_migrated_binary_>
	...
	replace migrated_binary=0 if m11==2
...
*<_migrated_years_>    
	...
	replace migrated_years=round(m11m/12,0.1) if !mi(m11a)&m11a!=0
...
Original categorization of the M15 (level of education):

0. No level
1. Primary
2. General Secondary 1st cycle
3. General Secondary 2nd cycle
4. Technical Secondary 1st cycle
5. Technical Secondary 2nd cycle
6. Upper
7. Post primary

Translated original categorization of the M16 (highest degree earned):

1. No diploma --- 0 year
2. CEPE/CEP/FSLC (Primary School Certificate) --- 6 years [ISCED 100]
3. BEPC/CAP/GCEOL (Certificate of Undergraduate Studies) --- 10 years [ISCED 244]
4. Probation/BP (Probationary Technical Certificate, after CAP) --- 12 years [ISCED 352] 
5. BAC/GCEAL/BEP (Technical Baccalaureate Certificate) --- 13 years [ISCED 354]
6. BTS/DUT/DEUG/NHD (Professional License) --- 16 years [ISCED 660]
7. License/Bachelor Degree --- 13 years [ISCED 344] 
8. Master's Degree/Masters/MBA --- 18 years [ISCED 760]
9. Ph.D. --- 20 years [ISCED 860]

** External reference for educational system: 
https://www.alberta.ca/iqas-education-guide-cameroon

*<_educy_note_>*/

	gen byte educy=.
	replace educy=0 if m16==1 
	replace educy=6 if m16==2
	replace educy=10 if m16==3
	replace educy=12 if m16==4
	replace educy=13 if m16==5
	replace educy=16 if m16==6
	replace educy=13 if m16==7
	replace educy=18 if m16==8
	replace educy=20 if m16==9 
...
Variable educat7 cannot be coded with M16 since no category can be mapped to "Primary incomplete".
Moreover, "4-Probation" and  "5-BAC/GCEAL/BEP" are at upper secondary educational level,
so they are both "Primary Complete" and "Secondary Incomplete". 

In this case, we only coded educat4.
...
*<_educat4_>
	gen byte educat4=m16
	recode educat4 (4/6=3) (7/9=4)
...
*<_nlfreason_>
	...
	recode nlfreason (1=4) (2=1) (4=2) (6=5)
...
*<_empstat_>
	...
	recode empstat (1/5=3) (6 7=4) (8=2) (10=5)   
...
*<_industrycat10_>
	...
	recode industrycat10 (2/5=1) (6=2) (7/28=3) (29/30=4) (31=5) (32 33=6) (34 35=7) (36/38=8) (39=9) (40/44=10)
...
*<_wage_no_compen_note_>*/
    ...
    * to missing if value is 0.
     ...
     * Create salary categories based on winsor values
     ...
     replace salary_cata=2 if inrange(wage13a_w, 200000, 399999)
     replace salary_cata=3 if inrange(wage13a_w, 400000, 799999)
     replace salary_cata=4 if inrange(wage13a_w, 800000, 1499999)
     replace salary_cata=5 if inrange(wage13a_w, 1500000, 2999999)
     replace salary_cata=6 if inrange(wage13a_w, 3000000, 4999999)
     replace salary_cata=7 if inrange(wage13a_w, 5000000, 99999999)
