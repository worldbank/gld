...
<_Program name_>				ALB_2008_LFS_V01_M_V01_A_GLD </_Program name_>
<_Application_>					Stata SE 18.0 <_Application_>
<_Author(s)_>					World Bank Jobs Group (gld@worldbank.org) </_Author(s)_>
<_Date created_>				2024-11-15 </_Date created_>
...
<_Study ID_>					ALB_2008_LFS_V01_M </_Study ID_>
...
<_Sample size (HH)_> 			6662 </_Sample size (HH)_>
...
use "`path_in_stata'/english_version_lfs_2008.dta", clear
...
/* <_subnatid1_note>
	...
	egen subnatid1 = concat(id_prefekture prefekture), punct(" - ")
	replace subnatid1 = lower(subnatid1)
...
/* <_relationharm_note>
	...
	*unique hhid if total_heads == 0  //230 hh
	
	*spouse
		gen new_head = 1 if total_heads == 0 & hhlink == 2 //211 hh
		bys hhid : egen hh_new_head = count(new_head)
	*oldest member
		bysort hhid (age): gen oldest = (_n == _N) if total_heads == 0 & hh_new_head == 0 //19 hh
...
*<_migrated_binary_>
	gen migrated_binary = .
	replace migrated_binary = 1 if q17 != "00" | inrange(yearesid,1,99)
...
/* <_migrated_years_note>
	...
	gen migrated_years = 1 if q17 != "00"
...
*<_migrated_from_cat_>
	...
	replace migrated_from_cat = 4 if q17 == "AL" //national level
	replace migrated_from_cat = 5 if (q17 != "AL" & q17 != "00") | (inrange(yearesid,1,99) & migrated_from_cat == .)
...
/* <_migrated_from_code_note>
	...
	The information provided lacks clarity.
...
/* <_lstatus_note>
	...
	*** Exceptions ***
	...
	Respondents who answer yes in q82_10,q82_11 or q82_12 OR all aptions no in q82_* (confirms no job search) are considered Out of labour force
...
*<_occup_orig_>
	gen occup_orig = string(kode_profe)
...
*<_occup_isco_>
	gen occup_isco = string(kode_profe * 10, "%04.0f")
