...
<_Program name_>				ALB_2010_LFS_V01_M_V01_A_GLD </_Program name_>
<_Application_>					Stata SE 18.0 <_Application_>
<_Author(s)_>					World Bank Jobs Group (gld@worldbank.org) </_Author(s)_>
<_Date created_>				2024-11-27 </_Date created_>
...
<_Study ID_>					ALB_2010_LFS_V01_M </_Study ID_>
<_Data collection from_>		09/2010 </_Data collection from_>
<_Data collection to_>			10/2010 </_Data collection to_>
<_Source of dataset_> 			INSTAT </_Source of dataset_>
<_Sample size (HH)_> 			6411 </_Sample size (HH)_>
<_Sample size (IND)_> 			18436 </_Sample size (IND)_>
...
use "`path_in_stata'/LFS 2010_English.dta", clear
...
/* <_hhid_note>
	...
	tostring ID_HH, gen(hh_str) format(%04.0f)
...
*<_weight_>
/* <_weight_note>
	In 3 observations, the weight did not retain all the decimal points. Ensure that all the appropriate decimal points are included.
</_weight_note> */
...
/* <_subnatid1_note>
	...
	gen str subnatid1 = ""
	replace subnatid1 = "1 - Berat" if Prefecture == 1
	replace subnatid1 = "2 - Diber" if Prefecture == 2
	replace subnatid1 = "3 - Durres" if Prefecture == 3
	replace subnatid1 = "4 - Elbasan" if Prefecture == 4
	replace subnatid1 = "5 - Fier" if Prefecture == 5
	replace subnatid1 = "6 - Gjirokaster" if Prefecture == 6
	replace subnatid1 = "7 - Korce" if Prefecture == 7
	replace subnatid1 = "8 - Kukes" if Prefecture == 8
	replace subnatid1 = "9 - Lezhe" if Prefecture == 9
	replace subnatid1 = "10 - Shkoder" if Prefecture == 10
	replace subnatid1 = "11 - Tirane" if Prefecture == 11
	replace subnatid1 = "12 - Vlore" if Prefecture == 12
...
*<_migrated_from_code_>
	...
	label de lblmigrated_from_code 12 "Vlore"
...
*<_migrated_from_country_>
	...
	replace migrated_from_country = "EGY" if (Q17 == "EG") & migrated_from_cat == 5
...
/* <_educat7_note>
	...
	*inconsistent cases (122 obs)
	...
	replace educat7 = 3 if Q123 == 2 & (educat7 == .)
	replace educat7 = 4 if Q123 == 3 & (educat7 == .)
...
/* <_lstatus_note>
	...
	*Exception
	forval i = 1/13 {
		...
		gen aux_method`theLetter' = .
		replace aux_method`theLetter' = 0 if METHOD`theLetter' == 2 // no
		replace aux_method`theLetter' = 1 if METHOD`theLetter' == 1 // yes
	}
...
/* <_occup_isco_note>
	...
	*Increase hierarchy
	replace occup_isco = "0100" if occup_isco == "0120"
	replace occup_isco = "1100" if occup_isco == "1130"
	replace occup_isco = "1300" if occup_isco == "1350"
	replace occup_isco = "3400" if occup_isco == "3440"
	replace occup_isco = "3500" if occup_isco == "3530"
	...
	replace occup_isco = "6100" if occup_isco == "6140"
	replace occup_isco = "6100" if occup_isco == "6150"
	replace occup_isco = "7300" if occup_isco == "7330"
	replace occup_isco = "7300" if occup_isco == "7340"
...
/* <_wage_no_compen_note>
	The calculation of sales - costs has a lot of negative numbers. Instead the earnings variable
</_wage_no_compen_note> */
	gen double wage_no_compen = .
	
	*Wages
	replace wage_no_compen = Q56 if empstat == 1
...
/* <_wage_no_compen_2_note>
	...
	*Wages
	replace wage_no_compen_2 = Q76 if empstat == 1
	replace wage_no_compen_2 = . if inrange(Q76,9999999,99999999) // Refuses
	
	*Sales
	replace wage_no_compen_2 = Q86 if inlist(empstat,3,4)
	replace wage_no_compen_2 = 0 if inlist(Q85,2,3) & inlist(empstat,3,4) // had loss or broke even
	replace wage_no_compen_2 = . if inrange(Q86,9999999,99999999) // Refuses
...
/* <_t_hours_total_note>
	...
	Only info of main and secondary job. Use question
