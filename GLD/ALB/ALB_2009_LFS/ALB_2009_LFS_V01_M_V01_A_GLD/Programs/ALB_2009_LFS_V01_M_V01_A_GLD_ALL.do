...
<_Program name_>				ALB_2009_LFS_V01_M_V01_A_GLD </_Program name_>
<_Application_>					Stata SE 18.0 <_Application_>
<_Author(s)_>					World Bank Jobs Group (gld@worldbank.org) </_Author(s)_>
<_Date created_>				2024-11-20 </_Date created_>
...
<_Study ID_>					ALB_2009_LFS_V01_M </_Study ID_>
<_Data collection from_>		09/2009 </_Data collection from_>
<_Data collection to_>			10/2009 </_Data collection to_>
<_Source of dataset_> 			INSTAT </_Source of dataset_>
<_Sample size (HH)_> 			6560 </_Sample size (HH)_>
<_Sample size (IND)_> 			18997 </_Sample size (IND)_>
<_Sampling method_> 			Two sample stage selections are done: in the firs step were chosen the geographic zones (PSU) and in the second stage, 
								were selected the families inside these selected zones. </_Sampling method_>
...
use "`path_in_stata'/lfs2009 english.dta", clear
...
/* <_hhid_note>
	...
	tostring ID_PSU, gen(psu_str) format(%03.0f)
	tostring ID_HH, gen(hh_str) format(%03.0f)
...
*<_weight_>
/* <_weight_note>
	In 72 observations, the weight did not retain all the decimal points. Ensure that all the appropriate decimal points are included.
</_weight_note> */
	bys hhid (weight): gen diff = weight[1] != weight[_N]
...
/* <_subnatid1_note>
	...
	gen str subnatid1 = ""
	replace subnatid1 = "1 - Berat" if ID_Prefecture == 1
	replace subnatid1 = "2 - Diber" if ID_Prefecture == 2
	replace subnatid1 = "3 - Durres" if ID_Prefecture == 3
	replace subnatid1 = "4 - Elbasan" if ID_Prefecture == 4
	replace subnatid1 = "5 - Fier" if ID_Prefecture == 5
	replace subnatid1 = "6 - Gjirokaster" if ID_Prefecture == 6
	replace subnatid1 = "7 - Korce" if ID_Prefecture == 7
	replace subnatid1 = "8 - Kukes" if ID_Prefecture == 8
	replace subnatid1 = "9 - Lezhe" if ID_Prefecture == 9
	replace subnatid1 = "10 - Shkoder" if ID_Prefecture == 10
	replace subnatid1 = "11 - Tirane" if ID_Prefecture == 11
	replace subnatid1 = "12 - Vlore" if ID_Prefecture == 12
	label var subnatid1 "Subnational ID at First Administrative Level"
*</_subnatid1_>


*<_subnatid2_>
	decode ID_DST, gen(dst_str)
	egen subnatid2 = concat(ID_DST dst_str), punct(" - ")
	replace subnatid2 = lower(subnatid2)
...
/* <_relationharm_note>
	...
	*unique hhid if total_heads == 0  //225 hh
	
	*spouse
		gen new_head = 1 if total_heads == 0 & hhlink == 2 //207 hh
		bys hhid : egen hh_new_head = count(new_head)
	*oldest member
		bysort hhid (age): gen oldest = (_n == _N) if total_heads == 0 & hh_new_head == 0 //18 hh
...
*<_migrated_from_code_>
	...
	replace migrated_from_code = 1 if Q17 == "1"
	replace migrated_from_code = 3 if Q17 == "3"
	replace migrated_from_code = 12 if Q17 == "12"
	label de lblmigrated_from_code 1 "Berat" 3 "Durres" 12 "Vlore"
...
*<_migrated_from_country_>
	...
	replace migrated_from_country = "GRC" if (countryb == "GR" | Q17 == "GR") & migrated_from_cat == 5
	replace migrated_from_country = "ITA" if Q17 == "IT" & migrated_from_cat == 5
...
/* <_educy_note>
	...
	(Q123) What is your highest level of education or training successfully completed? 
		1-  No school									-> 0yrs                                               
		2-  Primary										-> 4yrs (mean)
...
/* <_educat7_note>
	...
	Classifies respondents based on their highest completed level of education (Q123) 
	and their current level of education (Q119). 
	
	(Q119) current Level of education 
		1-  Primary
	...
	After harmonization there are some inconsistencies
		tab Q119 Q123 if educat7 == . // 122 obs
	...
	For the inconsistent cases we prioritize the variable Q123 (highest completed level). 

</_educat7_note> */
	gen educat7 = .
	* Classification based on Q123 (highest completed) and Q119 (current level)
	replace educat7 = 1 if Q123 == 1 & missing(Q119) // "No education"
	replace educat7 = 2 if inlist(Q123,1) & inlist(Q119,1) & missing(educat7) // "Primary incomplete"
	replace educat7 = 3 if Q123 == 2 & missing(Q119) & missing(educat7) // "Primary complete"
	replace educat7 = 4 if Q123 == 3 & inlist(Q119,3,4) & missing(educat7) // "Secondary incomplete"
	replace educat7 = 4 if Q123 == 2 & inlist(Q119,2) & missing(educat7) // "Secondary incomplete"
	replace educat7 = 5 if inlist(Q123,4,5,6) & missing(educat7) // "Secondary complete"
	replace educat7 = 7 if (inlist(Q123,7,8,9) | inlist(Q119,5,6,7)) & missing(educat7) // "University incomplete or complete"

	*inconsistent cases (122 obs)
	replace educat7 = 1 if Q123 == 1 & (educat7 == .)
	replace educat7 = 2 if Q123 == 2 & (educat7 == .)
	replace educat7 = 3 if Q123 == 3 & (educat7 == .)
	
	*There is one person that has only info of Q119
	replace educat7 = 4 if  Q119 == 3 & Q123 == .
...
*<_educat_orig_>
	decode Q123, gen(educat_orig)
	label var educat_orig "Original survey education code"
*</_educat_orig_>


*<_educat_isced_>
	gen educat_isced = Q123
...
/* <_lstatus_note>
	...
	*** Exceptions ***
	...
	Respondents who answer yes in methodj methodk methodl or methodm OR answer no to all options in method_* (confirms not looking for a job) are considered Out of the labor force.
	
</_lstatus_note> */
	gen byte lstatus = .
	
	*code employed
	replace lstatus = 1 if inrange(Q19,2,6) | Q20 == 1 & (inrange(Q24,1,3)|inrange(Q26,1,2)|Q27 == 1|Q28 == 1)
	
	*code unemployed
	gen active = 1 if Q104 == 1
	gen passive = 1 if Q113 == 1
	gen emp_not_start = 1 if Q103 == 1
	...
	*Exception
	forval i = 1/13 {
		...
		local lowerLetter = lower("`theLetter'")
		gen aux_method`lowerLetter' = .
		replace aux_method`lowerLetter' = 0 if method`lowerLetter' == 2 // no
		replace aux_method`lowerLetter' = 1 if method`lowerLetter' == 1 // yes
	}
	
	gen searching = aux_methoda + aux_methodb + aux_methodc + aux_methodd + aux_methode + aux_methodf + aux_methodg + aux_methodh + aux_methodi 
	gen waiting = aux_methodj + aux_methodk + aux_methodl + aux_methodm
	
	replace lstatus = 3 if lstatus == 2 & searching == 0 & Q103 == 4 & (inrange(waiting,1,3) | waiting == 0)
...
/* <_empstat_note>
	...
	*** Exceptions ***
	1) After harmonization There are 65 people who did not have information about their employment status, keep the as missing
...
*<_industry_orig_>
	gen industry_orig = string(P40_NACE)
...
/* <_industrycat_isic_note>
	...
	gen industrycat_isic = string(P40_NACE * 100, "%04.0f")
	replace industrycat_isic = "" if  industrycat_isic == "99900" // they coded unknown as 999
...
*<_industrycat10_>
	gen byte industrycat10 = P40_NACE
	recode industrycat10 (2/5 = 1) (10/14 = 2) (15/37 = 3) (40/41 = 4) (45 = 5) (50/55 = 6) (60/64 = 7) (65/74 = 8) (75 = 9) (80/99 = 10)
	replace industrycat10 = . if industrycat10 == 999 // they coded unknown as 999
...
/* <_unitwage_note>
	...
	(Q57) What period of time does this payment cover?
		1 - monthly
		2 - 15 days
		3 - weekly
		4 - daily
	...
	gen byte unitwage = Q57 if lstatus == 1 & empstat == 1
...
/* <_whours_note>
	...
	*Persons who not have info of number of worked hours the last week, put the average number of hours. 
	...
	replace whours = Q46 if (Q19 == 7 & lstatus == 1)
...
/* <_firmsize_l_note>
	...
	replace firmsize_l = Q41_A if sizefirm == 1 & inrange(Q41_A,1,10)
...
*<_firmsize_u_>
	...
	replace firmsize_u = Q41_A if sizefirm == 1 & inrange(Q41_A,1,10)
...
*<_industrycat_isic_2_>
	gen industrycat_isic_2 = string(NACE2J2D * 100, "%04.0f")
...
*<_industrycat10_2_>
	gen byte industrycat10_2 = NACE2J2D
...
*<_wage_no_compen_2_>
	...
	*Paid Employee Employer and Self-Employed
	...
	replace wage_no_compen_2 = Q76 if inlist(empstat_2,1,3,4)
	replace wage_no_compen_2 = 0 if inlist(empstat_2,3,4) & wage_no_compen_2 == . // own consumption
...
*<_unitwage_2_>
	gen byte unitwage_2 = Q77 if lstatus == 1 & empstat_2 == 1
	recode unitwage_2 (1 = 5) (2 = 3) (3 = 2) (4 = 1)
...
*<_t_wage_nocompen_total_>
	egen t_wage_nocompen_total = rowtotal(Q58 Q78)
...
*<_t_wage_total_>
	egen t_bonus_total = rowtotal(Q61 Q64 Q81)
	replace t_bonus_total = t_bonus_total * 12
	egen t_wage_total = rowtotal(t_wage_nocompen_total t_bonus_total)
...
*<_industrycat_isic_year_>
	gen industrycat_isic_year = string(NACE1Y2D * 100, "%04.0f")
	replace industrycat_isic_year = "5000" if  industrycat_isic_year == "5300" //wrong coding
	replace industrycat_isic_year = "" if  industrycat_isic_year == "99900" // they coded unknown as 999
...
*<_industrycat10_year_>
	gen byte industrycat10_year = NACE1Y2D
