...
<_Program name_>				ALB_2013_LFS_V01_M_V01_A_GLD </_Program name_>
...
<_Study ID_>					ALB_2013_LFS_V01_M </_Study ID_>
...
<_Sample size (HH)_> 				6080 </_Sample size (HH)_>
<_Sample size (IND)_> 				17523 </_Sample size (IND)_>
...
*<_wave_>
	gen str2 wave = "Q" + string(mod(quarter,10))
...
/* <_relationharm_note>
	...
	There are cases where the Head is missing (896 hh in all quarters). spouse as the head of the household. If spouse is also not available, then we will use oldest member of the household as the head
	
	*Exception
	There are some households where there are more than 1 head coded. Put the oldest person as head an recode the rest as 5 "Other relatives"
	...
	*Exception
	bysort quarter hhid (heads age): egen max_age = max(age) if hhlink == 1
	bysort quarter hhid (age): gen oldest_exception = inrange(total_heads,2,99) & hhlink == 1 & age == max_age
	replace relationharm = 5 if oldest_exception == 0 & inrange(total_heads,2,99)
...
*<_migrated_years_>
	...
	gen years_bornoutside = 2013 - yearesid if !inlist(yearesid,.,0)
...
*<_migrated_from_code_>
	decode Q19, gen(migrated_from_code_str)
	replace migrated_from_code_str = lower(migrated_from_code_str)
	egen migrated_from_code = concat(Q19 migrated_from_code_str) if migrated_from_cat == 4, punct(" - ")
	replace migrated_from_code = "" if inlist(Q19,0,.) 
...
/* <_migrated_from_country_note>
	...
	* There are people from albania who were abroad, however the questionnaire does not ask about the country they were in: tab yearesid if !inlist(yearesid,.,0) & Q16 == 1:  5 people. code those cases as "Other World"
	* The raw data has no information about the country if the place of birth is abroad, code those cases as "Other World"
	...
	replace migrated_from_country = "GBR" if Q20 == 16 & migrated_from_cat == 5
...
/* <_educat7_note>
	...
	After harmonization there are some inconsistencies
		tab Q124 Q128 if educat7 == . // 140 obs
	...
	*inconsistent cases
	replace educat7 = 3 if Q128 == 2 & (educat7 == .)
...
*<_nlfreason_>
	...
	recode nlfreason (1 3 = 2) (2 = 4) (4 = 1) (5 = 3) (6 7 8 9 10 0 = 5)
...
*<_industrycat_isic_>
	...
	*Not stated cases 
	replace industrycat_isic = "" if industrycat_isic == "999900"
...
*<_industrycat10_>
	...
	recode industrycat10 (2/5 = 1) (10/14 = 2) (15/37 = 3) (40/41 = 4) (45 = 5) (50/55 = 6) (60/64 = 7) (65/74 = 8) (75 = 9) (80/99 = 10) (9999 = 10)
...
/* <_occup_isco_note>
	...
	replace occup_isco = "" if occup_isco == "." | occup_isco == "99990"
	replace occup_isco = "" if lstatus != 1
	
	*Increase hierarchy
	replace occup_isco = "1100" if occup_isco == "1130"
	replace occup_isco = "5100" if occup_isco == "5180"
	replace occup_isco = "9100" if occup_isco == "9150"
