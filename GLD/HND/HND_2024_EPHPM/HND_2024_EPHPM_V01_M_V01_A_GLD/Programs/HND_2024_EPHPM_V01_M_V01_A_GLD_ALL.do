...
<_Program name_>         [HND_2024_EPHPM_V01_M_V01_A_GLD_ALL.do] </_Program name_>
...
<_Study ID_>             [HND_2024_EPHPM_V01_M] </_Study ID_>
<_Data collection from_> [2024-06-17] </_Data collection from_>
<_Data collection to_>   [2024-07-16] </_Data collection to_>
<_Source of dataset_>    [INE Honduras raw merged person-household file: Data de la Encuesta de Hogares 2024_PDVF.dta] </_Source of dataset_>
<_Sample size (HH)_>     [6487] </_Sample size (HH)_>
<_Sample size (IND)_>    [24534] </_Sample size (IND)_>
...
tempfile raw_stage
use "`path_in_stata'/Data de la Encuesta de Hogares 2024_PDVF.dta", clear

gen double __dept_source = DEPMUESTRA

gen str30 region_est2 = ""
replace region_est2 = "01 - Atlantida" if __dept_source == 1
replace region_est2 = "02 - Colon" if __dept_source == 2
replace region_est2 = "03 - Comayagua" if __dept_source == 3
replace region_est2 = "04 - Copan" if __dept_source == 4
replace region_est2 = "05 - Cortes" if __dept_source == 5
replace region_est2 = "06 - Choluteca" if __dept_source == 6
replace region_est2 = "07 - El Paraiso" if __dept_source == 7
replace region_est2 = "08 - Francisco Morazan" if __dept_source == 8
replace region_est2 = "09 - Gracias a Dios" if __dept_source == 9
replace region_est2 = "10 - Intibuca" if __dept_source == 10
replace region_est2 = "11 - Islas de Bahia" if __dept_source == 11
replace region_est2 = "12 - La Paz" if __dept_source == 12
replace region_est2 = "13 - Lempira" if __dept_source == 13
replace region_est2 = "14 - Ocotepeque" if __dept_source == 14
replace region_est2 = "15 - Olancho" if __dept_source == 15
replace region_est2 = "16 - Santa Barbara" if __dept_source == 16
replace region_est2 = "17 - Valle" if __dept_source == 17
replace region_est2 = "18 - Yoro" if __dept_source == 18

gen str40 region_est3 = ""
drop __dept_source
...
002, ..., 160.
	...
	gen str32 hhid = strtrim(HOGAR)
	replace hhid = "" if missing(HOGAR)
...
*<_subnatid1_>
/* <_subnatid1_note>
The 2024 raw file includes DEPMUESTRA, labeled Departamento. The assembly block
maps it to region_est2, which is used directly for first-level geography.
</_subnatid1_note> */
	gen str30 subnatid1 = region_est2
	label var subnatid1 "Subnational ID at First Administrative Level"
*</_subnatid1_>

*<_subnatid2_>
/* <_subnatid2_note>
No current municipality or second-level geography source was identified in the
checked 2024 raw person file.
</_subnatid2_note> */
	gen str30 subnatid2 = ""
...
*<_subnatid3_>
/* <_subnatid3_note>
No current third-level geography source was identified in the checked 2024 raw
person file.
</_subnatid3_note> */
	gen str40 subnatid3 = ""
...
See entry in GLD Guidelines (https://github.com/worldbank/gld/blob/main/Support/A%20-%20Guides%20and%20Documentation/GLD_1.0_Guidelines.docx) for more details
	...
	gen str40 subnatidsurvey = subnatid1
...
subnatid1_prev is coded as missing unless the classification used for subnatid1 has changed since the previous survey.
	...
	gen str60 subnatid1_prev = ""
	label var subnatid1_prev "Classification used for subnatid1 from previous survey"
*</_subnatid1_prev_>

*<_subnatid2_prev_>
	gen str60 subnatid2_prev = ""
	label var subnatid2_prev "Classification used for subnatid2 from previous survey"
*</_subnatid2_prev_>

*<_subnatid3_prev_>
	gen str60 subnatid3_prev = ""
...
/* <_hsize_note>
	...
	bysort hhid: gen double hsize = _N
...
*<_migrated_from_code_>
	...
	label var migrated_from_code "Code of migration area"
*</_migrated_from_code_>

*<_migrated_from_country_>
	gen str30 migrated_from_country = ""
	label var migrated_from_country "Country from which individual migrated"
*</_migrated_from_country_>
...
*<_industry_orig_>
/* <_industry_orig_note>
O02_CODIGO is the retained detailed main-job industry code. Nonclassifiable
codes beginning with 999 are not retained as original industry.
</_industry_orig_note> */
	gen str12 industry_orig = ""
	replace industry_orig = strtrim(string(O02_CODIGO, "%12.0f")) if lstatus == 1 & !missing(O02_CODIGO)
	replace industry_orig = "" if substr(industry_orig, 1, 3) == "999"
	label var industry_orig "Original survey industry code, main job 7 day recall"
*</_industry_orig_>

*<_industrycat_isic_>
/* <_industrycat_isic_note>
O02_CODIGO is numeric, so leading zeros are not stored. The code restores the
leading zero for four-digit raw values before taking the first four characters:
8100 -> 0810, 7291 -> 0729, and 8930 -> 0893. This keeps the 2024 mining cases
...
digits and are collapsed to their valid two-digit ISIC groups.
	...
	replace `industry_code' = "0" + string(O02_CODIGO, "%04.0f") if lstatus == 1 & inrange(O02_CODIGO, 1, 9999)
...
two industry variables stay internally aligned. RAMAOP is a raw broad branch
variable and usually agrees with O02_CODIGO, but 25 employed records differ in
2024. In those discrepancies, this do-file prioritizes the O02_CODIGO-based
ISIC category for both industrycat_isic and industrycat10.
</_industrycat10_note> */
	tempvar isic2
...
*<_occup_orig_>
/* <_occup_orig_note>
O01_CODIGO is the retained detailed main-job occupation code. Nonclassifiable
codes beginning with 999 are not retained as original occupation.
</_occup_orig_note> */
	gen str12 occup_orig = ""
	replace occup_orig = strtrim(string(O01_CODIGO, "%12.0f")) if lstatus == 1 & !missing(O01_CODIGO)
	replace occup_orig = "" if substr(occup_orig, 1, 3) == "999"
	label var occup_orig "Original occupation record primary job 7 day recall"
*</_occup_orig_>

*<_occup_isco_>
/* <_occup_isco_note>
Raw O01_CODIGO is a national extension aligned with ISCO-08, but the detailed
codes do not fully match official ISCO-08. The code uses a conservative two-digit
fallback stored as a four-character string. Groups 05, 06, 98, and 99 remain
invalid or nonclassifiable after fallback and are left blank.
</_occup_isco_note> */
	tempvar occup_code
	gen str6 `occup_code' = ""
	replace `occup_code' = string(real(occup_orig), "%06.0f") if occup_orig != ""
	gen str4 occup_isco = substr(`occup_code', 1, 2) + "00" if !missing(occup_orig)
	replace occup_isco = "" if inlist(substr(`occup_code', 1, 2), "05", "06", "98", "99")
...
*<_occup_>
/* <_occup_note>
Occup is derived from the retained ISCO-08 fallback in occup_isco. This avoids
using the broad OCUPAOP value when it conflicts with the detailed occupation
code. In the 2024 raw data, 56 employed records have detailed occupation codes
beginning with 51, 53, or 54, which map to ISCO-08 major group 5, while OCUPAOP
codes those same records as 9. The same detailed codes are coded as OCUPAOP = 5
in the other Honduras EPHPM years inspected, and most 2024 records with those
same detailed codes are also OCUPAOP = 5. We therefore code these records as
occup = 5 from O01_CODIGO. If the 56 records followed OCUPAOP instead, the
2024 weighted employed distribution would shift from 27.4 to 26.8 percent for
occup = 5 and from 24.8 to 25.5 percent for occup = 9. Occupation residual
groups 98 and 99 are left missing because they do not map to valid ISCO-08
groups in occup_isco. ISCO armed-forces groups 01-03 are mapped to GLD occup =
10.
</_occup_note> */
	tempvar occup_code_text occup_first_digit occup_first_two
	gen str6 `occup_code_text' = ""
	replace `occup_code_text' = string(real(occup_orig), "%06.0f") if occup_orig != ""
	gen double `occup_first_digit' = real(substr(`occup_code_text', 1, 1))
	gen str2 `occup_first_two' = substr(`occup_code_text', 1, 2)
	gen byte occup = .
	replace occup = `occup_first_digit' if occup_isco != ""
	replace occup = 10 if inlist(`occup_first_two', "01", "02", "03")
	replace occup = . if inlist(`occup_first_two', "05", "06", "98", "99")
	replace occup = . if !inrange(occup, 1, 10) & occup != 99
...
YTRAOP is the retained monthly total labor income from the main occupation,
including the monetary and in-kind wage and self-employment components reported
in the raw income variables.
</_wage_no_compen_note> */
	gen double wage_no_compen = .
	replace wage_no_compen = YTRAOP if lstatus == 1 & !missing(YTRAOP)
...
*<_empstat_2_>
/* <_empstat_2_note>
Secondary job employment-status information is not available in the 2024 raw
file. The raw file has secondary occupation, industry, and income aggregates,
but no secondary-job category/status variable comparable to OC6091 or CATEGOS.
</_empstat_2_note> */
	gen byte empstat_2 = .
...
*<_industry_orig_2_>
	...
	replace industry_orig_2 = strtrim(string(OS02_CODIGO, "%12.0f")) if lstatus == 1 & !missing(OS02_CODIGO)
	replace industry_orig_2 = "" if substr(industry_orig_2, 1, 3) == "999"
	label var industry_orig_2 "Original survey industry code, secondary job 7 day recall"
*</_industry_orig_2_>

*<_industrycat_isic_2_>
/* <_industrycat_isic_2_note>
The 2024 raw file includes secondary-job industry codes in OS02_CODIGO. As with
the primary job, the national detailed codes are harmonized conservatively to
the two-digit ISIC Rev. 4 group plus "00". The 2024 secondary fallback has no
invalid ISIC groups after first-two-digit fallback.
</_industrycat_isic_2_note> */
	tempvar industry2_code isic2_2
	gen str6 `industry2_code' = industry_orig_2
	replace `industry2_code' = "0" + substr(`industry2_code', 1, 3) if length(`industry2_code') == 4 & substr(`industry2_code', 1, 1) == "1"
	replace `industry2_code' = substr(`industry2_code', 1, 4) if length(`industry2_code') > 4
	gen str4 industrycat_isic_2 = substr(`industry2_code', 1, 2) + "00" if !missing(industry_orig_2)
...
*<_occup_orig_2_>
	...
	replace occup_orig_2 = strtrim(string(OS01_CODIGO, "%12.0f")) if lstatus == 1 & !missing(OS01_CODIGO)
	replace occup_orig_2 = "" if substr(occup_orig_2, 1, 3) == "999"
	label var occup_orig_2 "Original occupation record secondary job 7 day recall"
*</_occup_orig_2_>

*<_occup_isco_2_>
/* <_occup_isco_2_note>
The 2024 raw file includes secondary-job occupation codes in OS01_CODIGO. The
national detailed codes are harmonized conservatively to the two-digit ISCO-08
group plus "00"; residual groups 05, 06, 98, and 99 are left missing.
</_occup_isco_2_note> */
	tempvar occup2_code occup2_first_digit occup2_first_two
	gen str6 `occup2_code' = ""
	replace `occup2_code' = string(real(occup_orig_2), "%06.0f") if occup_orig_2 != ""
	gen str4 occup_isco_2 = substr(`occup2_code', 1, 2) + "00" if !missing(occup_orig_2)
	replace occup_isco_2 = "" if inlist(substr(`occup2_code', 1, 2), "05", "06", "98", "99")
...
*<_occup_2_>
	gen byte occup_2 = .
	gen double `occup2_first_digit' = real(substr(`occup2_code', 1, 1))
	gen str2 `occup2_first_two' = substr(`occup2_code', 1, 2)
	replace occup_2 = `occup2_first_digit' if !missing(occup_orig_2) & !inlist(`occup2_first_two', "05", "06", "98", "99")
	replace occup_2 = 10 if inlist(`occup2_first_two', "01", "02", "03")
	replace occup_2 = . if inlist(`occup2_first_two', "05", "06", "98", "99")
	replace occup_2 = . if occup_isco_2 == ""
...
YTRAOS is the retained monthly total labor income from the secondary occupation,
including the monetary and in-kind wage and self-employment components reported
in the raw secondary income variables.
</_wage_no_compen_2_note> */
	gen double wage_no_compen_2 = .
	replace wage_no_compen_2 = YTRAOS if lstatus == 1 & !missing(YTRAOS)
...
*<_whours_2_>
/* <_whours_2_note>
Secondary job hours are not available in the 2024 raw file. The file includes
main-job daily hours but no secondary-job daily-hours counterpart.
</_whours_2_note> */
	gen double whours_2 = .
...
*<_firmsize_l_2_>
/* <_firmsize_l_2_note>
Secondary job firm-size information is not available in the 2024 raw file.
</_firmsize_l_2_note> */
...
*<_industry_orig_2_year_>
	gen str12 industry_orig_2_year = ""
...
*<_occup_orig_2_year_>
	gen str12 occup_orig_2_year = ""
	label var occup_orig_2_year "Original occupation record secondary job 12 month recall"
*</_occup_orig_2_year_>

*<_occup_isco_2_year_>
	gen str4 occup_isco_2_year = ""
