...
<_Author(s)_>            [cedlas-reeng auto exporter] </_Author(s)_>
...
* 2026-04-20 - Added the Honduras 2023 GLD_ALL placeholder do-file and placeholder-complete DTA export surface.
* SEDLAC extraction summary (GLD surface): 47 exact, 6 non-exact, 1 not comparable.
...
*<_harmonization_>
	gen harmonization = "GLD_ALL"
	label var harmonization "Type of harmonization"
*</_harmonization_>

*<_int_year_>
/* <_int_year_note>
SEDLAC provenance: GLD int_year is sourced from SEDLAC-R int_year.
Raw extraction exactness: 1.0000 (20308/20308 comparable observations).
Final exactness after promotion: 1.0000.
</_int_year_note> */
...
002, ..., 160.
SEDLAC-R hh_id corresponds to GLD hhid.
SEDLAC provenance: GLD hhid is sourced from SEDLAC-R hh_id.
Raw extraction exactness: 1.0000 (20308/20308 comparable observations).
Final exactness after promotion: 1.0000.
</_hhid_note> */
...
*<_weight_>
/* <_weight_note>
SEDLAC-R w_person_survey corresponds to GLD weight.
SEDLAC provenance: GLD weight is sourced from SEDLAC-R w_person_survey.
Raw extraction exactness: 1.0000 (20308/20308 comparable observations).
Final exactness after promotion: 1.0000.
</_weight_note> */
...
*<_psu_>
/* <_psu_note>
SEDLAC provenance: GLD psu is sourced from SEDLAC-R psu.
Raw extraction exactness: 1.0000 (20308/20308 comparable observations).
Final exactness after promotion: 1.0000.
</_psu_note> */
...
*<_strata_>
/* <_strata_note>
SEDLAC provenance: GLD strata is sourced from SEDLAC-R strata.
Raw extraction exactness: 1.0000 (20308/20308 comparable observations).
Final exactness after promotion: 1.0000.
</_strata_note> */
...
*<_urban_>
/* <_urban_note>
Derived from SEDLAC-R area string.
SEDLAC provenance: GLD urban is sourced from SEDLAC-R area.
Raw extraction exactness: 1.0000 (20308/20308 comparable observations).
Final exactness after promotion: 1.0000.
</_urban_note> */
	gen byte urban = .
...
SEDLAC-R subnatid corresponds to GLD subnatid1.
SEDLAC provenance: GLD subnatid1 is sourced from SEDLAC-R subnatid.
Raw extraction exactness: 1.0000 (20308/20308 comparable observations).
Final exactness after promotion: 1.0000.
</_subnatid1_note> */
	gen str20 subnatid1 = ""
	replace subnatid1 = "2 - Norte" if region_est2 == "1 - Atlantida"
	replace subnatid1 = "2 - Norte" if region_est2 == "2 - Colon"
	replace subnatid1 = "6 - Central" if region_est2 == "3 - Comayagua"
	replace subnatid1 = "3 - Occidente" if region_est2 == "4 - Copan"
	replace subnatid1 = "2 - Norte" if region_est2 == "5 - Cortes"
	replace subnatid1 = "4 - Sur" if region_est2 == "6 - Choluteca"
	replace subnatid1 = "5 - Oriente" if region_est2 == "7 - El Paraiso"
	replace subnatid1 = "6 - Central" if region_est2 == "8 - Francisco Morazan"
	replace subnatid1 = "5 - Oriente" if region_est2 == "9 - Gracias a Dios"
	replace subnatid1 = "6 - Central" if region_est2 == "10 - Intibuca"
	replace subnatid1 = "2 - Norte" if region_est2 == "11 - Islas de Bahia"
	replace subnatid1 = "6 - Central" if region_est2 == "12 - La Paz"
	replace subnatid1 = "3 - Occidente" if region_est2 == "13 - Lempira"
	replace subnatid1 = "3 - Occidente" if region_est2 == "14 - Ocotepeque"
	replace subnatid1 = "5 - Oriente" if region_est2 == "15 - Olancho"
	replace subnatid1 = "3 - Occidente" if region_est2 == "16 - Santa Barbara"
	replace subnatid1 = "4 - Sur" if region_est2 == "17 - Valle"
	replace subnatid1 = "2 - Norte" if region_est2 == "18 - Yoro"
	replace subnatid1 = "1 - Metropolitana" if inlist(DOMINIO, 1, 2)
	label var subnatid1 "Subnational ID at First Administrative Level"
*</_subnatid1_>

*<_subnatid2_>
/* <_subnatid2_note>
SEDLAC provenance: GLD subnatid2 is sourced from SEDLAC-R subnatid2.
Raw extraction exactness: 1.0000 (20308/20308 comparable observations).
Final exactness after promotion: 1.0000.
</_subnatid2_note> */
	gen str30 subnatid2 = region_est2
	label var subnatid2 "Subnational ID at Second Administrative Level"
*</_subnatid2_>

*<_subnatid3_>
/* <_subnatid3_note>
SEDLAC provenance: GLD subnatid3 is sourced from SEDLAC-R subnatid3.
Raw extraction exactness: 1.0000 (18972/18972 comparable observations).
Final exactness after promotion: 1.0000.
</_subnatid3_note> */
	gen str40 subnatid3 = region_est3
...
SEDLAC provenance: GLD subnatidsurvey is sourced from SEDLAC-R subnatidsurvey.
Raw extraction exactness: 1.0000 (20308/20308 comparable observations).
Final exactness after promotion: 1.0000.
</_subnatidsurvey_note> */
...
*<_hsize_>
/* <_hsize_note>
SEDLAC-R hhsize corresponds to GLD hsize.
SEDLAC provenance: GLD hsize is sourced from SEDLAC-R hhsize.
Raw extraction exactness: 1.0000 (20308/20308 comparable observations).
Final exactness after promotion: 1.0000.
</_hsize_note> */
...
*<_age_>
/* <_age_note>
SEDLAC provenance: GLD age is sourced from SEDLAC-R age.
Raw extraction exactness: 1.0000 (20308/20308 comparable observations).
Final exactness after promotion: 1.0000.
</_age_note> */
	gen age = EDAD
...
*<_male_>
/* <_male_note>
Derived as the complement of SEDLAC-R female.
SEDLAC provenance: GLD male is sourced from SEDLAC-R female.
Raw extraction exactness: 1.0000 (20308/20308 comparable observations).
Final exactness after promotion: 1.0000.
</_male_note> */
	gen byte male = .
...
*<_relationharm_>
/* <_relationharm_note>
SEDLAC provenance: GLD relationharm is sourced from SEDLAC-R relationharm.
Raw extraction exactness: 1.0000 (20278/20278 comparable observations).
Final exactness after promotion: 1.0000.
</_relationharm_note> */
...
*<_relationcs_>
/* <_relationcs_note>
GLD relationcs keeps the original numeric relationship code; SEDLAC-R relationcs keeps the labeled string.
SEDLAC provenance: GLD relationcs is sourced from SEDLAC-R relationcs.
Raw extraction exactness: 1.0000 (20278/20278 comparable observations).
Final exactness after promotion: 1.0000.
</_relationcs_note> */
...
*<_marital_>
/* <_marital_note>
SEDLAC provenance: GLD marital is sourced from SEDLAC-R marital.
Raw extraction exactness: 1.0000 (20308/20308 comparable observations).
Final exactness after promotion: 1.0000.
</_marital_note> */
	gen byte marital = .
...
*<_school_>
/* <_school_note>
SEDLAC provenance: GLD school is sourced from SEDLAC-R school.
Raw extraction exactness: 1.0000 (19392/19392 comparable observations).
Final exactness after promotion: 1.0000.
</_school_note> */
	gen byte school = .
...
*<_literacy_>
/* <_literacy_note>
SEDLAC provenance: GLD literacy is sourced from SEDLAC-R literacy.
Raw extraction exactness: 1.0000 (19392/19392 comparable observations).
Final exactness after promotion: 1.0000.
</_literacy_note> */
	gen byte literacy = .
...
*<_lstatus_>
/* <_lstatus_note>
SEDLAC-R labor_status corresponds to GLD lstatus.
SEDLAC provenance: GLD lstatus is sourced from SEDLAC-R labor_status.
Raw extraction exactness: 1.0000 (14461/14461 comparable observations).
Final exactness after promotion: 1.0000.
</_lstatus_note> */
	gen byte lstatus = CONDACT
	replace lstatus = 3 if lstatus == 1 & OCUPAOP == 99 & O01_CODIGO == 999999
...
*<_empstat_>
/* <_empstat_note>
SEDLAC provenance: GLD empstat is sourced from SEDLAC-R empstat.
Raw extraction exactness: 1.0000 (7498/7498 comparable observations).
Final exactness after promotion: 1.0000.
</_empstat_note> */
	gen byte empstat = .
...
*<_industry_orig_>
/* <_industry_orig_note>
SEDLAC provenance: GLD industry_orig is sourced from SEDLAC-R industry_orig.
Raw extraction exactness: 1.0000 (7667/7667 comparable observations).
Final exactness after promotion: 1.0000.
</_industry_orig_note> */
...
*<_industrycat4_>
/* <_industrycat4_note>
SEDLAC provenance: GLD industrycat4 is sourced from SEDLAC-R industrycat4.
Raw extraction exactness: 0.9992 (7435/7441 comparable observations).
Final exactness after promotion: 0.9992.
</_industrycat4_note> */
...
*<_occup_orig_>
/* <_occup_orig_note>
SEDLAC provenance: GLD occup_orig is sourced from SEDLAC-R occup_orig.
Raw extraction exactness: 1.0000 (7674/7674 comparable observations).
Final exactness after promotion: 1.0000.
</_occup_orig_note> */
...
*<_occup_>
/* <_occup_note>
SEDLAC provenance: GLD occup is sourced from SEDLAC-R occup.
Raw extraction exactness: 1.0000 (7498/7498 comparable observations).
Final exactness after promotion: 1.0000.
...
SEDLAC provenance: GLD occup_skill is sourced from SEDLAC-R occup.
Raw extraction exactness: 1.0000 (7452/7452 comparable observations).
Final exactness after promotion: 1.0000.
</_occup_skill_note> */
	gen occup_skill = .
...
SEDLAC-R wage_nc corresponds to GLD wage_no_compen.
SEDLAC provenance: GLD wage_no_compen is sourced from SEDLAC-R wage_nc.
Raw extraction exactness: 0.9983 (6953/6965 comparable observations).
Final exactness after promotion: 1.0000.
...
SEDLAC provenance: GLD unitwage is sourced from SEDLAC-R unitwage.
Raw extraction exactness: 1.0000 (7498/7498 comparable observations).
Final exactness after promotion: 1.0000.
...
*<_whours_>
/* <_whours_note>
SEDLAC provenance: GLD whours is sourced from SEDLAC-R whours.
Raw extraction exactness: 1.0000 (7677/7677 comparable observations).
Final exactness after promotion: 1.0000.
...
*<_socialsec_>
/* <_socialsec_note>
Left missing. The available candidate source did not cleanly identify social
security coverage for the employed population.
</_socialsec_note> */
	gen byte socialsec = .
...
*<_firmsize_l_>
/* <_firmsize_l_note>
SEDLAC provenance: GLD firmsize_l is sourced from SEDLAC-R firmsize_l.
Raw extraction exactness: 1.0000 (7379/7379 comparable observations).
Final exactness after promotion: 1.0000.
</_firmsize_l_note> */
...
*<_firmsize_u_>
/* <_firmsize_u_note>
SEDLAC provenance: GLD firmsize_u is sourced from SEDLAC-R firmsize_u.
Raw extraction exactness: 1.0000 (6841/6841 comparable observations).
Final exactness after promotion: 1.0000.
</_firmsize_u_note> */
...
*<_empstat_2_>
/* <_empstat_2_note>
SEDLAC provenance: GLD empstat_2 is sourced from SEDLAC-R empstat_2.
Raw extraction exactness: 1.0000 (512/512 comparable observations).
Final exactness after promotion: 1.0000.
</_empstat_2_note> */
	gen byte empstat_2 = .
...
SEDLAC-R wage_nc_2 corresponds to GLD wage_no_compen_2.
SEDLAC provenance: GLD wage_no_compen_2 is sourced from SEDLAC-R wage_nc_2.
Raw extraction exactness: 0.9859 (419/425 comparable observations).
Final exactness after promotion: 1.0000.
...
*<_unitwage_2_>
/* <_unitwage_2_note>
SEDLAC provenance: GLD unitwage_2 is sourced from SEDLAC-R unitwage_2.
Raw extraction exactness: 1.0000 (512/512 comparable observations).
Final exactness after promotion: 1.0000.
...
*<_whours_2_>
/* <_whours_2_note>
SEDLAC provenance: GLD whours_2 is sourced from SEDLAC-R whours_2.
Raw extraction exactness: 1.0000 (513/513 comparable observations).
Final exactness after promotion: 1.0000.
</_whours_2_note> */
	tempvar whours_2_nn
...
*<_firmsize_l_2_>
/* <_firmsize_l_2_note>
SEDLAC provenance: GLD firmsize_l_2 is sourced from SEDLAC-R firmsize_l_2.
Raw extraction exactness: 1.0000 (513/513 comparable observations).
Final exactness after promotion: 1.0000.
</_firmsize_l_2_note> */
...
*<_firmsize_u_2_>
/* <_firmsize_u_2_note>
SEDLAC provenance: GLD firmsize_u_2 is sourced from SEDLAC-R firmsize_u_2.
Raw extraction exactness: 1.0000 (513/513 comparable observations).
Final exactness after promotion: 1.0000.
</_firmsize_u_2_note> */
...
*<_t_hours_total_>
/* <_t_hours_total_note>
Derived as weekly main plus secondary hours; SEDLAC-R t_hours_total remains the annualized companion.
SEDLAC provenance: GLD t_hours_total is sourced from SEDLAC-R whours + whours_2.
Raw extraction exactness: 1.0000 (7677/7677 comparable observations).
Final exactness after promotion: 1.0000.
...
*<_njobs_>
/* <_njobs_note>
Derived from the raw count of reported jobs (CA519); SEDLAC-R num_trabaj remains unrecovered in the canonical output.
SEDLAC provenance: GLD njobs is sourced from SEDLAC-R num_trabaj.
Comparable benchmark status: no comparable authoritative SEDLAC benchmark is available because SEDLAC-R num_trabaj remains unrecovered on the reference surface.
...
SEDLAC-R t_hours_total corresponds to GLD t_hours_annual under the current annualization rule.
SEDLAC provenance: GLD t_hours_annual is sourced from SEDLAC-R t_hours_total.
Raw extraction exactness: 1.0000 (7677/7677 comparable observations).
Final exactness after promotion: 1.0000.
</_t_hours_annual_note> */
