...
<_Program name_>				MUS_2006_CMPHS_V01_M_V01_A_GLD_ALL.do </_Program name_>
...
<_Sample size (IND)_> 			41,559 </_Sample size (IND)_>
...
use "`path_in_stata'/CMPHS06.dta", clear
...
*<_pid_>
	...
	* 6 duplicates remaining but share same labor respones
...
*<_lstatus_>
	gen byte lstatus=.
	replace lstatus=1 if work==1 | activities==1 | awayfromwrk==1
...
*<_industry_orig_>
	gen industry_orig=string(industry, "%02.0f") if !missing(industry)
...
*<_industry_orig_2_>
	gen industry_orig_2= string(secondindustry, "%02.0f") if !missing(secondindustry)
...
*<_whours_2_>
	gen whours_2 = hrssec if lstatus == 1
	recode whours_2 (0 = .)
