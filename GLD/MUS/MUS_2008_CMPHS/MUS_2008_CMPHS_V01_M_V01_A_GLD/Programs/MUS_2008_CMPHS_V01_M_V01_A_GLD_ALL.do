...
<_Program name_>				MUS_2008_CMPHS_V01_M_V01_A_GLD_ALL.do </_Program name_>
...
<_Sample size (IND)_> 			41,121 </_Sample size (IND)_>
...
use "`path_in_stata'/CMPHS2008.dta", clear
...
*<_hhid_>
	gen hhid = string(serialno, "%04.0f")	
...
*<_pid_>
	...
	* drop complete duplicates
	...
	duplicates tag pid maritalstat - hrsmain, gen(x2)
	* There are duplicates in PID, share the same responses in the labor module. We can drop them!
	
	tab x1 x2, mi
	* All duplicate share the same responses in the labor questoins
	duplicates drop pid maritalstat - hrsmain, force
...
*<_educat7_>
	...
	replace educat7=4 if educlevel>=21 & educlevel<=26
	replace educat7=5 if educlevel>=27 & educlevel<=31
...
*<_occup_orig_>
    gen occup_orig = string(occup) if !missing(occup)
...
*<_empstat_2_>
	...
	recode empstat_2 (3=1) (4 5=2) (1=3) (2=4) (6=5)
...
*<_industry_orig_2_>
	gen industry_orig_2= string(secondact, "%05.0f") if !missing(secondact)
...
*<_industrycat_isic_2_>
	gen isic_2d_2 = substr(industry_orig_2, 1, 2)
    gen industrycat_isic_2 = isic_2d_2 + "00" if !missing(industry_orig_2)
	label var industrycat_isic_2 "ISIC code of secondary job 7 day recall"
*</_industrycat_isic_2_>


*<_industrycat10_2_>
    destring isic_2d_2, gen(industrycat10_2)
