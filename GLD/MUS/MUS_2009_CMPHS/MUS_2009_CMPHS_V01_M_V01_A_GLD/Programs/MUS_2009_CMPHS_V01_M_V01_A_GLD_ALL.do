...
<_Program name_>				MUS_2009_CMPHS_V01_M_V01_A_GLD_ALL.do </_Program name_>
...
<_Sample size (HH)_> 			6,480 </_Sample size (HH)_>
<_Sample size (IND)_> 			24,393 </_Sample size (IND)_>
...
use "`path_in_stata'/CMPHS 2009FINAL.dta", clear
...
*<_hhid_>
	gen hhid = string(serialno, "%05.0f")	
