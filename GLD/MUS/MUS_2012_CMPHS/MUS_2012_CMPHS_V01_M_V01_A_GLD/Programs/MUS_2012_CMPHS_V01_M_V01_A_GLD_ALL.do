...
<_Program name_>				MUS_2012_CMPHS_V01_M_V01_A_GLD_ALL.do </_Program name_>
...
<_Sample size (IND)_> 			41,699 </_Sample size (IND)_>
...
<_OCCUP National_>				National Classification of Occupations 2008 </_OCCUP National_>
<_ISIC Version_>				ISIC version 4 </_ISIC Version_>
<_INDUS National_>				National Standard Industrial Classification of Economic Activities rev 2 </_INDUS National_> 
-----------------------------------------------------------------------
<_Version Control_>
...
use "`path_in_stata'/CMPHS2012.dta", clear
...
*<_hhid_>
	gen hhid = string(questno, "%05.0f")	
	label var hhid "Household ID"
*</_hhid_>


*<_pid_>
	gen  pid_str = string(memberno, "%02.0f")
...
*<_relationharm_>
	gen byte relationharm=relationtohead
	replace relationharm=4 if relationtohead==6
	replace relationharm=5 if relationtohead==4 |relationtohead==5 |relationtohead==7 | relationtohead==8
	replace relationharm=6 if relationtohead==9
...
*<_educat_orig_>
* I included field of study and education level here. 
...
*<_lstatus_>
	gen byte lstatus=.
	replace lstatus=1 if workforIhr==1 | activitiesforsalepay==1 | absentfromwork==1
	replace lstatus=2 if workforIhr==2 & lookwk==1
...
*<_nlfreason_>
	...
	recode nlfreason (1/2=1) (5 = 4) (8 = 2) (6 7 9 10 11 12 13 14 = 5)
...
*<_unempldur_l_>
	gen byte unempldur_l=timelookwork if lstatus==2
	label var unempldur_l "Unemployment duration (months) lower bracket"
*</_unempldur_l_>


*<_unempldur_u_>
	gen byte unempldur_u=timelookwork if lstatus==2
...
{
*<_empstat_>
	gen empstat = employmentstatus
	recode empstat (3=1) (4 5 6=2) (1=3) (2=4)
...
*<_ocusec_>
	gen byte ocusec=establishmentname
	recode ocusec 1/3=1 4=3 4/8=2 0=1
...
*<_industrycat10_>
    gen industrycat10 = activity
    recode industrycat10 (1/3=1) (5/9 = 2) (10/33 = 3) (35/39 = 4) (41/43 = 5) (45/47 55/56 = 6) (49/53 58/63 = 7) (64/82 = 8) (84 = 9) (85/99 = 10) (4 83 89 = .)	
    replace industrycat10 = . if lstatus != 1
    label var industrycat10 "1 digit industry classification, primary job 7 day recall"
    label define lblindustrycat10 1 "Agriculture" 2 "Mining" 3 "Manufacturing" 4 "Public utilities" 5 "Construction" 6 "Commerce" 7 "Transport and Comnunications" 8 "Financial and Business Services" 9 "Public Administration" 10 "Other Services, Unspecified", replace
...
{
*<_empstat_2_>
	gen byte empstat_2= secondaruempstatus
...
*<_industry_orig_2_>
	gen industry_orig_2= string(secondaryactivity, "%05.0f") if !missing(secondaryactivity)
...
*<_whours_2_>
	gen whours_2 = hrsatotherjob if !missing(empstat_2) & lstatus == 1
	recode whours_2 (0 = .)
