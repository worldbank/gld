...
<_Program name_>				MUS_2010_CMPHS_V01_M_V01_A_GLD_ALL.do </_Program name_>
<_Application_>					Stata 18 <_Application_>
<_Author(s)_>					World Bank Jobs Group (gld@worldbank.org) </_Author(s)_>
<_Date created_>				2026-02-25 </_Date created_>
...
<_Sample size (HH)_> 			11,280 </_Sample size (HH)_>
<_Sample size (IND)_> 			41,103 </_Sample size (IND)_>
...
<_OCCUP National_>				National Classification of Occupations rev 1 </_OCCUP National_>
<_ISIC Version_>				ISIC version 3 </_ISIC Version_>
<_INDUS National_>				National Standard Industrial Classification of Economic Activities rev 1 </_INDUS National_> 
-----------------------------------------------------------------------
<_Version Control_>
...
use "`path_in_stata'/CMPHS 2010.dta", clear
...
*<_hhid_>
	gen hhid = string(Serialnumber, "%05.0f")	
	label var hhid "Household ID"
*</_hhid_>


*<_pid_>
	gen  pid_str = string(membernumber, "%02.0f")
	gen pid = hhid + pid_str
	
	* There are duplicates in PID: drop complete duplicates
	duplicates drop 
	
	* Check for duplicates in pid and demographic characteristics
	duplicates tag pid, gen(x1)
	duplicates tag Serialnumber month district householdnumber membernumber age sex reltohead, gen(x2)
	
	tab x1 x2, mi
	* The duplicates in pid share the same age, sex and household relation
	* Only differ in some questions relating to the non-labor module but same responses in labor
	* Thus, in the perpsective of GLD harmonization, they are duplicates!
...
*<_school_>
	gen byte school=schoolattendance
	recode school  (2/4=0) 
...
*<_educat7_>
	...
	replace educat7=3 if inlist(educationlevel, 16, 17)
	...
	* Use ISCED from field of study vble
	gen qual1d = int(qualification/100)
...
*<_educat_orig_>
	gen educat_orig = educationlevel
	replace educat_orig = qualification if !missing(qualification)
...
*<_lstatus_>
	gen byte lstatus=.
	replace lstatus=1 if workfor1hour==1 | activity==1 | absentforwork==1
	replace lstatus=2 if workfor1hour==2 & lookingforwork==1
	replace lstatus=3 if lstatus!=1 & availableforwork==2
...
*<_nlfreason_>
	gen byte nlfreason=whynotavailable if lstatus==3
	recode nlfreason (2 = 3) (3 = 4) (5 = 2) (6 = .) (6 7 8 = 5)
...
*<_unempldur_l_>
	gen byte unempldur_l=timelookingforwork if lstatus==2
	label var unempldur_l "Unemployment duration (months) lower bracket"
*</_unempldur_l_>


*<_unempldur_u_>
	gen byte unempldur_u=timelookingforwork if lstatus==2
...
{
*<_empstat_>
	gen byte empstat=employmentstatus
	recode empstat (3=1) (4 5 6=2) (1=3) (2=4) (7 = 5)
...
*<_ocusec_>
	gen byte ocusec=.
	replace ocusec=1 if nameofestablishment>=1 & nameofestablishment<=3
	replace ocusec=2 if nameofestablishment>=5 & nameofestablishment<=9
	replace ocusec=3 if nameofestablishment==4
...
*<_industry_orig_>
	gen industry_orig=string(W, "%02.0f") if !missing(W)
...
*<_industrycat_isic_>
    ...
    replace industrycat_isic = "" if inlist(activity, 4, 83, 89)
...
*<_industrycat10_>
	...
	replace industrycat10 = 7 if inrange(isic_2d, 60, 64)
...
*<_occup_isco_>
	...
	replace occup_isco = "" if inlist(occupation, 26, 47, 55, 65, 77, 87, 99)
...
*<_wage_no_compen_>
	gen double wage_no_compen=paidemployment
...
{
*<_empstat_2_>
* Note that the categories for primary empstat vs secondary differ
	gen byte empstat_2= secondaryemploymentstatus
	recode empstat_2 (1 = 3) (2 = 4) (3 = 1) (4 5 = 2) (6 = 5)
...
*<_industry_orig_2_>
	gen industry_orig_2= string(secondactivity, "%02.0f") if !missing(secondactivity)
	replace industry_orig_2= "" if lstatus!=1 | missing(empstat_2)
...
*<_industrycat_isic_2_>
	...
	replace industrycat_isic_2 = "" if inlist(industrycat_isic_2, "0000", "8300")
	label var industrycat_isic_2 "ISIC code of secondary job 7 day recall"
*</_industrycat_isic_2_>


*<_industrycat10_2_>
    destring industry_orig_2, gen(industrycat10_2)
    recode industrycat10_2 (1/3=1) ( 11/14=2) (15/37=3) (40/41=4) (45=5) (50/55=6) (60/64=7) (65/74=8) (75=9) (76/95=10) (99 0 83=.)
...
*<_whours_2_>
	gen whours_2 = hrsatotherjob if empstat_2 != . & lstatus == 1
	recode whours_2 (0 = .)
