...
<_Program name_>				MUS_2005_CMPHS_V01_M_V01_A_GLD_ALL.do </_Program name_>
...
<_Sample size (IND)_> 			41,894 </_Sample size (IND)_>
...
use "`path_in_stata'/CMPHS 05.dta", clear
...
*<_hhid_>
	gen hhid_str = string(serialno, "%04.0f")
...
*<_pid_>
	...
	* There are two duplicates in pid
	
	* Question: do they share the same responses in the labor module?
	duplicates tag pid reltohead - hrsmain, gen(x2)
	* Yes they do!
	
	duplicates drop pid reltohead - hrsmain, force
...
*<_educat7_>
	gen byte educat7=.
	replace educat7=1 if educlevel==1
	replace educat7=2 if educlevel>=11 & educlevel<=16
	replace educat7=3 if inlist(educlevel, 16, 17)
	replace educat7=4 if educlevel>=21 & educlevel<=23
	replace educat7=5 if educlevel>=24 & educlevel<=28
...
*<_lstatus_>
	gen byte lstatus=.
	replace lstatus=1 if work==1 | activities==1 | awayfromwk==1
	replace lstatus=2 if work==2 & lookingwork==1
	replace lstatus=3 if lstatus!=1 & availwork==2
...
*<_unempldur_l_>
	gen byte unempldur_l=timelookwrk if lstatus==2
	label var unempldur_l "Unemployment duration (months) lower bracket"
*</_unempldur_l_>


*<_unempldur_u_>
	gen byte unempldur_u=timelookwrk if lstatus==2
...
*<_industry_orig_>
	gen industry_orig=string(activity, "%02.0f") if !missing(activity)
...
*<_occup_isco_>
	...
	replace occup_isco = "" if inlist(occupation, 36, 39, 45, 63, 64, 65, 75, 85, 94, 95, 99)
...
* Beginning 2005, the secondary activity status is asked in the surveys

{
*<_empstat_2_>
	gen byte empstat_2=secempstat
	recode empstat_2 (3=1) (4 5=2) (1=3) (2=4) (6=5) (0 = .)
...
*<_industry_orig_2_>
	gen industry_orig_2= string(secondact, "%02.0f") if !missing(secondact)
...
*<_industrycat10_2_>
    ...
    recode industrycat10_2 (1/3=1) ( 11/14=2) (15/37=3) (40/41=4) (45=5) (50/55=6) (60/64=7) (65/74=8) (75=9) (76/95=10) (99=.)
...
*<_whours_2_>
	gen whours_2 = hrssec if !missing(empstat_2)
	recode whours_2 (0 = .)
