...
<_Program name_>				MUS_2011_CMPHS_V01_M_V01_A_GLD_ALL.do </_Program name_>
...
<_Sample size (IND)_> 			41,671 </_Sample size (IND)_>
...
<_OCCUP National_>				National Classification of Occupations rev 2 </_OCCUP National_>
...
use "`path_in_stata'/CMPHS2011.dta", clear
...
*<_educat7_>
* The educlevel variable here is at the three digits. in the questinonaire, only two digits. odd!
	gen byte educat7=.
...
*<_lstatus_>
	gen byte lstatus=.
	replace lstatus=1 if work==1 | activ==1 | absentwk==1
	replace lstatus=2 if work==2 & lookwk==1
...
*<_industry_orig_2_>
	gen industry_orig_2= string(secondactnew, "%05.0f") if !missing(secondactnew)
...
*<_whours_2_>
	gen whours_2 = hrsother if !missing(empstat_2) & lstatus == 1
	recode whours_2 (0 = .)
