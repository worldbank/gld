...
/* -----------------------------------------------------------------------
<_Program name_>				CHL_2011_CASEN_V01_M_V05_A_GLD_ALL.do </_Program name_>
...
use "`path_in_stata'\casen2011_octubre2011_enero2012_principal_08032013stata.dta"
...
*<_wage_no_compen_>
* only one child reports a lot of income not possible.
	gen double wage_no_compen =yopraj
	replace wage_no_compen=. if lstatus!=1
	replace wage_no_compen=. if wage_no_compen == 0
	replace wage_no_compen=. if age<15
