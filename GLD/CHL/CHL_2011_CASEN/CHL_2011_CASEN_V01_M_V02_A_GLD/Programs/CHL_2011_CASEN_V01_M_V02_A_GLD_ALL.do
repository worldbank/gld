...
/* -----------------------------------------------------------------------
<_Program name_>				CHL_2011_CASEN_V01_M_V02_A_GLD_ALL.do </_Program name_>
...
local path_in "Z:\GLD-Harmonization\582018_AQ\CHL\CHL_2011_CASEN\CHL_2011_CASEN_V01_M\Data\Stata"
local path_output "Z:\GLD-Harmonization\582018_AQ\CHL\CHL_2011_CASEN\CHL_2011_CASEN_V01_M_V02_A_GLD\Data\Harmonized"

*----------1.3: Database assembly------------------------------*

* All steps necessary to merge datasets (if several) to have all elements needed to produce
* harmonized output in a single file
use "`path_in'\casen2011_octubre2011_enero2012_principal_08032013stata.dta"
...
*<_int_year_>
	gen int_year=a_o_ent
	label var int_year "Year of the interview"
*</_int_year_>


*<_int_month_>
	gen  int_month = mes_ent
...
*4 digits
	...
	*gen industrycat_isic= string(rama4_helper,"%04.0f")
	gen industrycat_isic= rama4_sub
...
*<_industrycat10_>
	...
	recode industrycat10 2=1 3=2 4=3 5=4 6=5 7=6 8=10 9=7 10=8 11=10 12=9 13/16=10 17=9 18=.
...
*<_occup_isco_>
	...
	*gen occup_isco = string(o9_helper,"%04.0f")
	...
	replace occup_isco="3429" if oficio4=="9500"
...
*<_occup_skill_>
	destring oficio1, force replace
...
*<_firmsize_u_>
	gen firmsize_u=o24
	recode firmsize_u 1=1 2=5 3=9 4=49 5=199 6=. 9=.
...
*<_empstat_2_>
	...
	recode empstat_2 (1=3) (2=4) (3/5=1) (6=2) ( 6 7=5) (8=5) (9=2)
...
save "`path_output'\CHL_2011_CASEN_V01_M_V02_A_GLD_ALL.dta", replace
