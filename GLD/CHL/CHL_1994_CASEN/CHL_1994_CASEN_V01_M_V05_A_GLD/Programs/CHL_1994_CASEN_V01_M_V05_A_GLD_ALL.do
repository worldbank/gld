...
/* -----------------------------------------------------------------------
<_Program name_>				CHL_1994_CASEN_V01_M_V05_A_GLD_ALL.do </_Program name_>
...
use "`path_in_stata'\casen1994.dta"
...
*<_subnatid2_>
	gen subnatid2=p
	la de lblsubnatid2    11 "1 - Arica"  13 "2 - Iquique"  21 "3 - Tocopilla"  22 "4 - El Loa"  23 "5 - Antofagasta"  31 "6 - Chañaral"  32 "7 - Copiapó"  33 "8 - Huasco"  41 "9 - Elqui"  42 "10 - Limarí"  43 "11 - Choapa"  51 "12 - Petorca"  52 "13 - Los Andes"  53 "14 - San Felipe de Aconcagua"  54 "15 - Quillota"  55 "16 - Valparaíso"  56 "17 - San Antonio"  61 "18 - Cachapoal"  62 "19 - Colchagua"  71 "20 - Curico"  72 "21 - Talca"  73 "22 - Linares"  74 "23 - Cauquenes"  81 "24 - Ñuble"  82 "25 - Bio Bío"  83 "26 - Concepción"  84 "27 - Arauco"  92 "28 - Cautín"  101 "29 - Valdivia"  102 "30 - Osorno"  103 "31 - Llanquihue"  104 "32 - Chiloé"  111 "34 - Cohaique"  105 "33 - Palena"  112 "35 - Aisén"  122 "36 - Magallanes"  131 "37 - Santiago"  132 "38 - Chacabuco"  133 "39 - Cordillera"  134 "40 - Maipo"  135 "41 - Melipilla"  136 "42 - Talagante"
...
*<_educat7_>
	gen byte educat7 = .
	replace educat7=1 if e9==1
	replace educat7=3 if e9==3
	replace educat7=2 if e9==2
	replace educat7=4 if e9==5 
	replace educat7=4 if e9==7
	replace educat7=5 if e9==6 
	replace educat7=5 if e9==8
	replace educat7=6 if e9==11 
	replace educat7=6 if e9==12
	replace educat7=7 if e9==9 
	replace educat7=7 if e9==10 
	replace educat7=7 if e9==13 
	replace educat7=7 if e9==14
	replace educat7=1 if e9==15
...
*<_vocational_>
	gen vocational = o20
	recode vocational 1/5=1 6=0
	label de lblvocational 0 "No" 1 "Yes"
	label var vocational "Ever received vocational training"
*</_vocational_>

*<_vocational_type_>
	gen vocational_type = o20
...
*<_empstat_>
	gen byte empstat = o7
	recode empstat (1=3) (2=4) (3=1) (7=2) (4 5 6=1) (8=.)
...
*three digits , the following codes are not clear or do not match the guide 110 120 123 310 320 340 350 360 363 370 380 503 630 710 830 940 950"
	...
	tostring o6_helper, force replace
	gen industrycat_isic = o6_helper + substr("0000", 1, 4 - length(o6_helper))
	replace industrycat_isic = "" if industrycat_isic ==".000"
	replace industrycat_isic = "" if industrycat_isic =="0000"
	replace industrycat_isic="" if industrycat_isic =="1230" |  industrycat_isic =="3630" |  industrycat_isic =="5030"
...
*<_occup_isco_>
	*110 130 220 230 330 410 510 610 620 720 740 810 820 910 are not in the guide from the nso but are in the data, they are not present on the isco 88 list either.
	gen o5_helper=string(o5)
	replace o5_helper="" if o5==999
	gen occup_isco= o5_helper + substr("0000", 1, 4 - length(o5_helper))
	replace occup_isco="" if o5==.
...
*<_wage_total_>
*can I calculate this with no months?
	gen wage_total = .
