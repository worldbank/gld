...
/* -----------------------------------------------------------------------
<_Program name_>				CHL_2017_CASEN_V01_M_V04_A_GLD_ALL.do </_Program name_>
...
<_Data collection from_> nov 2017 </_Data collection from_>
<_Data collection to_>		febrero 2018 </_Data collection to_>
<_Source of dataset_> 	CASEN </_Source of dataset_>
<_Sample size (HH)_> 	70948 </_Sample size (HH)_>
<_Sample size (IND)_> 	216439 </_Sample size (IND)_>
...
local path_in "Z:\GLD-Harmonization\582018_AQ\CHL\CHL_2017_CASEN\CHL_2017_CASEN_V01_M\Data\Stata"
local path_output "Z:\GLD-Harmonization\582018_AQ\CHL\CHL_2017_CASEN\CHL_2017_CASEN_V01_M_V04_A_GLD\Data\Harmonized"

*----------1.3: Database assembly------------------------------*

* All steps necessary to merge datasets (if several) to have all elements needed to produce
* harmonized output in a single file
use "`path_in'\casen_2017.dta"
...
*<_hhid_>
	gen f_helper=string(folio, "%013.0f")
	gen hhid = f_helper
	drop f_helper
...
*<_subnatid1_>
	...
	la de lblsubnatid1 1 "1 - Tarapacá" 2 "2 - Antofagasta" 3 "3 -  Atacama" 4 "4 - Coquimbo" 5 "5 -  Valparaiso" 6 "6 - O'higgins" 7 "7 -  Maule" 8 "8 -  Bío bío" 9 "9 -  La araucanía" 10 "10 - Los lagos" 11 "11 - Aysén" 12 "12 - Magallanes y la antartida" 13 "13 - Región Metropolitana" 14 "14 -  Los rios" 15 "15 -  Arica y Parinacota" 16 "16 - Ñuble"
...
*<_subnatid1_prev_>
	gen subnatid1_prev = ""
	replace subnatid1_prev = "8 - Bío bío" if region==8 | region==16
...
*<_industry_orig_>
	gen industry_orig= string(rama4,"%04.0f")
	replace industry_orig="" if rama4==.
...
*<_industrycat_isic_>
*4 digits
	gen industrycat_isic= string(rama4,"%04.0f")
...
*<_industrycat10_>
	gen industrycat10=rama4
	replace industrycat10=1 if inrange(rama4,111,500)
	replace industrycat10=2 if inrange(rama4,1010,1429)
	replace industrycat10=3 if inrange(rama4,1511,3720)
	replace industrycat10=4 if inrange(rama4,4010,4100)
	replace industrycat10=5 if inrange(rama4,4510,4550)
	replace industrycat10=6 if inrange(rama4,5010,5520)
	replace industrycat10=7 if inrange(rama4,6010,6420)
	replace industrycat10=8 if inrange(rama4,6511,7499)
	replace industrycat10=9 if inrange(rama4,7511,7530)
	replace industrycat10=10 if inrange(rama4,8010,9900)
	replace industrycat10=. if rama4==9999
...
*<_occup_isco_>
	...
	replace occup_isco="" if o9_helper==.
...
save "`path_output'\CHL_2017_CASEN_V01_M_V04_A_GLD_ALL.dta", replace
