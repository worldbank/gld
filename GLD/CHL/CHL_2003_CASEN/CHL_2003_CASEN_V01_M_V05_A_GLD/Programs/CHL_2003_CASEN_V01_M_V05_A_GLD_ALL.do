...
/* -----------------------------------------------------------------------
<_Program name_>				CHL_2003_CASEN_V01_M_V04_A_GLD_ALL.do </_Program name_>
...
<_Data collection from_>	8 nov 2003 </_Data collection from_>
<_Data collection to_>		20 dec 2003 </_Data collection to_>
<_Source of dataset_> 	CASEN </_Source of dataset_>
<_Sample size (HH)_> 	68153 </_Sample size (HH)_>
<_Sample size (IND)_> 	257077 </_Sample size (IND)_>
...
-----------------------------------------------------------------------
<_Version Control_>
* Date: [2022-06-10] - [changes in isco and isic]
* Date: [YYYY-MM-DD] - [Description of changes]
* Date: 2023/5/8 - Update to V05, use o28 for social security 
</_Version Control_>
-------------------------------------------------------------------------*/
...
use "`path_in_stata'\casen2003.dta"
...
*<_educat7_>
	...
	replace educat7=4 if educ==4
	replace educat7=4 if educ==6
	replace educat7=5 if educ==5
	replace educat7=5 if educ==7
	replace educat7=6 if educ==8
	replace educat7=6 if educ==9
	replace educat7=7 if educ==10
	replace educat7=7 if educ==11
...
*<_empstat_>
	gen byte empstat = o9
	recode empstat (1=3) (2=4) (3/5=1) (6 7 9=1) (8=2)
...
*4 digits, not present in the raw data 3853
	gen o8_helper=o8
	gen industrycat_isic= string(o8_helper,"%04.0f")
	replace industrycat_isic ="0" if industrycat_isic=="0000"
	replace industrycat_isic = "" if industrycat_isic =="."
	replace industrycat_isic ="" if o8==0 | o8==1310 | o8== 1311| o8==1319 | o8==2112| o8==2523 | o8==3221 | o8==3414 | o8==3415 | o8==3626 | o8==4132 | o8==4143 | o8==5220 | o8==5230 | o8==5323| o8==6110 | o8==6210 | o8==6220 | o8==6522 | o8==7314 | o8==7412 | o8==8121 | o8==8340 | o8==9111 | o8==9112 | o8==9113 | o8==9131 | o8==9132 | o8==9152 | o8== 9191 | o8== 9230 | o8== 9325 | o8==9559 | o8==9999
...
*<_industrycat10_>
	gen industrycat10=.
	tostring o8_helper, replace force
	replace industrycat10=1 if inrange(o8_helper,"1000","1399")
	replace industrycat10=2 if inrange(o8_helper,"2100","2999")
	replace industrycat10=3 if inrange(o8_helper,"3111","3999")
	replace industrycat10=4 if inrange(o8_helper,"4100","4200")
	replace industrycat10=5 if inrange(o8_helper,"5000","5999")
	replace industrycat10=6 if inrange(o8_helper,"6100","6522")
	replace industrycat10=7 if inrange(o8_helper,"7111","7499")
	replace industrycat10=8 if inrange(o8_helper,"8100","8340")
	replace industrycat10=9 if o8_helper=="9100"
	replace industrycat10=9 if inrange(o8_helper,"9111","9191")
	replace industrycat10=10 if inrange(o8_helper,"9200","9600")
	replace industrycat10=10 if o8_helper=="0"
	replace industrycat10=. if o8_helper=="9999"
...
*<_occup_orig_>
	gen occup_orig = string(o7)
	replace occup_orig="" if o7==.
...
*<_occup_isco_>
	...
	gen occup_isco = string(o7_helper,"%04.0f")
	replace occup_isco="" if o7==1523 | o7== 1612 | o7==2313 | o7== 2322| o7==3137|  o7==3219 | o7== 3574 | o7==3745 | o7== 4102 | o7==4230 | o7==6211 | o7==6322 | o7==6460 | o7==7114| o7==7317 | o7==7333 | o7==7315 |o7==7317 | o7==7333 |o7==8136 | o7==8183| o7==8328 | o7==8363 | o7==9121 | o7==9122 | o7==9137 |  o7==9231| o7==9323 | o7==9831 | o7==9233 | o7==6212
	replace occup_isco="" if o7_helper==.
	drop o7_helper
...
*<_socialsec_>
	...
	recode socialsec 7=0 0/6=1 8=1 9=.
