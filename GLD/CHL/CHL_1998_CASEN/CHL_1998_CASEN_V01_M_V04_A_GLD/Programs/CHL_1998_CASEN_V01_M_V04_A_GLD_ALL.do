...
/* -----------------------------------------------------------------------
<_Program name_>				CHL_1998_CASEN_V01_M_V04_A_GLD_ALL.do </_Program name_>
...
use "`path_in_stata'\casen1998.dta"
...
*<_educat7_>
	...
	recode educat7 0=1 1=2 2=3 3/4=4 5/6=5 8=6 9=7 10=. 99=.
...
*<_empstat_>
	gen byte empstat = o8
	recode empstat (1=3) (2=4) (3=1) (6=2) (4 5 7=1) (9=.)
...
*<_industrycat10_>
	gen industrycat10=.
	tostring o7_helper, replace force
	replace industrycat10=1 if inrange(o7_helper,"1000","1399")
	replace industrycat10=2 if inrange(o7_helper,"2100","2999")
	replace industrycat10=3 if inrange(o7_helper,"3111","3999")
	replace industrycat10=4 if inrange(o7_helper,"4100","4200")
	replace industrycat10=5 if inrange(o7_helper,"5000","5999")
	replace industrycat10=6 if inrange(o7_helper,"6100","6320")
	replace industrycat10=7 if inrange(o7_helper,"7111","7200")
	replace industrycat10=8 if inrange(o7_helper,"8100","8339")
	replace industrycat10=9 if o7_helper=="9100"
	replace industrycat10=10 if inrange(o7_helper,"9200","9600")
	replace industrycat10=10 if o7_helper=="0"
...
*<_firmsize_l_>
	gen firmsize_l=o10
	recode firmsize_l 1=1 2=2 3=6 4=10 5=50 6=200 9=.
