...
<_Program name_>				GHA_2023_AHIES_V02_M_V01_A_GLD_ALL </_Program name_>
...
<_Sample size (HH)_> 		10,241 //  40,253 </_Sample size (HH)_>
<_Sample size (IND)_> 		54,509 // 196,953 </_Sample size (IND)_>
...
use "`path_in_stata'/2023 AHIES Q1-Q4_Rev_20250827.dta", clear
...
*<_industrycat_isic_>
	...
	replace industrycat_isic = "0300" if industrycat_isic == "0339"
	replace industrycat_isic = "0810" if industrycat_isic == "0817"
	replace industrycat_isic = "0900" if industrycat_isic == "0956"
	replace industrycat_isic = "1100" if industrycat_isic == "1119"
	replace industrycat_isic = "4790" if industrycat_isic == "4792"
	replace industrycat_isic = "7490" if industrycat_isic == "7499"
	replace industrycat_isic = "8530" if industrycat_isic == "8531"
	replace industrycat_isic = "8600" if industrycat_isic == "8630"
	replace industrycat_isic = "9500" if industrycat_isic == "9531"
	replace industrycat_isic = "9600" if industrycat_isic == "9610"
	replace industrycat_isic = "9600" if industrycat_isic == "9621"
...
*<_occup_isco_>
	...
	replace occup_isco = ""     if occup_isco == "5979"
	replace occup_isco = "7510" if occup_isco == "7517"
	replace occup_isco = "7510" if occup_isco == "7518"
	
	* code 2132 in s4aq40a2 is way bigger than other years, compared to s4aq40a1 seems misaligned
	tab s4aq40a1 if s4aq40a2 == 2132
	/*
			 Main occupation (code) - Major |      Freq.     Percent        Cum.
	----------------------------------------+-----------------------------------
								   Managers |          6        0.07        0.07
							  Professionals |         18        0.22        0.29
	Technicians and associate professionals |         15        0.18        0.47
				   Clerical support workers |          9        0.11        0.58
				  Service and sales workers |        185        2.23        2.81
	Skilled agricultural, forestry and fish |      7,572       91.42       94.23
		   Craft and related trades workers |        247        2.98       97.21
	Plant and machine operators, and assemb |         57        0.69       97.90
					 Elementary occupations |        174        2.10      100.00
	----------------------------------------+-----------------------------------
									  Total |      8,283      100.00
	*/
	* Code it as two digit if general code is skilled ag
	
	tostring s4aq40a3, gen(occup_isco_helper) format(%06.0f)
	replace occup_isco_helper = substr(occup_isco_helper, 1, 2)
	replace occup_isco_helper = occup_isco_helper + "00"
	
	replace occup_isco = occup_isco_helper if inrange(occup_isco_helper, "6100", "6300") & s4aq40a1 == 6 & s4aq40a2 == 2132
