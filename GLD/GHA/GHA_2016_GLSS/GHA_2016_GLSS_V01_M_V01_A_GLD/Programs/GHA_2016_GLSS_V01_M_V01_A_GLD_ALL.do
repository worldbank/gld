...
<_Sample size (HH)_> 				14009 </_Sample size (HH)_>
<_Sample size (IND)_> 				59864 </_Sample size (IND)_>
...
*Part A
use "`path_in_stata'/g7PartA/g7loc_upd.dta", clear
merge 1:1 hid using "`path_in_stata'/g7PartA/g7sec0.dta", nogenerate
merge 1:m hid using "`path_in_stata'/g7PartA/g7sec1.dta", nogenerate

foreach sec in g7sec1_5 g7sec2 g7sec3a g7sec3b g7sec3c g7sec3d g7sec3e g7sec3f g7sec4_reviewed g7sec5a g7sec5b g7sec5c {
	dis "THIS IS `sec'"
	merge 1:1 hid pid using "`path_in_stata'/g7PartA/`sec'.dta", nogenerate assert(master match)
}

/*
foreach sec in  g7sec6a g7sec6b g7sec6q10 {
	dis "THIS IS `sec'"
	merge m:1 hid using "`path_in_stata'/g7PartA/`sec'.dta", nogenerate assert(master match)
}
*/
...
*<_subnatid2_>
	*We did not find information about district name
	tostring district, gen(subnatid2)
...
/* <_eye_dsablty_note>
	...
	gen eye_dsablty = 1
	replace eye_dsablty = 4 if s3aq27a == 1
...
*<_hear_dsablty_>
	gen hear_dsablty = 1
	replace hear_dsablty = 4 if s3aq27b == 1
...
*<_walk_dsablty_>
	gen walk_dsablty = 1
	replace walk_dsablty = 4 if s3aq27d == 1
	label define dsablty 1 "No – no difficulty" 2 "Yes – some difficulty" 3 "Yes – a lot of difficulty" 4 "Cannot do at all", replace
...
*<_conc_dsord_>
	gen conc_dsord = 1
	replace conc_dsord = 4 if s3aq27e == 1
	label define dsablty 1 "No – no difficulty" 2 "Yes – some difficulty" 3 "Yes – a lot of difficulty" 4 "Cannot do at all", replace
...
*<_slfcre_dsablty_>
	...
	replace slfcre_dsablty = 4 if s3aq27f == 1
	label define dsablty 1 "No – no difficulty" 2 "Yes – some difficulty" 3 "Yes – a lot of difficulty" 4 "Cannot do at all", replace
...
*<_comm_dsablty_>
	gen comm_dsablty = 1
	replace comm_dsablty = 4 if  s3aq27c == 1
	label define dsablty 1 "No – no difficulty" 2 "Yes – some difficulty" 3 "Yes – a lot of difficulty" 4 "Cannot do at all", replace
...
*<_migrated_binary_>
	gen migrated_binary = 1 if !missing(s5aq4)
	replace migrated_binary = 0 if missing(migrated_binary) & inrange(age,5,999)
...
/* <_migrated_years_note>
 ...
 <_migrated_years_note>*/
	gen migrated_years = s5aq4
	recode migrated_years (1 = 1) (2 = 3) (3 = 7) (4 = 10)
...
(s5aq5):
	...
	17. Cote d'Ivoire  
	18. Other ECOWAS  
	19. Africa, other than ECOWAS  
	20. Europe Caribbean  
	21. Americas (North, South)  
	22. Asia  
	23. Oceania  

</_migrated_from_cat_note> */
	gen migrated_from_cat = .
	replace migrated_from_cat = 4 if s5aq5 != region & inrange(s5aq5,1,10)
	replace migrated_from_cat = 6 if s5aq5 == region & inrange(s5aq5,1,10) & missing(migrated_from_cat)
	replace migrated_from_cat = 5 if inrange(s5aq5,11,23)
...
*<_migrated_from_country_>
	gen migrated_from_country = "NGA" if s5aq5 == 11
	replace migrated_from_country = "LBR" if s5aq5 == 12
	replace migrated_from_country = "SLE" if s5aq5 == 13
	replace migrated_from_country = "GMB" if s5aq5 == 14
	replace migrated_from_country = "TGO" if s5aq5 == 15
	replace migrated_from_country = "BFA" if s5aq5 == 16
	replace migrated_from_country = "CIV" if s5aq5 == 17
	replace migrated_from_country = "Other ECOWAS" if s5aq5 == 18
	replace migrated_from_country = "Africa other than ECOWAS" if s5aq5 == 19
	replace migrated_from_country = "Europe Caribbean" if s5aq5 == 20
	replace migrated_from_country = "Americas" if s5aq5 == 21
	replace migrated_from_country = "Asia" if s5aq5 == 22
	replace migrated_from_country = "Oceania" if s5aq5 == 23
	label var migrated_from_country "Code of migration country (ISO 3 Letter Code)"
*</_migrated_from_country_>


*<_migrated_reason_>
	gen migrated_reason = s5aq7
...
/* <_educy_note>
	...
	s2aq1b - What is the highest level of education (NAME) has  attained?
		0. None  
		1. Kindergarten  
		2. Primary  
		3. JSS/JHS  
		...
		6. Secondary  
		7. Voc/Tech/Comm  
		8. Teacher Training/Agric/Nursing Cert  
		9. Polytechnic  
		10. University (Bachelor)  
		11. University (Post Graduate)  
		12. Professional  
		13. Don't know  
		
	s2aq2 - What is the highest grade completed at that level?
		0. None  
		1. Pre school  
		11. P1  
		12. P2  
	...
	forvalues i = 7/12 {
		replace educy = 14 if s2aq1b == `i' &s2aq2 == 0 
		replace educy = 15 if s2aq1b == `i' &s2aq2 == 41 
		replace educy = 16 if s2aq1b == `i' &s2aq2 == 42
		replace educy = 17 if s2aq1b == `i' &s2aq2 == 43
		replace educy = 18 if s2aq1b == `i' &s2aq2 == 44
		replace educy = 19 if s2aq1b == `i' &s2aq2 == 45
		replace educy = 20 if s2aq1b == `i' &s2aq2 == 46
		replace educy = 17 if s2aq1b == `i' &s2aq2 == 47
	}
	
	//master and PHD 
	replace educy = 21 if s2aq3 == 10
	replace educy = 22 if s2aq3 == 11
...
*<_educat7_>
	gen byte educat7 = .
	replace educat7 = 1 if inlist(s2aq1b, 1) | s2aq1 == 2
	replace educat7 = 2 if s2aq1b == 2 & inlist(s2aq2, 0,11,12,13,14,15) & missing(educat7)
	replace educat7 = 3 if s2aq1b == 2 & inlist(s2aq2, 16) & missing(educat7)
	replace educat7 = 4 if inlist(s2aq1b,3,4) & missing(educat7)
	replace educat7 = 5 if inlist(s2aq1b,5,6) & missing(educat7)
	replace educat7 = 6 if inlist(s2aq1b,7,8,9) & missing(educat7)
	replace educat7 = 7 if inlist(s2aq1b,10,11,12) & missing(educat7)
...
*<_educat_orig_>
	decode s2aq1b, gen(high_educ_str)
	decode s2aq2, gen(high_grade_str)
	egen educat_orig = concat(high_educ_str high_grade_str), punct(" - ")
...
*<_lstatus_>
	...
	*Code employed
	replace lstatus = 1 if inlist(s4aq2,1) | s4aq4 == 1 | inlist(s4aq8,1,2) | inlist(s4aq11,1,2) |  inlist(s4aq14,1,2) | inlist(s4aq15,1) | inlist(s4aq17,1) | s4aq22 == 1 | inlist(s4aq24,1,2) | inlist(s4aq26,1,2) | inlist(s4aq28,1) | inlist(s4aq29,1) 
...
*<_ocusec_>
	gen byte ocusec = s4aq35
	recode ocusec (1 = 1) (2 = 3) (3 4 5 6 = 2) (7 = 4)
...
*<_industry_orig_>
	decode s4aq34c, gen(industry_orig)
...
*<_industrycat_isic_>
	tostring s4aq34c, gen(industrycat_isic) format(%04.0f)
	replace industrycat_isic = "" if industrycat_isic == "."
	replace industrycat_isic = "" if lstatus != 1
	replace industrycat_isic = "0100" if industrycat_isic == "0011"
	replace industrycat_isic = "0150" if industrycat_isic == "0151"
	replace industrycat_isic = "0150" if industrycat_isic == "0152"
	replace industrycat_isic = "0720" if industrycat_isic == "0722"
	replace industrycat_isic = "0720" if industrycat_isic == "0723"
	replace industrycat_isic = "0730" if industrycat_isic == "0730"  
	replace industrycat_isic = "0700" if industrycat_isic == "0730"
	replace industrycat_isic = "0800" if industrycat_isic == "0821"
	replace industrycat_isic = "1040" if industrycat_isic == "1041"
	replace industrycat_isic = "1100" if industrycat_isic == "1111"
	replace industrycat_isic = "1100" if industrycat_isic == "1113"
	replace industrycat_isic = "1920" if industrycat_isic == "1929"
	replace industrycat_isic = "2100" if industrycat_isic == "2111"
	replace industrycat_isic = "4750" if industrycat_isic == "4756"
	replace industrycat_isic = "4780" if industrycat_isic == "4788"
	replace industrycat_isic = "4900" if industrycat_isic == "4977"
	replace industrycat_isic = "6300" if industrycat_isic == "6349"
	replace industrycat_isic = "6490" if industrycat_isic == "6493"
	replace industrycat_isic = "8120" if industrycat_isic == "8123"
	replace industrycat_isic = "8220" if industrycat_isic == "8221"
	replace industrycat_isic = "8510" if industrycat_isic == "8512" 
	replace industrycat_isic = "8600" if industrycat_isic == "8630"
	replace industrycat_isic = "8840" if industrycat_isic == "8840" 
	replace industrycat_isic = "8800" if industrycat_isic == "8840"
	replace industrycat_isic = "9490" if industrycat_isic == "9493"
	replace industrycat_isic = "9490" if industrycat_isic == "9496"
	replace industrycat_isic = "9520" if industrycat_isic == "9526"
	replace industrycat_isic = "9700" if industrycat_isic == "9701"
...
*<_occup_isco_>
	tostring s4aq33c, gen(occup_isco) format(%04.0f)
	replace occup_isco = "" if occup_isco == "."
	replace occup_isco = "" if lstatus != 1
	replace occup_isco = "2110" if occup_isco == "2118"
	replace occup_isco = "2300" if occup_isco == "2363"
	replace occup_isco = "3410" if occup_isco == "3416"
	replace occup_isco = "3430" if occup_isco == "3439"
	replace occup_isco = "4210" if occup_isco == "4215"
	replace occup_isco = "4220" if occup_isco == "4228"
	replace occup_isco = "5120" if occup_isco == "5122"
	replace occup_isco = "5140" if occup_isco == "5145"
	replace occup_isco = "5230" if occup_isco == "5233"
	replace occup_isco = "6110" if occup_isco == "6116"
	replace occup_isco = "6130" if occup_isco == "6133"
	replace occup_isco = "6100" if occup_isco == "6144"
	replace occup_isco = "6220" if occup_isco == "6225"
	replace occup_isco = "6330" if occup_isco == "6332"
	replace occup_isco = "7210" if occup_isco == "7217"
	replace occup_isco = "7200" if occup_isco == "7244"
	replace occup_isco = "7200" if occup_isco == "7249"
	replace occup_isco = "7410" if occup_isco == "7414"
	...
	replace occup_isco = "7510" if occup_isco == "7519"
	replace occup_isco = "7520" if occup_isco == "7527"
	replace occup_isco = "8320" if occup_isco == "8324"
	replace occup_isco = "9200" if occup_isco == "9231"
	replace occup_isco = "9200" if occup_isco == "9250"  
	replace occup_isco = "9520" if occup_isco == "9521"
	replace occup_isco = "9520" if occup_isco == "9522"
	replace occup_isco = "9520" if occup_isco == "9524"
...
/* <_wage_no_compen_note>
	Employers and Self Employees has not info. onlu payments of 12 months
</_wage_no_compen_note> */
	gen double wage_no_compen = .
	
	*Paid employees
	replace wage_no_compen = s4aq45a if empstat == 1 & !inlist(s4aq45a,0)
...
*<_whours_>
	gen whours_second =  s4bq4
	replace whours_second = 0 if whours_second == . | whours_second == 999
	gen whours = tothrs - whours_second
...
*<_contract_>
	*Only asked to paid employees
	gen byte contract = s4aq37  if empstat == 1
...
*<_healthins_>
	*Only asked to paid employees
	gen byte healthins = s4aq38 if empstat == 1
...
*<_socialsec_>
	gen byte socialsec = s4aq41 if empstat == 1
...
{
*<_empstat_2_>
	gen byte empstat_2 = s4bq6
	recode empstat_2 (2 3 11 = 1) (4 7 10 = 2) (5 8 = 3) (6 9 = 4) (12 = 5)
	replace empstat_2 = . if inlist(s4bq1,1,.) | lstatus != 1
...
*<_ocusec_2_>
	gen byte ocusec_2 = s4bq5
	recode ocusec_2 (1 = 1) (2 = 3) (3 4 5 6 = 2) (7 = 4)
	replace ocusec_2 = . if lstatus != 1 | inlist(s4bq1,1,.)
*</_ocusec_2_>


*<_industry_orig_2_>
	decode s4bq3c, gen(industry_orig_2)
	replace industry_orig_2 = "" if inlist(s4bq1,1,.) | lstatus != 1
...
*<_industrycat_isic_2_>
	...
	tostring s4bq3c, gen(industrycat_isic_2) format(%04.0f)
	replace industrycat_isic_2 = "" if industrycat_isic_2 == "."
	replace industrycat_isic_2 = "" if inlist(s4bq1,1,.) | lstatus != 1
	replace industrycat_isic_2 = "0150" if industrycat_isic_2 == "0151"
	replace industrycat_isic_2 = "0150" if industrycat_isic_2 == "0152"
	replace industrycat_isic_2 = "0300" if industrycat_isic_2 == "0332"
	replace industrycat_isic_2 = "0720" if industrycat_isic_2 == "0722"
	replace industrycat_isic_2 = "0700" if industrycat_isic_2 == "0730"
	replace industrycat_isic_2 = "" if industrycat_isic_2 == "4420" // 1 obs 
	replace industrycat_isic_2 = "4620" if industrycat_isic_2 == "4623"
	replace industrycat_isic_2 = "6490" if industrycat_isic_2 == "6493"
	replace industrycat_isic_2 = "8600" if industrycat_isic_2 == "8630"
	replace industrycat_isic_2 = "9700" if industrycat_isic_2 == "9701"
...
*<_occup_orig_2_>
	decode s4bq2c, gen(occup_orig_2)
	replace occup_orig_2 = "" if inlist(s4bq1,1,.) | lstatus != 1
	label var occup_orig_2 "Original occupation record secondary job 7 day recall"
*</_occup_orig_2_>


*<_occup_isco_2_>
	tostring s4bq2c, gen(occup_isco_2) format(%04.0f)
	replace occup_isco_2 = "" if occup_isco_2 == "."
	replace occup_isco_2 = "" if inlist(s4bq1,1,.) | lstatus != 1
	
	replace occup_isco_2 = "0110" if occup_isco_2 == "0114"
	replace occup_isco_2 = "6000" if occup_isco_2 == "0624"
	replace occup_isco_2 = "4210" if occup_isco_2 == "4215"
	replace occup_isco_2 = "6100" if occup_isco_2 == "6144"
	replace occup_isco_2 = "6210" if occup_isco_2 == "6211"
	replace occup_isco_2 = "7200" if occup_isco_2 == "7249"
	replace occup_isco_2 = "7510" if occup_isco_2 == "7517"
	replace occup_isco_2 = "7510" if occup_isco_2 == "7518"
	replace occup_isco_2 = "7510" if occup_isco_2 == "7519"
...
/* <_wage_no_compen_2_note>
	Employers and Self Employees has not info. only payments of 12 months
</_wage_no_compen_2_note> */

	gen double wage_no_compen_2 = . 
	
	*Paid employees
	replace wage_no_compen_2 = s4bq8a if empstat_2 == 1 & !inlist(s4bq8a,0)
...
*<_whours_2_>
	gen whours_2 = s4bq4
	replace whours_2 = . if s4bq4 == 999 | empstat_2 != 1
...
*<_empstat_year_>
	* Same main job in the past seven days
...
*<_ocusec_year_>
	...
	recode ocusec_year_helper (1 = 1) (2 = 3) (3 4 5 6 = 2) (7 = 4)
...
*<_industry_orig_year_>
	...
	decode s4dq4c, gen(industry_orig_year_helper) 
	replace industry_orig_year = industry_orig_year_helper if missing(industry_orig_year)
...
*<_industrycat_isic_year_>
	...
	tostring s4dq4c, gen(industrycat_isic_year_helper) format(%04.0f)
	...
	replace industrycat_isic_year = "0150" if industrycat_isic_year == "0151"
	replace industrycat_isic_year = "0150" if industrycat_isic_year == "0152"
	replace industrycat_isic_year = "0720" if industrycat_isic_year == "0722"
	replace industrycat_isic_year = "0720" if industrycat_isic_year == "0723"
	replace industrycat_isic_year = "0700" if industrycat_isic_year == "0730"  
	replace industrycat_isic_year = "1100" if industrycat_isic_year == "1111"
	replace industrycat_isic_year = "6490" if industrycat_isic_year == "6493"
	replace industrycat_isic_year = "9490" if industrycat_isic_year == "9493"
	replace industrycat_isic_year = "" if industrycat_isic_year == "9999"
...
*<_occup_orig_year_>
	...
	decode s4dq3c, gen(occup_orig_year_helper) 
	replace occup_orig_year = occup_orig_year_helper if missing(occup_orig_year)
...
*<_occup_isco_year_>
	...
	tostring s4dq3c, gen(occup_isco_year_helper) format(%04.0f)
	...
	replace occup_isco_year = "9310" if occup_isco_year == "0931"
	replace occup_isco_year = "2330" if occup_isco_year == "2339"
	replace occup_isco_year = "2300" if occup_isco_year == "2363"
	replace occup_isco_year = "4210" if occup_isco_year == "4215"
	replace occup_isco_year = "7200" if occup_isco_year == "7249"
	replace occup_isco_year = "7510" if occup_isco_year == "7517"
	replace occup_isco_year = "7510" if occup_isco_year == "7518"
	replace occup_isco_year = "7510" if occup_isco_year == "7519"
...
*<_t_hours_annual_>
	...
	replace t_hours_annual = . if lstatus != 1
