...
<_Program name_>				GHA_2024_AHIES_V01_M_V01_A_GLD_ALL </_Program name_>
...
<_Sample size (HH)_> 		 9,915 //  39,298, </_Sample size (HH)_>
<_Sample size (IND)_> 		52,849 // 188,500 </_Sample size (IND)_>
...
use "`path_in_stata'/2024 AHIES Q1-Q4_20250827.dta", clear
...
*<_industrycat_isic_>
	...
	* Correct codes that are outside the ISIC universe, take them to the next upper level
	replace industrycat_isic = "0220" if industrycat_isic == "0222"
	replace industrycat_isic = "0900" if industrycat_isic == "0956"
	replace industrycat_isic = "1500" if industrycat_isic == "1554"
	replace industrycat_isic = "3100" if industrycat_isic == "3155"
	replace industrycat_isic = "3100" if industrycat_isic == "3179"
	replace industrycat_isic = "3300" if industrycat_isic == "3391"
	replace industrycat_isic = "4790" if industrycat_isic == "4792"
	replace industrycat_isic = ""     if industrycat_isic == "4888"
...
*<_occup_isco_>
	...
	replace occup_isco = ""     if occup_isco == "5806"
	replace occup_isco = ""     if occup_isco == "5859"
	replace occup_isco = ""     if occup_isco == "5912"
