...
<_Program name_>			GHA_2022_AHIES_V02_M_V01_A_GLD_ALL </_Program name_>
<_Application_>				Stata 18 <_Application_>
<_Author(s)_>				World Bank Jobs Group (gld@worldbank.org) </_Author(s)_>
<_Date created_>			2026-01-13 </_Date created_>

-------------------------------------------------------------------------

<_Country_>					GHA </_Country_>
<_Survey Title_>			Annual Household Income and Expenditure Survey </_Survey Title_>
...
<_Sample size (HH)_> 		10,772 //  42,210 </_Sample size (HH)_>
<_Sample size (IND)_> 		56,574 // 209,943 </_Sample size (IND)_>
<_Sampling method_> 		[Brief description] </_Sampling method_>
<_Geographic coverage_> 	Regions </_Geographic coverage_>
<_Currency_> 				Cedi </_Currency_>
...
* Date: 2026-01-12 - Update raw data with new release that includes Q4
...
use "`path_in_stata'/2022 AHIES Q1-Q4_Rev_20250827.dta", clear
...
/* <_hhid_note>
	...
	tostring cluster, gen(cluster_str) format(%03.0f)
	tostring HholdID, gen(HholdID_str) format(%02.0f)
	egen hhid = concat(cluster_str HholdID_str)
	label var hhid "Household ID"
*</_hhid_>


*<_pid_>
	tostring new_pid, gen(new_pid_str) format(%02.0f)
	egen pid = concat(hhid new_pid_str)
...
*<_industry_orig_>
	tostring s4aq41a2, gen(industry_orig)
...
*<_industrycat_isic_>
	...
	replace industrycat_isic = "0110" if industrycat_isic == "0118"
	replace industrycat_isic = "0130" if industrycat_isic == "0139"
	replace industrycat_isic = "0100" if industrycat_isic == "0182"
	replace industrycat_isic = "0210" if industrycat_isic == "0215"
	replace industrycat_isic = "0200" if industrycat_isic == "0257"
	replace industrycat_isic = "0300" if industrycat_isic == "0355"
	replace industrycat_isic = ""     if industrycat_isic == "0422"
	replace industrycat_isic = ""     if industrycat_isic == "0446"
	replace industrycat_isic = ""     if industrycat_isic == "0468"
	replace industrycat_isic = ""     if industrycat_isic == "0482"
	replace industrycat_isic = "0520" if industrycat_isic == "0523"
	replace industrycat_isic = "0500" if industrycat_isic == "0549"
	replace industrycat_isic = "0500" if industrycat_isic == "0553"
	replace industrycat_isic = "0500" if industrycat_isic == "0578"
	replace industrycat_isic = "0500" if industrycat_isic == "0592"
	replace industrycat_isic = "0610" if industrycat_isic == "0612"
	replace industrycat_isic = "0600" if industrycat_isic == "0638"
	replace industrycat_isic = "0600" if industrycat_isic == "0645"
	replace industrycat_isic = "0600" if industrycat_isic == "0674"
	replace industrycat_isic = "0600" if industrycat_isic == "0698"
	replace industrycat_isic = "0700" if industrycat_isic == "0739"
	replace industrycat_isic = "0700" if industrycat_isic == "0744"
	replace industrycat_isic = "0700" if industrycat_isic == "0745"
	replace industrycat_isic = "0700" if industrycat_isic == "0773"
	replace industrycat_isic = "0810" if industrycat_isic == "0819"
	replace industrycat_isic = "0800" if industrycat_isic == "0864"
	replace industrycat_isic = "0800" if industrycat_isic == "0867"
	replace industrycat_isic = "0800" if industrycat_isic == "0873"
	replace industrycat_isic = "0800" if industrycat_isic == "0876"
	replace industrycat_isic = "0800" if industrycat_isic == "0881"
	replace industrycat_isic = "0800" if industrycat_isic == "0883"
	replace industrycat_isic = "0890" if industrycat_isic == "0898"
	replace industrycat_isic = "0910" if industrycat_isic == "0916"
	replace industrycat_isic = "0900" if industrycat_isic == "0955"
	replace industrycat_isic = "0900" if industrycat_isic == "0956"
	replace industrycat_isic = "0900" if industrycat_isic == "0957"
	replace industrycat_isic = "1100" if industrycat_isic == "1117"
	replace industrycat_isic = "1100" if industrycat_isic == "1119"
	replace industrycat_isic = "1100" if industrycat_isic == "1130"
	replace industrycat_isic = "1100" if industrycat_isic == "1134"
	replace industrycat_isic = "1100" if industrycat_isic == "1190"
	replace industrycat_isic = "1200" if industrycat_isic == "1236"
	replace industrycat_isic = "1300" if industrycat_isic == "1320"
	replace industrycat_isic = "1300" if industrycat_isic == "1333"
	replace industrycat_isic = "1300" if industrycat_isic == "1335"
	replace industrycat_isic = "1300" if industrycat_isic == "1346"
	replace industrycat_isic = "1300" if industrycat_isic == "1372"
	replace industrycat_isic = "1300" if industrycat_isic == "1381"
	replace industrycat_isic = "1300" if industrycat_isic == "1389"
	replace industrycat_isic = "1400" if industrycat_isic == "1454"
	replace industrycat_isic = "1400" if industrycat_isic == "1472"
	replace industrycat_isic = "1400" if industrycat_isic == "1478"
	replace industrycat_isic = "1400" if industrycat_isic == "1490"
	replace industrycat_isic = "1400" if industrycat_isic == "1498"
	replace industrycat_isic = "1500" if industrycat_isic == "1568"
	replace industrycat_isic = "1600" if industrycat_isic == "1636"
	replace industrycat_isic = "1700" if industrycat_isic == "1746"
	replace industrycat_isic = "1700" if industrycat_isic == "1759"
	replace industrycat_isic = "1700" if industrycat_isic == "1769"
	replace industrycat_isic = "1700" if industrycat_isic == "1792"
	replace industrycat_isic = "1800" if industrycat_isic == "1886"
	replace industrycat_isic = "1920" if industrycat_isic == "1922"
	replace industrycat_isic = "1900" if industrycat_isic == "1933"
	replace industrycat_isic = "1900" if industrycat_isic == "1976"
	replace industrycat_isic = "1900" if industrycat_isic == "1987"
	replace industrycat_isic = "2020" if industrycat_isic == "2028"
	replace industrycat_isic = "2100" if industrycat_isic == "2153"
	replace industrycat_isic = "2200" if industrycat_isic == "2204"
	replace industrycat_isic = "2200" if industrycat_isic == "2205"
	replace industrycat_isic = "2300" if industrycat_isic == "2307"
	replace industrycat_isic = "2420" if industrycat_isic == "2422"
	replace industrycat_isic = "2400" if industrycat_isic == "2456"
	replace industrycat_isic = "2500" if industrycat_isic == "2503"
	replace industrycat_isic = "2600" if industrycat_isic == "2607"
	replace industrycat_isic = "2640" if industrycat_isic == "2648"
	replace industrycat_isic = "2730" if industrycat_isic == "2735"
	replace industrycat_isic = "2800" if industrycat_isic == "2862"
	replace industrycat_isic = "2900" if industrycat_isic == "2902"
	replace industrycat_isic = "2900" if industrycat_isic == "2906"
	replace industrycat_isic = "2900" if industrycat_isic == "2951"
	replace industrycat_isic = "3030" if industrycat_isic == "3031"
	replace industrycat_isic = "3200" if industrycat_isic == "3202"
	replace industrycat_isic = "3240" if industrycat_isic == "3242"
	replace industrycat_isic = "3300" if industrycat_isic == "3391"
	replace industrycat_isic = ""     if industrycat_isic == "3412"
	replace industrycat_isic = "3600" if industrycat_isic == "3666"
	replace industrycat_isic = "3800" if industrycat_isic == "3804"
	replace industrycat_isic = "3900" if industrycat_isic == "3981"
	replace industrycat_isic = "4100" if industrycat_isic == "4116"
	replace industrycat_isic = "4220" if industrycat_isic == "4221"
	replace industrycat_isic = ""     if industrycat_isic == "4435"
	replace industrycat_isic = "4500" if industrycat_isic == "4562"
	replace industrycat_isic = "4640" if industrycat_isic == "4647"
	replace industrycat_isic = "5510" if industrycat_isic == "5511"
	replace industrycat_isic = "6600" if industrycat_isic == "6670"
	replace industrycat_isic = "6600" if industrycat_isic == "6676"
...
*<_occup_orig_>
	tostring s4aq40a3, gen(occup_orig)
...
*<_occup_isco_>
	...
	replace occup_isco = ""     if occup_isco == "2763"
	replace occup_isco = "3400" if occup_isco == "3484"
	replace occup_isco = "4200" if occup_isco == "4240"
	replace occup_isco = ""     if occup_isco == "4608"
	replace occup_isco = ""     if occup_isco == "4717"
	replace occup_isco = ""     if inrange(occup_isco, "5500", "6099")
	replace occup_isco = "6100" if occup_isco == "6104"
	replace occup_isco = "6100" if occup_isco == "6105"
	replace occup_isco = "6120" if occup_isco == "6128"
	replace occup_isco = "6100" if inrange(occup_isco, "6130", "6199")
	replace occup_isco = "6200" if inrange(occup_isco, "6200", "6299")
	replace occup_isco = "6300" if inrange(occup_isco, "6300", "6399")
	replace occup_isco = ""     if inrange(occup_isco, "6400", "6999")
...
*<_industry_orig_2_>
	tostring s4bq3a3, gen(industry_orig_2)
	replace industry_orig_2 = "" if empstat_2 == . | industry_orig_2 == "."
...
*<_occup_orig_2_>
	tostring s4bq2a3, gen(occup_orig_2)
	replace occup_orig_2 = "" if empstat_2 == . | occup_orig_2 == "."
...
*<_industry_orig_year_>
	...
	tostring s4dq4a2, gen(industrycat_orig_year_helper) format(%04.0f)
	replace industry_orig_year = industrycat_orig_year_helper if missing(industry_orig_year)
...
*<_occup_orig_year_>
	...
	tostring s4dq3a2, gen(occup_orig_year_helper) format(%04.0f)
