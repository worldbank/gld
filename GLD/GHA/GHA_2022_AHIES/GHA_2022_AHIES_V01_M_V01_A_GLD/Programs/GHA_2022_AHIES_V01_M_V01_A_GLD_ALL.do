...
use "`path_in_stata'/AHIES2022_Sec01234_q1q2q3q4.dta", clear
...
/* <_subnatid1_prev_note>
	...
	gen subnatid1_prev = ""
	replace subnatid1_prev = "1 - Western" if region_str == "Western" | region_str == "Western North" 
	replace subnatid1_prev = "2 - Central" if region_str == "Central"  
	replace subnatid1_prev = "3 - Greater Accra" if region_str == "Greater Accra"  
	replace subnatid1_prev = "4 - Volta" if region_str == "Volta" | region_str == "Oti" 
	replace subnatid1_prev = "5 - Eastern" if region_str == "Eastern" 
	replace subnatid1_prev = "6 - Ashanti" if region_str == "Ashanti" 
	replace subnatid1_prev = "7 - Brong Ahafo" if region_str == "Bono" | region_str == "Bono East" | region_str == "Ahafo" 
	replace subnatid1_prev = "8 - Northern" if region_str == "Northern" | region_str == "Savannah" | region_str == "North East" 
	replace subnatid1_prev = "9 - Upper East" if region_str == "Upper East" 
	replace subnatid1_prev = "10 - Upper West" if region_str == "Upper West" 
...
*<_educy_>
	...
	replace educy = 9 + s2aq4 if s2aq3 == 7 & inrange(s2aq4,0,4) // secondary
...
*Create an indicator "emp_diff" that identifies the difference between definitions (emp_diff)
  ...
  * Use emp_diff to generate ICLS-13 definition
	gen lstatus2 = lstatus
	replace lstatus2 = 1 if emp_diff == 1
	
	replace lstatus2 = . if age < minlaborage
