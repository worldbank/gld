...
<_Program name_>				PHL_1999_GLD_LFS.do </_Program name_>
...
<_Data collection to_>			[10/1999] </_Data collection to_>
...
<_INDUS National_>				PSIC 1977</_INDUS National_>

-----------------------------------------------------------------------
<_Version Control_>

ISIC / ISCO versions where inorrectly identified.
...
** FILES
	* input
	...
	local round2 `"`stata'\LFS APR1999.dta"'
...
/* <_hhid_note>
	...
	* in 99, it appears that regn and hcn uniquely identify the HH
...
** INDIVIDUAL IDENTIFICATION NUMBER
	* in 99, region, hh control and line number variables uniquely identify observations. use line number as pid
...
/*
	...
	*<_wave_note>
	* for 1999 there is only 1 data file so I cannot distinguish difinitively between waves
	*</_wave_note>
*</_wave_>
...
*<_educat7_>
	...
	replace educat7=1 if grade==0			// "No Grade Completed" -> "No education"
	replace educat7=2 if grade==1 | grade==2 | grade==3 // "Grades 1-5" -> " Primary Incomplete"
	replace educat7=3 if grade==4 	// "Elementary Graduate" -> "Primary Complete"
	replace educat7=4 if grade==5		// "1st-3rd Year in High School" -> "Secondary Incomplete"
	replace educat7=5 if grade==6		// "High school graduate" -> "Secondary Complete"
	replace educat7=7 if grade==7 | ( grade>=40 & grade<=98) // "College Graduate" and "[x] Bachelors/Advanced Degree" -> "University"
...
*<_industrycat10_>
	destring wkb, gen(industrycat10)
	replace industrycat10 = floor(industrycat10/10)
	recode industrycat10 (0 9 = 10)
	replace industrycat10 = 9 if wkb == "91"
