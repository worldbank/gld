...
<_Program name_>				PHL_2001_GLD_LFS.do </_Program name_>
<_Application_>					Stata 15 <_Application_>
<_Author(s)_>					World Bank Jobs Group </_Author(s)_>
<_Date created_>				2022-02-16 </_Date created_>
...
<_Data collection to_>			[10/2001] </_Data collection to_>
...
Unitwage is daily, since that is what basic pay is reported
...
** RUN SETTINGS
	...
	local 	i2d2		"`year'\\`cty3'_`surv_yr'_LFS_v01_M_v02_A_I2D2"
...
** FILES
	* input
	...
	local round2 `"`stata'\LFS APR2001.dta"'
...
/*
	...
	*<_wave_note>
	* for 2001 there is only 1 data file so I cannot distinguish difinitively between waves
	*</_wave_note>
*</_wave_>
