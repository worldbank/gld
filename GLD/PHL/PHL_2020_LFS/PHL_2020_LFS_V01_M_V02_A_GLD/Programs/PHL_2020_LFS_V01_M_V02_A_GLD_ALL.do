...
<_Program name_>				PHL_2020_LFS_V01_M_V02_A_GLD_ALL.do </_Program name_>
...
* Monthly raw files are compiled in the raw-folder conversion program.
* See `level_2_mast'/Programs/convert_append_lfs.do
...
*<_educat7_>
	/*Please refer to the "Education_Levels.md" for a detailed discussion on classification of how each level is classified and why,
		...
		For 2020, all four quarters already use the detailed PSCED 2017-style
		ladder rather than the grouped 2019 January/April version. The detailed
		100xx, 240xx, 340xx, 400xx, 500xx, and 600xx+ blocks are therefore coded
		consistently across January, April, July, and October, so July and October
		are no longer left missing.

		The small special-program codes 10002 and 24002 are labelled only as
		IPed / Madrasah / SPED. We keep 10002 in primary incomplete and 24002 in
		secondary incomplete so the first digit remains informative in the 2020
		ladder. These affect 176 and 110 raw cases respectively.

		Following the detailed 2019 bridge, codes 10011-10015 are treated as
		primary incomplete and 10016-10018 as primary complete. Codes 24011-24014
		are treated as secondary incomplete, while 24015 is treated as secondary
		complete together with the 340xx/350xx upper-secondary block. */
