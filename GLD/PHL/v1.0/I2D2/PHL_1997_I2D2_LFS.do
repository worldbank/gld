...
** DATABASE ASSEMBLENT
	...
	use "`path'\Original\LFS JAN1997.dta"
...
** RELATIONSHIP TO THE HEAD OF HOUSEHOLD
	...
	gen jh=(head==1)
	bys idh: egen hh=sum(jh)

/*
4 obs. Two spouses, don't know who to designate as head.
*/
	drop if hh==0
...
** DELETE MISSING VARIABLES
	...
	saveold "`path'\Processed\PHL_1997_I2D2_LFS.dta", replace
	saveold "D:\__CURRENT\PHL_1997_I2D2_LFS.dta", replace
