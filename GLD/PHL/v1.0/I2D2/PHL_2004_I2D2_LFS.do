...
** NUMBER OF INDIVIDUALS	218972
** EXPANDED POPULATION	82717965.1
**                                                                                                  **
******************************************************************************************************
*****************************************************************************************************/
...
** DATABASE ASSEMBLENT
	...
	use "`path'\Original\LFS JAN2004.dta"
...
** HOUSEHOLD SIZE
	sort idh
	by idh: egen hhsize= count(n1) if c05_rel>=1 & c05_rel<9
...
** DELETE MISSING VARIABLES
	...
	saveold "`path'\Processed\PHL_2004_I2D2_LFS.dta", replace
	saveold "D:\__CURRENT\PHL_2004_I2D2_LFS.dta", replace
