...
** NUMBER OF INDIVIDUALS	201089
** EXPANDED POPULATION	78581650.5
**                                                                                                  **
******************************************************************************************************
*****************************************************************************************************/
...
** DIRECTORY
	local path "D:\__I2D2\Philippines\2002\LFS"


** LOG FILE
	log using "`path'\Processed\PHL_2002_I2D2_LFS.log", replace
...
** DATABASE ASSEMBLENT
	...
	use "`path'\Original\LFS JAN2002.dta"
...
** HOUSEHOLD SIZE
	sort idh
	by idh: egen hhsize= count(c101_lno) if c03_rel>=1 & c03_rel<9
...
** LABOR STATUS
	...
	replace lstatus=2 if c36_lookw==1
...
** REASONS NOT IN THE LABOR FORCE
	...
	replace nlfreason=3 if c40_wynot==6 & age>10
...
** INDUSTRY CLASSIFICATION
	gen byte industry=.
	replace industry=1 if c16a_pkb>0 & c16a_pkb<7
	...
	replace industry=9 if c16a_pkb>74 & c16a_pkb<94
	replace industry=10 if c16a_pkb>94 & c16a_pkb<100
	replace industry=10 if industry==. & c16a_pkb!=.
...
** DELETE MISSING VARIABLES
	...
	saveold "`path'\Processed\PHL_2002_I2D2_LFS.dta", replace
	saveold "D:\__CURRENT\PHL_2002_I2D2_LFS.dta", replace
