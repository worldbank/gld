...
** EXPANDED POPULATION	72342617.8
**                                                                                                  **
******************************************************************************************************
*****************************************************************************************************/
...
** DATABASE ASSEMBLENT
	...
	use "`path'\Original\LFS JAN1998.dta"
...
** HOUSEHOLD IDENTIFICATION NUMBER
	egen idh=concat( regn  prov  domain urb hcn )
	sort idh
...
** DELETE MISSING VARIABLES
	...
	saveold "`path'\Processed\PHL_1998_I2D2_LFS.dta", replace
	saveold "D:\__CURRENT\PHL_1998_I2D2_LFS.dta", replace
