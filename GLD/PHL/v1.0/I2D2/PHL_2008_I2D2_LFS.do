...
** INPUT DATABASES	Z:\_I2D2\_I2D2\Philippines\2008\Original\LFS_JAN2008.dta
** RESPONSIBLE	Cristian Jara 
** Created	2/28/2012
** Modified	2/22/2017
** NUMBER OF HOUSEHOLDS	42161
** NUMBER OF INDIVIDUALS	202168
** EXPANDED POPULATION	89579107.1
**                                                                                                  **
******************************************************************************************************
*****************************************************************************************************/
...
** DIRECTORY
	local path "D:\__I2D2\Philippines\2008\LFS"


** LOG FILE
	log using "`path'\Processed\PHL_2008_I2D2_LFS.log", replace
...
** DATABASE ASSEMBLENT
	...
	use "`path'\Original\LFS_JAN2008.dta"
...
** DELETE MISSING VARIABLES
	...
	saveold "`path'\Processed\PHL_2008_I2D2_LFS.dta", replace
	saveold "D:\__CURRENT\PHL_2008_I2D2_LFS.dta", replace
