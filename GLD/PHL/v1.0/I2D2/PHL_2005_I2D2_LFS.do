...
** INPUT DATABASES	Z:\_I2D2\_I2D2\Philippines\2005\Original\LFS_JAN2005.dta
** RESPONSIBLE	Cristian Jara
** Created	3/27/2012
** Modified	2/22/2017
** NUMBER OF HOUSEHOLDS	43744
** NUMBER OF INDIVIDUALS	211888
** EXPANDED POPULATION	84409526
**                                                                                                  **
******************************************************************************************************
*****************************************************************************************************/
...
** DIRECTORY
	local path "D:\__I2D2\Philippines\2005\LFS"


** LOG FILE
	log using "`path'\Processed\PHL_2005_I2D2_LFS.log", replace
...
** DATABASE ASSEMBLENT
	...
	use "`path'\Original\LFS JAN2005.dta"
...
** DELETE MISSING VARIABLES
	...
	saveold "`path'\Processed\PHL_2005_I2D2_LFS.dta", replace
	saveold "D:\__CURRENT\PHL_2005_I2D2_LFS.dta", replace
