...
** INPUT DATABASES	/Users/ariannazapanta/Documents/LFS/LFS JAN2019.dta
** RESPONSIBLE	Arianna Zapanta
** Created	1/17/2021
** Modified	
** NUMBER OF HOUSEHOLDS	39876
** NUMBER OF INDIVIDUALS	181233
** EXPANDED POPULATION	107443368
**                                                                                                  **
******************************************************************************************************
*****************************************************************************************************/
...
** DIRECTORY
	use "C:\Users\wb529063\WBG\Arianna Ma Francesca S Zapanta - LFS\2019\LFS JAN2019.dta" 
...
** HOUSEHOLD IDENTIFICATION NUMBER
	tostring pufhhnum, gen(idh)
	label var idh "Household id"


** INDIVIDUAL IDENTIFICATION NUMBER
	sort pufhhnum
	bys pufhhnum: generate n1 = _n
	egen idp=concat(idh n1), punct(-)
	label var idp "Individual id"


** HOUSEHOLD WEIGHTS
	gen double wgt=pufpwgtprv
...
**REGIONAL AREAS
	gen byte reg01=pufreg
	recode reg01 (41=4)  (42=4) (17=4)
	label define lblreg01 1 "Region I - Ilocos Region" 2 "Region II - Cagayan Valley" 3 "Region III - Central Luzon" 4 "Region IV - Southern Tagalog, Calabarzon, Mimaropa" 5 "Region V- Bicol" 6 "Region VI - Western Visayas" 7 "Region VII - Central Visayas" 8 "Region VIII - Eastern Visayas" 9 "Region IX - Zamboanga Peninsula" 10 "Region X - Northern Mindanao" 11 "Region XI - Davao" 12 "Region XII - SOCCSKSARGEN" 13 "National Capital Region" 14 "Cordillera Administrative Region" 15 "Autonomous Region in Muslim Mindanao" 16 "Caraga"
...
** HOUSEHOLD SIZE
	gen byte hhsize=pufhhsize
	label var hhsize "Household size"


** RELATIONSHIP TO THE HEAD OF HOUSEHOLD
	gen byte head=pufc03_rel
...
** YEARS OF EDUCATION COMPLETED
	gen c09_grd=0 if inrange(pufc07_grade,0,2000)
	replace c09_grd=1 if (pufc07_grade>=10002 & pufc07_grade<=10010)
	replace c09_grd=2 if pufc07_grade==10020
	replace c09_grd=3 if inrange(pufc07_grade,24002,24010) | pufc07_grade==34011  | pufc07_grade==34021  | pufc07_grade==34031| pufc07_grade==35001
	replace c09_grd=4 if pufc07_grade==24020 | pufc07_grade==34012 |pufc07_grade==34022 | pufc07_grade==34032 | pufc07_grade==35002 | inrange(pufc07_grade,40010,59999)
	replace c09_grd=5 if pufc07_grade==60010  
	replace c09_grd=60 if  pufc07_grade==60000  | inrange(pufc07_grade,60011,89999) 
...
** LABOR STATUS
	gen byte lstatus=3
	replace lstatus=1 if  pufc11_work==1 | pufc12_job==1
	replace lstatus=2 if  pufc30_lookw==1
...
** EMPLOYMENT STATUS
	gen byte empstat=.
	replace empstat=1 if pufc23_pclass==0 | pufc23_pclass==1 | pufc23_pclass==2
	replace empstat=2 if pufc23_pclass==6
	replace empstat=3 if pufc23_pclass==4
	replace empstat=4 if pufc23_pclass==3  | pufc23_pclass==5
...
** REASONS NOT IN THE LABOR FORCE
	...
	replace nlfreason=3 if pufc34_wynot==6 & age>15
...
** OCCUPATION CLASSIFICATION
	gen byte occup=floor(pufc14_procc/10)
	recode occup 0=10
	replace occup=99 if pufc14_procc==9
	replace occup=. if lstatus~=1
	label var occup "1 digit occupational classification"
	la de lbloccup 1 "Managers" 2 "Professionals" 3 "Technicians" 4 "Clerks" 5 "Service and sales workers" 6 "Skilled agricultural" 7 "Craft workers" 8 "Plant and machine operators" 9 "Elementary occupations" 10 "Armed forces"  99 "Others"
...
** KEEP VARIABLES - ALL
	keep ccode year intv_year month idh idp wgt strata psu urb reg01 reg02 reg03 reg04 ownhouse water electricity toilet landphone cellphone computer internet hhsize head gender age soc marital ed_mod_age everattend atschool literacy educy edulevel1 edulevel2 edulevel3 lb_mod_age lstatus lstatus_year empstat empstat_year njobs njobs_year ocusec nlfreason unempldur_l unempldur_u industry industry1 industry_orig occup occup_orig firmsize_l firmsize_u whours wage unitwage contract empstat_2 empstat_2_year industry_2 industry1_2 industry_orig_2 occup_2 wage_2 unitwage_2 healthins socialsec union rbirth_juris rbirth rprevious_juris rprevious yrmove rprevious_time_ref pci pci_d pcc pcc_d

** ORDER VARIABLES
	order ccode year intv_year month idh idp wgt strata psu urb reg01 reg02 reg03 reg04 ownhouse water electricity toilet landphone  cellphone computer internet hhsize head gender age soc marital ed_mod_age everattend atschool literacy educy edulevel1 edulevel2 edulevel3 lb_mod_age lstatus lstatus_year empstat empstat_year njobs njobs_year ocusec nlfreason unempldur_l unempldur_u industry industry1 industry_orig occup occup_orig firmsize_l firmsize_u whours wage unitwage contract empstat_2 empstat_2_year industry_2 industry1_2 industry_orig_2 occup_2 wage_2 unitwage_2 healthins socialsec union rbirth_juris rbirth rprevious_juris rprevious yrmove rprevious_time_ref pci pci_d pcc pcc_d
...
** DELETE MISSING VARIABLES
	...
	save "C:\Users\wb529063\OneDrive - WBG\Philipines\I2D2\PHL_2019_I2D2_LFS.dta", replace
