...
### Import via creating metadata file 

Note, folowing along first vignette.
...
Are all of the individual rounds we imported via group import "surveys"?
```{r}
is.survey(i2d2_waves)
```
...
```{r}
i2d2_metadata <- lapply(X = i2d2_waves, FUN = metadata_create)
