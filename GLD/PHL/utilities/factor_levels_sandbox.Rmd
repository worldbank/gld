...
```{r}
saveRDS(jan2012dta, file.path(yr2012data, "rds/LFSjan12.Rds"))
saveRDS(apr2012dta, file.path(yr2012data, "rds/LFSapr12.Rds"))
saveRDS(jul2012dta, file.path(yr2012data, "rds/LFSjul12.Rds"))
saveRDS(oct2012dta, file.path(yr2012data, "rds/LFSoct12.Rds"))
...
```{r}
# createa subsect of test variables 
