...
** INPUT DATABASES	LFS JAN2011
** RESPONSIBLE	 Tom Mosher
** Created	4/4/2012
** Modified	24/5/2021
** NUMBER OF HOUSEHOLDS	165,473
** NUMBER OF INDIVIDUALS	807,631
** EXPANDED POPULATION
...
** FILES
	local round1 `"`stata'\LFS JAN2011.dta"'
	local round2 `"`stata'\LFS APR2011.dta"'
...
*** set up the codebook template
	iecodebook template ///
		...
		, clear replace surveys(JAN2011 APR2011 JUL2011 OCT2011) /// survey names
...
*** append the dataset
	iecodebook append ///
		...
		, clear surveys(JAN2011 APR2011 JUL2011 OCT2011) // survey names
	}
	else {
*** use the single file
	use `"`round1'"', clear
...
** OCCUPATION CLASSIFICATION
	* in 2011, raw variable is numeric
