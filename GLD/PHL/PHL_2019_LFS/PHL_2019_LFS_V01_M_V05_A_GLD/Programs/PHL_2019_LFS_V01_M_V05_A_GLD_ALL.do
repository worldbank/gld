...
*<_educat7_>
	...
	replace educat7 = 2 if inrange(pufc07_grade, 10000, 10018)
	replace educat7 = 3 if inrange(pufc07_grade, 10020, 24002)
	replace educat7 = 4 if inrange(pufc07_grade, 24010, 24015)
	replace educat7 = 5 if inrange(pufc07_grade, 24020, 35013)
