...
<_Program name_>				PHL_2006_GLD_LFS.do </_Program name_>
...
<_Data collection to_>			[10/2006] </_Data collection to_>
...
* harmonized output in a single file
	...
	iecodebook append ///
		...
		using `"`gld'\Doc\\`cty3'_`surv_yr'_append_template-IN.xlsx"' /// output just created above
...
*<_weight_>
	gen 		weight = fwgt /  (4 * 10000)  // inverse scaling by [no. rounds]*[10 000]. See "weights_methodology.Rmd"
...
*<_educat7_>
	...
	replace educat7=1 if c09_grade==0			// "No Grade Completed" -> "No education"
	replace educat7=2 if c09_grade==1 	// "Elementary Undergraduate" -> " Primary Incomplete"
	replace educat7=3 if c09_grade==2 	// "Elementary Graduate" -> "Primary Complete"
	replace educat7=4 if c09_grade==3		// "High School Undergraduate" -> "Secondary Incomplete"
	replace educat7=5 if c09_grade==4		// "High school graduate" -> "Secondary Complete"
	replace educat7=7 if c09_grade==5 | ( c09_grade>=60 & c09_grade<=98) // "College Graduate" and "[x] Bachelors/Advanced Degree" -> "University"
