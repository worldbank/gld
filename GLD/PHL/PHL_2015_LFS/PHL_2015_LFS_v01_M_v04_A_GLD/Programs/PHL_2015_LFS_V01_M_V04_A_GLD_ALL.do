...
<_Program name_>				PHL_2015_LFS_V01_M_V04_A_GLD_ALL.do </_Program name_>
...
* Date: 2026-04-02 - Split PSCED 2008 tertiary codes more carefully. 5xx stays post-secondary non-university, while 6xx and 810+ are treated as tertiary.
...
*<_educat7_>
	...
	replace educat7=6 if j12c09_grade>=410 &  j12c09_grade<=589 	// post-secondary programs not equivalent to a first university or baccalaureate degree
	replace educat7=7 if j12c09_grade>=601 & 	j12c09_grade<=699	// first-stage tertiary programs leading to a baccalaureate or first university/professional degree
	replace educat7=7 if j12c09_grade>= 810 & j12c09_grade <= . // college years and post-baccalaureate programs -> "University"
