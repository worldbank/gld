...
** VALUES
	...
	local cases  	769512		// 191783 (Jan) + 188902 (APR) + 194162 (Jul) + 194665 (Oct) (Source: ILO from PSA)
...
*** set up the codebook template
	iecodebook template ///
		...
		, clear replace surveys(JAN2015 APR2015 JUL2015 OCT2015) /// survey names
...
*** append the dataset
	iecodebook append ///
		...
		, clear surveys(JAN2015 APR2015 JUL2015 OCT2015) // survey names
	}
	else {
*** use the single file
	use `"`round1'"', clear
...
** OCCUPATION CLASSIFICATION
	* in 2015, raw variable is numeric
