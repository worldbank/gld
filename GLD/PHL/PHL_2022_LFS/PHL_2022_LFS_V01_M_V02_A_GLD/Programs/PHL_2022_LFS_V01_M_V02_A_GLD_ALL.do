...
<_Program name_>				PHL_2022_LFS_V01_M_V02_A_GLD_ALL.do </_Program name_>
...
local root    "/Users/angelosantos/Downloads/PHL/PHL_2022_LFS"
local country "PHL"
local year    "2022"
local survey  "LFS"
local vermast "V01"
...
foreach month of local months {
    local filename "LFS PUF `month' 2022"
...
foreach var of varlist pufreg pufurb2015-pufsvyyr pufrpl-online{
...
save "`path_in_stata'/PHL_LFS_2022.dta", replace
...
*/
use "`path_in_stata'/PHL_LFS_2022.dta", clear
...
*<_educat7_>
	/*Please refer to the "Education_Levels.md" for a detailed discussion on classification of how each level is classified and why,
		...
		For 2022, the raw education codes follow the PSCED 2017 structure and are
		coded directly. */
