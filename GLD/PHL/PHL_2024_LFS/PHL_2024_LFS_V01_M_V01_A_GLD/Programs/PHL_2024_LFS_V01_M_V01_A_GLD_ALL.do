...
<_Program name_>				PHL_2024_LFS_V01_M_V01_A_GLD_ALL.do </_Program name_>
...
<_Sample size (HH)_> 			325570 </_Sample size (HH)_>
<_Sample size (IND)_> 			1319066 </_Sample size (IND)_>
...
* Date: 2026-04-02 - Updated educat7 to use the detailed post-2020 education ladder across all available months and removed the inherited grouped 2019 cutoffs.
...
* previous limited month list before Q4 files were added:
...
foreach month of local months {
    local filename "LFS PUF `month' 2024"
...
foreach var of varlist pufpwgtprv - ethnicity {
...
save "`path_in_stata'/PHL_LFS_2024.dta", replace
* Variable label for 'pufreg'
* All steps necessary to merge datasets (if several) to have all elements needed to produce
* harmonized output in a single file

use "`path_in_stata'/PHL_LFS_2024.dta", clear
...
* Urban/rural variable not in the 2024 data
*<_urban_>
	gen byte urban = .
...
*<_educat7_>
	/*Please refer to the "Education_Levels.md" for a detailed discussion on classification of how each level is classified and why,
		...
		For 2024, the raw education codes follow the PSCED 2017 structure and are
		coded directly. */
