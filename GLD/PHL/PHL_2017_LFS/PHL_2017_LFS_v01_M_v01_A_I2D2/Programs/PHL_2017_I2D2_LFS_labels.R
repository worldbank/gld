...
setwd("Y:/GLD-Harmonization/551206_TM/PHL/PHL_2012_LFS/PHL_2012_LFS_v01_M_v01_A_I2D2/Doc")

# Value Lable Harmonization ----
## Read in all choices ----
round1 <- read_xlsx(
  path = "PHL_2012_append_template-IN-R.xlsx",
...
template <- loadWorkbook("PHL_2012_append_template-IN-S.xlsx")
...
saveWorkbook(template, 
             file = "PHL_2012_append_template-IN-S.xlsx",
             overwrite = TRUE)
