...
** FILES
	...
	* processed
	local i2d2_1	`"`id_data'\rounds\PHL_2004_I2D2_LFS_JAN.dta"'
	local i2d2_2	`"`id_data'\rounds\PHL_2004_I2D2_LFS_APR.dta"'
	local i2d2_3	`"`id_data'\rounds\PHL_2004_I2D2_LFS_JUL.dta"'
	local i2d2_4	`"`id_data'\rounds\PHL_2004_I2D2_LFS_OCT.dta"'
...
if (drop == 1) {
do `"${code}/PHL/PHL_2004_LFS/PHL_2004_LFS_v01_M_v01_A_I2D2/Programs/PHL_2004_I2D2_LFS_JAN.do"'
do `"${code}/PHL/PHL_2004_LFS/PHL_2004_LFS_v01_M_v01_A_I2D2/Programs/PHL_2004_I2D2_LFS_APR.do"'
do `"${code}/PHL/PHL_2004_LFS/PHL_2004_LFS_v01_M_v01_A_I2D2/Programs/PHL_2004_I2D2_LFS_JUL.do"'
do `"${code}/PHL/PHL_2004_LFS/PHL_2004_LFS_v01_M_v01_A_I2D2/Programs/PHL_2004_I2D2_LFS_OCT.do"'
...
** OBSERVATION MISSING VALUES
	...
	save `"`id_data'\\PHL_2004_I2D2_LFS.dta"', replace
