...
** INPUT DATABASES	LFS JAN2010
** RESPONSIBLE	 Tom Mosher
** Created	4/4/2012
** Modified	24/5/2021
** NUMBER OF HOUSEHOLDS	163,744
** NUMBER OF INDIVIDUALS	795,851
** EXPANDED POPULATION
...
** VALUES
	...
	local cases  	795851		// 195850 (Jan) + 202479 (APR) + 195827 (Jul) + 201695 (Oct) (Source: ILO from PSA)
...
*** set up the codebook template
	iecodebook template ///
		...
		, clear replace surveys(JAN2010 APR2010 JUL2010 OCT2010) /// survey names
...
*** append the dataset
	iecodebook append ///
		...
		, clear surveys(JAN2010 APR2010 JUL2010 OCT2010) // survey names
	}
	else {
*** use the single file
	use `"`round1'"', clear
...
** OCCUPATION CLASSIFICATION
	* in 2010, raw variable is numeric
