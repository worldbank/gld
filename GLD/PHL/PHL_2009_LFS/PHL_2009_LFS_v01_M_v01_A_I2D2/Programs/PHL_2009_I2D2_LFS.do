...
** INPUT DATABASES	LFS JAN2009
** RESPONSIBLE	 Tom Mosher
** Created	4/4/2012
** Modified	24/5/2021
** NUMBER OF HOUSEHOLDS	159,740 (PSA site says ~50,000 households, but unclear for total or each round)
** NUMBER OF INDIVIDUALS	804,166
** EXPANDED POPULATION
...
** FILES
	local round1 `"`stata'\LFS JAN2009.dta"'
	local round2 `"`stata'\LFS APR2009.dta"'
	local round3 `"`stata'\LFS JUL2009.dta"'
	local round4 `"`stata'\LFS OCT2009.dta"'

** VALUES
	local n_round 	4			// numer of survey rounds
	local cases  	804166		// 202132 (Jan) + 201686 (APR) + 198870 (Jul) + 201478 (Oct)
...
*** set up the codebook template
	iecodebook template ///
		...
		, clear replace surveys(JAN2009 APR2009 JUL2009 OCT2009) /// survey names
...
*** append the dataset
	iecodebook append ///
		...
		, clear surveys(JAN2009 APR2009 JUL2009 OCT2009) // survey names
	}
	else {
*** use the single file
	use `"`round1'"', clear
...
** OCCUPATION CLASSIFICATION
	* in 2009, raw variable is numeric
