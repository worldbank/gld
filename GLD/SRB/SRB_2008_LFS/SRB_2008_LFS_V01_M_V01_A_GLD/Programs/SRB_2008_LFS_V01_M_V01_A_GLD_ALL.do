...
<_Program name_>				SRB_2008_LFS_V01_M_V01_A_GLD_ALL.do </_Program name_>
...
<_Sample size (HH)_> 				10692 </_Sample size (HH)_>
<_Sample size (IND)_> 				42592 </_Sample size (IND)_>
...
use "`path_in_stata'/super datasets new.dta", clear
gen first4 = substr(PERIOD, 1, 4)
keep if first4 == "2008"
drop first4
...
*<_int_month_>
	gen  int_month = substr(PERIOD, 5, 2)
...
*<_hhid_>
	egen hhid= concat(OPS PK STAN HHNUM)
	label var hhid "Household ID"
*</_hhid_>


*<_pid_>
	gen ind_str = string(HHSEQNUM, "%02.0f")
...
*<_weight_>
* We can replicate the official report wiht this weight variable for full year
	gen double weight=POPW_PAN
...
** Each household must have exactly one head **
	...
	*(1) respondent originally coded `head'
	...
	recode relationharm (7 = 3) (6 8 = 5) (9 = 6)
	...
	* Create runner (oldest, male, HH head)
	gen neg_age = -age
	bys hhid (relationharm SEX age): gen hhrunner = _n
	...
	* When multiple hh head
	...
	replace relationharm = 6 if relationharm == 0
...
*<_marital_>
	...
	replace marital = . if !inrange(marital,1,5)
...
*<_migrated_binary_>
	...
	replace migrated_binary = . if !inrange(migrated_binary,0,1)
...
*<_migrated_from_country_>
	...
	replace migrated_from_country = "AUS" if COUNTRY1 == "Australija"
	replace migrated_from_country = "AUT" if COUNTRY1 == "Austrija"
	replace migrated_from_country = "BEL" if COUNTRY1 == "Belgija"
	replace migrated_from_country = "BIH" if COUNTRY1 == "Bosna i Hercegovina"
	replace migrated_from_country = "MNE" if COUNTRY1 == "Crna Gora"
	replace migrated_from_country = "FRA" if COUNTRY1 == "Francuska"
	replace migrated_from_country = "GRC" if COUNTRY1 == "Grcka"
	replace migrated_from_country = "NLD" if COUNTRY1 == "Holandija"
	replace migrated_from_country = "HRV" if COUNTRY1 == "Hrvatska"
	replace migrated_from_country = "ITA" if COUNTRY1 == "Italija"
	replace migrated_from_country = "KAZ" if COUNTRY1 == "Kazahstan"
	replace migrated_from_country = "HUN" if COUNTRY1 == "Madjarska"
	replace migrated_from_country = "DEU" if COUNTRY1 == "Nemacka"
	replace migrated_from_country = "NOR" if COUNTRY1 == "Norveska"
	replace migrated_from_country = "POL" if COUNTRY1 == "Poljska"
	replace migrated_from_country = "ROU" if COUNTRY1 == "Rumunija"
	replace migrated_from_country = "RUS" if COUNTRY1 == "Ruska federacija"
	replace migrated_from_country = "USA" if COUNTRY1 == "SAD"
	replace migrated_from_country = "SVN" if COUNTRY1 == "Slovenija"
	replace migrated_from_country = "CHE" if COUNTRY1 == "Svajcarska"
	replace migrated_from_country = "TUR" if COUNTRY1 == "Turska"
	replace migrated_from_country = "ARE" if COUNTRY1 == "Ujedinjeni Arapski Emirati"
	replace migrated_from_country = "GBR" if COUNTRY1 == "Velika Britanija"
	replace migrated_from_country = "AUS" if COUNTRY1 == "AUS"
	replace migrated_from_country = "AUT" if inlist(COUNTRY1, "AUSTRIJA", "AUSTRIJA.")
	replace migrated_from_country = "BIH" if inlist(COUNTRY1, "BOSNA I HERCEGOVINA", "Bosna")
	replace migrated_from_country = "FRA" if COUNTRY1 == "FRANCUSKA"
	replace migrated_from_country = "NLD" if COUNTRY1 == "HOLANDIJA"
	replace migrated_from_country = "HRV" if inlist(COUNTRY1, "HRVATSKA", "hrvatska")
	replace migrated_from_country = "ITA" if COUNTRY1 == "ITALIJA"
	replace migrated_from_country = "HUN" if inlist(COUNTRY1, "MADJARSKA", "Mađarska")
	replace migrated_from_country = "DEU" if inlist(COUNTRY1, "NEMACKA", "Nemacka", "Nemačka")
	replace migrated_from_country = "RUS" if inlist(COUNTRY1, "RUSI", "RUSIJA")
	replace migrated_from_country = "CHE" if inlist(COUNTRY1, "SFAJCARSKA", "SVAJCARSKA", "Švajcarska")
	replace migrated_from_country = "SWE" if COUNTRY1 == "Svedska"
	replace migrated_from_country = "GBR" if inlist(COUNTRY1, "VELIKA BRITANIJA", "Ujedinjeno Kraljevstvo")
...
*<_educy_>
	...
	recode educy 0=. 1=0 2=2 3=5 4=8 5=10 6=12 7=15 8=17 9=19 10=21 99 =.
	label var educy "Years of education"
*</_educy_>


*<_educat7_>
	gen byte educat7=HATLEVEL
	recode educat7 3=2 4=3 5=4 6=5 7/10=7 0=. 99 =.
...
*<_lstatus_>
	...
	*** employed ***
	replace lstatus = 1 if POSPLATA==1 | POSPOC==1 |  POSNEPL==1 | POSPOLJ ==1 |ODSUTVL==1|ODSRADNI==1|ODSPOMCL== 1
	replace lstatus = 1 if inlist(RAZLNERA,1,3)
	replace lstatus = . if UKTRAJOD == 3 | (UKTRAJOD == 2 & inlist(ZARADA50,1,2))
	replace lstatus = . if inlist(RAZLNERA,2,4) 
	...
	*future starter
	gen starter = NASLIPOS == 1 & KADPOCRA == 1
...
*<_underemployment_>
	gen byte underemployment = (RADVISSA == 1)
...
*<_nlfreason_>
	...
	recode nlfreason (1 4 7 8 9 = 5) (2 = 4) (3 = 2) (5 = 1) (6 = 3) (0 99 = .)
...
*<_unempldur_l_>
	...
	recode unempldur_l (1 2 = 0) (3 = 1) (4 = 3) (5 = 6) (6 = 12) (7 = 18) (8 = 24) (9 = 48) (10 = 84) (11 = 120) (0 99 = .)
...
*<_unempldur_u_>
	...
	recode unempldur_u (1 = 0) (2 = 1) (3 = 2) (4 = 5) (5 = 11) (6 = 17) (7 =23) (8 = 47) (9 = 72) (10 = 120) (11 = .) (0 99 = .)
...
*<_industrycat_isic_>
	...
	*use NACE3DTX (economic activity in text) to code the issues 
	replace industrycat_isic = "4100" if industrycat_isic == "0300" //water related
	replace industrycat_isic = "6000" if industrycat_isic == "8300"   // Taxi transport
	replace industrycat_isic = "4100" if industrycat_isic == "0400"   // Water supply (Vodovod)
	replace industrycat_isic = "7400" if industrycat_isic == "7800"   // Photocopy / business services
	replace industrycat_isic = "4500" if industrycat_isic == "5400"   // Construction / painter (Moler)
	replace industrycat_isic = "6300" if industrycat_isic == "0800"   // Travel agency
	replace industrycat_isic = "5200" if industrycat_isic == "5600"   // Retail trade (mixed goods)
...
*<_occup_isco_>
	gen occup_isco = string(ISCO4D, "%04.0f")
	...
	replace occup_isco = "8340" if occup_isco == "8341"
	replace occup_isco = "9300" if occup_isco == "9323"
	replace occup_isco = "" if inlist(occup_isco,"9991","9992","9993","9999","0000")
	...
	replace occup_isco = "0110" if occup_isco == "0130"
	replace occup_isco = "1300" if occup_isco == "1324"
	replace occup_isco = "1300" if occup_isco == "1371"
	replace occup_isco = "3320" if occup_isco == "3324"
	replace occup_isco = "3430" if occup_isco == "3438"
	replace occup_isco = "" if occup_isco == "3643"
	replace occup_isco = "4130" if occup_isco == "4134"
	replace occup_isco = "4200" if occup_isco == "4245"
	replace occup_isco = "" if occup_isco == "4311"
	replace occup_isco = "" if occup_isco == "4511"
	replace occup_isco = "" if inlist(occup_isco, "4711", "4712")
	replace occup_isco = "5220" if occup_isco == "5222"
	replace occup_isco = "5230" if occup_isco == "5231"
	replace occup_isco = "5200" if occup_isco == "5241"
	...
	replace occup_isco = "6200" if occup_isco == "6231"
	replace occup_isco = "" if occup_isco == "6417"
	replace occup_isco = "" if occup_isco == "6911"
	replace occup_isco = "" if occup_isco == "7513"
	replace occup_isco = "" if occup_isco == "8433"
	replace occup_isco = "9200" if occup_isco == "9232"
...
*<_whours_>
	...
	replace whours = . if inlist(HWACTUAL,0,99)
...
*<_contract_>
	...
	recode contract (1 3 5 = 1) (2 4 6 = 0) (9 0 = .)
...
*<_healthins_>
	gen byte healthins= PRAVAZDR if lstatus == 1
	recode healthins (2 = 0) (9 0 = .)
...
*<_socialsec_>
	gen byte socialsec= PRAVAPEN if lstatus == 1
	recode socialsec (2 = 0) (9 0 = .)
...
*<_firmsize_l_>
	...
	recode firmsize_l (12 = 20) (13 = 50) (14 = 100) (15 = 250) (16 = .) (17 = 11) (0 99 = .)
...
*<_firmsize_u_>
	...
	recode firmsize_u (11 = 19) (12 = 49) (13 = 99) (14 = 249) (15 = .) (16 =11) (17 = .) (0 99 = .)
...
{
*<_empstat_2_>
	gen byte empstat_2 = STATUS2J if lstatus == 1
	recode empstat_2 (1 = 3) (3 = 4) (4 = 1) (0 9 = .)
...
replace industrycat_isic_2 = substr(industrycat_isic_2,1,2) + "00"
	replace industrycat_isic_2="" if lstatus != 1 | industrycat_isic_2 == ".00" | industrycat_isic_2 == "0000" | missing(empstat_2)
...
*<_whours_2_>
	...
	replace whours_2 = . if inlist(HWACTUA2,0,99) | empstat_2 == 2
...
*<_lstatus_year_>
	*They ask an auto report status one year ago: WHAT WAS YOUR ACTIVITY STATUS ONE YEAR BEFORE SURVEY? 
	...
	recode lstatus_year (2 3 4 5 6 7 8 = 1) (9 = 2) (1 10 11 12 13 14 15 = 3) (0 99 = .)
...
*<_empstat_year_>
	gen byte empstat_year = STATUS1Y if lstatus_year == 1
	recode empstat_year (1 = 3) (3 = 4) (4 = 1) (0 9 = .)
...
*<_industrycat_isic_year_>
	...
	replace industrycat_isic_year = "3000" if industrycat_isic_year == "3400"
	replace industrycat_isic_year = "3500" if industrycat_isic_year == "4000"
	replace industrycat_isic_year = "6400" if industrycat_isic_year == "6700"
	replace industrycat_isic_year = "" if industrycat_isic_year == "5400"
	replace industrycat_isic_year = "" if industrycat_isic_year == "8300"
