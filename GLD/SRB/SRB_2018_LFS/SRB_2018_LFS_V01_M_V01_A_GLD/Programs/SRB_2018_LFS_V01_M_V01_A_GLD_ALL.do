...
<_Program name_>				SRB_2018_LFS_V01_M_V01_A_GLD_ALL.do </_Program name_>
...
/*
* Load first dataset
use "`path_in_stata'/lfs_2018q1.dta", clear
...
* Load second dataset
use "`path_in_stata'/lfs_2018q2.dta", clear
foreach v of varlist _all {
    capture confirm numeric variable `v'
    if _rc {                               // only if not numeric
        quietly destring `v', replace ignore(" ,") force
...
save "`path_in_stata'/lfs_2018.dta", replace

*/
use "`path_in_stata'/lfs_2018.dta", clear
/*%%=============================================================================================
	2: Survey & ID
==============================================================================================%%*/
...
*<_potential_lf_>
	gen byte potential_lf = (seekwork == 1 | availble == 1)
...
*<_wage_no_compen_>
	gen double wage_no_compen= INCDECIL_TACNO // exact amount
