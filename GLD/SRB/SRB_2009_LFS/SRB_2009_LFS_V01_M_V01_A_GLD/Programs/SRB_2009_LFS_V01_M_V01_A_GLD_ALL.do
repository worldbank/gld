...
<_Program name_>				SRB_2009_LFS_V01_M_V01_A_GLD_ALL.do </_Program name_>
...
<_Sample size (HH)_> 				11054 </_Sample size (HH)_>
<_Sample size (IND)_> 				43316 </_Sample size (IND)_>
...
*<_migrated_from_country_>
	...
	replace migrated_from_country = "USA" if inlist(COUNTRY1, "AMERIKA", "usa")
	replace migrated_from_country = "AUT" if inlist(COUNTRY1, "AUSTIJA", "AUSTR")
	replace migrated_from_country = "BGR" if inlist(COUNTRY1, "Bugarska", "bugars")
	replace migrated_from_country = "YUG" if COUNTRY1 == "JUG"  // antigua Yugoslavia (código histórico no ISO vigente)
	replace migrated_from_country = "DEU" if inlist(COUNTRY1, "NEM", "NEMACKA", "Nemačka")
	replace migrated_from_country = "ESP" if COUNTRY1 == "Spanija"
	replace migrated_from_country = "DNK" if COUNTRY1 == "dan"
	replace migrated_from_country = "ITA" if inlist(COUNTRY1, "italija", "ITALIJA")
	replace migrated_from_country = "HUN" if inlist(COUNTRY1, "madarska", "Mađarska")
	replace migrated_from_country = "ROU" if inlist(COUNTRY1, "rumunija", "Rumunija")
	replace migrated_from_country = "SVN" if inlist(COUNTRY1, "slov", "Slovenija")
	replace migrated_from_country = "CHE" if inlist(COUNTRY1, "ŠVAJCARSKA", "Švajcarska", "SVAJCARSKA", "�VAJCARSKA", " vajcarska", " VAJCARSKA", "�vajcarska")
	replace migrated_from_country = "CHE" if regexm(lower(COUNTRY1), "vajcarska")
...
*<_educy_>
	...
	recode educy 1=0 2=2 3=5 4=8 5=10 6=12 7=15 8=17 9=19 10=21
...
*<_educat7_>
	...
	recode educat7 3=2 4=3 5=4 6=5 7/10=7
...
*<_industrycat_isic_>
	...
	*use NACE3DTX (economic activity in text) to code the issues 
	...
	replace industrycat_isic = "4100" if industrycat_isic == "0300"   // Vodoprivreda / Vodovod (Water supply)
	replace industrycat_isic = "" if industrycat_isic == "8800" //no info, just 1 observation
...
*<_wage_no_compen_>
	...
	replace wage_no_compen = .       if INCMON == 99  // no answer
...
*<_whours_>
	...
	replace whours = HWUSUAL if inlist(whours,0,.) & !missing(wage_no_compen)
...
*<_firmsize_l_>
	...
	recode firmsize_l (12 = 20) (13 = 50) (14 = 100) (15 = 250) (16 = .) (17 = 11)
...
*<_lstatus_year_>
	*They ask an auto report status one year ago: WHAT WAS YOUR ACTIVITY STATUS ONE YEAR BEFORE SURVEY? 
	...
	recode lstatus_year (2 3 4 5 6 7 8 = 1) (9 = 2) (1 10 11 12 13 14 15 = 3)
...
*<_empstat_year_>
	...
	recode empstat_year (1 = 3) (3 = 4) (4 = 1)
