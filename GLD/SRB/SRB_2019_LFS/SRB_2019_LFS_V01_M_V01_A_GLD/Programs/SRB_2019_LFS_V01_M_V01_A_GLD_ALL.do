...
<_Program name_>				SRB_2019_LFS_V01_M_V01_A_GLD_ALL.do </_Program name_>
...
use "`path_in_stata'/SRB_LFS_2019_FULL.dta", clear
...
*<_migrated_from_country_>
	...
	replace migrated_from_country = "AUS" if countr1ytxt == "Australija"
	replace migrated_from_country = "AUT" if countr1ytxt == "Austrija"
	replace migrated_from_country = "BEL" if countr1ytxt == "Belgija"
	replace migrated_from_country = "BIH" if countr1ytxt == "Bosna i Hercegovina"
	replace migrated_from_country = "MNE" if countr1ytxt == "Crna Gora"
	replace migrated_from_country = "FRA" if countr1ytxt == "Francuska"
	replace migrated_from_country = "GRC" if countr1ytxt == "Grcka"
	replace migrated_from_country = "NLD" if countr1ytxt == "Holandija"
	replace migrated_from_country = "HRV" if countr1ytxt == "Hrvatska"
	replace migrated_from_country = "ITA" if countr1ytxt == "Italija"
	replace migrated_from_country = "KAZ" if countr1ytxt == "Kazahstan"
	replace migrated_from_country = "HUN" if countr1ytxt == "Madjarska"
	replace migrated_from_country = "DEU" if countr1ytxt == "Nemacka"
	replace migrated_from_country = "NOR" if countr1ytxt == "Norveska"
	replace migrated_from_country = "POL" if countr1ytxt == "Poljska"
	replace migrated_from_country = "ROU" if countr1ytxt == "Rumunija"
	replace migrated_from_country = "RUS" if countr1ytxt == "Ruska federacija"
	replace migrated_from_country = "USA" if countr1ytxt == "SAD"
	replace migrated_from_country = "SVN" if countr1ytxt == "Slovenija"
	replace migrated_from_country = "CHE" if countr1ytxt == "Svajcarska"
	replace migrated_from_country = "TUR" if countr1ytxt == "Turska"
	replace migrated_from_country = "ARE" if countr1ytxt == "Ujedinjeni Arapski Emirati"
	replace migrated_from_country = "GBR" if countr1ytxt == "Velika Britanija"
	replace migrated_from_country = "GBR" if countr1ytxt == "Velika Britanija"
	replace migrated_from_country = "DZA" if countr1ytxt == "Alzir"
	replace migrated_from_country = "AFG" if countr1ytxt == "Avganistan"
	replace migrated_from_country = "BWA" if countr1ytxt == "Bocvana"
	replace migrated_from_country = "BGR" if countr1ytxt == "Bugarska"
	replace migrated_from_country = "CAN" if countr1ytxt == "Kanada"
	replace migrated_from_country = "MKD" if countr1ytxt == "Makedonija"
	replace migrated_from_country = "PRT" if countr1ytxt == "Portugalija"
	replace migrated_from_country = "SWE" if countr1ytxt == "Svedska"
	replace migrated_from_country = "ARM" if countr1ytxt == "Armenija"
	replace migrated_from_country = "BLR" if countr1ytxt == "Belorusija"
	replace migrated_from_country = "CZE" if countr1ytxt == "Ceska Republika"
	replace migrated_from_country = "PHL" if countr1ytxt == "Filipini"
	replace migrated_from_country = "QAT" if countr1ytxt == "Katar"
	replace migrated_from_country = "LUX" if countr1ytxt == "Luksemburg"
	replace migrated_from_country = "MLT" if countr1ytxt == "Malta"
	replace migrated_from_country = "NZL" if countr1ytxt == "Novi Zeland"
	replace migrated_from_country = "SVK" if countr1ytxt == "Slovacka"
	replace migrated_from_country = "ESP" if countr1ytxt == "Spanija"
	replace migrated_from_country = "ALB" if countr1ytxt == "Albanija"
	replace migrated_from_country = "AZE" if countr1ytxt == "Azerbejdzan"
	replace migrated_from_country = "DNK" if countr1ytxt == "Danska"
	replace migrated_from_country = "ISL" if countr1ytxt == "Island"
	replace migrated_from_country = "ISR" if countr1ytxt == "Izrael"
	replace migrated_from_country = "CHN" if countr1ytxt == "Kina"
	replace migrated_from_country = "LBY" if countr1ytxt == "Libijska Ar. Dzamahirija"
	replace migrated_from_country = "BIH" if inlist(countr1ytxt, "BOSNA I HERCEGOVINA", "Bosna i Hercegovina")
replace migrated_from_country = "BHS" if countr1ytxt == "Bahami"
replace migrated_from_country = "MNE" if inlist(countr1ytxt, "CRNA GORA", "Republika Crna Gora", "crna gora")
replace migrated_from_country = "ITA" if countr1ytxt == "ITALIJA"
replace migrated_from_country = "HUN" if inlist(countr1ytxt, "Mađarska", "Madjarska")
replace migrated_from_country = "DEU" if inlist(countr1ytxt, "NEMACKA", "Nemačka", "Nemacka")
replace migrated_from_country = "SVK" if inlist(countr1ytxt, "Slovačka", "Slovacka")
replace migrated_from_country = "ARE" if inlist(countr1ytxt, "UJEDINJENI ARAPSKI EMIRATI", "Ujedinjeni Arapski Emirati")
...
* attend school in the last 12 months
	gen byte school= ilo_edu_attendance == 1
...
*<_industry_orig_>
	gen industry_orig = string(nace3d, "%03.0f")
	replace industry_orig= "" if lstatus!=1 | missing(nace3d)
	label var industry_orig "Original survey industry code, main job 7 day recall"
*</_industry_orig_>


*<_industrycat_isic_>
	gen industrycat_isic = substr(industry_orig, 1, 2) + "00" if lstatus == 1
...
*<_occup_orig_>
	gen occup_orig= string(isco4d, "%04.0f")
	replace occup_orig= "" if lstatus!=1 | isco4d == .
	label var occup_orig "Original occupation record primary job 7 day recall"
*</_occup_orig_>


*<_occup_isco_>
	gen occup_isco = occup_orig if lstatus == 1
...
*<_wage_no_compen_>
	gen double wage_no_compen=ilo_job1_lri_ees
...
*<_industry_orig_2_>
	gen industry_orig_2 = string(nace2j2d, "%02.0f")
	replace industry_orig_2= "" if lstatus!=1 | missing(nace2j2d)
	label var industry_orig_2 "Original survey industry code, secondary job 7 day recall"
*</_industry_orig_2_>


*<_industrycat_isic_2_>
	gen industrycat_isic_2 = substr(industry_orig_2, 1, 2) + "00" if lstatus == 1
	replace industrycat_isic_2 = "" if industrycat_isic_2 == "00" | missing(empstat_2)
