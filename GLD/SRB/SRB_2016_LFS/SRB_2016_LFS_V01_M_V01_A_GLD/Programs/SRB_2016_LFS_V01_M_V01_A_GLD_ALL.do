...
<_Program name_>				SRB_2016_LFS_V01_M_V01_A_GLD_ALL.do </_Program name_>
...
use "`path_in_stata'/lfs_2016.dta", clear
...
*<_migrated_from_country_>
	...
	replace migrated_from_country = "GBR" if country1 == "Velika Britanija"
	replace migrated_from_country = "DZA" if country1 == "Alzir"
	replace migrated_from_country = "AFG" if country1 == "Avganistan"
	replace migrated_from_country = "BWA" if country1 == "Bocvana"
	replace migrated_from_country = "BGR" if country1 == "Bugarska"
	replace migrated_from_country = "CAN" if country1 == "Kanada"
	replace migrated_from_country = "MKD" if country1 == "Makedonija"
	replace migrated_from_country = "PRT" if country1 == "Portugalija"
	replace migrated_from_country = "SWE" if country1 == "Svedska"
	replace migrated_from_country = "ARM" if country1 == "Armenija"
	replace migrated_from_country = "BLR" if country1 == "Belorusija"
	replace migrated_from_country = "CZE" if country1 == "Ceska Republika"
	replace migrated_from_country = "PHL" if country1 == "Filipini"
	replace migrated_from_country = "QAT" if country1 == "Katar"
	replace migrated_from_country = "LUX" if country1 == "Luksemburg"
	replace migrated_from_country = "MLT" if country1 == "Malta"
	replace migrated_from_country = "NZL" if country1 == "Novi Zeland"
	replace migrated_from_country = "SVK" if country1 == "Slovacka"
	replace migrated_from_country = "ESP" if country1 == "Spanija"
	replace migrated_from_country = "ALB" if country1 == "Albanija"
	replace migrated_from_country = "AZE" if country1 == "Azerbejdzan"
...
*<_wage_no_compen_>
	gen double wage_no_compen= v85_a // exact amount
