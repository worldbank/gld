...
<_Program name_>				SRB_2017_LFS_V01_M_V01_A_GLD_ALL.do </_Program name_>
...
use "`path_in_stata'/lfs_2017.dta", clear
...
*<_migrated_from_country_>
	...
	replace migrated_from_country = "AUS" if countr1y == "Australija"
	replace migrated_from_country = "AUT" if countr1y == "Austrija"
	replace migrated_from_country = "BEL" if countr1y == "Belgija"
	replace migrated_from_country = "BIH" if countr1y == "Bosna i Hercegovina"
	replace migrated_from_country = "MNE" if countr1y == "Crna Gora"
	replace migrated_from_country = "FRA" if countr1y == "Francuska"
	replace migrated_from_country = "GRC" if countr1y == "Grcka"
	replace migrated_from_country = "NLD" if countr1y == "Holandija"
	replace migrated_from_country = "HRV" if countr1y == "Hrvatska"
	replace migrated_from_country = "ITA" if countr1y == "Italija"
	replace migrated_from_country = "KAZ" if countr1y == "Kazahstan"
	replace migrated_from_country = "HUN" if countr1y == "Madjarska"
	replace migrated_from_country = "DEU" if countr1y == "Nemacka"
	replace migrated_from_country = "NOR" if countr1y == "Norveska"
	replace migrated_from_country = "POL" if countr1y == "Poljska"
	replace migrated_from_country = "ROU" if countr1y == "Rumunija"
	replace migrated_from_country = "RUS" if countr1y == "Ruska federacija"
	replace migrated_from_country = "USA" if countr1y == "SAD"
	replace migrated_from_country = "SVN" if countr1y == "Slovenija"
	replace migrated_from_country = "CHE" if countr1y == "Svajcarska"
	replace migrated_from_country = "TUR" if countr1y == "Turska"
	replace migrated_from_country = "ARE" if countr1y == "Ujedinjeni Arapski Emirati"
	replace migrated_from_country = "GBR" if countr1y == "Velika Britanija"
	replace migrated_from_country = "GBR" if countr1y == "Velika Britanija"
	replace migrated_from_country = "DZA" if countr1y == "Alzir"
	replace migrated_from_country = "AFG" if countr1y == "Avganistan"
	replace migrated_from_country = "BWA" if countr1y == "Bocvana"
	replace migrated_from_country = "BGR" if countr1y == "Bugarska"
	replace migrated_from_country = "CAN" if countr1y == "Kanada"
	replace migrated_from_country = "MKD" if countr1y == "Makedonija"
	replace migrated_from_country = "PRT" if countr1y == "Portugalija"
	replace migrated_from_country = "SWE" if countr1y == "Svedska"
	replace migrated_from_country = "ARM" if countr1y == "Armenija"
	replace migrated_from_country = "BLR" if countr1y == "Belorusija"
	replace migrated_from_country = "CZE" if countr1y == "Ceska Republika"
	replace migrated_from_country = "PHL" if countr1y == "Filipini"
	replace migrated_from_country = "QAT" if countr1y == "Katar"
	replace migrated_from_country = "LUX" if countr1y == "Luksemburg"
	replace migrated_from_country = "MLT" if countr1y == "Malta"
	replace migrated_from_country = "NZL" if countr1y == "Novi Zeland"
	replace migrated_from_country = "SVK" if countr1y == "Slovacka"
	replace migrated_from_country = "ESP" if countr1y == "Spanija"
	replace migrated_from_country = "ALB" if countr1y == "Albanija"
	replace migrated_from_country = "AZE" if countr1y == "Azerbejdzan"
	replace migrated_from_country = "DNK" if countr1y == "Danska"
	replace migrated_from_country = "ISL" if countr1y == "Island"
	replace migrated_from_country = "ISR" if countr1y == "Izrael"
	replace migrated_from_country = "CHN" if countr1y == "Kina"
	replace migrated_from_country = "LBY" if countr1y == "Libijska Ar. Dzamahirija"
...
*<_lstatus_>
	...
	*** employed ***
	replace lstatus = 1 if posplata==1 | pospoc==1 |  posnepl==1 | pospolj ==1 |odsutvl==1 | odspomcl == 1 | odsradni==1
...
*<_industrycat_isic_>
	...
	replace industrycat_isic = "" if lstatus != 1 | industrycat_isic == "." | industrycat_isic == "0000"
...
*<_wage_no_compen_>
	gen double wage_no_compen= v86_a // exact amount
	gen wage_no_compen_interval = incdecil
	recode wage_no_compen_interval 1=8500 2=21000 3=30000 4=40000 5=52500 6=70000 7=90000 8=125000 9=175000 10=200000 98 99=.
	replace wage_no_compen = wage_no_compen_interval if missing(wage_no_compen) // amount in intervals 
