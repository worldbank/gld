...
<_Program name_>				SRB_2011_LFS_V01_M_V01_A_GLD_ALL.do </_Program name_>
...
<_Sample size (HH)_> 				8104 </_Sample size (HH)_>
<_Sample size (IND)_> 				23029 </_Sample size (IND)_>
...
*<_hhid_>
	gen quarter = "Q" + string(TALAS_IZ)
	egen hhid= concat(GRUPA DEMOGRAP DEMOGR_A DEMOGR_B DEMOGR_C quarter)
...
*<_urban_>
	gen byte urban= . 
	replace urban = 1 if strpos(TIP, "1") > 0
	replace urban = 0 if strpos(TIP, "2") > 0
...
/* <_subnatid1_note>
	...
	gen subnatid1= ""
	replace subnatid1 = "11 - Belgrade Region"              if inlist(OKR,0)
	replace subnatid1 = "12 - Vojvodina Region"             if inlist(OKR,1,2,3,4,5,6,7)
	replace subnatid1 = "21 - Sumadija & Western Serbia"    if inlist(OKR,8,9,12,13,16,17,18,19)
	replace subnatid1 = "22 - Southern & Eastern Serbia"    if inlist(OKR,10,11,14,15,20,21,22,23,24)
	label var subnatid1 "Subnational ID at First Administrative Level"
*</_subnatid1_>


*<_subnatid2_>
	egen byte subnatid2= concat(OKR IMEOKR), punct(" - ")
...
** Each household must have exactly one head **
	...
	*If household has no head:
	...
	--------------+--------------------------------------------
	Valid   0     |        150       0.23       0.23       0.23
			1     |      66018      99.77      99.77     100.00
			Total |      66168     100.00     100.00           
	-----------------------------------------------------------

	unique hhid if number_heads == 0
		Number of unique values of hhid is  52
		Number of records is  150

	There are 52 households (150 individuals) with no household head
	*/
...
*<_migrated_from_country_>
	...
	replace migrated_from_country = "FIN" if COUNTRY1 == "Finska"
...
*<_industrycat_isic_>
	...
	replace industrycat_isic = "3000" if industrycat_isic == "3400"
	replace industrycat_isic = "3500" if industrycat_isic == "4000"
	replace industrycat_isic = "6400" if industrycat_isic == "6700"
