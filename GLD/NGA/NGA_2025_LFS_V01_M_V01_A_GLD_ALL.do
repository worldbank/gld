...
<_Program name_>				NGA_2025_LFS_V01_M_V01_A_GLD_ALL.do </_Program name_>
...
<_Data collection from_>		10/2025 </_Data collection from_>
...
use "`path_in_stata'/nlfs_2025q1_hh.dta", clear
merge 1:m interview_key using "`path_in_stata'/nlfs_2025q1_indiv.dta", nogen
gen qtr = 1

tempfile q1
save `q1'

use "`path_in_stata'/nlfs_2025q2_hh.dta", clear
merge 1:m interview_key using "`path_in_stata'/nlfs_2025q2_indiv.dta", keep(match) nogen
gen qtr = 2
