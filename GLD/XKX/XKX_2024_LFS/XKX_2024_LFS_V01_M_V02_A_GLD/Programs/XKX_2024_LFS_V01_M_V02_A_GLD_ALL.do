...
<_Program name_>				XKX_2024_LFS_V01_M_V01_A_GLD_ALL </_Program name_>
...
<_Sample size (HH)_> 			13,874 </_Sample size (HH)_>
<_Sample size (IND)_> 			62,897 </_Sample size (IND)_>
...
/*
import spss using "`path_in_other'\Kosovo_LFS_2024_For_WB.sav", case(upper)
save "`path_in_stata'/Kosovo_LFS_2024_For_WB.dta",replace
*/

use "`path_in_stata'/Kosovo_LFS_2024_For_WB.dta", clear
