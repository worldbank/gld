...
<_Sample size (HH)_> 			16,552 </_Sample size (HH)_>
<_Sample size (IND)_> 			80,423 </_Sample size (IND)_>
...
use "`path_in_stata'/LFS_2020_translated.dta", clear
...
*<_pid_>
* INdividual runner is not unique!
	gen neg_age = -(AGE)
	bys HHNUM (PPF_P4 PPF_P8 neg_age): gen runner = _n
	gen ind_str = string(runner,"%02.0f")
...
*<_educy_>
	*for more information see: https://masht.rks-gov.net/wp-content/uploads/2020/09/isced-eng-2020.pdf
