...
<_Program name_>				XKX_2019_LFS_V01_M_V01_A_GLD_ALL </_Program name_>
...
<_Sample size (HH)_> 			15,406 </_Sample size (HH)_>
<_Sample size (IND)_> 			76,683 </_Sample size (IND)_>
...
use "`path_in_stata'/For_WB_Kosovo_LFS_2019.dta", clear
...
**** A household is not repeated in the following quarters. ****
	...
	tostring HHNUM, gen(hhid) format("%05.0f")
...
*<_pid_>
	...
	gen ind_birth = string(PPF_P9, "%10.0f")
	egen  pid = concat(hhid ind_str ind_birth)
