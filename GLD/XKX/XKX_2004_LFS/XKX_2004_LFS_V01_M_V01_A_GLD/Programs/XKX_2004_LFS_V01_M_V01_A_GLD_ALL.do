...
<_Program name_>				XKX_2004_LFS_V01_M_V01_A_GLD_ALL </_Program name_>
...
<_Data collection from_>		09/2004 </_Data collection from_>
<_Data collection to_>			10/2004 </_Data collection to_>
<_Source of dataset_> 			Kosovo Agency of Statistics </_Source of dataset_>
<_Sample size (HH)_> 			3,192 </_Sample size (HH)_>
<_Sample size (IND)_> 			19,904 </_Sample size (IND)_>
...
use "`path_in_stata'/LFS_2004.dta", clear

destring p13-p77k, replace
...
*<_int_month_>
	gen  int_month = 9
	replace int_month = 10 if b1a>16345 & !missing(b1a)
