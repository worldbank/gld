...
<_Program name_>				MKD_2012_LFS_V01_M_V01_A_GLD_ALL.do </_Program name_>
...
<_Sample size (HH)_> 			13143 </_Sample size (HH)_>
<_Sample size (IND)_> 			46933 </_Sample size (IND)_>
...
use "`path_in_stata'/raw_lfs_mkd_dlw_2012.dta", clear
...
*<_unempldur_l_>
	* Gave month - year when asked "how long unemployed?", assuming this means: when did u start looking for work?
	...
	gen surveydate = ym(2012, int_month)
