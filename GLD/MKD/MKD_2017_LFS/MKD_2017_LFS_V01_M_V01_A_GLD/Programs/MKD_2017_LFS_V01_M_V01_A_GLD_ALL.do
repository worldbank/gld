...
<_Program name_>				MKD_2017_LFS_V01_M_V01_A_GLD_ALL.do </_Program name_>
...
<_Sample size (HH)_> 			16445 </_Sample size (HH)_>
<_Sample size (IND)_> 			53700 </_Sample size (IND)_>
...
use "`path_in_stata'/raw_lfs_mkd_dlw_2017.dta", clear
...
*<_unempldur_l_>
	* Gave month - year when asked "how long unemployed?", assuming this means: when did u start looking for work?
	...
	gen surveydate = ym(2017, int_month)
