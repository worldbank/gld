...
<_Program name_>				MKD_2011_LFS_V01_M_V01_A_GLD_ALL.do </_Program name_>
<_Application_>					Stata 18 <_Application_>
<_Author(s)_>					World Bank Jobs Group (gld@worldbank.org) </_Author(s)_>
<_Date created_>				2025-09-08 </_Date created_>
...
<_Sample size (HH)_> 			15400 </_Sample size (HH)_>
<_Sample size (IND)_> 			54331 </_Sample size (IND)_>
...
use "`path_in_stata'/raw_lfs_mkd_dlw_2011.dta", clear
...
* Subnational information not available!
*<_subnatid1_>
	gen byte subnatid1=.
...
*<_unempldur_l_>
	* Gave month - year when asked "how long unemployed?", assuming this means: when did u start looking for work?
	...
	gen surveydate = ym(2011, int_month)
...
* Mostly value of zero when empstat is non-paid employee
	gen double wage_no_compen=q42_01
...
*<_occup_isco_2_>
	...
	replace occup_isco_2 = "" if occup_isco_2 == "0900"
