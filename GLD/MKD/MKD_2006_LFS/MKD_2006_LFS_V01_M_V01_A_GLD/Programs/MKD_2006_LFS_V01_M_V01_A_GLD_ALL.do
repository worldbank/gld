...
<_Program name_>				MKD_2006_LFS_V01_M_V01_A_GLD_ALL.do </_Program name_>
...
<_Sample size (HH)_> 			16491 </_Sample size (HH)_>
<_Sample size (IND)_> 			63080 </_Sample size (IND)_>
...
use "`path_in_stata'/raw_lfs_mkd_dlw_2006.dta", clear
...
* This is monthly according to methodology note
	gen double wage_no_compen= q34a
	replace wage_no_compen = 0 if q34 == 3 | q34 == 2
...
*<_firmsize_l_>
	gen byte firmsize_l = .
	replace firmsize_l = q14b if q14==1 & inrange(q14b,1,10)    // 1–10 exact
	replace firmsize_l = 10   if q14==2       
	replace firmsize_l = 26   if q14==3       
...
*<_firmsize_u_>
	gen byte firmsize_u = .
	replace firmsize_u = q14b if q14==1 & inrange(q14b,1,10)    // 1–10 exact
	replace firmsize_u = 25  if q14==2
...
*<_whours_2_>
	gen whours_2 = q45 if !missing(empstat_2)
