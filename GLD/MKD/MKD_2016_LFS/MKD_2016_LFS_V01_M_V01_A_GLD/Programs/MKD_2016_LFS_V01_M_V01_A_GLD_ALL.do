...
<_Program name_>				MKD_2016_LFS_V01_M_V01_A_GLD_ALL.do </_Program name_>
...
<_Sample size (HH)_> 			14823 </_Sample size (HH)_>
<_Sample size (IND)_> 			48994 </_Sample size (IND)_>
...
use "`path_in_stata'/raw_lfs_mkd_dlw_2016.dta", clear
...
*<_unempldur_l_>
	* Gave month - year when asked "how long unemployed?", assuming this means: when did u start looking for work?
	...
	gen surveydate = ym(2016, int_month)
...
* This is monthly according to methodology note
	...
	* set this to zero because according to q42, these are employed that "has not received wages" or "unpaid family worker"
	...
	replace wage_no_compen=. if lstatus!=1 | wage_no_compen == 99999
