...
<_Program name_>				MKD_2023_LFS_V01_M_V01_A_GLD_ALL.do </_Program name_>
...
<_Sample size (HH)_> 			14833 </_Sample size (HH)_>
<_Sample size (IND)_> 			41315 </_Sample size (IND)_>
...
use "`path_in_stata'/lfs2023.dta", clear

* Start by deleting observations with missing values and duplicates
drop if personno == .
duplicates drop
...
*<_educat7_>
	...
	recode educat7 (1 = 1) /// No education
	(2/3 = 2) /// Primary incomplete
	(4 = 3) /// Primary complete
	(5/6 = 4) /// Secondary incomplete
	(7 70 = 5) /// Secondary complete (4-yr voc. & gymnasium)
	(71/72 8 = 6) /// Post-secondary non-university
	(9/11 = 7) /// University (incomplete or complete)
	(12 51 = .)
...
{
*<_lstatus_>
	* Variables are not very clean -- no clear corresopndence with questionnaire. I will just use given lstatus variable, "ulogars"
	gen lstatus = ulogars
	recode lstatus (0 = .)
...
*<_unempldur_l_>
	...
	* We don't know the month, we just assume the last month of the quarter(upper bound)
	gen month_ub = kvartal*3
	
	gen surveydate = ym(2023, month_ub)
	gen unempdate = ym(q67a, q67b)
...
*<_wage_no_compen_>
	...
	replace wage_no_compen =  2500  if q42 == 2
	replace wage_no_compen =  6501  if q42 == 3
	replace wage_no_compen =  9001  if q42 == 4
	replace wage_no_compen = 11001  if q42 == 5
	replace wage_no_compen = 14001  if q42 == 6
	replace wage_no_compen = 18001  if q42 == 7
	replace wage_no_compen = 22501  if q42 == 8
	replace wage_no_compen = 27501  if q42 == 9
	replace wage_no_compen = 35001  if q42 == 10
	* This is 40,000 and above. In 2019, the midpoint value is 48,000. 
	* If i grow all the values from 2019 by the inflation, the new midpoint is ~60,000
	replace wage_no_compen = 40000  if q42 == 11
	replace wage_no_compen = 0		if q42 == 13
	replace wage_no_compen = .      if q42 == 12
