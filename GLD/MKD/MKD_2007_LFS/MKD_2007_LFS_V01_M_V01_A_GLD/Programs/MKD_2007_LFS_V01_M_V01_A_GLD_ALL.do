...
<_Program name_>				MKD_2007_LFS_V01_M_V01_A_GLD_ALL.do </_Program name_>
...
<_Sample size (HH)_> 			17087 </_Sample size (HH)_>
<_Sample size (IND)_> 			63239 </_Sample size (IND)_>
...
use "`path_in_stata'/raw_lfs_mkd_dlw_2007.dta", clear
...
*<_pid_>
	...
	drop if hhnum == 4156 & personno == 1 & sex == .
	isid pid kvartal
...
*<_marital_>
	...
	recode marital (1 = 2) (2 = 1) (3 = 5) (5 = 3) (0 = .)
...
*<_potential_lf_>
	...
	* available non-seekers
	replace potential_lf = 1 if q52 == 2 & q61 == 1 & lstatus == 3
	
	* unavailable jobseekers
	replace potential_lf = 1 if  inlist(q52, 1, 3) & q61 == 2 & lstatus == 3
...
*<_underemployment_>
	...
	replace underemployment = q31 == 1 if lstatus == 1
...
*<_nlfreason_>
	gen byte nlfreason=q53
	recode nlfreason (1 2 9 10= 5) (3 = 4) (4 5 6 = 2) (7 = 1) (8 = 3)
...
*<_unempldur_l_>
	...
	* Generate hypothetical month
	gen impmonth = 3 if kvartal == 1
	replace impmonth = 6 if kvartal == 2
	replace impmonth = 9 if kvartal == 3
	replace impmonth = 12 if kvartal == 4

	gen surveydate = ym(2007, impmonth)
	gen unempdate = ym(q59b, q59a)
...
*<_industry_orig_>
	gen industry_orig=string(sdejnos1, "%05.0f")
...
* This is monthly according to methodology note
	gen double wage_no_compen= q37a
...
*<_firmsize_l_>
	gen byte firmsize_l = .
	replace firmsize_l = q18 if q18==1 & inrange(q18b,1,10)    // 1–10 exact
	replace firmsize_l = 1   if q18==1 & missing(q18b)          // fallback
	replace firmsize_l = 11  if q18==2                          // 11–19
	replace firmsize_l = 20  if q18==3                          // 20–49
	replace firmsize_l = 50  if q18==4                          // 50+
	replace firmsize_l = 1   if q18==5                          // DK, <11 -> 1–10
	replace firmsize_l = 11  if q18==6                          // DK, >10 -> 11+
...
*<_firmsize_u_>
	gen byte firmsize_u = .
	replace firmsize_u = q18 if q18==1 & inrange(q18b,1,10)    // 1–10 exact
	replace firmsize_u = 10  if q18==1 & missing(q18b)
	replace firmsize_u = 19  if q18==2
	replace firmsize_u = 49  if q18==3
	replace firmsize_u = .   if q18==4                          // 50+ 
	replace firmsize_u = 10  if q18==5                          // IDK but less than 11 -> 1–10
	replace firmsize_u = .   if q18==6                          // DK, >10 -> 11+
...
*<_industry_orig_2_>
	gen industry_orig_2=string(sdejnos2, "%05.0f")
...
* NOt available for 2007
	gen whours_2 = . if !missing(empstat_2)
