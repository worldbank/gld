...
<_Program name_>				MKD_2008_LFS_V01_M_V01_A_GLD_ALL.do </_Program name_>
...
<_Sample size (HH)_> 			16770 </_Sample size (HH)_>
<_Sample size (IND)_> 			61418 </_Sample size (IND)_>
...
use "`path_in_stata'/raw_lfs_mkd_dlw_2008.dta", clear
...
*<_unempldur_l_>
	...
	* Generate hypothetical month
	...
	gen surveydate = ym(2008, impmonth)
...
*<_firmsize_l_>
	gen byte firmsize_l = .
	replace firmsize_l = q21 if q21==1 & inrange(q21b,1,10)    // 1–10 exact
	replace firmsize_l = 1   if q21==1 & missing(q21b)          // fallback
	replace firmsize_l = 11  if q21==2                          // 11–19
	replace firmsize_l = 20  if q21==3                          // 20–49
	replace firmsize_l = 50  if q21==4                          // 50+
	replace firmsize_l = 1   if q21==5                          // DK, <11 -> 1–10
	replace firmsize_l = 11  if q21==6                          // DK, >10 -> 11+
...
*<_firmsize_u_>
	gen byte firmsize_u = .
	replace firmsize_u = q21 if q21==1 & inrange(q21b,1,10)    // 1–10 exact
	replace firmsize_u = 10  if q21==1 & missing(q21b)
	replace firmsize_u = 19  if q21==2
	replace firmsize_u = 49  if q21==3
	replace firmsize_u = .   if q21==4                          // 50+ 
	replace firmsize_u = 10  if q21==5                          // IDK but less than 11 -> 1–10
	replace firmsize_u = .   if q21==6                          // DK, >10 -> 11+
...
*<_whours_2_>
	gen whours_2 = q42 if !missing(empstat_2)
