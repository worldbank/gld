...
<_Program name_>				MKD_2005_LFS_V01_M_V01_A_GLD_ALL.do </_Program name_>
...
<_Sample size (HH)_> 			15076 </_Sample size (HH)_>
<_Sample size (IND)_> 			65580 </_Sample size (IND)_>
...
use "`path_in_stata'/raw_lfs_mkd_dlw_2005.dta", clear
...
*<_hhid_>
	...
	gen hhid = string(fprimary, "%05.0f")
...
*<_potential_lf_>
	...
	* available non-seekers
	replace potential_lf = 1 if q64 == 2 & q72 == 1 & lstatus == 3
	
	* unavailable jobseekers
	replace potential_lf = 1 if  q64 == 1 & q72 == 2 & lstatus == 3
...
*<_underemployment_>
	...
	replace underemployment = q53 == 1 if lstatus == 1
...
*<_nlfreason_>
	gen byte nlfreason=q66
	recode nlfreason (4 6 = 5) (5 = 4)
...
*<_unempldur_l_>
	* Gave month - year when asked "how long unemployed?", assuming this means: when did u start looking for work?
	...
	gen surveydate = ym(2005, month)
	gen unempdate = ym(q70b, q70a)
...
* This is monthly according to methodology note
	gen double wage_no_compen= q40
	replace wage_no_compen = 0 if q40a == 3
...
*<_whours_>
* Here they ask how many usually work, and then asked how many more hours than usual worked in the past week
	gen whours= q27
	replace whours = q27 + q29 if !missing(q29)
...
*<_firmsize_l_>
	gen byte firmsize_l = .
	replace firmsize_l = q19 if q19==1 & inrange(q19b,1,10)    // 1–10 exact
	replace firmsize_l = 10   if q19==2       
	replace firmsize_l = 26   if q19==3       
...
*<_firmsize_u_>
	gen byte firmsize_u = .
	replace firmsize_u = q18 if q19==1 & inrange(q19b,1,10)    // 1–10 exact
	replace firmsize_u = 25  if q19==2
...
*<_whours_2_>
	gen whours_2 = q52 if !missing(empstat_2)
