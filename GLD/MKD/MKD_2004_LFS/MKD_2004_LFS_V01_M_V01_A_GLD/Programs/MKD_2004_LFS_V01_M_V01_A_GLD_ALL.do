...
<_Program name_>				MKD_2004_LFS_V01_M_V01_A_GLD_ALL.do </_Program name_>
...
<_Sample size (HH)_> 			16067 </_Sample size (HH)_>
<_Sample size (IND)_> 			68971 </_Sample size (IND)_>
...
use "`path_in_stata'/raw_lfs_mkd_dlw_2004.dta", clear
...
*<_school_>
	gen byte school= inrange(q791, 2, 11)
...
*<_unempldur_l_>
	* Gave month - year when asked "how long unemployed?", assuming this means: when did u start looking for work?
	...
	gen surveydate = ym(2004, month)
	gen unempdate = ym(q70y, q70m)
...
* This is monthly according to methodology note
	...
	replace wage_no_compen = 0 if q40 == 2 | q40 == 3
