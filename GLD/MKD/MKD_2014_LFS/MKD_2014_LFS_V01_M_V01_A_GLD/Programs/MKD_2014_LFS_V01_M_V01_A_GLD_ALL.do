...
<_Program name_>				MKD_2014_LFS_V01_M_V01_A_GLD_ALL.do </_Program name_>
...
<_Sample size (HH)_> 			11688 </_Sample size (HH)_>
<_Sample size (IND)_> 			40835 </_Sample size (IND)_>
...
use "`path_in_stata'/raw_lfs_mkd_dlw_2014.dta", clear
...
*<_relationharm_>
    ...
    (10 99 = 6)  // Code 99 for non-relatives
	gen neg_age = -age
	gen neg_male = -male
...
*<_unempldur_l_>
	* Gave month - year when asked "how long unemployed?", assuming this means: when did u start looking for work?
	...
	gen surveydate = ym(2014, int_month)
