...
/* -----------------------------------------------------------------------
<_Program name_>				GEO_2019_LFS_V01_M_V02_A_GLD_ALL.do </_Program name_>
...
merge m:1 UID          using "`path_in_stata'/LFS_ID.dta",               assert(match) nogen
merge m:1 UID          using "`path_in_stata'/LFS_Familysize.dta",       assert(match) nogen
...
*<_weight_>
	...
	* Estimated population for 2019 thus is 3,747,765.
	* Population for 2019 as on GeoStat is  3,716,900. Tracks. 
*</_weight_>
...
*<_wave_>
	gen wave = .
	replace wave = 1 if QuarterNo == "91"
	replace wave = 2 if QuarterNo == "92"
	replace wave = 3 if QuarterNo == "93"
	replace wave = 4 if QuarterNo == "94"
...
- 12,342 observations out of 15,873 paid observations answered B17_2 with a specific
number of their income, which gives 78.2% of paid employees values for wage. 
- 3,500 observations out of 15,873 paid observations have missing values for B17_2
whereas 31 observations answered B17_2 zero. 
...
save "Y:/GLD-Harmonization/529026_MG/Countries/GEO/GEO_2019_LFS/GEO_2019_LFS_V01_M_V02_A_GLD/Data/Harmonized/`level_2_harm'_ALL.dta", replace
