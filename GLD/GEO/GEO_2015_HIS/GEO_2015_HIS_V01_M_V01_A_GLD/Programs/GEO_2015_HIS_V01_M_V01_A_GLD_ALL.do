...
<_Study ID_>					GEO_2015_HIS_V01_M </_Study ID_>
...
<_Sample size (HH)_> 				10999 </_Sample size (HH)_>
<_Sample size (IND)_> 				38130 </_Sample size (IND)_>
...
* harmonized output in a single file
	...
	*datalibweb, coun(GEO) y(2015) t(ECARAW) sur(GEO_2015_HIS_v01_M) filen(tblshinda02.dta)
	...
	*datalibweb, coun(GEO) y(2015) t(ECARAW) sur(GEO_2015_HIS_v02_M) filen(tblshinda05_1.dta)
	rename (UID MEMBERNO) (hhid pid)
	sort hhid pid
	save "`labor'"
	...
	*datalibweb, coun(GEO) y(2015) t(ECARAW) sur(GEO_2015_HIS_v02_M) filen(tblincomes.dta)
	rename (uid ) (hhid )
	...
	*datalibweb, coun(GEO) y(2015) t(ECARAW) sur(GEO_2015_HIS_v02_M) filen(tblshinda01.dta)
	rename (uid ) (hhid )
	sort hhid
	save "`roster'"

	use "`path_in_stata'/ecapov.dta"
	*datalibweb, country(GEO) year(2015) type(ecapov-02) module(2 3 7 9) clear
