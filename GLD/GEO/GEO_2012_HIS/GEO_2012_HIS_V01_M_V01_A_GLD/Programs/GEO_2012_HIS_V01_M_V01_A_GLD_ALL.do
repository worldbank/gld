...
<_Study ID_>					GEO_2012_HIS_V01_M </_Study ID_>
...
*datalibweb, coun(GEO) y(2012) t(ECARAW) sur(GEO_2012_HIS_v02_M) filen(tblshinda02.dta)
...
*datalibweb, coun(GEO) y(2012) t(ECARAW) sur(GEO_2012_HIS_v02_M) filen(tblshinda05_1.dta)
rename (UID MemberNo) (hhid pid)
sort hhid pid
save "`labor'"
...
*datalibweb, coun(GEO) y(2012) t(ECARAW) sur(GEO_2012_HIS_v02_M) filen(tblincomes.dta)
rename (UID ) (hhid )
...
*datalibweb, coun(GEO) y(2012) t(ECARAW) sur(GEO_2012_HIS_v02_M) filen(tblshinda01.dta)
rename (UID ) (hhid )
sort hhid
save "`roster'"

use "`path_in_stata'/ecapov-03.dta", clear
*datalibweb, country(GEO) year(2012) type(ecapov-02) module(2 3 7 9) clear
