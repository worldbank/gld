...
<_ICLS Version_>				[Version of ICLS 13,14,15,16] </_ICLS Version_> 
...
<_OCCUP National_>				[Sistema Nacional de Clasificación de Ocupaciones 2019 (SINCO) https://www.snieg.mx/DocumentacionPortal/Normatividad/historica/sinco-2019.pdf] </_OCCUP National_> 
...
local path_in "C:\Users\wb582018\OneDrive - WBG\Surveys\MEX\MEX_2020_LFS\MEX_2020_LFS_v01_M\Data\Original"
local path_output "C:\Users\wb582018\OneDrive - WBG\Surveys\MEX\MEX_2020_LFS\MEX_2020_LFS_v01_M_v01_A_GLD\Data\Harmonized"
...
*<_occup_isco_2_>
	...
	*SINCO data to ISCO
	*2
	replace occup_isco_2=2000 if occup2==22	| occup2==23 | occup2==24 | occup2==27  | occup2==29
	*3
	replace occup_isco_2=3000 if occup2==25	| occup2==26 | occup2==28  
	*4
	replace occup_isco_2=4000 if occup2==31	| occup2==32 | occup2==39
	*5
	replace occup_isco_2=5000 if occup2==41	| occup2==42 | occup2==43 | occup2==49 | occup2==51 | occup2==52 | occup2==53 | occup2==59
	*6
	...
	*9
	replace occup_isco_2=9000 if occup2==91	| occup2==92 | occup2==93 | occup2==94 | occup2==95 | occup2==96 | occup2==97 | occup2==98 | occup2==99
...
*<_occup_skill_2_>
	gen occup_skill_2 = .
	replace occup_skill_2 = 1 if inrange(occup_isco_2,1000,2000) 
