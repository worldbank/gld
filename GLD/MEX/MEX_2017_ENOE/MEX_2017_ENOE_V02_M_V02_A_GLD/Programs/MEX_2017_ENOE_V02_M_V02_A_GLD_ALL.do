...
<_Program name_>				[MEX_2017_ENOE_V02_M_V02_A_GLD_ALL.do] </_Program name_>
...
<_Sample size (HH)_> 			[129,946] </_Sample size (HH)_>
<_Sample size (IND)_> 			[535,341] </_Sample size (IND)_>
...
local exclude "cd_a ent con v_sel n_hog h_mud n_ren loc t_loc t_loc_tri t_loc_men fac fac_tri fac_men mun est est_d ageb ur n_ent r_def upm n_pro_viv per ca est_d_tri est_d_men"

*** COE1 ***
clear
forvalues quarter = 1/4 {
	
	use "`path_in_stata'/coe1t`quarter'17.dta", clear
	rename *, lower
	tempfile d`quarter'
...
forvalues quarter = 1/4 {
	...
	use "`path_in_stata'/coe2t`quarter'17.dta", clear
	rename *, lower
	tempfile d`quarter'
	save "d`quarter'", replace
...
forvalues quarter = 1/4 {
	...
	use "`path_in_stata'/sdemt`quarter'17.dta", clear
	rename *, lower
	tempfile d`quarter'
	save "d`quarter'", replace
...
forvalues quarter = 1/4 {
	...
	use "`path_in_stata'/hogt`quarter'17.dta", clear
	rename *, lower
...
forvalues quarter = 1/4 {
	...
	use "`path_in_stata'/vivt`quarter'17.dta", clear
	rename *, lower
	cap tostring t_loc, replace force
	tempfile d`quarter'
	save "d`quarter'", replace
...
* Save the file
save "`path_in_stata'/ENOE_2017.dta", replace

*/	
	use "`path_in_stata'\ENOE_2017.dta", clear	
