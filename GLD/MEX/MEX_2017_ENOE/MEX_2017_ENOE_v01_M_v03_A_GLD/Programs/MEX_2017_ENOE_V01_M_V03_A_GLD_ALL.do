...
<_Program name_>				[MEX_2017_ENOE_V01_M_V03_A_GLD_ALL.do] </_Program name_>
...
local path_output "Z:\GLD-Harmonization\582018_AQ\MEX\MEX_2017_ENOE\MEX_2017_ENOE_V01_M_V03_A_GLD\Data\Harmonized"

*----------1.3: Database assembly------------------------------*

* All steps necessary to merge datasets (if several) to have all elements needed to produce
* harmonized output in a single file
		use "`path_in'\COE1T117.dta", clear
	...
	use "`path_in'\COE2T117.dta", clear
	tostring (ent v_sel n_ren), gen(ent_str v_sel_str n_ren_str) format("%02.0f")
	tostring con, gen(con_str) format("%05.0f")
	tostring (n_hog h_mud), gen(n_hog_str h_mud_str) format("%01.0f")
	...
	* Overwrtwrite temp file
	...
	use "`path_in'\SDEMT117.dta", clear
	tostring (ent v_sel n_ren), gen(ent_str v_sel_str n_ren_str) format("%02.0f")
	tostring con, gen(con_str) format("%05.0f")
	tostring (n_hog h_mud), gen(n_hog_str h_mud_str) format("%01.0f")
...
save "`path_output'\MEX_2017_ENOE_V01_M_V03_A_GLD_ALL.dta", replace
