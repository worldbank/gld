...
/*
	...
	*** COE1 ***
		...
		use "`path_in_stata'\COE1T`q'09.dta", clear
	...
	*** COE2 ***
		...
		use "`path_in_stata'\COE2T`q'09.dta", clear
		tostring (ent v_sel n_ren), gen(ent_str v_sel_str n_ren_str) format("%02.0f")
		tostring con, gen(con_str) format("%05.0f")
		tostring (n_hog h_mud), gen(n_hog_str h_mud_str) format("%01.0f")
	...
	*** SDEMT ***
		...
		use "`path_in_stata'\SDEMT`q'09.dta", clear
		tostring (ent v_sel n_ren), gen(ent_str v_sel_str n_ren_str) format("%02.0f")
		tostring con, gen(con_str) format("%05.0f")
		tostring (n_hog h_mud), gen(n_hog_str h_mud_str) format("%01.0f")
	...
	*** VIV ***
		...
		use "`path_in_stata'\VIVT`q'09.dta",clear
		drop p1-p3
	...
	*** HOG ***
		...
		use "`path_in_stata'\HOGT`q'09.dta", clear
	...
	*** Rename vars for append (extended questionnarie: q2) ***
		if `q' > 1  {
			local old_varname = "p5f1 p5f10 p5f11 p5f12 p5f13 p5f14 p5f15 p5f2 p5f3 p5f4 p5f5 p5f6 p5f7 p5f8 p5f9 p5f99 p3l p5c p3i p5 p5a p5b_thrs p5d_thrs"
			local new_varname = "p5g1 p5g10 p5g11 p5g12 p5g13 p5g14 p5g15 p5g2 p5g3 p5g4 p5g5 p5g6 p5g7 p5g8 p5g9 p5g99 p3q p5d p3j p5a p5b p5c_thrs p5e_thrs"
			*rename
