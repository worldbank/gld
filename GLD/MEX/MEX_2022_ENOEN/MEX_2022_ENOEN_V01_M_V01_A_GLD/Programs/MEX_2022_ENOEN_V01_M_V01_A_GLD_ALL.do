...
<_Program name_>				[MEX_2022_ENOEN_V01_M_V01_A_GLD_ALL.do] </_Program name_>
...
<_OCCUP National_>				[INCO 2019] </_OCCUP National_>
...
forvalues quarter = 1/4 {
	...
	quietly: append using "`path_in_stata'/ENOEN_COE1T`quarter'22.dta"
...
forvalues quarter = 1/4 {
	...
	quietly: append using "`path_in_stata'/ENOEN_COE2T`quarter'22.dta"
...
forvalues quarter = 1/4 {
	...
	quietly: append using "`path_in_stata'/ENOEN_SDEMT`quarter'22.dta"
	cap gen quarter = `quarter'
	replace quarter = `quarter' if mi(quarter)
...
forvalues quarter = 1/4 {
	...
	quietly: append using "`path_in_stata'/ENOEN_HOGT`quarter'22.dta"
...
forvalues quarter = 1/4 {
	...
	quietly: append using "`path_in_stata'/ENOEN_VIVT`quarter'22.dta"
...
*<_migrated_from_country_>
	...
	replace migrated_from_country = "IRL" if sdem_cs_p20a_c == 423
	replace migrated_from_country = "ITA" if sdem_cs_p20a_c == 425
	replace migrated_from_country = "NLD" if sdem_cs_p20a_c == 436
	replace migrated_from_country = "POR" if sdem_cs_p20a_c == 438
