...
<_Program name_>				[MEX_2020_ENOEN_V01_M_V01_A_GLD_ALL.do] </_Program name_>
...
*** COE1 ***
clear
forvalues quarter = 3/4 {
	
	quietly: append using "`path_in_stata'/ENOEN_COE1T`quarter'20.dta"
...
forvalues quarter = 3/4 {
	...
	quietly: append using "`path_in_stata'/ENOEN_COE2T`quarter'20.dta"
...
forvalues quarter = 3/4 {
	...
	quietly: append using "`path_in_stata'/ENOEN_SDEMT`quarter'20.dta"
...
forvalues quarter = 3/4 {
	...
	quietly: append using "`path_in_stata'/ENOEN_HOGT`quarter'20.dta"
...
forvalues quarter = 3/4 {
	...
	quietly: append using "`path_in_stata'/ENOEN_VIVT`quarter'20.dta"
...
*<_whours_>
	* Var differs if extended or basic questionnaire - ENOEN 2020 only basic Q3, 4
...
*<_wmonths_>
* Var changes if extended or basic questionnaire - ENOEN 2020 only basic Q3, 4
...
*<_firmsize_l_>
	...
	gen byte firmsize_l = .
	replace firmsize_l =   1 if coe1_p3l == 1
	replace firmsize_l =   2 if coe1_p3l == 2
	replace firmsize_l =   6 if coe1_p3l == 3
	replace firmsize_l =  11 if coe1_p3l == 4
	replace firmsize_l =  16 if coe1_p3l == 5
	replace firmsize_l =  21 if coe1_p3l == 6
	replace firmsize_l =  31 if coe1_p3l == 7
	replace firmsize_l =  51 if coe1_p3l == 8
	replace firmsize_l = 101 if coe1_p3l == 9
	replace firmsize_l = 251 if coe1_p3l == 10
	replace firmsize_l = 501 if coe1_p3l == 11
...
*<_firmsize_u_>
	gen byte firmsize_u = .
	replace firmsize_u =   1 if coe1_p3l == 1
	replace firmsize_u =   5 if coe1_p3l == 2
	replace firmsize_u =  10 if coe1_p3l == 3
	replace firmsize_u =  15 if coe1_p3l == 4
	replace firmsize_u =  20 if coe1_p3l == 5
	replace firmsize_u =  30 if coe1_p3l == 6
	replace firmsize_u =  50 if coe1_p3l == 7
	replace firmsize_u = 100 if coe1_p3l == 8
	replace firmsize_u = 250 if coe1_p3l == 9
	replace firmsize_u = 500 if coe1_p3l==10
	replace firmsize_u =   . if coe1_p3l==11
...
*<_firmsize_l_2_>
	* Only in extended survey. This version only has Q3, Q4, so skip
