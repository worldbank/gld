...
** DIRECTORY
	*	local path "~/Desktop/MEX/MEX_2008_LFS"
	local path "C:\Users\wb582018\OneDrive - WBG\Surveys\MEX\MEX_2010_LFS"
...
*****************************************************************************************************/
** DATABASE ASSEMBLENT
	use "`path'/MEX_2010_LFS_v01_M/Data/Original/VIVT110.dta",clear
	drop p1-p3
	destring loc mun est ageb t_loc cd_a upm d_sem n_pro_viv ent con v_sel n_ent per, replace
	merge 1:m ent con v_sel using "`path'/MEX_2010_LFS_v01_M/Data/Original/HOGT110.dta", nogen
	merge 1:m ent con v_sel n_hog using "`path'/MEX_2010_LFS_v01_M/Data/Original/SDEMT110.dta"
	drop if _m==1
	drop _m
	merge 1:1 ent con v_sel n_hog n_ren using "`path'/MEX_2010_LFS_v01_M/Data/Original/COE1T110.dta", nogen
	merge 1:1 ent con v_sel n_hog n_ren using "`path'/MEX_2010_LFS_v01_M/Data/Original/COE2T110.dta", nogen
