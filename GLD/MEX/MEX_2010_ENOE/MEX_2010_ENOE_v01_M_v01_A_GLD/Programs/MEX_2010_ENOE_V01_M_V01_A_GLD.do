...
<_Program name_>				[MEX_2010_ENOE_V01_M_v01_A_GLD.do] </_Program name_> 
...
<_Sample size (HH)_> 			[102489] </_Sample size (HH)_> 
<_Sample size (IND)_> 			[392674] </_Sample size (IND)_> 
...
local path_in "Z:\GLD-Harmonization\582018_AQ\MEX\MEX_2010_LFS\MEX_2010_LFS_v01_M\Data\Stata"
local path_output "Z:\GLD-Harmonization\582018_AQ\MEX\MEX_2010_LFS\MEX_2010_LFS_v01_M_v01_A_GLD\Data\Harmonized"
...
* harmonized output in a single file	
	...
	merge 1:m ent con v_sel using "`path_in'\HOGT110.dta", nogen
	merge 1:m ent con v_sel n_hog using "`path_in'\SDEMT110.dta"
	drop if _merge==1
	drop _merge
	merge 1:1 ent con v_sel n_hog n_ren using "`path_in'\COE1T110.dta", nogen
	merge 1:1 ent con v_sel n_hog n_ren using "`path_in'\COE2T110.dta", nogen
...
***first job
	...
	merge m:1 scian using "Z:\GLD-Harmonization\582018_AQ\MEX\MEX_2010_LFS\MEX_2010_LFS_v01_M\Data\Stata\SCIAN_07_ISIC_4.dta", keep(master match) nogen
...
*<_occup_isco_>
	...
	replace occup_isco=2000 if occup2==11 |  occup2==13 |  occup2==14
	replace occup_isco=1000 if occup2==61 |  occup2==21 |  occup2==51
	replace occup_isco=3000 if occup2==12 
	replace occup_isco=4000 if occup2==62
	replace occup_isco=5000 if occup2==71
	replace occup_isco=6000 if occup2==41
	replace occup_isco=7000 if occup2==72  | occup2==81
	replace occup_isco=8000 if occup2==52	| occup2==53 | occup2==55
	replace occup_isco=9000 if occup2==54	| occup2==82| occup2==99
...
*<_occup_skill_>
	...
	replace occup_skill = 4 if occup2 == 53
...
*<_occup_isco_2_>
	...
	replace occup_isco_2=2000 if occup2==11 |  occup2==13 |  occup2==14
	replace occup_isco_2=1000 if occup2==61 |  occup2==21 |  occup2==51
	replace occup_isco_2=3000 if occup2==12 
	replace occup_isco_2=4000 if occup2==62
	replace occup_isco_2=5000 if occup2==71
	replace occup_isco_2=6000 if occup2==41
	replace occup_isco_2=7000 if occup2==72  | occup2==81
	replace occup_isco_2=8000 if occup2==52	| occup2==53 | occup2==55
	replace occup_isco_2=9000 if occup2==54	| occup2==82| occup2==99
...
*<_occup_skill_2_>
	...
	replace occup_skill_2 = 4 if occup2 == 53
...
save "`path_output'\MEX_2010_ENOE_V01_M_V01_A_GLD.dta", replace
