...
<_Program name_>				[MEX_2010_ENOE_V01_M_V03_A_GLD_ALL.do] </_Program name_>
...
local path_output "Z:\GLD-Harmonization\582018_AQ\MEX\MEX_2010_ENOE\MEX_2010_ENOE_V01_M_V03_A_GLD\Data\Harmonized"

*----------1.3: Database assembly------------------------------*

* All steps necessary to merge datasets (if several) to have all elements needed to produce
* harmonized output in a single file
		use "`path_in'\COE1T110.dta", clear
...
save "`path_output'\MEX_2010_ENOE_V01_M_V03_A_GLD_ALL.dta", replace
