...
<_Program name_>				[MEX_2010_ENOE_V02_M_V02_A_GLD_ALL.do] </_Program name_>
...
<_Sample size (HH)_> 			[126,099] </_Sample size (HH)_>
<_Sample size (IND)_> 			[546,625] </_Sample size (IND)_>
...
forvalues quarter = 1/4 {
	...
	quietly: append using "`path_in_stata'/coe1t`quarter'10.dta"
...
forvalues quarter = 1/4 {
	...
	quietly: append using "`path_in_stata'/coe2t`quarter'10.dta"
...
forvalues quarter = 1/4 {
	...
	quietly: append using "`path_in_stata'/sdemt`quarter'10.dta"
	cap gen quarter = `quarter'
	replace quarter = `quarter' if mi(quarter)
...
forvalues quarter = 1/4 {
	...
	quietly: append using "`path_in_stata'/hogt`quarter'10.dta"
...
forvalues quarter = 1/4 {
	...
	quietly: append using "`path_in_stata'/vivt`quarter'10.dta"
...
* Save the file
save "`path_in_stata'/ENOE_2010.dta", replace
*/	

use "`path_in_stata'\ENOE_2010.dta", clear
