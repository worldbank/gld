...
<_Program name_>				[MEX_2012_ENOE_V01_M_v01_A_GLD.do] </_Program name_> 
...
<_ICLS Version_>				[combinación de CIET 13,14,15,16,18] </_ICLS Version_>
...
local path_in "C:\Users\wb582018\OneDrive - WBG\Surveys\MEX\MEX_2012_LFS\MEX_2012_LFS_v01_M\Data\Original"
local path_output "C:\Users\wb582018\OneDrive - WBG\Surveys\MEX\MEX_2012_LFS\MEX_2012_LFS_v01_M_v01_A_GLD\Data\Harmonized"
...
* harmonized output in a single file	
	...
	local path_in "C:\Users\wb582018\OneDrive - WBG\Surveys\MEX\MEX_2012_LFS\MEX_2012_LFS_v01_M\Data\Original"
	merge 1:m ent con v_sel using "`path_in'\HOGT112.dta", nogen
	local path_in "C:\Users\wb582018\OneDrive - WBG\Surveys\MEX\MEX_2012_LFS\MEX_2012_LFS_v01_M\Data\Original"
	merge 1:m ent con v_sel n_hog using "`path_in'\SDEMT112.dta"
	drop if _merge==1
	drop _merge
	merge 1:1 ent con v_sel n_hog n_ren using "`path_in'\COE1T112.dta", nogen
	merge 1:1 ent con v_sel n_hog n_ren using "`path_in'\COE2T112.dta", nogen
...
*<_icls_v_>
	gen icls_v = "ICLS-[13,14,15,16,18]"
...
*<_industrycat_isic_>
	...
	replace industrycat_isic="E" if p4a==2222 | p4a==2221
	...
	replace industrycat_isic="N" if p4a==5322 | p4a==5321 | p4a==5330| indus1==5615 | indus1==5620
	...
	replace industrycat_isic="S" if p4a==8129 | p4a==8124 | p4a==8121 | p4a==8122 | p4a==8123 | p4a==8111 | p4a==8112 | p4a==8113 | p4a==8114 | p4a==97 | p4a==98
	replace industrycat_isic="T" if p4a==8141
...
*<_occup_isco_>
	...
	replace occup_isco=2000 if occup2==11 |  occup2==13 
	replace occup_isco=1000 if occup2==61 |  occup2==21
	replace occup_isco=3000 if occup2==14	| occup2==12 
	replace occup_isco=4000 if occup2==62
	replace occup_isco=5000 if occup2==83| occup2==71
	replace occup_isco=6000 if occup2==41
	replace occup_isco=7000 if occup2==51
	replace occup_isco=8000 if occup2==52	| occup2==53 | occup2==54 | occup2==55
	replace occup_isco=9000 if occup2==72	| occup2==81 | occup2==82| occup2==99
...
*<_industrycat_isic_2_>
	...
	replace industrycat_isic_2="E" if p7c==2222 | p7c==2221
	...
	replace industrycat_isic_2="L" if p7c==5310
	replace industrycat_isic_2="M" if indus1==54
	replace industrycat_isic_2="N" if p7c==5322 | p7c==5321 | p7c==5330| indus1==5615 | indus1==5620
	replace industrycat_isic_2="O" if indus1==93
	...
	replace industrycat_isic_2="S" if p7c==8129 | p7c==8124 | p7c==8121 | p7c==8122 | p7c==8123 | p7c==8111 | p7c==8112 | p7c==8113 | p7c==8114 | p7c==97 | p7c==98
	replace industrycat_isic_2="T" if p7c==8141
	replace industrycat_isic_2="U" if indus1==99
...
*<_occup_isco_2_>
	...
	replace occup_isco_2=4000 if occup2==62
	replace occup_isco_2=5000 if occup2==83| occup2==71
	replace occup_isco_2=6000 if occup2==41
	replace occup_isco_2=7000 if occup2==51
	replace occup_isco_2=8000 if occup2==52	| occup2==53 | occup2==54 | occup2==55
	replace occup_isco_2=9000 if occup2==72	| occup2==81 | occup2==82| occup2==99
...
*<_occup_skill_2_>
	...
	drop occup2
	la de lbloccupskill_2 1 "High" 2 "Medium" 3 "Low" 4 "Armed Forces" 5 "Not elsewhere classified"
	replace occup_skill_2=. if lstatus!=1
...
** Drop info for cases under the age for which questions to be asked (do not need a variable for this)
local lab_var "minlaborage lstatus nlfreason unempldur_l unempldur_u empstat ocusec industry_orig industrycat_isic industrycat10 industrycat4 occup_orig occup_isco occup_skill occup wage_no_compen unitwage whours wmonths wage_total contract healthins socialsec union firmsize_l firmsize_u empstat_2 ocusec_2 industry_orig_2 industrycat_isic_2 industrycat10_2 industrycat4_2 occup_orig_2 occup_isco_2 occup_skill_2 occup_2 wage_no_compen_2 unitwage_2 whours_2 wmonths_2 wage_total_2 firmsize_l_2 firmsize_u_2 t_hours_others t_wage_nocompen_others t_wage_others_total t_hours_total t_wage_nocompen_total t_wage_total lstatus_year nlfreason_year unempldur_l_year unempldur_u_year empstat_year ocusec_year industry_orig_year industrycat_isic_year industrycat10_year  occup_orig_year occup_isco_year occup_skill_year occup_year wage_no_compen_year unitwage_year whours_year wmonths_year wage_total_year contract_year healthins_year socialsec_year union_year firmsize_l_year firmsize_u_year empstat_2_year ocusec_2_year industry_orig_2_year industrycat_isic_2_year industrycat10_2_year occup_orig_2_year occup_isco_2_year occup_skill_2_year occup_2_year wage_no_compen_2_year unitwage_2_year whours_2_year wmonths_2_year wage_total_2_year firmsize_l_2_year firmsize_u_2_year t_hours_others_year t_wage_nocompen_others_year t_wage_others_total_year t_hours_total_year t_wage_nocompen_total_year t_wage_total_year njobs t_hours_annual linc_nc laborincome industrycat4_year industrycat4_2_year"
*I change in the code is not in but of 
...
save "`path_output'\MEX_2012_ENOE_V01_M_V01_A_GLD.dta", replace
