...
** DIRECTORY
	local path "Z:/GLD-Harmonization/582018_AQ/MEX/MEX_2011_ENOE"

** LOG FILE
	log using "`path'/MEX_2011_ENOE_V01_M_V01_A_I2D2/Programs/MEX_2011_I2D2_ENOE.log", replace
...
*****************************************************************************************************/
** DATABASE ASSEMBLENT
	use "`path'/MEX_2011_ENOE_V01_M/Data/Original/VIVT111.dta",clear
	drop p1-p3
	destring loc mun est ageb t_loc cd_a upm d_sem n_pro_viv ent con v_sel n_ent per, replace
	merge 1:m ent con v_sel using "`path'/MEX_2011_ENOE_V01_M/Data/Original/HOGT111.dta", nogen
	merge 1:m ent con v_sel n_hog using "`path'/MEX_2011_ENOE_V01_M/Data/Original/SDEMT111.dta"
	drop if _merge==1
	drop _merge
	merge 1:1 ent con v_sel n_hog n_ren using "`path'/MEX_2011_ENOE_V01_M/Data/Original/COE1T111.dta", nogen
	merge 1:1 ent con v_sel n_hog n_ren using "`path'/MEX_2011_ENOE_V01_M/Data/Original/COE2T111.dta", nogen
...
** DELETE MISSING VARIABLES
	...
	save "`path'\MEX_2011_ENOE_V01_M_V01_A_I2D2\Data\Harmonized\MEX_2011_I2D2_ENOE.dta", replace
