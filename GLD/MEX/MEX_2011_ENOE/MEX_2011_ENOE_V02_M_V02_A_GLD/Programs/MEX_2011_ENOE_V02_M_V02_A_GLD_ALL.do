...
<_Program name_>				[MEX_2011_ENOE_V02_M_V02_A_GLD_ALL.do] </_Program name_>
<_Application_>					[STATA-18] <_Application_>
<_Author(s)_>					[The World Bank Jobs Group] </_Author(s)_>
<_Date created_>				2012-12-12 </_Date created_>
...
<_Sample size (HH)_> 			[125,888] </_Sample size (HH)_>
<_Sample size (IND)_> 			[540,860] </_Sample size (IND)_>
...
forvalues quarter = 1/4 {
	...
	quietly: append using "`path_in_stata'/coe1t`quarter'11.dta"
...
forvalues quarter = 1/4 {
	...
	quietly: append using "`path_in_stata'/coe2t`quarter'11.dta"
...
forvalues quarter = 1/4 {
	...
	quietly: append using "`path_in_stata'/sdemt`quarter'11.dta"
	cap gen quarter = `quarter'
	replace quarter = `quarter' if mi(quarter)
...
forvalues quarter = 1/4 {
	...
	quietly: append using "`path_in_stata'/hogt`quarter'11.dta"
...
forvalues quarter = 1/4 {
	...
	quietly: append using "`path_in_stata'/vivt`quarter'11.dta"
...
* Save the file
save "`path_in_stata'/ENOE_2011.dta", replace
*/	

use "`path_in_stata'\ENOE_2011.dta", clear
