...
/*
	...
	*** COE1 ***
		...
		use "`path_in_stata'\COE1T`q'07.dta", clear
	...
	*** COE2 ***
		...
		use "`path_in_stata'\COE2T`q'07.dta", clear
		tostring (ent v_sel n_ren), gen(ent_str v_sel_str n_ren_str) format("%02.0f")
		tostring con, gen(con_str) format("%05.0f")
		tostring (n_hog h_mud), gen(n_hog_str h_mud_str) format("%01.0f")
	...
	*** SDEMT ***
		...
		use "`path_in_stata'\SDEMT`q'07.dta", clear
		tostring (ent v_sel n_ren), gen(ent_str v_sel_str n_ren_str) format("%02.0f")
		tostring con, gen(con_str) format("%05.0f")
		tostring (n_hog h_mud), gen(n_hog_str h_mud_str) format("%01.0f")
	...
	*** VIV ***
		...
		use "`path_in_stata'\VIVT`q'07.dta",clear
		drop p1-p3
	...
	*** HOG ***
		...
		use "`path_in_stata'\HOGT`q'07.dta", clear
...
local variables = "cd_a con cs_ad_mot cs_p12 cs_p13_1 cs_p13_2 cs_p15 cs_p17 d_mes e_con eda ent est_d fac h_mud loc n_hog n_ren p1 p1a1 p1a2 p1b p1c p1d p1e p2_1 p2_2 p2_3 p2_4 p2b p2e p3 p3d p3g1_1 p3g2_1 p3g3_1 p3g4_1 p3h p3i p3l p4a p4c p4d2 p5 p5b_thrs p5d_thrs p5f1 p5f10 p5f11 p5f12 p5f13 p5f14 p5f15 p5f2 p5f3 p5f4 p5f5 p5f6 p5f7 p5f8 p5f9 p5f99 p6b2 p7 p7a p7c par_c r_def sex t_loc t_tra upm v_sel"
