...
** Created					03-27-2020
** Modified					05-29-2021
** NUMBER OF HOUSEHOLDS		105151
** NUMBER OF INDIVIDUALS 	407673
** EXPANDED POPULATION		108032070
**                                                                                                  **
******************************************************************************************************
*****************************************************************************************************/
...
** DIRECTORY
	*	local path "~/Desktop/MEX/MEX_2007_LFS"
	local path "C:\Users\wb582018\OneDrive - WBG\Surveys\MEX\MEX_2007_LFS"

** LOG FILE
	*	log using "`path'/MEX_2007_LFS_v01_M_v01_A_I2D2/Programs/MEX_2007_I2D2_ENOE.log", replace
	log using "`path'\MEX_2007_LFS_v01_M_v01_A_I2D2\Programs\MEX_2007_I2D2_ENOE.log", replace
...
** DATABASE ASSEMBLENT
	use "`path'/MEX_2007_LFS_v01_M/Data/Original/VIVT107.dta",clear
	drop p1-p3
	destring loc mun est ageb t_loc cd_a upm d_sem n_pro_viv ent con v_sel n_ent per, replace
	merge 1:m ent con v_sel using "`path'/MEX_2007_LFS_v01_M/Data/Original/HOGT107.dta", nogen
	merge 1:m ent con v_sel n_hog using "`path'/MEX_2007_LFS_v01_M/Data/Original/SDEMT107.dta"
	drop if _m==1
	drop _m
	merge 1:1 ent con v_sel n_hog n_ren using "`path'/MEX_2007_LFS_v01_M/Data/Original/COE1T107.dta", nogen
	merge 1:1 ent con v_sel n_hog n_ren using "`path'/MEX_2007_LFS_v01_M/Data/Original/COE2T107.dta", nogen
...
** DELETE MISSING VARIABLES
	...
	*save "`path'/MEX_2007_LFS_v01_M_v01_A_I2D2/Data/Harmonized/MEX_2007_I2D2_ENOE.dta", replace
	save "`path'\MEX_2007_LFS_v01_M_v01_A_I2D2\Data\Harmonized\MEX_2007_I2D2_ENOE.dta", replace
