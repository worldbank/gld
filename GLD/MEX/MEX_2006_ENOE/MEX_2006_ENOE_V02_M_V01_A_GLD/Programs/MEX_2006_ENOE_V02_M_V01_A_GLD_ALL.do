...
/*
	...
	*** COE1 ***
		...
		use "`path_in_stata'\COE1T`q'06.dta", clear
	...
	*** COE2 ***
		...
		use "`path_in_stata'\COE2T`q'06.dta", clear
		tostring (ent v_sel n_ren), gen(ent_str v_sel_str n_ren_str) format("%02.0f")
		tostring con, gen(con_str) format("%05.0f")
		tostring (n_hog h_mud), gen(n_hog_str h_mud_str) format("%01.0f")
	...
	*** SDEMT ***
		...
		use "`path_in_stata'\SDEMT`q'06.dta", clear
		tostring (ent v_sel n_ren), gen(ent_str v_sel_str n_ren_str) format("%02.0f")
		tostring con, gen(con_str) format("%05.0f")
		tostring (n_hog h_mud), gen(n_hog_str h_mud_str) format("%01.0f")
	...
	*** VIV ***
		...
		use "`path_in_stata'\VIVT`q'06.dta",clear
		drop p1-p3
	...
	*** HOG ***
		...
		use "`path_in_stata'\HOGT`q'06.dta", clear
	...
	*** Rename vars for append (basic questionnarie: q3 and q4) ***
		if `q' > 2  {
...
local variables = "d_mes cd_a con cs_ad_mot cs_p12 cs_p13_1 cs_p13_2 cs_p15 cs_p17 e_con eda ent est_d fac h_mud loc n_hog n_ren p1 p1a1 p1a2 p1b p1c p1d p1e p2_1 p2_2 p2_3 p2_4 p2b p2e p3 p3d p3g_tot p3g1_1 p3g2_1 p3g3_1 p3g4_1 p3h p3i p3j p3m4 p3m5 p3q p5a p5b p5c_thrs p5d p5e_thrs p5g1 p5g10 p5g11 p5g12 p5g13 p5g14 p5g2 p5g3 p5g4 p5g5 p5g6 p5g7 p5g8 p5g9 p5g99 p7 p7a p7c p7e p8a par_c r_def sex t_loc t_tra upm v_sel"
