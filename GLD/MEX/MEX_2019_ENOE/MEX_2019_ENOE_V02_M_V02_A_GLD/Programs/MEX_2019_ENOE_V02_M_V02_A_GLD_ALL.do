...
<_Program name_>				[MEX_2019_ENOE_V02_M_V02_A_GLD_ALL.do] </_Program name_>
...
<_Sample size (HH)_> 			[134,545] </_Sample size (HH)_>
<_Sample size (IND)_> 			[547,309] </_Sample size (IND)_>
...
forvalues quarter = 1/4 {
	...
	use "`path_in_stata'/coe1t`quarter'19.dta", clear
	rename *, lower
	tempfile d`quarter'
...
forvalues quarter = 1/4 {
	...
	use "`path_in_stata'/coe2t`quarter'19.dta", clear
	rename *, lower
	tempfile d`quarter'
	save "d`quarter'", replace
...
forvalues quarter = 1/4 {
	...
	use "`path_in_stata'/sdemt`quarter'19.dta", clear
	rename *, lower
	tempfile d`quarter'
	save "d`quarter'", replace
...
forvalues quarter = 1/4 {
	...
	use "`path_in_stata'/hogt`quarter'19.dta", clear
	rename *, lower
...
forvalues quarter = 1/4 {
	...
	use "`path_in_stata'/vivt`quarter'19.dta", clear
	rename *, lower
	cap tostring t_loc, replace force
	tempfile d`quarter'
	save "d`quarter'", replace
...
* Save the file
save "`path_in_stata'/ENOE_2019.dta", replace

*/	
	use "`path_in_stata'\ENOE_2019.dta", clear	
