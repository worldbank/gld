...
** DIRECTORY
	local path "Z:/GLD-Harmonization/582018_AQ/MEX/MEX_2019_ENOE"

** LOG FILE
	log using "`path'/MEX_2019_ENOE_V01_M_V01_A_I2D2/Programs/MEX_2019_I2D2_ENOE.log", replace
...
** DATABASE ASSEMBLENT
	use "`path'/MEX_2019_ENOE_V01_M/Data/Original/VIVT119.dta",clear
	drop p1-p3
	destring loc mun est ageb t_loc cd_a upm d_sem n_pro_viv ent con v_sel n_ent per, replace
	merge 1:m ent con v_sel using "`path'/MEX_2019_ENOE_V01_M/Data/Original/HOGT119.dta", nogen
	merge 1:m ent con v_sel n_hog using "`path'/MEX_2019_ENOE_V01_M/Data/Original/SDEMT119.dta"
	drop if _merge==1
	drop _merge
	merge 1:1 ent con v_sel n_hog n_ren using "`path'/MEX_2019_ENOE_V01_M/Data/Original/COE1T119.dta", nogen
	merge 1:1 ent con v_sel n_hog n_ren using "`path'/MEX_2019_ENOE_V01_M/Data/Original/COE2T119.dta", nogen
...
** REASONS NOT IN THE LABOR FORCE
	...
	gen unempldur=(2019- p2a_anio)*12 + p2b_mes- p2a_mes if p2b_anio==2019
...
** DELETE MISSING VARIABLES
	...
	save "`path'\MEX_2019_ENOE_V01_M_V01_A_I2D2\Data\Harmonized\MEX_2019_I2D2_ENOE.dta", replace
