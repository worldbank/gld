...
/*
	...
	*** COE1 ***
		...
		use "`path_in_stata'\COE1T`q'19.dta", clear
		
		*There are some variables in uppercase in Q3 and Q4; make them lowercase.
		if `q' > 2 {
	...
	*** COE2 ***
		...
		use "`path_in_stata'\COE2T`q'19.dta", clear
	...
	*** SDEMT ***
		...
		use "`path_in_stata'\SDEMT`q'19.dta", clear
	...
	*** VIV ***
		...
		use "`path_in_stata'\VIVT`q'19.dta",clear
		...
		*There are some variables in uppercase in Q3 and Q4; make them lowercase.
		...
		// t_loc is double but in the other data is str1. In q1 is str
		if `q' >= 2 {
			label values t_loc . // remove var label
	...
	*** HOG ***
		...
		use "`path_in_stata'\HOGT`q'19.dta", clear
		...
		*There are some variables in uppercase in Q3 and Q4; make them lowercase.
		...
		// t_loc is double but in the other data is str1
		label values t_loc . // remove var label
		tostring t_loc, replace
	...
	*** Rename vars for append (extended questionnarie: q1) ***
		...
		* There are  variables which has different types across quarters, those variables do not matter in gld armonization, delete them
		drop cs_p14_c
	...
	/*
local variables = "cd_a con cs_ad_mot cs_p12 cs_p13_1 cs_p13_2 cs_p15 cs_p17 d_mes e_con eda ent est_d fac h_mud loc n_hog n_ren p1 p1a1 p1a2 p1b p1c p1d p1e p2_1 p2_2 p2_3 p2_4 p2b p2e p3 p3d p3g_tot p3g1_1 p3g2_1 p3g3_1 p3g4_1 p3h p3i p3j p3m4 p3m5 p3q p4 p4a p4c p4d2 p5a p5c_thrs p5e_thrs p5g1 p5g10 p5g11 p5g12 p5g13 p5g14 p5g15 p5g2 p5g3 p5g4 p5g5 p5g6 p5g7 p5g8 p5g9 p5g99 p6b2 p7 p7a p7c p7e p8a par_c r_def sex t_loc t_tra upm v_sel"

foreach v of local variables {
	display "`v' :"
	tab quarter `v' if missing(`v'), miss
}


local variables = "cs_p12 cs_p13_1 cs_p13_2 cs_p15 cs_p17 p1 p1a1 p1a2 p1b p1c p1d p1e p2_1 p2_2 p2_3 p2_4 p2b p2e p3d p3g1_1 p3g2_1 p3g3_1 p3g4_1 p3h p3i p3j p3m4 p3m5 p3q p4 p4c p4d2 p5a p5g1 p5g10 p5g11 p5g12 p5g13 p5g14 p5g15 p5g2 p5g3 p5g4 p5g5 p5g6 p5g7 p5g8 p5g9 p5g99 p7 p7e p8a par_c r_def sex t_loc t_tra"
...
*<_subnatid1_>
  ...
  * In 2019, for some reason the data does not work with accents, puts "�" instead.
  * Correct here
  replace helper_lbl = "México" if helper_num == "15"
  replace helper_lbl = "Michoacán de Ocampo" if helper_num == "16"
  replace helper_lbl = "Nuevo León" if helper_num == "19"
  replace helper_lbl = "Querétaro" if helper_num == "22"
  replace helper_lbl = "San Luis Potosí" if helper_num == "24"
  replace helper_lbl = "Yucatán" if helper_num == "31"
