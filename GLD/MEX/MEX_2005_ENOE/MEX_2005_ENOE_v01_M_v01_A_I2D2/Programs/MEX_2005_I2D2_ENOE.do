...
** INPUT DATABASES			VIVT105.dta
*							HOGT105.dta
*							SDEMT105.dta
*							COE1T105.dta
*							COE2T105.dta
** MODIFIED BY				World Bank Jobs Group
** Created					03-28-2020
** Modified					06-03-2021
** NUMBER OF HOUSEHOLDS		100776
** NUMBER OF INDIVIDUALS	402186
** EXPANDED POPULATION		106005203
**                                                                                                  **
******************************************************************************************************
*****************************************************************************************************/
...
** DIRECTORY
	local path "Z:/GLD-Harmonization/582018_AQ/MEX/MEX_2005_ENOE"

** LOG FILE
	log using "`path'/MEX_2005_ENOE_v01_M_v01_A_I2D2/Programs/MEX_2005_I2D2_ENOE.log", replace
...
** DATABASE ASSEMBLENT
	use "`path'/MEX_2005_ENOE_v01_M/Data/Original/VIVT105.dta",clear
	drop p1-p3
	destring loc mun est ageb t_loc cd_a upm d_sem n_pro_viv ent con v_sel n_ent per, replace
	merge 1:m ent con v_sel using "`path'/MEX_2005_ENOE_v01_M/Data/Original/HOGT105.dta", nogen
	merge 1:m ent con v_sel n_hog using "`path'/MEX_2005_ENOE_v01_M/Data/Original/SDEMT105.dta"
	drop if _merge==1
	drop _merge
	merge 1:1 ent con v_sel n_hog n_ren using "`path'/MEX_2005_ENOE_v01_M/Data/Original/COE1T105.dta", nogen
	merge 1:1 ent con v_sel n_hog n_ren using "`path'/MEX_2005_ENOE_v01_M/Data/Original/COE2T105.dta", nogen
...
** DELETE MISSING VARIABLES
	...
	save "`path'\MEX_2005_ENOE_v01_M_v01_A_I2D2\Data\Harmonized\MEX_2005_I2D2_ENOE.dta", replace
