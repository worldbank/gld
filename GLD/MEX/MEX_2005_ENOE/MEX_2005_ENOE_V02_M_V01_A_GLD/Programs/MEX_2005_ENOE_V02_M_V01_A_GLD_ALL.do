...
/*
	...
	display "Merge COE1 - T`q':"
		use "`path_in_stata'\COE1T`q'05.dta", clear
	...
	*** COE2 ***
		...
		use "`path_in_stata'\COE2T`q'05.dta", clear
		tostring (ent v_sel n_ren), gen(ent_str v_sel_str n_ren_str) format("%02.0f")
		tostring con, gen(con_str) format("%05.0f")
		tostring (n_hog h_mud), gen(n_hog_str h_mud_str) format("%01.0f")
	...
	*** SDEMT ***
		...
		use "`path_in_stata'\SDEMT`q'05.dta", clear
		tostring (ent v_sel n_ren), gen(ent_str v_sel_str n_ren_str) format("%02.0f")
		tostring con, gen(con_str) format("%05.0f")
		tostring (n_hog h_mud), gen(n_hog_str h_mud_str) format("%01.0f")
	...
	*** VIV ***
		...
		use "`path_in_stata'\VIVT`q'05.dta",clear
		drop p1-p3
	...
	*** HOG ***
		...
		use "`path_in_stata'\HOGT`q'05.dta", clear
