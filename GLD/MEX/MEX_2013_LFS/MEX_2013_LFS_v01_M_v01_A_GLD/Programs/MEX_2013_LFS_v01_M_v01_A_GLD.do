...
<_Sample size (HH)_> 			[101,382] </_Sample size (HH)_> 
<_Sample size (IND)_> 			[379,010] </_Sample size (IND)_> 
...
local path_in "Z:\GLD-Harmonization\582018_AQ\MEX\MEX_2013_LFS\MEX_2013_LFS_v01_M\Data\Stata"
local path_output "Z:\GLD-Harmonization\582018_AQ\MEX\MEX_2013_LFS\MEX_2013_LFS_v01_M_v01_A_GLD\Data\Harmonized"
...
* harmonized output in a single file	
	...
	drop if _merge==1
	drop _merge
	merge 1:1 ent con v_sel n_hog n_ren using "`path_in'\COE1T113.dta", nogen
	merge 1:1 ent con v_sel n_hog n_ren using "`path_in'\COE2T113.dta", nogen
...
***first job
	...
	merge m:1 scian using "Z:\GLD-Harmonization\582018_AQ\MEX\MEX_2013_LFS\MEX_2013_LFS_v01_M\Data\Stata\SCIAN_07_ISIC_4.dta", keep(master match) nogen
...
***then first job
	...
	merge m:1 sinco using "Z:\GLD-Harmonization\582018_AQ\MEX\MEX_2013_LFS\MEX_2013_LFS_v01_M\Data\Stata\SINCO_11_ISCO_08.dta", keep(master match) nogen
...
save "`path_output'\MEX_2013_ENOE_V01_M_V01_A_GLD.dta", replace
