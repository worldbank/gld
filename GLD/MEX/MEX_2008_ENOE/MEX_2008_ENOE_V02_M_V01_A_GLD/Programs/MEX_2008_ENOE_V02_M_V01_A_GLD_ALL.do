...
/*
	...
	*** COE1 ***
		...
		use "`path_in_stata'\COE1T`q'08.dta", clear
	...
	*** COE2 ***
		...
		use "`path_in_stata'\COE2T`q'08.dta", clear
		tostring (ent v_sel n_ren), gen(ent_str v_sel_str n_ren_str) format("%02.0f")
		tostring con, gen(con_str) format("%05.0f")
		tostring (n_hog h_mud), gen(n_hog_str h_mud_str) format("%01.0f")
	...
	*** SDEMT ***
		...
		use "`path_in_stata'\SDEMT`q'08.dta", clear
		tostring (ent v_sel n_ren), gen(ent_str v_sel_str n_ren_str) format("%02.0f")
		tostring con, gen(con_str) format("%05.0f")
		tostring (n_hog h_mud), gen(n_hog_str h_mud_str) format("%01.0f")
	...
	*** VIV ***
		...
		use "`path_in_stata'\VIVT`q'08.dta",clear
		drop p1-p3
	...
	*** HOG ***
		...
		use "`path_in_stata'\HOGT`q'08.dta", clear
	...
	*** Rename vars for append (extended questionnarie: q2) ***
		if `q' == 2  {
			local old_varname = "p5g1 p5g10 p5g11 p5g12 p5g13 p5g14 p5g15 p5g2 p5g3 p5g4 p5g5 p5g6 p5g7 p5g8 p5g9 p5g99 p5e_thrs p5c_thrs p3q p3i p3j p5 p5a"
			local new_varname = "p5f1 p5f10 p5f11 p5f12 p5f13 p5f14 p5f15 p5f2 p5f3 p5f4 p5f5 p5f6 p5f7 p5f8 p5f9 p5f99 p5d_thrs p5b_thrs p3l p3j p3i p5a p5"
			*Look whether the new varname already exists
			*rename
...
local variables = "ent v_sel n_ren con n_hog h_mud r_def d_mes p7c p3 p7a fac upm est_d t_loc cd_a loc par_c eda sex e_con cs_p17 cs_p12 cs_p13_1 cs_p13_2 cs_p15 p1 p1a1 p1a2 p1b p1c p1d p1e p2_1 p2_2 p2_3 p2_4 p8a p2e p2b p3g1_1 p3g2_1 p3g3_1 p3g4_1 p3h p3d p4c p4d2 p4a p6b2 p5b_thrs p5d_thrs p5 p4 p5f1 p5f2 p5f3 p5f4 p5f5 p5f6 p5f7 p5f8 p5f9 p5f10 p5f11 p5f12 p5f13 p5f14 p5f15 p5f99 p3i p6d p3l p3g_tot p7 t_tra"

foreach v of local variables {
	display "`v' :"
	tab d_mes `v' if missing(`v'), miss
}
