...
<_Program name_>				[MEX_2008_ENOE_V02_M_V02_A_GLD_ALL.do] </_Program name_>
...
<_Sample size (HH)_> 			[126,719] </_Sample size (HH)_>
<_Sample size (IND)_> 			[555,179] </_Sample size (IND)_>
...
forvalues quarter = 1/4 {
	...
	quietly: append using "`path_in_stata'/coe1t`quarter'08.dta"
...
forvalues quarter = 1/4 {
	...
	quietly: append using "`path_in_stata'/coe2t`quarter'08.dta"
...
forvalues quarter = 1/4 {
	...
	quietly: append using "`path_in_stata'/sdemt`quarter'08.dta"
...
forvalues quarter = 1/4 {
	...
	quietly: append using "`path_in_stata'/hogt`quarter'08.dta"
...
forvalues quarter = 1/4 {
	...
	quietly: append using "`path_in_stata'/vivt`quarter'08.dta"
...
* Save the file
save "`path_in_stata'/ENOE_2008.dta", replace
*/	

use "`path_in_stata'\ENOE_2008.dta", clear
