...
<_Program name_>				[MEX_2016_ENOE_V01_M_V02_A_GLD_ALL.do] </_Program name_>
...
local path_output "Z:\GLD-Harmonization\582018_AQ\MEX\MEX_2016_ENOE\MEX_2016_ENOE_V01_M_V02_A_GLD\Data\Harmonized"

*----------1.3: Database assembly------------------------------*

* All steps necessary to merge datasets (if several) to have all elements needed to produce
* harmonized output in a single file
		use "`path_in'\COE1T116.dta", clear
	...
	use "`path_in'\COE2T116.dta", clear
	tostring (ent v_sel n_ren), gen(ent_str v_sel_str n_ren_str) format("%02.0f")
	tostring con, gen(con_str) format("%05.0f")
	tostring (n_hog h_mud), gen(n_hog_str h_mud_str) format("%01.0f")
	...
	* Overwrtwrite temp file
	...
	use "`path_in'\SDEMT116.dta", clear
	tostring (ent v_sel n_ren), gen(ent_str v_sel_str n_ren_str) format("%02.0f")
	tostring con, gen(con_str) format("%05.0f")
	tostring (n_hog h_mud), gen(n_hog_str h_mud_str) format("%01.0f")
	...
	***first job
		...
		merge m:1 scian using "Z:\GLD-Harmonization\582018_AQ\MEX\MEX_2016_ENOE\MEX_2016_ENOE_V01_M\Data\Stata\SCIAN_07_3D_ISIC_4.dta", keep(master match) nogen
...
save "`path_output'\MEX_2016_ENOE_V01_M_V02_A_GLD_ALL.dta", replace
