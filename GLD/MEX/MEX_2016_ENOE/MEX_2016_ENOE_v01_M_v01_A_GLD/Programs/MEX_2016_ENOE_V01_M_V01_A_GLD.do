...
<_Program name_>				[MEX_2016_ENOE_V01_M_v01_A_GLD.do] </_Program name_> 
...
<_Sample size (HH)_> 			[104,809] </_Sample size (HH)_> 
<_Sample size (IND)_> 			[383,381] </_Sample size (IND)_> 
...
*----------1.2: Set directories------------------------------*
local path_in "Z:\GLD-Harmonization\582018_AQ\MEX\MEX_2016_LFS\MEX_2016_LFS_v01_M\Data\Stata"
local path_output "Z:\GLD-Harmonization\582018_AQ\MEX\MEX_2016_LFS\MEX_2016_LFS_v01_M_v01_A_GLD\Data\Harmonized"

*----------1.3: Database assembly------------------------------*

* All steps necessary to merge datasets (if several) to have all elements needed to produce
* harmonized output in a single file	
	use "`path_in'\VIVT116.dta",clear
	drop p1-p3
	destring loc mun est ageb t_loc cd_a upm d_sem n_pro_viv ent con v_sel n_ent per, replace
	merge 1:m ent con v_sel using "`path_in'\HOGT116.dta", nogen
	merge 1:m ent con v_sel n_hog using "`path_in'\SDEMT116.dta"
	drop if _merge==1
	drop _merge
	merge 1:1 ent con v_sel n_hog n_ren using "`path_in'\COE1T116.dta", nogen
	merge 1:1 ent con v_sel n_hog n_ren using "`path_in'\COE2T116.dta", nogen
...
***first job
	...
	merge m:1 scian using "Z:\GLD-Harmonization\582018_AQ\MEX\MEX_2016_LFS\MEX_2016_LFS_v01_M\Data\Stata\SCIAN_13_ISIC_4.dta", keep(master match) nogen
...
***then first job
	...
	merge m:1 sinco using "Z:\GLD-Harmonization\582018_AQ\MEX\MEX_2016_LFS\MEX_2016_LFS_v01_M\Data\Stata\SINCO_11_ISCO_08.dta", keep(master match) nogen
...
*<_occup_skill_>
	...
	replace occup_skill = 1 if inrange(occup_isco,1000,2999)
	replace occup_skill = 2 if inrange(occup_isco,3000,7999) 
	replace occup_skill = 3 if inrange(occup_isco,8000,8999) 
	replace occup_skill = 4 if inrange(occup_isco,5400,5499) 
	...
	label values occup_skill lbloccupskilll
*</_occup_skill_>
...
*<_occup_skill_2_>
	...
	replace occup_skill_2 = 1 if inrange(occup_isco_2,1000,2999)
	replace occup_skill_2 = 2 if inrange(occup_isco_2,3000,7999) 
	replace occup_skill_2 = 3 if inrange(occup_isco_2,8000,8999) 
	replace occup_skill_2 = 4 if inrange(occup_isco_2,5400,5499) 
...
save "`path_output'\MEX_2016_ENOE_V01_M_V01_A_GLD.dta", replace
