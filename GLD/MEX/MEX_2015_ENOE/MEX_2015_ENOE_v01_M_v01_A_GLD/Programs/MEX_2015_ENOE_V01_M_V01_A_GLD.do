...
<_Sample size (HH)_> 			[105,628] </_Sample size (HH)_> 
<_Sample size (IND)_> 			[390,565] </_Sample size (IND)_> 
...
local path_in "Z:\GLD-Harmonization\582018_AQ\MEX\MEX_2015_LFS\MEX_2015_LFS_v01_M\Data\Stata"
local path_output "Z:\GLD-Harmonization\582018_AQ\MEX\MEX_2015_LFS\MEX_2015_LFS_v01_M_v01_A_GLD\Data\Harmonized"

*----------1.3: Database assembly------------------------------*

* All steps necessary to merge datasets (if several) to have all elements needed to produce
* harmonized output in a single file	
	use "`path_in'\VIVT115.dta",clear
	drop p1-p3
	destring loc mun est ageb t_loc cd_a upm d_sem n_pro_viv ent con v_sel n_ent per, replace
	merge 1:m ent con v_sel using "`path_in'\HOGT115.dta", nogen
	merge 1:m ent con v_sel n_hog using "`path_in'\SDEMT115.dta"
	drop if _merge==1
	drop _merge
	merge 1:1 ent con v_sel n_hog n_ren using "`path_in'\COE1T115.dta", nogen
	merge 1:1 ent con v_sel n_hog n_ren using "`path_in'\COE2T115.dta", nogen
...
***first job
	...
	merge m:1 scian using "Z:\GLD-Harmonization\582018_AQ\MEX\MEX_2015_LFS\MEX_2015_LFS_v01_M\Data\Stata\SCIAN_13_ISIC_4.dta", keep(master match) nogen
...
***then first job
	...
	merge m:1 sinco using "Z:\GLD-Harmonization\582018_AQ\MEX\MEX_2015_LFS\MEX_2015_LFS_v01_M\Data\Stata\SINCO_11_ISCO_08.dta", keep(master match) nogen
...
save "`path_output'\MEX_2015_ENOE_V01_M_V01_A_GLD.dta", replace
