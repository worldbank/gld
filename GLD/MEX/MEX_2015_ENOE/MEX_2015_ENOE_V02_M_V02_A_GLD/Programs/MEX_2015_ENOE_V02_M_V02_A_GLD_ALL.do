...
<_Program name_>				[MEX_2015_ENOE_V02_M_V02_A_GLD_ALL.do] </_Program name_>
<_Application_>					[STATA-18] <_Application_>
<_Author(s)_>					[The World Bank Jobs Group] </_Author(s)_>
<_Date created_>				2022-12-03 </_Date created_>
...
<_Sample size (HH)_> 			[126,994] </_Sample size (HH)_>
<_Sample size (IND)_> 			[536,347] </_Sample size (IND)_>
...
* Date: [2024-12-03] - [Update based on new series since 2020 (assembly, ISIC/ISCO, ...)]
...
forvalues quarter = 1/4 {
	...
	use "`path_in_stata'/coe1t`quarter'15.dta", clear
	rename *, lower
	tempfile d`quarter'
...
forvalues quarter = 1/4 {
	...
	use "`path_in_stata'/coe2t`quarter'15.dta", clear
	rename *, lower
	tempfile d`quarter'
	save "d`quarter'", replace
...
forvalues quarter = 1/4 {
	...
	use "`path_in_stata'/sdemt`quarter'15.dta", clear
	rename *, lower
	tempfile d`quarter'
	save "d`quarter'", replace
...
forvalues quarter = 1/4 {
	...
	use "`path_in_stata'/hogt`quarter'15.dta", clear
	rename *, lower
...
forvalues quarter = 1/4 {
	...
	use "`path_in_stata'/vivt`quarter'15.dta", clear
	rename *, lower
	cap tostring t_loc, replace force
	tempfile d`quarter'
	save "d`quarter'", replace
...
* Save the file
save "`path_in_stata'/ENOE_2015.dta", replace
*/	

use "`path_in_stata'\ENOE_2015.dta", clear	
