...
<_Program name_>				BTN_2024_Sakernas_v01_M_v01_A_GLD.do </_Program name_>
...
<_Study ID_>					BTN_2024_LFS_v01_M </_Study ID_>
<_Data collection from (M/Y)_>	01/2024 </_Data collection from (M/Y)_>
<_Data collection to (M/Y)_>	12/2024 </_Data collection to (M/Y)_>
...
<_Sample size (HH)_> 			11,804 </_Sample size (HH)_>
<_Sample size (IND)_> 			42,504 </_Sample size (IND)_>
...
use "`path_in_stata'\Q2_QLFS_2024.dta", clear
gen wave = "Q2"
egen hhid = group(interview__key)
tostring(hhid), replace
replace hhid = "Q2-"+hhid
tempfile q2
save `q2', replace

use "`path_in_stata'\Q3_QLFS_2024.dta",clear
gen wave = "Q3"
egen hhid = group(interview__id)
tostring(hhid), replace
replace hhid = "Q3-"+hhid
rename pry_occgroups q1_4a
tempfile q3
save `q3', replace

use "`path_in_stata'\Q4_QLFS_2024.dta",clear
gen wave = "Q4"
gen hhid = 1 if q1_3 == 1
replace hhid = sum(hhid)
tostring(hhid), replace
replace hhid = "Q4-"+hhid
rename sex q1_2
rename pry_occgroups q1_4a
tempfile q4
save `q4', replace

use "`path_in_stata'\Q1_QLFS_2024_PUF.dta", clear
gen wave = "Q1"
egen hhid = group(interview__key)
tostring(hhid), replace
replace hhid = "Q1-"+hhid

append using `q2'
append using `q3'
append using `q4'

** the raw data we received have many missing interview keys, the interview keys don't seem to map households across quarters so we generate our own hhids
...
/* <_pid_note>
	...
	BTN QLFS 2024 raw does not have pid
...
*<_relationharm_>
	recode q1_3 (1=1) (2=2) (3/4=3) (5/6=4) (7/31=5) (33=6) (*=.), g(relationharm)
...
*<_vocational_length_l_>
	...
	replace vocational_length_l = 1 if q2_9 == 2
	replace vocational_length_l = 6 if q2_9 == 3
	replace vocational_length_l = 12 if q2_9 == 4
	replace vocational_length_l = 24 if q2_9 == 5
...
*<_vocational_length_u_>
	...
	replace vocational_length_u = 1 if q2_9 == 1
	replace vocational_length_u = 6 if q2_9 == 2
	replace vocational_length_u = 12 if q2_9 == 3
	replace vocational_length_u = 24 if q2_9 == 4
	label var vocational_length_u "Length of training in months, upper limit"
*</_vocational_length_u_>


*<_vocational_field_orig_>
	tostring(q2_11a), gen(vocational_field_orig)
...
*<_industry_orig_>
	gen industry_orig = q4_2a
	label var industry_orig "Original survey industry code, main job 7 day recall"
*</_industry_orig_>


*<_industrycat_isic_>
	gen industrycat_isic = floor(q4_2a/10) if lstatus==1 & q4_2a > 9999
	replace industrycat_isic = . if lstatus != 1
	tostring(industrycat_isic), replace
	replace industrycat_isic = "" if industrycat_isic == "."
	replace industrycat_isic = "" if industrycat_isic == "9999" // unknown
...
*<_occup_orig_>
	gen occup_orig = q4_1a
	label var occup_orig "Original occupation record primary job 7 day recall"
*</_occup_orig_>


*<_occup_isco_>
	gen occup_isco = floor(q4_1a/10) if lstatus==1 & q4_1a > 9999
	replace occup_isco = . if lstatus != 1
	tostring(occup_isco), replace
	replace occup_isco = "" if occup_isco == "."
	replace occup_isco = "" if occup_isco == "9999" // unknown
	
	replace occup_isco = "2144" if occup_isco == "2147" //Transport and Vehicle Engineers
	replace occup_isco = "2269" if occup_isco == "2268"
	replace occup_isco = "2420" if occup_isco == "2429" // Administration Professionals Not Elsewhere Classified
	replace occup_isco = "2619" if occup_isco == "2613" //legal professionals not elsewhere classified
	
	* 2024 BSCO-specific / invalid detailed codes
	* 1429 is not found in the BSCO/BSIC codebooks and do not have labels in the raw data.
	* Occupation code 1429 is not found in the BSCO codebook and has no raw label.
	* Since the industry is manufacturing rather than commerce, we do not recode it to 1420.
	drop if occup_isco == "1429"
// 	replace occup_isco = "1420" if occup_isco == "1429" //Retail and wholesale trade managers
	replace occup_isco = "2514" if occup_isco == "1514" //Applications programmers
	replace occup_isco = "2212" if inlist(occup_isco, "22121", "221211") // Specialist medical practitioners
	replace occup_isco = "3341" if occup_isco == "33410" // Office supervisors
	* Check that no errors --> using our universe check function, count should be 0 (no obs wrong)
	* https://github.com/worldbank/gld/tree/main/Support/Z%20-%20GLD%20Ecosystem%20Tools/ISIC%20ISCO%20universe%20check
...
*<_wage_no_compen_>
	gen double wage_no_compen = q4_13 if lstatus==1 & ~inlist(q4_13,-98,.,.a)
...
*<_wage_no_compen_2_>
	gen double wage_no_compen_2 = q4_15e if lstatus==1 & ~inlist(q4_15e,-98,.,.a)
	label var wage_no_compen_2 "Last wage payment secondary job 7 day recall"
*</_wage_no_compen_2_>


*<_unitwage_2_>
	gen byte unitwage_2 = 5 if lstatus==1 & ~inlist(q4_15e,-98,.,.a)
