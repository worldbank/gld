...
<_Program name_>				BTN_2020_LFS_v01_M_v01_A_GLD.do </_Program name_>
...
<_Study ID_>					BTN_2020_LFS_v01_M </_Study ID_>
<_Data collection from (M/Y)_>	[01/2020] </_Data collection from (M/Y)_>
<_Data collection to (M/Y)_>	[12/2020] </_Data collection to (M/Y)_>
...
use "`path_in_stata'\LFS2020_ PUF.dta", clear
...
/* <_int_month_note>
	...
	BTN 2020 LFS was primarily conducted in Nov and Dec 2020
...
/* <_psu_note>
	...
	and for rural areas 'chiwogs'. that is the case for 2020 and 2020. 
...
/* <_subnatid1_note>
	...
	replace subnatid1 = string(dzong) + " - " + subnatid1
...
*<_relationharm_>
	recode Q1_4 (1=1) (2=2) (3/4=3) (5/6=4) (7/31=5) (33=6) (*=.), g(relationharm)
...
*<_educat7_>
	...
	replace educat7 = . if missing(educat7) & (Q2_8==22 | Q2_2==22)
...
*<_vocational_length_l_>
	...
	replace vocational_length_l = 1 if Q2_8 == 2
	replace vocational_length_l = 6 if Q2_8 == 3
	replace vocational_length_l = 12 if Q2_8 == 4
	replace vocational_length_l = 24 if Q2_8 == 5
...
*<_vocational_length_u_>
	...
	replace vocational_length_u = 1 if Q2_8 == 1
	replace vocational_length_u = 6 if Q2_8 == 2
	replace vocational_length_u = 12 if Q2_8 == 3
	replace vocational_length_u = 24 if Q2_8 == 4
...
*<_lstatus_>
	...
	replace	lstatus = 2 if Q5_1 == 1 & Q5_3 == 1
...
*<_ocusec_>
	recode Q4_5 (1/2=1) (3 6/9=2) (4/5=3) (*=.) if lstatus==1, g(ocusec)
...
*<_industry_orig_>
	gen industry_orig = Q4_3A
	label var industry_orig "Original survey industry code, main job 7 day recall"
*</_industry_orig_>


*<_industrycat_isic_>
	gen industrycat_isic = string(Q4_3A, "%04.0f")
...
*<_occup_isco_>
	gen occup_isco = string(Q4_1A, "%04.0f")
...
*<_wage_no_compen_>
	gen double wage_no_compen = Q4_7 if lstatus==1 & ~inlist(Q4_7,-98,.,.a)
...
*<_wage_no_compen_2_>
	gen double wage_no_compen_2 = Q4_10 if lstatus==1 & ~inlist(Q4_10,-98,.,.a)
	label var wage_no_compen_2 "Last wage payment secondary job 7 day recall"
*</_wage_no_compen_2_>


*<_unitwage_2_>
	gen byte unitwage_2 = 5 if lstatus==1 & ~inlist(Q4_10,-98,.,.a)
