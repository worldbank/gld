...
<_Program name_>				BTN_2018_LFS_v01_M_v01_A_GLD.do </_Program name_>
<_Application_>					Stata 17 <_Application_>
<_Author(s)_>					Wolrd Bank Job's Group </_Author(s)_>
<_Date created_>				2026-05-12 </_Date created_>
-------------------------------------------------------------------------
<_Country_>						Bhutan (BTN) </_Country_>
<_Survey Title_>                Quarterly Labour Force Survey </_Survey Title_>
<_Survey Year_>					2018 </_Survey Year_>
<_Study ID_>					BTN_2018_LFS_v01_M </_Study ID_>
...
<_Source of dataset_> 			Shared with Job's Group by the World Bank Bhtan Team
								data request form required to get the access</_Source of dataset_>
<_Sample size (HH)_> 			10,506 </_Sample size (HH)_>
<_Sample size (IND)_> 			40,762 </_Sample size (IND)_>
<_Sampling method_>             Stratified two-stage sampling design </_Sampling method_>
<_Geographic coverage_>         National; Dzongkhag/Thromde; Urban/Rural </_Geographic coverage_>
<_Currency_>                    Bhutanese Ngultrum </_Currency_>
---------------------------------------------------------------------------------------
<_ICLS Version_>                ICLS 13 </_ICLS Version_>
<_ISCED Version_>               ISCED-2011 </_ISCED Version_>
<_ISCO Version_>                ISCO-08 </_ISCO Version_>
<_OCCUP National_>              BSCO </_OCCUP National_>
<_ISIC Version_>                ISIC Rev. 4 </_ISIC Version_>
<_INDUS National_>              BSIC </_INDUS National_>
---------------------------------------------------------------------------------------
<_Version Control_>
...
use "`path_in_stata'\LFS2018_PUF.dta", clear
...
/* <_int_month_note>
	...
	BTN 2018 LFS was primarily conducted in Nov and Dec 2018
...
*<_pid_>
	tostring(Hh_mem_rost__id), g(rost_id)
	gen pid = hhid + rost_id
...
/* <_psu_note>
	...
	and for rural areas 'chiwogs'. that is the case for 2018 and 2018. 
...
/* <_subnatid1_note>
	...
	replace subnatid1 = string(Dzongkhag) + " - " + subnatid1
...
*<_relationharm_>
	recode Q1_5 (1=1) (2=2) (3/4=3) (5/6=4) (7/31=5) (33=6) (*=.), g(relationharm)
...
*<_marital_>
	recode Q1_7 (1=2) (2=3) (3=1) (4/5=4) (6=5) (*=.), g(marital)
...
*<_educat7_>
	recode Q3_7 (0 17 20=1) (1/5=2) (6=3) (7/11=4) (12=5) (13=6) (14/16=7) (*=.), g(educat7)
...
*<_vocational_>
	recode Q4_1 (1 2 = 1)(3=0)(*=.), g(vocational)
...
*<_vocational_length_l_>
	...
	replace vocational_length_l = 1 if Q4_5 == 2
	replace vocational_length_l = 6 if Q4_5 == 3
	replace vocational_length_l = 12 if Q4_5 == 4
	replace vocational_length_l = 24 if Q4_5 == 5
...
*<_vocational_length_u_>
	...
	replace vocational_length_u = 1 if Q4_5 == 1
	replace vocational_length_u = 6 if Q4_5 == 2
	replace vocational_length_u = 12 if Q4_5 == 3
	replace vocational_length_u = 24 if Q4_5 == 4
	label var vocational_length_u "Length of training in months, upper limit"
*</_vocational_length_u_>


*<_vocational_field_orig_>
	decode(Q4_4), g(vocational_field_orig)
...
*<_nlfreason_>
	recode Q7_3 (1 7=4) (3=1) (5=2) (9=3) (*=5) if lstatus==3, g(nlfreason)
...
*<_industry_orig_>
	gen industry_orig = Q6_3A
	label var industry_orig "Original survey industry code, main job 7 day recall"
*</_industry_orig_>


*<_industrycat_isic_>
	gen industrycat_isic = string(Q6_3A, "%04.0f")
	replace industrycat_isic = "" if lstatus != 1
	
	replace industrycat_isic = "9700" if industrycat_isic == "9690" //babysitters and household staff
	replace industrycat_isic = "2420" if industrycat_isic == "2428" //Manufacture of basic precious and other non-ferrous metals
...
*<_occup_orig_>
	gen occup_orig = Q6_1A
	label var occup_orig "Original occupation record primary job 7 day recall"
*</_occup_orig_>


*<_occup_isco_>
	gen occup_isco = string(Q6_1A, "%04.0f")
	replace occup_isco = "" if lstatus != 1
	replace occup_isco = "" if occup_isco == "9999"
	
	* Map BSCO national extensions to nearest valid ISCO-08 groups

	replace occup_isco = "1110" if inlist(occup_isco, "1115", "1116", "1117", "1118")

	replace occup_isco = "1330" if occup_isco == "1331"
	replace occup_isco = "1420" if occup_isco == "1421"
	replace occup_isco = "2230" if occup_isco == "2231"
	replace occup_isco = "2250" if occup_isco == "2251"

	replace occup_isco = "2310" if inlist(occup_isco, "2311", "2312")
	replace occup_isco = "2320" if occup_isco == "2321"
	replace occup_isco = "2330" if inlist(occup_isco, "2331", "2332")
	replace occup_isco = "2350" if occup_isco == "2357"

	replace occup_isco = "2410" if inlist(occup_isco, "2414", "2415", "2416")
	replace occup_isco = "2420" if inlist(occup_isco, "2425", "2426", "2427")

	replace occup_isco = "2510" if inlist(occup_isco, "2515", "2516")

	replace occup_isco = "3230" if occup_isco == "3231"
	replace occup_isco = "3240" if occup_isco == "3241"

	replace occup_isco = "4110" if occup_isco == "4111"
	replace occup_isco = "5120" if occup_isco == "5121"
	replace occup_isco = "5230" if occup_isco == "5231"
	replace occup_isco = "6210" if occup_isco == "6211"

	replace occup_isco = "9110" if inlist(occup_isco, "9113", "9114")

	* BSCO-specific occupation codes: map to closest ISCO-08 group

	replace occup_isco = "2269" if occup_isco == "2268"   // Occupational therapists -> Health professionals n.e.c.
	replace occup_isco = "2420" if occup_isco == "2429"   // Administration professionals n.e.c. -> Administration professionals

	* BTN 2018 occupation code clean-up based on labels

	replace occup_isco = "0110" if occup_isco == "1101"   // Commissioned Armed Forces Officers
	replace occup_isco = "1439" if occup_isco == "1432"   // Services managers n.e.c.
	replace occup_isco = "0210" if occup_isco == "2101"   // Non-commissioned Armed Forces Officers
	replace occup_isco = "2164" if occup_isco == "2167"   // Urban planners
	replace occup_isco = "0310" if occup_isco == "3101"   // Armed Forces Occupations, Other Ranks
	replace occup_isco = "0210" if occup_isco == "2102"   // Non-commissioned Armed Forces Officers
	replace occup_isco = "0310" if occup_isco == "3102"   // Armed Forces Occupations, Other Ranks
...
*<_occup_>
	recode Q6_1A (1101 1102 2101 2102 3101 3102 1000 2000 3000 4000 = 10) (1111/1999=1) (2111/2999=2) (3111/3999=3) (4111/4999=4) (5111/5999 9999=5) (6111/6999=6) (7111/7999=7) (8111/8999=8) (9111/9629=9) if lstatus==1, g(occup)
...
*<_wage_no_compen_>
	gen double wage_no_compen = Q6_7 if lstatus==1 & ~inlist(Q6_7,-98,.,.a)
...
/* <_unitwage_note>
	...
	gen byte unitwage = 5 if lstatus==1 & ~inlist(Q6_7,-98,.,.a)
...
*<_wage_no_compen_2_>
	gen double wage_no_compen_2 = Q6_10 if lstatus==1 & ~inlist(Q6_10,-98,.,.a)
	label var wage_no_compen_2 "Last wage payment secondary job 7 day recall"
*</_wage_no_compen_2_>


*<_unitwage_2_>
	gen byte unitwage_2 = 5 if lstatus==1 & ~inlist(Q6_10,-98,.,.a)
