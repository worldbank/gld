...
<_Program name_>				BTN_2019_LFS_v01_M_v01_A_GLD.do </_Program name_>
...
<_Study ID_>					BTN_2019_LFS_v01_M </_Study ID_>
...
use "`path_in_stata'\LFS2019_PUF.dta", clear
...
/* <_int_month_note>
	...
	BTN 2019 LFS was primarily conducted in Nov 2019
...
/* <_psu_note>
	...
	and for rural areas 'chiwogs'. that is the case for 2019 and 2019. 
...
*<_occup_isco_>
	...
	* BTN 2019 occupation code clean-up based on labels
...
*<_wage_no_compen_>
	gen double wage_no_compen = Q6_8 if lstatus==1 & ~inlist(Q6_8,-98,.,.a)
...
/* <_unitwage_note>
	...
	gen byte unitwage = 5 if lstatus==1 & ~inlist(Q6_8,-98,.,.a)
...
*<_wage_no_compen_2_>
	gen double wage_no_compen_2 = Q6_11 if lstatus==1 & ~inlist(Q6_11,-98,.,.a)
	label var wage_no_compen_2 "Last wage payment secondary job 7 day recall"
*</_wage_no_compen_2_>


*<_unitwage_2_>
	gen byte unitwage_2 = 5 if lstatus==1 & ~inlist(Q6_11,-98,.,.a)
