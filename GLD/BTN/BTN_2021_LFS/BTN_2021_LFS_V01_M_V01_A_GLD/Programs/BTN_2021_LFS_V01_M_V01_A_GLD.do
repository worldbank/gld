...
<_Program name_>				BTN_2021_LFS_v01_M_v01_A_GLD.do </_Program name_>
...
<_Study ID_>					BTN_2021_LFS_v01_M </_Study ID_>
...
use "`path_in_stata'\LFS2021_PUF.dta", clear
...
/* <_int_month_note>
	...
	BTN 2021 QLFS was primarily conducted in Nov and Dec 2021
...
*<_industry_orig_>
	gen industry_orig = q4_4a
	label var industry_orig "Original survey industry code, main job 7 day recall"
*</_industry_orig_>


*<_industrycat_isic_>
	gen industrycat_isic = floor(q4_4a/10) if lstatus==1 & q4_4a > 9999
...
*<_occup_isco_>
	...
	* 2021 BSCO-specific / invalid detailed codes
...
*<_wage_no_compen_>
	gen double wage_no_compen = q4_9 if lstatus==1 & ~inlist(q4_9,-98,.,.a)
...
/* <_unitwage_note>
	...
	gen byte unitwage = 5 if lstatus==1 & ~inlist(q4_9,-98,.,.a)
...
*<_wage_no_compen_2_>
	gen double wage_no_compen_2 = q4_12 if lstatus==1 & ~inlist(q4_12,-98,.,.a)
	label var wage_no_compen_2 "Last wage payment secondary job 7 day recall"
*</_wage_no_compen_2_>


*<_unitwage_2_>
	gen byte unitwage_2 = 5 if lstatus==1 & ~inlist(q4_12,-98,.,.a)
