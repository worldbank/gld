...
<_Program name_>				BTN_2025_Sakernas_v01_M_v01_A_GLD.do </_Program name_>
...
<_Study ID_>					BTN_2025_LFS_v01_M </_Study ID_>
<_Data collection from (M/Y)_>	01/2025 </_Data collection from (M/Y)_>
<_Data collection to (M/Y)_>	12/2025 </_Data collection to (M/Y)_>
...
<_Sample size (HH)_> 			11,686 </_Sample size (HH)_>
<_Sample size (IND)_> 			41,912 </_Sample size (IND)_>
...
use "`path_in_stata'\Q2LFS_PUF2025.dta", clear
gen wave = "Q2"
tempfile q2
save `q2', replace

use "`path_in_stata'\Q3LFS2025_PUF.dta",clear
gen wave = "Q3"
tempfile q3
save `q3', replace

use "`path_in_stata'\Q4LFS2025_PUF.dta",clear
gen wave = "Q4"
tempfile q4
save `q4', replace

use "`path_in_stata'\Q1LFS2025_PUF.dta",clear
gen wave = "Q1"
...
/* <_pid_note>
	...
	BTN QLFS 2025 raw does not have pid
...
*<_age_>
	replace age = q1_4 if missing(age)
...
*<_nlfreason_>
	recode q5_6 (1 4=1) (2=2) (6=4) (7=3) (*=5) if lstatus==3, g(nlfreason)
...
*<_industrycat_isic_>
	...
	replace industrycat_isic = "9609" if industrycat_isic == "9690" // babysitters and household staff; treated as typo for 9609
...
*<_occup_isco_>
	decode q4_1a, gen(occup_label)
	gen occup_code = real(regexs(1)) if regexm(occup_label, "^([0-9]+)")
	gen occup_isco = floor(occup_code/10) if lstatus==1 & occup_code > 9999
...
*<_occup_>
	recode occup_code (11111/14399=1) (21111/26599=2) (31111/35220=3) (41100/44190=4) (51111/54199=5) (61111/63400=6) (71110/75499=7) (81111/83503=8) (91110/96295 96299=9) (1101 2101 3101 99999=10) (* = .)if lstatus==1, g(occup)
