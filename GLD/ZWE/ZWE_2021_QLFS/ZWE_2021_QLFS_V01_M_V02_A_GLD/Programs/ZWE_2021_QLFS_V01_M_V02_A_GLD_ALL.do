...
<_Program name_>				ZWE_2021_LFCLS_v01_M_v02_A_GLD </_Program name_>
...
<_Study ID_>					ZWE_2021_LFCLS_v01_M </_Study ID_>
...
* Date: [2023-07-20] File: [ZWE_2021_LFCLS_v01_M_v02_A_GLD_ALL.do] - [Coded educat7 to missing considering the mixed educational category in the dataset, different from the categorization in the questionnaire.]
...
*<_contract_>
	gen byte contract = .
	replace contract = 0 if empstat == 1 | empstat == 2
	replace contract = 1 if contract == 0 & mj10b == 1
