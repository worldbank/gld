...
<_Program name_>				ZWE_2021_QLFS_V01_M_V02_A_GLD </_Program name_>
...
*<_healthins_>
	gen byte healthins = 0 if !mi(empstat)
	* Health yes if health or health and pension
	replace healthins = 1 if healthins == 0 & inlist(mj10c, 2, 3)
...
*<_socialsec_>
	gen byte socialsec = 0 if !mi(empstat)
	* Social yes if pension or health and pension
	replace socialsec = 1 if socialsec == 0 & inlist(mj10c, 1, 2)
