...
<_Program name_>				ZWE_2022_QLFS_V01_M_V02_A_GLD </_Program name_>
...
* Date: 2024-08-22 - update underemployment, ocusec, firmsize
...
use "`path_in_stata'/zwe-qlfs-q1-2022.dta", clear

gen quarter=1

append using "`path_in_stata'/zwe-qlfs-q2-2022.dta", force

replace quarter=2 if quarter==.

append using "`path_in_stata'/zwe-qlfs-q3-2022.dta", force
...
*save "`path_in_stata'/qlfs_2022.dta", replace
...
* However, naming by Zimstat (and everyone else) is the 2022 LFS, to not create confusion write as 2022.
	gen int year =2022
...
* 0.25 represents 1/4 which is the value of each quarter in a year. Since this is a consolidated quarterly survey.
*<_note_>

	gen migrated_ref_time = 0.25
...
*<_ocusec_>
	...
	replace ocusec = 1 if inrange(mj10,1,2)  & empstat == 1
	replace ocusec = 3 if inrange(mj10,3,4)  & empstat == 1
	replace ocusec = 2 if inrange(mj10,5,96) & empstat == 1
...
*<_contract_>
	...
	/*
	Universe: workers routed through MJ9a == 1 (wage/salary) to MJ10-MJ10c.
	Current choice keeps the previous GLD interpretation:
	contract = 1 only for written contract.
	Oral agreement is treated as no written contract.
	*/

	replace contract = 1 if lstatus == 1 & mj9a == 1 & mj10b == 1
	replace contract = 0 if lstatus == 1 & mj9a == 1 & inlist(mj10b, 2, 3)

	label var contract "Employment has contract primary job 7 day recall"
	la de lblcontract 0 "Without contract" 1 "With contract"
	label values contract lbcontract
*</_contract_alt_>
