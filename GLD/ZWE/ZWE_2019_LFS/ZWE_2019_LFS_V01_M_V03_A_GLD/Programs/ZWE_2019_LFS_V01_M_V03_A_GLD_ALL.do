...
<_Program name_>				ZWE_2019_LFS_V01_M_V03_A_GLD_ALL.do </_Program name_>
...
* Date: 2024-08-22 - Correct underemp, ocusec
...
use "`path_in_stata'/Labour forrce 2019_HL.dta", clear
...
* However, naming by Zimstat (and everyone else) is the 2019 LFS, to not create confusion write as 2019.
	gen int year =2019
...
/* <_subnatid1_note>
	...
	gen str subnatid1 = ""
	replace subnatid1="1 - Manicaland" if hh5==1
	replace subnatid1="2 - Mashonaland Central" if hh5==2
	replace subnatid1="3 - Masholand East" if hh5==3
	replace subnatid1="4 - Masholand West" if hh5==4
	replace subnatid1="5 - Matabeleland North" if hh5==5
	replace subnatid1="6 - Matabeleland South" if hh5==6
	replace subnatid1="7 - Midlands" if hh5==7
	replace subnatid1="8 - Masvingo" if hh5==8
	replace subnatid1="9 - Harare" if hh5==9
	replace subnatid1="10 - Bulawayo" if hh5==0
...
*<_migrated_from_cat_>
	...
	replace	migrated_from_cat = 3 if hh5 == m4 & migrated_binary == 1
	replace migrated_from_cat = 4 if hh5 != m4 & migrated_binary == 1
...
*<_ocusec_>
	...
	replace ocusec = 2 if inrange(mj10,5,96)
...
*<_industry_orig_>
	gen industry_orig = mj6b_isic_code
...
*<_contract_>
	...
	*/
	...
	replace contract = 1 if lstatus == 1 & mj10d == 1
	replace contract = 0 if lstatus == 1 & inlist(mj10d, 2, 3)
...
*<_healthins_>
	...
	healthins = employer-paid health insurance contribution
	*/

	replace healthins = 1 if lstatus == 1 & inlist(mj10k, 2, 3)
	replace healthins = 0 if lstatus == 1 & inlist(mj10k, 1, 4)
...
*<_socialsec_>
	...
	socialsec = employer-paid pension contribution
	*/

	replace socialsec = 1 if lstatus == 1 & inlist(mj10k, 1, 3)
	replace socialsec = 0 if lstatus == 1 & inlist(mj10k, 2, 4)
...
*<_firmsize_l_>
	gen firmsize_l = .
	replace firmsize_l = 1 if mj11a == 1
	replace firmsize_l = 2 if mj11a == 2
	replace firmsize_l = 6 if mj11a == 3
	replace firmsize_l = 10 if mj11a == 4
	replace firmsize_l = 20 if mj11a == 5
	replace firmsize_l = 50 if mj11a == 6
...
*<_firmsize_u_>
	gen firmsize_u= .
	replace firmsize_u = 1 if mj11a == 1
	replace firmsize_u = 5 if mj11a == 2
	replace firmsize_u = 9 if mj11a == 3
	replace firmsize_u = 19 if mj11a == 4
	replace firmsize_u = 49 if mj11a == 5
