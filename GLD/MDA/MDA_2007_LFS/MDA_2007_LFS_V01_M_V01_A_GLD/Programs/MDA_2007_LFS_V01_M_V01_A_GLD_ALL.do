...
<_Program name_>				MDA_2007_LFS_V01_M_V01_A_GLD_ALL</_Program name_>
...
<_Study ID_>					MDA_2007_LFS_V01_M </_Study ID_>
...
<_Sample size (HH)_> 				38,916 </_Sample size (HH)_>
<_Sample size (IND)_> 				111,540 </_Sample size (IND)_>
...
/* <_hhid_note>
	...
	tostring loc, gen(loc_str) format("%05.0f")
...
*<_occup_isco_>
	...
	*Include self-employed with no market interaction and worked less than 20 hours at reference week. Assume they work in Skilled agricultural occupations.
	...
	replace occup_isco = "7300" if occup_isco == "7333"
	replace occup_isco = "7300" if occup_isco == "7335"
	replace occup_isco = "7400" if occup_isco == "7438"
...
*<_occup_isco_2_>
	...
	*Include self-employed with no market interaction. Assume they work in Skilled agricultural occupations.
	...
	replace occup_isco_2 = "2400" if occup_isco_2 == "2470"
