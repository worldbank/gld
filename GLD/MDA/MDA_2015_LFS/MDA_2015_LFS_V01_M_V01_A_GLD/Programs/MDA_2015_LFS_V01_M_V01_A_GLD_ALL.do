...
<_Program name_>				MDA_2014_LFS_V01_M_V01_A_GLD_ALL</_Program name_>
...
<_Study ID_>					MDA_2014_LFS_V01_M </_Study ID_>
<_Data collection from_>			[01/2014] </_Data collection from_>
<_Data collection to_>				[06/2014] </_Data collection to_>
...
<_Sample size (IND)_> 				29,568 </_Sample size (IND)_>
...
/* <_hhid_note>
	...
	tostring loc, gen(loc_str) format("%04.0f")
...
*<_industrycat_isic_>
	...
	replace industrycat_isic = substr(industry_orig,1,2) + "00" if length(industry_orig)==4
	replace industrycat_isic = "0" + substr(industry_orig,1,1) + "00" if length(industry_orig)==3
...
*<_industrycat_isic_2_>
	...
	replace industrycat_isic_2 = substr(industry_orig_2,1,2) + "00" if length(industry_orig_2)==4
	replace industrycat_isic_2 = "0" + substr(industry_orig_2,1,1) + "00" if length(industry_orig_2)==3
