...
<_Program name_>				MDA_2009_LFS_V01_M_V01_A_GLD_ALL</_Program name_>
...
<_Study ID_>					MDA_2009_LFS_V01_M </_Study ID_>
...
<_Sample size (HH)_> 				39,999 </_Sample size (HH)_>
<_Sample size (IND)_> 				111,418 </_Sample size (IND)_>
...
use "`path_in_stata'/lfs2009.dta",clear
...
*<_occup_isco_>
	...
	*Include self-employed with no market interaction and worked less than 20 hours at reference week. Assume they work in Skilled agricultural occupations.
	...
	replace occup_isco = "7000" if occup_isco == "7515"
	...
	replace occup_isco = "7000" if occup_isco == "7620"
	...
	replace occup_isco = "8220" if occup_isco == "8227"
...
*<_firmsize_l_>
	gen firmsize_l = nrsal
	replace firmsize_l = . if lstatus != 1 | nrsal == 0
...
*<_industry_orig_2_>
	...
	replace industry_orig_2 = "" if industry_orig_2 == "." | missing(empstat_2)
...
*<_occup_orig_2_>
	...
	replace occup_orig_2 = "" if missing(empstat_2) | occup_orig_2 == "."
...
*<_occup_isco_2_>
	...
	*Include self-employed with no market interaction. Assume they work in Skilled agricultural occupations.
	...
	replace occup_isco_2 = "5140" if occup_isco_2 == "5145"
