...
<_Program name_>				MDA_2000_LFS_V01_M_V01_A_GLD_ALL</_Program name_>
...
<_Study ID_>					MDA_2000_LFS_V01_M </_Study ID_>
...
<_Sample size (HH)_> 				28,313 </_Sample size (HH)_>
<_Sample size (IND)_> 				83,119 </_Sample size (IND)_>
...
use "`path_in_stata'/lfs_2000.dta",clear
...
/* <_hhid_note>
	...
	tostring centr, gen(centr_str) format("%05.0f")
	egen hhid = concat(centr_str cifrulg loc nrcl)
	label var hhid "Household ID"
*</_hhid_>


*<_pid_>
	tostring nrp_cl, gen(nrp_cl_str) format("%02.0f")
	egen  pid = concat(hhid nrp_cl_str)
	isid hhid pid
...
*<_relationharm_>
	...
	2.Husband / Wife
	3.Son / daughter / son-in-law / daughter-in-law
	4.Father / mother/ mother-in-law/ father-in-law
	5.Brother / sister / brother-in-law / sister-in-law
	6.Other relative
	7.Not a relative	
	*/
...
*<_relationcs_>
	...
	replace relationcs = "3.Son / daughter / son-in-law / daughter-in-law" if grud == 3
	replace relationcs = "4.Father / mother/ mother-in-law/ father-in-law" if grud == 4
	replace relationcs = "5.Brother / sister / brother-in-law / sister-in-law" if grud == 5
	replace relationcs = "6.Other relative" if grud == 6
	replace relationcs = "7.Not a relative" if grud == 7
...
*<_school_>
	...
	recode school (1 = 0) (2 3 4 5 6 7 = 1)
...
*<_underemployment_>
	gen byte underemployment = (dispoc == 1)
...
*<_industrycat_isic_>
	gen industrycat_isic = string(act_orig*100, "%04.0f")
...
*<_occup_orig_>
	gen occup_orig = ocup_ori
	label var occup_orig "Original occupation record primary job 7 day recall"
*</_occup_orig_>


*<_occup_isco_>
	gen occup_isco = string(ocup_ori, "%04.0f")
...
*<_industry_orig_2_>
	gen industry_orig_2 = acts
	label var industry_orig_2 "Original survey industry code, secondary job 7 day recall"
*</_industry_orig_2_>


*<_industrycat_isic_2_>
	gen industrycat_isic_2 = char(acts + 64)
...
*<_occup_orig_2_>
	gen occup_orig_2 = ocups_or
	label var occup_orig_2 "Original occupation record secondary job 7 day recall"
*</_occup_orig_2_>


*<_occup_isco_2_>
	gen occup_isco_2 = string(ocup_ori, "%04.0f")
