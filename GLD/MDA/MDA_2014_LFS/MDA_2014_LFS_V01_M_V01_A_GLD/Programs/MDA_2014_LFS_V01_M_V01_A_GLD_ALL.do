...
<_Sample size (HH)_> 				37,767 </_Sample size (HH)_>
<_Sample size (IND)_> 				97,723 </_Sample size (IND)_>
...
use "`path_in_stata'/lfs20014.dta",clear
...
/* <_hhid_note>
	...
	tostring cifrulg, gen(cifrulg_str) format("%06.0f")
	egen hhid = concat(cifrulg_str nrcl)
	label var hhid "Household ID"
*</_hhid_>


*<_pid_>
	tostring nrp_cl, gen(nrp_str) format("%02.0f")
