...
<_Program name_>				BGD_2023_QLFS_Merge_V01.do </_Program name_>
...
<_Study ID_>					BGD_2023_QLFS </_Study ID_>
...
*================ Q1 2023 =================
use "`path_in_stata'/BBS_LFS_Q1_2023_Roster_Disability.dta", clear
merge m:1 QUARTER HHNO PSU EAUM using ///
    "`path_in_stata'/BBS_LFS_Q1_2023_Socio_Economic.dta", nogen

gen EMP_HRLN = HR_LN
merge 1:1 QUARTER HHNO PSU EAUM EMP_HRLN using ///
    "`path_in_stata'/BBS_LFS_Q1_2023_Employment_Education.dta", nogen

gen MGT_LN = EMP_HRLN
merge 1:1 QUARTER HHNO PSU EAUM MGT_LN using ///
    "`path_in_stata'/BBS_LFS_Q1_2023_Migration.dta", nogen
...
*================ Q2 2023 =================
use "`path_in_stata'/BBS_LFS_Q2_2023_Roster_Disability.dta", clear
merge m:1 QUARTER HHNO PSU EAUM using ///
    "`path_in_stata'/BBS_LFS_Q2_2023_Socio_Economic.dta", nogen

gen EMP_HRLN = HR_LN
merge 1:1 QUARTER HHNO PSU EAUM EMP_HRLN using ///
    "`path_in_stata'/BBS_LFS_Q2_2023_Employment_Education.dta", nogen

gen MGT_LN = EMP_HRLN
merge 1:1 QUARTER HHNO PSU EAUM MGT_LN using ///
    "`path_in_stata'/BBS_LFS_Q2_2023_Migration.dta", nogen
...
*================ Q3 2023 =================
use "`path_in_stata'/BBS_LFS_Q3_2023_Roster_Disability.dta", clear
merge m:1 QUARTER HHNO PSU EAUM using ///
    "`path_in_stata'/BBS_LFS_Q3_2023_Socio_Economic.dta", nogen

gen EMP_HRLN = HR_LN
merge 1:1 QUARTER HHNO PSU EAUM EMP_HRLN using ///
    "`path_in_stata'/BBS_LFS_Q3_2023_Employment_Education.dta", nogen

gen MGT_LN = EMP_HRLN
merge 1:1 QUARTER HHNO PSU EAUM MGT_LN using ///
    "`path_in_stata'/BBS_LFS_Q3_2023_Migration.dta", nogen
...
*================ Q4 2023 =================
use "`path_in_stata'/BBS_LFS_Q4_2023_Roster_Disability.dta", clear
merge m:1 QUARTER HHNO PSU EAUM using ///
    "`path_in_stata'/BBS_LFS_Q4_2023_Socio_Economic.dta", nogen

gen EMP_HRLN = HR_LN
merge 1:1 QUARTER HHNO PSU EAUM EMP_HRLN using ///
    "`path_in_stata'/BBS_LFS_Q4_2023_Employment_Education.dta", nogen

gen MGT_LN = EMP_HRLN
merge 1:1 QUARTER HHNO PSU EAUM MGT_LN using ///
    "`path_in_stata'/BBS_LFS_Q4_2023_Migration.dta", nogen
...
*<_weight_>
    gen weight = .
    replace weight = wgt_2023q1 if QUARTER == 1
    replace weight = wgt_2023q2 if QUARTER == 2
    replace weight = wgt_2023q3 if QUARTER == 3
    replace weight = wgt_2023q4 if QUARTER == 4
...
*<_weight_q_>
    gen weight_q = .
    replace weight_q = wgt_2023q1 if QUARTER == 1
    replace weight_q = wgt_2023q2 if QUARTER == 2
    replace weight_q = wgt_2023q3 if QUARTER == 3
    replace weight_q = wgt_2023q4 if QUARTER == 4
...
/* <_occup_isco_note>
	...
	* Additional undocumented occupation codes observed in the 2024 data.
	* These codes could not be mapped reliably to valid ISCO-08 unit groups
	* based on the available BSCO documentation and are left uncoded.

	local invalid_occup ///
		0141 1141 1230 1244 1437 2154 2239 2452 2465 ///
		2534 2541 3234 3235 3317 4119 4151 4153 4233 ///
		5149 5250 5326 6124 6126 6141 6151 7140 7219 7226 7330 7426 ///
		7430 7445 7503 7525 8214 8314 8333 9118 9220 9231 9322 ///
