...
<_Program name_>				BGD_2016_LFS_V02_M_V01_A_GLD_ALL.do </_Program name_>
...
<_Sample size (HH)_> 			69,351 </_Sample size (HH)_>
...
use "`path_in_stata'/bgd_qlfs_2016_17_sarraw.dta", clear
...
*------------------------------------------------------------------------
	...
	*------------------------------------------------------------------------
	replace lstatus = 2 if q77 == 1 & q81 == 1 & lstatus==.
...
*<_potential_lf_>
	...
	replace potential_lf = 1 if (q77 == 1 & q81 == 2) | (q81 == 1 & q77 == 2) | (q81 == . & q77 == 1)
