...
<_Program name_>				BGD_2016_LFS_V01_M_V01_A_GLD.do </_Program name_>
<_Application_>					Stata 17 <_Application_>
<_Author(s)_>					World Bank Jobs Group (gld@worldbank.org) </_Author(s)_>
<_Date created_>				2023-03-20 </_Date created_>
...
<_Sample size (HH)_> 			122,455 </_Sample size (HH)_>
<_Sample size (IND)_> 			493,886 </_Sample size (IND)_>
...
<_INDUS National_>				BSIC revision 4 </_INDUS National_>
...
use "`path_in_stata'/Bangladesh QLFS 2016-17 Microdata.dta", clear
...
*<_int_year_>
	gen int_year= 2016 if inlist(qtr, 1, 2)
	replace int_year = 2017 if inlist(qtr, 3, 4)
...
*<_migrated_years_>
	...
	* Fix the typo
	gen q101_rev = q101
	replace q101_rev = . if q101 == 9725 | q101<1900
...
*<_migrated_from_urban_>
	...
	replace migrated_from_urban = q100
	recode migrated_from_urban (1 = 0) (2 = 1)
...
*<_migrated_from_cat_>
	...
	replace migrated_from_cat = 2 if q98 == 2
...
* IF we have information on the district code, we can determine with certainty. 
	replace migrated_from_cat = . if q98 == 3
	replace migrated_from_cat = 5 if q98 == 4
...
replace migrated_from_country = "IND" if inlist(q99a, "1India", "Idia", "Indea", "India", "India'")
replace migrated_from_country = "IND" if inlist(q99a, "India'", "Indid", "Indioa", "Indir", "Inida", "Vharat", "Omdoa", "Ianda", "India '")
replace migrated_from_country = "MMR" if q99a == "Iiyanmar"
replace migrated_from_country = "KWT" if inlist(q99a, "Koyet", "Kuet", "Kwyet")
replace migrated_from_country = "LBN" if q99a == "Lebanan"
replace migrated_from_country = "LBY" if inlist(q99a, "Libia", "Libiya")
replace migrated_from_country = "MYS" if inlist(q99a, "Malay Asiya", "Malayasha", "Malayasiya")
replace migrated_from_country = "PAK" if q99a == "Pakistan"
replace migrated_from_country = "SAU" if inlist(q99a, "Saudi Arab", "Sawdia", "Soudi", "Soudi Arab")
replace migrated_from_country = "SGP" if inlist(q99a, "Singapore", "Singapur")
replace migrated_from_country = "LKA" if inlist(q99a, "Sreelonka", "Srilanka")
replace migrated_from_country = "THA" if inlist(q99a, "Thailand", "Thiland")
replace migrated_from_country = "ARE" if inlist(q99a, "Abudhabhi", "Dubai")
replace migrated_from_country = "ITA" if q99a == "Italy"
replace migrated_from_country = "GBR" if inlist(q99a, "Britain", "London")
replace migrated_from_country = "USA" if q99a == "America"
...
*<_underemployment_>
	...
	replace underemployment = 1 if trunder_avl == 1 & trunder_look == 1
...
*<_occup_isco_>
	...
	replace occup_isco = "4000" if inlist(occup_isco, "4600", "4900")
	replace occup_isco = "8000" if inlist(occup_isco, "8500", "8600")
