...
<_Program name_>				BGD_2005_LFS_V01_M_V01_A_GLD.do </_Program name_>
<_Application_>					Stata 17 <_Application_>
<_Author(s)_>					World Bank Jobs Group (gld@worldbank.org) </_Author(s)_>
<_Date created_>				2023-04-12 </_Date created_>
...
<_Sample size (HH)_> 			40,000 </_Sample size (HH)_>
<_Sample size (IND)_> 			188,487 </_Sample size (IND)_>
...
<_INDUS National_>				BSIC 2001 </_INDUS National_>
...
use "`path_in_stata'/LFS05_06_Final.dta", clear
...
*<_int_year_>
	gen int_year= 2005 if inrange(round, 10, 12)
	replace int_year = 2006 if inrange(round, 1, 9)
...
*<_vocational_>
	gen vocational = .
	replace vocational = inrange(trng, 2, 12)
	replace vocational = . if trng == 0
...
* Here unemployed can only be defined by "looking for work". Not asked about "available for work"
...
*<_potential_lf_>
	...
	replace potential_lf = 1 if s8q82 == 1 & s8q83vl1 == 9
...
* BSIC and ISIC are equivalent at the two-digit level
* Merge correspondence table

	merge m:1 industry_orig using "`path_in_stata'\bsic_isic_mapping.dta" , keep(master match)

* The following codes have no ISIC equivalent: 0133, 2928, 6024, 6039, 6230
* Assume equivalence at 2 digits
...
*<_wage_no_compen_>
	...
	replace wage_no_compen = wage_salary if s4q412 == 1
	replace wage_no_compen = wage_laborer if (s4q412 == 6 | s4q412 == 7)
	replace wage_no_compen = . if lstatus !=1
	* It turns out that wage workers report income monthly and day laborers weekly
...
/*
	replace unitwage = 1 if s4q417 == 1
	replace unitwage = 2 if s4q417 == 2
	replace unitwage = 5 if s4q417 == 3
	replace unitwage = . if inlist(s4q417, 0, 4, 5)
*/
...
*<_contract_>
	...
	replace contract = 1 if inlist(s4q416, 1, 2)
