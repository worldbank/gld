...
<_Program name_>				BGD_2010_LFS_V01_M_V01_A_GLD.do </_Program name_>
...
<_Data collection from_>		May 10, 2010 </_Data collection from_>
<_Data collection to_>			May 25, 2010 </_Data collection to_>
<_Source of dataset_> 			Bangladesh Bureau of Statistics </_Source of dataset_>
<_Sample size (HH)_> 			43,949 </_Sample size (HH)_>
<_Sample size (IND)_> 			199,274 </_Sample size (IND)_>
...
use "`path_in_stata'/LFS_2010_Final.dta", clear
...
*<_vocational_>
	gen vocational = .
	replace vocational = (q310a == 2)  | (q310b == 2) | (q310c == 2) | (q310d == 2) | (q310e == 2)
...
*<_lstatus_>
	...
	** Absent from work in the past 7 days
...
*<_potential_lf_>
	...
	replace potential_lf = 1 if (s5_1 == 3 & s5_5 == 1) | (s5_1 == 1 & s5_5 == 2)
...
*<_underemployment_>
	...
	replace underemployment = 1 if inlist(s4_44, 1, 2)
...
*<_wage_no_compen_>
	egen double wage_no_compen = rowtotal(s4_13 s4_14) if lstatus == 1
...
*<_contract_>
	...
	replace contract = 1 if inlist(s4_23, 1, 2)
