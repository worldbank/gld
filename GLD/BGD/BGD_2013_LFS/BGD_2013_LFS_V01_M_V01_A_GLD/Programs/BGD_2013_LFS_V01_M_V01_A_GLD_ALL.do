...
<_Program name_>				BGD_2013_LFS_V01_M_V01_A_GLD.do </_Program name_>
<_Application_>					Stata 17 <_Application_>
<_Author(s)_>					World Bank Jobs Group (gld@worldbank.org) </_Author(s)_>
<_Date created_>				2023-04-05 </_Date created_>
...
<_Data collection from_>		July 2013 </_Data collection from_>
...
<_Sample size (HH)_> 			36,242 </_Sample size (HH)_>
<_Sample size (IND)_> 			156,987 </_Sample size (IND)_>
...
use "`path_in_stata'/LFS 2013 Microdata.dta", clear
...
/* <_subnatidsurvey_note>
	...
	gen str subnatidsurvey = "urban" if urban == 1
...
*<_vocational_length_l_>
	...
	replace vocational_length_l = 0 if inrange(q35, 1, 3)
	replace vocational_length_l = 1 if q35 == 4
	replace vocational_length_l = 3 if q35 == 5
	replace vocational_length_l = 6 if q35 == 6
...
*<_vocational_length_u_>
	...
	replace vocational_length_u = 1 if inrange(q35, 1, 3)
	replace vocational_length_u = 3 if q35 == 4
	replace vocational_length_u = 6 if q35 == 5
	replace vocational_length_u = . if q35 == 6

	label var vocational_length_u "Length of training in months, upper limit"
*</_vocational_length_u_>

*<_vocational_field_orig_>
	gen vocational_field_orig = string(q38, "%02.0f")
	label var vocational_field_orig "Original field of training information"
*</_vocational_field_orig_>

*<_vocational_financed_>
	gen vocational_financed = .
	replace vocational_financed = q37
	recode vocational_financed ( 1 = 2) (2 3 4 5 9 = 5)
...
*<_lstatus_>
	...
	* Define the employed
	*------------------------------------------------------------------------
	** E1. Self employed in the past 7 days
	replace lstatus = 1 if q39 == 1
	
	** E2.  Wage or paid domestic work in the past 7 days
	replace lstatus = 1 if q40 == 1 | q41 == 1
	
	** E3. Unpaid family work
	replace lstatus = 1 if q42 == 1
	
	** E4. Absent from work in the past 7 days
	...
	* Matches almost perfectly with the "emp" variable except for one individual with missing tag in emp, aged over 5 and reported looking and being available for work. Need to probe?
...
*<_potential_lf_>
	...
	replace potential_lf = 1 if (q84 == 1 & q87 == 2) | (q87 == 1 & q84 == 2)
...
*<_underemployment_>
	...
	replace underemployment = 1 if trunder == 1
...
*<_occup_isco_>
	...
	replace occup_isco = "2000" if occup_isco == "2900"
	...
	replace occup_isco = "5000" if occup_isco == "5900" | occup_isco == "5600" | occup_isco == "5700" | occup_isco == "5800" | occup_isco == "5500"
...
*<_occup_>
	...
	* In this case: isco is unlabeled! assume to be others (not military!)
	recode occup (0 = 99) 
...
*<_wage_no_compen_>
	gen double wage_no_compen = q77_cashkind if lstatus == 1
...
*<_contract_>
	...
	replace contract = 1 if inlist(q55, 1, 2, 3)
...
*<_industrycat_isic_2_>
	...
	tempfile isic
	preserve
	import delimited  "C:\Users\wb510859\OneDrive - WBG\Documents\GitHub\gld\Support\D - Q Checks\Single survey checks\Helper_programs_1.5\isic_codes.txt" , varnames(1) clear 

	gen industrycat_isic_2 = code
	gen isic_version = version

	save `isic'
	restore

	merge m:1 industrycat_isic_2 isic_version using `isic', keep(master match)
	
	gen isic3d_s = substr(industry_orig_2, 1, 3) + "0"
	replace industrycat_isic_2 = isic3d_s if _merge == 1 & industrycat_isic_2 != ""
	replace industrycat_isic_2 = "4500" if industrycat_isic_2 == "4550"
	replace industrycat_isic_2 = "7500" if industrycat_isic_2 == "7530"
	replace industrycat_isic_2 = "9100" if industrycat_isic_2 == "9110"
	replace industrycat_isic_2 = "9900" if industrycat_isic_2 == "9990"
	replace industrycat_isic_2 = "" if industrycat_isic_2 == "0000" | industrycat_isic_2 == "0490" | industrycat_isic_2 == "8920"

	replace industrycat_isic_2 = "" if industrycat_isic_2 == ".0"
	label var industrycat_isic_2 "ISIC code of secondary job 7 day recall"
	
	drop _merge isic3d_s
*</_industrycat_isic_2_>
...
*<_occup_isco_2_>
	...
	tempfile isco
	preserve
	import delimited  "C:\Users\wb510859\OneDrive - WBG\Documents\GitHub\gld\Support\D - Q Checks\Single survey checks\Helper_programs_1.5\isco_codes.txt" , varnames(1) clear 

	gen occup_isco_2 = code
	gen isco_version = version

	save `isco'
	restore

	merge m:1 occup_isco_2 isco_version using `isco', keep(master match)
	
	gen isco3d = substr(occup_isco_2, 1, 3) + "0" 
	replace occup_isco_2 = isco3d if _merge == 1 & occup_isco_2 != ""
	...
	gen isco1d = substr(occup_isco_2, 1, 1) + "000" 
	replace occup_isco_2 = isco1d if _merge == 1 & occup_isco_2 != ""
...
*<_occup_2_>
	gen occup_2 = ""
	replace occup_2 = substr(occup_isco_2, 1, 1)
...
*<_wage_no_compen_2_>
* Information only available for first activity
