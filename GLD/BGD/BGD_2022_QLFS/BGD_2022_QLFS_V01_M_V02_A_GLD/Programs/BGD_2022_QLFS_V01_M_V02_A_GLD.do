...
<_Program name_>				BGD_2022_QLFS_V01_M_V02_A_GLD.do </_Program name_>
<_Application_>					Stata 18 <_Application_>
<_Author(s)_>					World Bank Jobs Group (gld@worldbank.org) </_Author(s)_>
<_Date created_>				2025-01-24 </_Date created_>
...
* Date: 2025-01-24 - Update occup, occup_isco for cases missing, but we know they are subsistence ag
...
/* <_occup_isco_note>
	...
	There is a set of individuals that have industry codes but no occupation codes.
	99% are in four precise industry codes

	Industry codes (BSIC 2020) used to map to occupations
	1131 - Growing leafy or stem vegetables 
	1411 - Raising and breeding of cattle and buffaloes
	1441 - Raising and breeding of sheep and goats
	1461 - Raising and breeding of chickens (other fowl)

	Individuals state to work mostly for own consumption. 

	Hence if working for own consumption and in these industries without occup, 
	we overwrite it and assign that information to code 6300 (subsistence farm)
	...
	replace occup_isco = "6300" if inlist(mj_04c, 1131, 1411, 1441, 1461) & ///
    inrange(emp_05, 3, 4) & mi(mj_02c)
...
*<_occup_>
	...
	* Add subsistence ag (see note on occup_isco)
	replace occup = 6 if inlist(mj_04c, 1131, 1411, 1441, 1461) & ///
    inrange(emp_05, 3, 4) & mi(mj_02c)
