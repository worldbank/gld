...
<_Sample size (HH)_> 			121,082 </_Sample size (HH)_>
<_Sample size (IND)_> 			503,756 </_Sample size (IND)_>
...
use "`path_in_stata'/Annual QLF2015-16 Final.dta", clear
...
*<_migrated_binary_>
	gen migrated_binary = .
	replace migrated_binary = q98 != 1 & q98!= 0
...
*<_migrated_from_urban_>
	...
	recode migrated_from_urban (0 3 5 7 8 = .) (1 = 0) (2 = 1) 
...
* IF we have information on the district code, we can determine with certainty. 
	replace migrated_from_cat = . if q98 == 3  | q98 == 0
...
*<_migrated_from_country_>
	...
	replace migrated_from_country = "USA" if q99a == "AMERICA" | q99a == "USA"
	*replace migrated_from_country = "BGD" if q99a == "BANGLADESH" | q99a == "BANLADESH"
	replace migrated_from_country = "MMR" if q99a == "BARMA"
	replace migrated_from_country = "BRN" if q99a == "BHURANAI"
	replace migrated_from_country = "IND" if q99a == "INDA" | q99a == "INDEA" | q99a == "INDIA" | q99a == "INDIA`" | q99a == "INDIOA" | q99a == "INDIZ" | q99a == "INDIa" | q99a == "india" | q99a == "INDIA `" | q99a == "BHAROT" | q99a == "VAROT" | q99a == "VRAOT"
	replace migrated_from_country = "ARE" if q99a == "DUBAI" | q99a == "DUBAI`"
	replace migrated_from_country = "IDN" if q99a == "INDONESIA" | q99a == "INDONISA"
	replace migrated_from_country = "KWT" if q99a == "KUATE" | q99a == "KUET" | q99a == "KUYET" | q99a == "KWYET" | q99a == "QWET"
	replace migrated_from_country = "LBY" if q99a == "LIBIA" | q99a == "LIBIYA"
	replace migrated_from_country = "GBR" if q99a == "LONDON"
	replace migrated_from_country = "MMR" if q99a == "MAYANMAR" | q99a == "MIANMAR" | q99a == "MIYANMAR" | q99a == "MYANMAR"
	replace migrated_from_country = "OMN" if q99a == "OMAN"
	replace migrated_from_country = "PAK" if q99a == "PAKISTAN"
	replace migrated_from_country = "SAU" if q99a == "SAUDI" | q99a == "SAUDI ARAB" | q99a == "SOUDI" | q99a == "SOUDI ARAB" | q99a == "SOUDI ARABIA" | q99a == "SOUDI AROB"
	replace migrated_from_country = "THA" if q99a == "THAILAND"
...
*<_underemployment_>
	...
	replace underemployment = 1 if q72 == 1 & q73 == 1
...
*<_ocusec_>
	...
	recode ocusec (2 = 4) (3 = 1) (4 5 6 7 = 2) (9 = .)
...
*<_industry_orig_2_>
	gen industry_orig_2 = string(q57c, "%04.0f")
