...
/* -----------------------------------------------------------------------
<_Program name_> 			LKA_1994_LFS_V01_M_V02_A_GLD_ALL.do </_Program name_>
...
*<_subnatid1_note_>*/
	gen subnatid1=""
	replace subnatid1="1 - Western" if province==1
	replace subnatid1="2 - Central" if province==2
	replace subnatid1="3 - Southern" if province==3
	replace subnatid1="4 - Northern Area" if province==4
	replace subnatid1="5 - Eastern" if province==5
	replace subnatid1="6 - North-western" if province==6
	replace subnatid1="7 - North-central" if province==7
	replace subnatid1="8 - Uva" if province==8
	replace subnatid1="9 - Sabaragamuwa" if province==9
...
4	Passed G.C.E(O/L)N.C.G.E. (upper secondary school) --> 11 years
...
*<_wage_no_compen_2_>
	...
	replace wage_no_compen_2=. if lstatus!=1|q15!=1|empstat_2==2
