...
/* -----------------------------------------------------------------------
<_Program name_> 			LKA_1993_LFS_V01_M_V02_A_GLD_ALL.do </_Program name_>
...
1993 has 91,624 obs and 18,828 households in the year. 1993 has only 40% of the
sample size of 1993's whereas its households are only 36% of 1993's. 

Adding weight to hhid might bump the number up a bit to 7500.
