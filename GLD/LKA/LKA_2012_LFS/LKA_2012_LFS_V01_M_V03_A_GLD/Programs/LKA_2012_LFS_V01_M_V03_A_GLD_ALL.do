...
/* -----------------------------------------------------------------------
<_Program name_> 			LKA_2012_LFS_V01_M_V03_A_GLD_ALL.do </_Program name_>
...
<_Study ID_>					LKA_2012_LFS_v01_M </_Study ID_>
<_Data collection from (M/Y)_>	[Apr/2012] </_Data collection from (M/Y)_>
<_Data collection to (M/Y)_>	[Dec/2012] </_Data collection to (M/Y)_>
...
<_Sample size (HH)_> 			16,336 </_Sample size (HH)_>
<_Sample size (IND)_> 		    62,298 </_Sample size (IND)_>
...
* Date: [2023-10-19] File: [LKA_2012_LFS_v01_M_v02_A_GLD_ALL] - [Typo correction of ISCED]
...
/*<_wave_note_>
Due to the heavy work load of the Census of Population & Housing – 2011, 
the survey could not be conducted in 4th quarter 2011 & 1st quarter 2012. 
So LFS 2012 only has three quarters. 
*<_wave_note_>*/
...
------------------+-------------------------
04024200307027027 |          1        15    
04026101506167167 |          1        17    
05024500503003003 |          2        14    
08029105205085085 |          2        16       
12025105201031031 |          1        17     
12038107305066066 |          1        17
------------------+---------------------------
...
*<_relationharm_note_>*/
	...
	gen nohead=1 if inlist(hhid, "04024200307027027", "04026101506167167" ///
								 "05024500503003003", "08029105205085085" ///
								 "12025105201031031", "12038107305066066") 
...
*<_underemployment_>
	...
	replace underemployment=1 if q30==1
	replace underemployment=0 if q30==2
...
*<_whours_>
	gen whours=q18
	replace whours=. if lstatus!=1|q18==0	
...
{
*<_empstat_2_>
	gen byte empstat_2=q24 
	recode empstat_2 (2=3) (3=4) (4=2) 
	replace empstat_2=. if lstatus!=1|q21!=1
...
*<_ocusec_2_>
	gen byte ocusec_2=.  
	replace ocusec_2=. if lstatus!=1|q21!=1
...
*<_industry_orig_2_>
	...
	replace industry_orig_2=. if lstatus!=1|q21!=1
...
*<_industrycat_isic_2_>
	...
	replace industrycat_isic_2="" if lstatus!=1|q21!=1
...
*<_occup_orig_2_>
	...
	replace occup_orig_2=. if lstatus!=1|q21!=1
...
*<_occup_isco_2_>
	...
	replace occup_isco_2="" if lstatus!=1|q21!=1
...
*<_occup_skill_2_>
	...
	replace occup_skill_2=. if skill_level_2==0|lstatus!=1|q21!=1
...
*<_whours_2_>
	gen whours_2=q25
	replace whours_2=. if lstatus!=1|q21!=1
...
*<_njobs_>
	gen njobs=.
	replace njobs=1 if lstatus==1&q21!=1
	replace njobs=2 if lstatus==1&q21==1
