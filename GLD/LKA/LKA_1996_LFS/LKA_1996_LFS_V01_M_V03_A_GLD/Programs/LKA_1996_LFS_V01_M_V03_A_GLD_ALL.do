...
/* -----------------------------------------------------------------------
<_Program name_> 			LKA_1996_LFS_V01_M_V03_A_GLD_ALL.do </_Program name_>
...
<_Study ID_>					LKA_1996_LFS_v01_M </_Study ID_>
<_Data collection from (M/Y)_>	[Jan/1996] </_Data collection from (M/Y)_>
<_Data collection to (M/Y)_>	[Oct/1996] </_Data collection to (M/Y)_>
...
* Date: 2024-10-08 - Update var whours
...
In 1996, Northern and Eastern provinces were excluded.

*<_subnatid1_note_>*/
	gen subnatid1_num=district
	recode subnatid1_num (1/3=1) (4/6=2) (7/9=3) (10/14=4) (15/17=5) (18/19=6) (20/21=7) (22/23=8) (24/25=9)
	gen subnatid1=""
...
*<_subnatid2_>
	...
	recode subnatid2_num (1=11) (2=12) (3=13) (4=21) (5=22) (6=23) (7=31) (8=32) (9=33) (18=61) (19=62) (20=71) (21=72) (22=81) (23=82) (24=91) (25=92)
...
*<_relationharm_>
	...
	replace relationharm=5 if headsum1==2&head==1&newp1!=headidmin
...
*<_school_>
	gen school=.
	replace school=0 if schooling==5
	replace school=1 if inrange(schooling,1,4)
...
*<_educat7_>
	...
	replace educat7=5 if inrange(educattn,11,13)
	replace educat7=6 if educattn==14
...
Q13 is hours usually worked, Q14 hours actually worked. We have coded Q14 in all the series. In the close by years (1995
and 1998) nearly all employed people answer Q14 (and as many answer Q14 as Q13). For some odd reason, this year only 50% of
respondents answer Q14. Hence here we will use Q13 to fill in the blanks.

*<_whours_note_>*/

	gen whours = q14
	replace whours = q13 if !mi(q13) & mi(q14)
