...
/* -----------------------------------------------------------------------
<_Program name_> 			LKA_2007_LFS_V01_M_V02_A_GLD_ALL.do </_Program name_>
...
* Date: [YYYY-MM-DD] File: [As in Program name above] - [Description of changes]
* Date: 2024-03-22 - Update vars icls_v
...
19 observations chose both of monthly and daily earner types which do not make 
