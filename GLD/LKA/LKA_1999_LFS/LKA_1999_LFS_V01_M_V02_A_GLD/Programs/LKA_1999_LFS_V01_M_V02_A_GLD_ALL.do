...
/* -----------------------------------------------------------------------
<_Program name_> 			LKA_1999_LFS_V01_M_V02_A_GLD_ALL.do </_Program name_>
...
In 1999, Northern and Eastern provinces were excluded.
...
*<_educy_note_>*/
	gen edu=educattn if !inlist(educattn,17,18,22,51,99)
	gen byte educy=.
...
Category 17, 18 and everything beyond 19 are mistaken.
