...
<_Program name_>				COL_2002_GLD_ECH_v01
...
<_Data collection from_>		[07/2002] </_Data collection from_>
...
<_Sample size (HH)_> 				32,067
<_Sample size (IND)_> 				131,924
...
local path_in  "Z:\GLD-Harmonization\582018_AQ\COL\COL_2002_ECH\COL_2002_ECH_v01_M\Data\Stata"
local path_output "Z:\GLD-Harmonization\582018_AQ\COL\COL_2002_ECH\COL_2002_ECH_v01_M_V02_A_GLD\Data\Harmonized"

*----------1.3: Database assembly------------------------------*

** DATABASE ASSEMBLENT

use "`path_in'/ECH_2002_1.dta"

forvalues i=2/12 {
    append using "`path_in'\ECH_2002_`i'.dta", force
}

save "`path_in'/ECH_2002.dta", replace
...
*<_int_year_>
	gen int_year = 2002 //instead of intv_year=ano
...
{
*<_lstatus_>
/*1 Trabajando 2 Buscando trabajo 3
Estudiando 4 Oficios del hogar 5 Otra actividad 6
Incapacitado permanente para trabajar*/
	destring p12, force replace
	gen byte lstatus = p12
	recode lstatus 4=1 5=3 6=3
...
*<_nlfreason_>
	...
	replace nlfreason=. if lstatus!=1
...
*<_industrycat10_>
	...
	replace industrycat10=. if rama2d==.
...
save "`path_output'/COL_2002_ECH_V01_M_V02_A_GLD_ALL.dta", replace
