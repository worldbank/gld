...
** DATABASE ASSEMBLENT
/*
use "`path_in_stata'/ECH_2002_1.dta"

forvalues i=2/12 {
    append using "`path_in_stata'\ECH_2002_`i'.dta", force
}

save "`path_in_stata'/ECH_2002.dta", replace
*/
use "`path_in_stata'/ECH_2002.dta", clear
