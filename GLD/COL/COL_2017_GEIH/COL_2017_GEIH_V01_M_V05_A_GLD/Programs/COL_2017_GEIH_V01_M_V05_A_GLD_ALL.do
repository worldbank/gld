...
<_Program name_>				COL_2017_GEIH_V01_M_V04_A_GLD_ALL
...
<_Data collection from_>			01/2017
...
<_Sample size (HH)_> 				208,521 </_Sample size (HH)_>
<_Sample size (IND)_> 				691,278 </_Sample size (IND)_>
...
clear all
use "`path_in_stata'\GEIH_2017_1.dta"

forvalues i=2/12 {
    append using "`path_in_stata'\GEIH_2017_`i'.dta", force
}
...
append using "`path_in_stata'\amazonia\amazonia_2017.dta", force

***San andrés
append using "`path_in_stata'\SA_2017.dta", force


tempfile general_2017
save `general_2017'

clear all


use "`path_in_stata'\Migration\mi_1.dta"
forvalues i=2/12 {
    append using "`path_in_stata'\Migration\mi_`i'.dta", force
}
*save "`path_in'\migration_2017.dta", replace
tempfile migration_2017
save `migration_2017'

*full set
use "`general_2017'",clear
...
merge 1:1 directorio secuencia_p orden  using "`migration_2017'", assert(master match) nogen
...
rename *, lower
*tostring mes, force replace format(%02.0f)
merge 1:1 directorio secuencia_p  orden using "`general_mig'", force assert(match using) nogen

save "`path_in_stata'\data_2017_final.dta", replace
*/
use "`path_in_stata'\data_2017_final.dta", clear
...
*<_int_year_>
	gen int_year = 2017 //instead of intv_year=ano
...
*<_subnatid1_>
	...
	replace subnatid1 = "6 - Aamazonia y Orinoquia" if area == "81" | area == "85" | area == "86" |area == "91" | area == "94" | area == "95" | area == "97" | area == "99"
	replace subnatid1="6 - Aamazonia y Orinoquia" if subnatid1=="Arauca"
	replace subnatid1="6 - Aamazonia y Orinoquia" if subnatid1=="Inirida"
	replace subnatid1="6 - Aamazonia y Orinoquia" if subnatid1=="Leticia"
	replace subnatid1="6 - Aamazonia y Orinoquia" if subnatid1=="Mitu"
	replace subnatid1="6 - Aamazonia y Orinoquia" if subnatid1=="Mocoa"
	replace subnatid1="6 - Aamazonia y Orinoquia" if subnatid1=="Puerto Carreño"
	replace subnatid1="6 - Aamazonia y Orinoquia" if subnatid1=="San Jose de Guaviare"
	replace subnatid1="6 - Aamazonia y Orinoquia" if subnatid1=="Yopal"
...
*<_subnatid2_>
	...
	replace subnatid2 = "81 - Arauca"                    if area == "Arauca"
	replace subnatid2 = "85 - Casanare"                     if area == "Yopal"
	replace subnatid2 = "86 - Putumayo"                     if area == "Mocoa"
	replace subnatid2 = "88 - San Andres"                if dpto == "88" 
	replace subnatid2 = "91 - Amazonas"                   if area == "Leticia"
	replace subnatid2 = "94 - Guainia"                   if area == "Inirida"
	replace subnatid2 = "95 - Guaviare"     if area == "San Jose del Guaviare"
	replace subnatid2 = "97 - Vaupes"                      if area == "Mitu"
	replace subnatid2 = "99 - Vichada"            if area == "Puerto Carreño"
...
*<_subnatid3_>
	...
	replace subnatid3 = "081 - Arauca"                    if area == "Arauca"
	replace subnatid3 = "085 - Yopal"                     if area == "Yopal"
	replace subnatid3 = "086 - Mocoa"                     if area == "Mocoa"
	replace subnatid3 = "088 - San Andres"                if area == "88" 
	replace subnatid3 = "091 - Leticia"                   if area == "Leticia"
	replace subnatid3 = "094 - Inirida"                   if area == "Inirida"
	replace subnatid3 = "095 - San Jose del Guaviare"     if area == "San Jose del Guaviare"
	replace subnatid3 = "097 - Mitu"                      if area == "Mitu"
	replace subnatid3 = "099 - Puerto Carreno"            if area == "Puerto Carreño"
