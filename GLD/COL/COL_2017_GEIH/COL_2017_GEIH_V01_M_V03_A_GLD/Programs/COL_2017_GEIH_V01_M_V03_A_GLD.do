...
<_Program name_>				COL_2017_GEIH_V01_M_V03_A_GLD_ALL
...
* Date: [2022-09-20] - [change in subnatid1]
...
local path_in "Z:\GLD-Harmonization\582018_AQ\COL\COL_2017_GEIH\COL_2017_GEIH_v01_M\Data\Stata\"
local path_output "Z:\GLD-Harmonization\582018_AQ\COL\COL_2017_GEIH\COL_2017_GEIH_v01_M_V03_A_GLD\Data\Harmonized\"
...
clear all
use "`path_in'\GEIH_2017_1.dta"

forvalues i=2/12 {
    append using "`path_in'\GEIH_2017_`i'.dta", force
}
...
append using "`path_in'\amazonia\amazonia_2017.dta", force

***San andrés
append using "`path_in'\SA_2017.dta", force
...
save "`path_in'\data_2017_final.dta", replace
...
*<_int_month_> // Includes all months
	*destring mes, gen(int_month)  //instead of gen byte month=mes
	gen  int_month = mes
...
*<_subnatid1_>
	...
	replace subnatid1=" 6 - Amazonia y Orinoquia" if subnatid1=="Mitu"
	replace subnatid1=" 6 - Amazonia y Orinoquia" if subnatid1=="Mocoa"
	replace subnatid1=" 6 - Amazonia y Orinoquia" if subnatid1=="Puerto Carreño"
	replace subnatid1=" 6 - Amazonia y Orinoquia" if subnatid1=="San Jose de Guaviare"
	replace subnatid1=" 6 - Amazonia y Orinoquia" if subnatid1=="Yopal"
...
*<_subnatid2_>
	...
	replace subnatid2 = "81 - Arauca" if subnatid2 =="Arauca"
	replace subnatid2 = "85 - Yopal" if subnatid2 == "Yopal"
	replace subnatid2 = "86 - Mocoa" if subnatid2 =="Mocoa"
	replace subnatid2 = "88 - San Andrés" if subnatid2 =="88"
	replace subnatid2 = "91 - Leticia" if subnatid2 =="Leticia"
	replace subnatid2 = "94 - Inirida" if subnatid2 =="Inirida"
	replace subnatid2 = "95 - San Jose del Guaviare" if subnatid2 =="San Jose de Guaviare"
	replace subnatid2 = "97 - Mitu" if subnatid2 =="Mitu"
	replace subnatid2 = "99 - Puerto Carreño" if subnatid2 =="Puerto Carreño"
...
save "`path_output'\COL_2017_GEIH_V01_M_V03_A_GLD_ALL.dta", replace
