...
clear all
use "`path_in_stata'\GEIH_2012_1.dta"

forvalues i=2/12 {
    append using "`path_in_stata'\GEIH_2012_`i'.dta", force
}
...
append using "`path_in_stata'\amazonia\GEIH_AMA_2012.dta"

***San andrés
append using "`path_in_stata'\SA_2012.dta"


tempfile general_2012
save `general_2012'

clear all

use "`path_in_stata'\Migration\mi_2.dta"
forvalues i=3/12 {
    append using "`path_in_stata'\Migration\mi_`i'.dta", force
}

tempfile migration_2012
save `migration_2012'

*full set
use "`general_2012'",clear
...
merge 1:1 directorio secuencia_p orden  using "`migration_2012'", assert(master match) nogen
...
save "`path_in_stata'\data_2012_final.dta", replace
*/

use "`path_in_stata'\data_2012_final.dta", clear
...
/*
local letters "secuencia_p mes orden"
	...
	egen hhid = concat(helper_d helper_secuencia_p helper_mes)
	drop helper_d helper_secuencia_p helper_mes
