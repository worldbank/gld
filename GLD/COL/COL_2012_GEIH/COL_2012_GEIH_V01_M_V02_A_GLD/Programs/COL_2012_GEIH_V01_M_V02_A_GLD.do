...
local path_output "Z:\GLD-Harmonization\582018_AQ\COL\COL_2012_GEIH\COL_2012_GEIH_v01_M_V02_A_GLD\Data\Harmonized\"

*----------1.3: Database assembly------------------------------*

*** append household monthly data
clear all
use "`path_in'\GEIH_2012_1.dta"

forvalues i=2/12 {
    append using "`path_in'\GEIH_2012_`i'.dta", force
}
...
append using "`path_in'\amazonia\GEIH_AMA_2012.dta"

***San andrés
append using "`path_in'\SA_2012.dta"
...
use "`path_in'\Migration\mi_2.dta"
forvalues i=3/12 {
...
save "`path_in'\data_2012_final.dta", replace
...
save "`path_output'\COL_2012_GEIH_V01_M_V02_A_GLD_ALL.dta", replace
