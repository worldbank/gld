...
** DATABASE ASSEMBLENT
/*
use "`path_in_stata'/ECH_2005_1.dta"

forvalues i=2/12 {
    append using "`path_in_stata'\ECH_2005_`i'.dta", force
}

save "`path_in_stata'/ECH_2005.dta", replace
*/

use "`path_in_stata'/ECH_2005.dta", clear
...
*<_educat7_>
	...
	replace educat7=4 if p10=="411"
	replace educat7=4 if p10=="412"
	replace educat7=4 if p10=="413"
	replace educat7=5 if inrange(p10,"610","613")
