...
<_Program name_>				COL_2005_ECH_V01_M_V01_A_GLD_ALL
...
<_Data collection from_>		[07/2005] </_Data collection from_>
...
<_Sample size (HH)_> 			37,580
<_Sample size (IND)_> 			148,430
...
<_INDUS National_>		ISI REV 3 COLOMBIA	</_INDUS National_>

-----------------------------------------------------------------------
<_Version Control_>

* Date: 2022-20-05 - Changes from I2D2 to GLD
...
local path_in  "Z:\GLD-Harmonization\582018_AQ\COL\COL_2005_ECH\COL_2005_ECH_v01_M\Data\Stata"
local path_output "Z:\GLD-Harmonization\582018_AQ\COL\COL_2005_ECH\COL_2005_ECH_v01_M_v01_A_GLD\Data\Harmonized"

*----------1.3: Database assembly------------------------------*

** DATABASE ASSEMBLENT

use "`path_in'/COL_2005_ECH_MERGED.dta"
...
*<_int_year_>
	gen int_year = 2005 //instead of intv_year=ano
...
save "`path_output'/COL_2005_ECH_V01_M_V01_A_GLD_ALL.dta", replace
