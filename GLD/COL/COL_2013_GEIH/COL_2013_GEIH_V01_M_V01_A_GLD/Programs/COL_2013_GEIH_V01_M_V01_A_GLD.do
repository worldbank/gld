...
clear all
use "`path_in'\GEIH_2013_1.dta"

forvalues i=2/12 {
    append using "`path_in'\GEIH_2013_`i'.dta", force
}
...
append using "`path_in'\amazonia\GEIH_AMA_2013.dta"

***San andrés
append using "`path_in'\SA_2013.dta"
...
save "`path_in'\data_2013_final.dta", replace
