...
<_Program name_>				COL_2013_GEIH_V01_M_V01_A_GLD_ALL
...
<_INDUS National_>			Colombia ISIC rev 3.1	 </_INDUS National_>
...
local path_in "Z:\GLD-Harmonization\582018_AQ\COL\COL_2013_GEIH\COL_2013_GEIH_v01_M\Data\Stata\" 
local path_output "Z:\GLD-Harmonization\582018_AQ\COL\COL_2013_GEIH\COL_2013_GEIH_v01_M_v01_A_GLD\Data\Harmonized\"
...
clear all
use "Z:\GLD-Harmonization\582018_AQ\COL\COL_2013_GEIH\COL_2013_GEIH_v01_M\Data\Stata\GEIH_2013_1.dta"

forvalues i=2/12 {
    append using "Z:\GLD-Harmonization\582018_AQ\COL\COL_2013_GEIH\COL_2013_GEIH_v01_M\Data\Stata\GEIH_2013_`i'.dta", force
}
keep if _merge==3
drop _merge
rename *, lower
save "Z:\GLD-Harmonization\582018_AQ\COL\COL_2013_GEIH\COL_2013_GEIH_v01_M\Data\Stata\GEIH_2013.dta", replace

clear all


use "Z:\GLD-Harmonization\582018_AQ\COL\COL_2013_GEIH\COL_2013_GEIH_v01_M\Data\Stata\Migration\mi_1.dta"
forvalues i=2/12 {
    append using "Z:\GLD-Harmonization\582018_AQ\COL\COL_2013_GEIH\COL_2013_GEIH_v01_M\Data\Stata\Migration\mi_`i'.dta", force
}
save "Z:\GLD-Harmonization\582018_AQ\COL\COL_2013_GEIH\COL_2013_GEIH_v01_M\Data\Stata\migration_2013.dta", replace
	
	
*** merge appended to households data 
merge 1:m directorio secuencia_p orden using "Z:\GLD-Harmonization\582018_AQ\COL\COL_2013_GEIH\COL_2013_GEIH_v01_M\Data\Stata\GEIH_2013.dta"
keep if _merge==3
drop _merge 

save "Z:\GLD-Harmonization\582018_AQ\COL\COL_2013_GEIH\COL_2013_GEIH_v01_M\Data\Stata\merged_2013.dta", replace

 

****final dataset with updated weights
use "Z:\GLD-Harmonization\582018_AQ\COL\COL_2013_GEIH\COL_2013_GEIH_v01_M\Data\Stata\Fex proyeccion CNPV_2018.dta"
rename *, lower
merge 1:m directorio secuencia_p orden using "Z:\GLD-Harmonization\582018_AQ\COL\COL_2013_GEIH\COL_2013_GEIH_v01_M\Data\Stata\merged_2013.dta", force

keep if _merge==3
drop _merge 

save "Z:\GLD-Harmonization\582018_AQ\COL\COL_2013_GEIH\COL_2013_GEIH_v01_M\Data\Stata\data_2013_final.dta", replace
...
*<_industrycat_isic_>// Colombian ISIC rev 3.1 to ISIC rev. 3.1
	...
	replace industrycat_isic = 121 if rama4d == 121 | rama4d == 124 | rama4d == 129
	...
	replace industrycat_isic = 2511 if rama4d == 2511 | rama4d == 2512
	...
	replace industrycat_isic = 3430 if rama4d == 3420
	...
	replace industrycat_isic = 5151 if rama4d == 5163
	replace industrycat_isic = 5152 if rama4d == 5169
	...
	replace industrycat_isic = 5239 if rama4d == 5243 | rama4d == 5244 | rama4d == 5245 | rama4d == 5246 | rama4d == 5249
...
save "`path_output'\COL_2013_GEIH_V01_M_V01_A_GLD_ALL.dta", replace
