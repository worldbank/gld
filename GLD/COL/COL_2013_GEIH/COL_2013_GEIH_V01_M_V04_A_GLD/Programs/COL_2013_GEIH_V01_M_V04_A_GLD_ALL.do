...
<_Program name_>				COL_2013_GEIH_V01_M_V03_A_GLD_ALL
...
<_Data collection from_>			01/2013
...
<_Sample size (HH)_> 				228,944 </_Sample size (HH)_>
<_Sample size (IND)_> 				772,074 </_Sample size (IND)_>
...
clear all
use "`path_in_stata'\GEIH_2013_1.dta"

forvalues i=2/12 {
    append using "`path_in_stata'\GEIH_2013_`i'.dta", force
}
...
append using "`path_in_stata'\amazonia\GEIH_AMA_2013.dta"

***San andrés
append using "`path_in_stata'\SA_2013.dta"


tempfile general_2013
save `general_2013'
...
*save "`path_in'\migration_2013.dta", replace
tempfile migration_2013
save `migration_2013'

*full set
use "`general_2013'",clear
...
merge 1:1 directorio secuencia_p orden  using "`migration_2013'", assert(master match) nogen
...
save "`path_in_stata'\data_2013_final.dta", replace
*/

use "`path_in_stata'\data_2013_final.dta", clear
...
*<_int_year_>
	gen int_year = 2013 //instead of intv_year=ano
...
*<_subnatid2_>
	...
	replace subnatid2 = "85 - Casanare"                     if area == "85"
	replace subnatid2 = "86 - Putumayo"                     if area == "86"
	replace subnatid2 = "88 - San Andres"                if dpto == "88" 
	replace subnatid2 = "91 - Amazonas"                   if area == "91"
	replace subnatid2 = "94 - Guainia"                   if area == "94"
	replace subnatid2 = "95 - Guaviare"     if area == "95"
	replace subnatid2 = "97 - Vaupes"                      if area == "97"
	replace subnatid2 = "99 - Vichada"            if area == "99"
...
/*%%=============================================================================================
	5: Migration
==============================================================================================%%*/
*check about the usefullness of info about where people where born, were 5 years ago and 12 months ago.
{
...
*<_migrated_reason_>
	gen migrated_reason = p751
	recode migrated_reason 1=3 3/4=5
...
*<_vocational_field_orig_>
	...
	label var vocational_field_orig "Field of training original"
*</_vocational_field_orig_>
