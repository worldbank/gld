...
<_Program name_>				COL_2015_GEIH_V01_M_V03_A_GLD_ALL
...
* Date: 2022-16-04 - Changes from I2D2 to GLD
...
clear all
use "`path_in_stata'\GEIH_2015_1.dta"

forvalues i=2/12 {
    append using "`path_in_stata'\GEIH_2015_`i'.dta", force
}
...
append using "`path_in_stata'\amazonia\GEIH_AMA_2015.dta"

***San andrés
append using "`path_in_stata'\SA_2015.dta"
...
*save "`path_in'\migration_2015.dta", replace
tempfile migration_2015
save `migration_2015'

*full set
use "`general_2015'",clear
...
merge 1:1 directorio secuencia_p orden  using "`migration_2015'", assert(master match) nogen
...
save "`path_in_stata'\data_2015_final.dta", replace
*/

use "`path_in_stata'\data_2015_final.dta", clear
...
*<_int_year_>
	gen int_year = 2015 //instead of intv_year=ano
