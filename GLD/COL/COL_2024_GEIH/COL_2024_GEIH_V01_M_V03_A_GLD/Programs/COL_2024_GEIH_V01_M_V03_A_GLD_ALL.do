...
<_Program name_>				COL_2024_GLD_GEIH_V02 </_Program name_>
...
<_Sample size (HH)_> 				829,683 </_Sample size (HH)_>
<_Sample size (IND)_> 				290,968 </_Sample size (IND)_>
...
/*
clear all
use "`path_in_stata'\GEIH_2024_1.dta"

forvalues i=2/12 {
    append using "`path_in_stata'\GEIH_2024_`i'.dta", force
}

rename *, lower
drop _merge
save "`path_in_stata'\data_2024_final.dta", replace
*/

use "`path_in_stata'\data_2024_final.dta", clear
