...
<_Program name_>				COL_2019_GEIH_V01_M_V03_A_GLD_ALL
...
<_Data collection from_>			01/2019
...
<_Sample size (HH)_> 				231,831</_Sample size (HH)_>
...
clear all
use "`path_in_stata'\GEIH_2019_1.dta"

forvalues i=2/12 {
    append using "`path_in_stata'\GEIH_2019_`i'.dta", force
}
...
append using "`path_in_stata'\amazonia\amazonia_2019.dta", force

***San andrés
append using "`path_in_stata'\SA_2019.dta", force
...
save "`path_in_stata'\data_2019_final.dta", replace
*/

use "`path_in_stata'\data_2019_final.dta", clear
...
*<_int_year_>
	gen int_year = 2019 //instead of intv_year=ano
