...
clear all
use "`path_in'\GEIH_2016_1.dta"

forvalues i=2/12 {
    append using "`path_in'\GEIH_2016_`i'.dta", force
}
...
append using "`path_in'\amazonia\amazonia_2016.dta", force

***San andrés
append using "`path_in'\SA_2016.dta", force
...
save "`path_in'\data_2016_final.dta", replace
