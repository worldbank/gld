...
<_Program name_>				COL_2016_GEIH_V01_M_V03_A_GLD_ALL
...
<_Data collection from_>			01/2016
...
<_Sample size (HH)_> 				288,763 </_Sample size (HH)_>
<_Sample size (IND)_> 				701,013 </_Sample size (IND)_>
...
clear all
use "`path_in_stata'\GEIH_2016_1.dta"

forvalues i=2/12 {
    append using "`path_in_stata'\GEIH_2016_`i'.dta", force
}
...
append using "`path_in_stata'\amazonia\amazonia_2016.dta", force

***San andrés
append using "`path_in_stata'\SA_2016.dta", force


tempfile general_2016
save `general_2016'
...
*save "`path_in'\migration_2016.dta", replace
tempfile migration_2016
save `migration_2016'

*full set
use "`general_2016'",clear
...
merge 1:1 directorio secuencia_p orden  using "`migration_2016'", assert(master match) nogen
...
save "`path_in_stata'\data_2016_final.dta", replace
*/

use "`path_in_stata'\data_2016_final.dta", clear
...
local letters "mes"
	...
	*gen helper_d=string(directorio,"%07.0f")
	egen hhid = concat(directorio secuencia_p helper_mes)
	drop helper_*
