...
** DATABASE ASSEMBLENT
/*
use "`path_in_stata'/ECH_2003_1.dta"

forvalues i=2/12 {
    append using "`path_in_stata'\ECH_2003_`i'.dta", force
}

save "`path_in_stata'/ECH_2003.dta", replace
*/

use "`path_in_stata'/ECH_2003.dta", clear
...
*<_wage_no_compen_>
	...
	replace wage_no_compen=. if valor28==99
	replace wage_no_compen=. if valor28==98
