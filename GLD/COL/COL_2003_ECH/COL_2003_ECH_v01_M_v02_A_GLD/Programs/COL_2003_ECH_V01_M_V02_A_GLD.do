...
local path_output "Z:\GLD-Harmonization\582018_AQ\COL\COL_2003_ECH\COL_2003_ECH_v01_M_V02_A_GLD\Data\Harmonized"

*----------1.3: Database assembly------------------------------*

** DATABASE ASSEMBLENT

use "`path_in'/ECH_2003_1.dta"

forvalues i=2/12 {
    append using "`path_in'\ECH_2003_`i'.dta", force
}

save "`path_in'/ECH_2003.dta", replace
...
save "`path_output'/COL_2003_ECH_V01_M_V02_A_GLD_ALL.dta", replace
