...
<_Program name_>				COL_2023_GLD_GEIH_V02 </_Program name_>
...
<_Sample size (HH)_> 				860,802 </_Sample size (HH)_>
<_Sample size (IND)_> 				293,511 </_Sample size (IND)_>
...
/*
clear all
use "`path_in_stata'\GEIH_2023_1.dta"

forvalues i=2/12 {
    append using "`path_in_stata'\GEIH_2023_`i'.dta", force
}

rename *, lower
drop _merge
save "`path_in_stata'\data_2023_final.dta", replace
*/

use "`path_in_stata'\data_2023_final.dta", clear
