...
<_Program name_>				COL_2018_GEIH_V01_M_V03_A_GLD_ALL
...
clear all
use "`path_in_stata'\GEIH_2018_1.dta"

forvalues i=2/12 {
    append using "`path_in_stata'\GEIH_2018_`i'.dta", force
}
...
append using "`path_in_stata'\amazonia\amazonia_2018.dta", force

***San andrés
append using "`path_in_stata'\SA_2018.dta", force
...
save "`path_in_stata'\data_2018_final.dta", replace
*/

use "`path_in_stata'\data_2018_final.dta", clear
