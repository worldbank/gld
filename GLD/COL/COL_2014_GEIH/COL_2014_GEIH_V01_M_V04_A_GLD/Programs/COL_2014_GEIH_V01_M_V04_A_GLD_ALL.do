...
<_Program name_>				COL_2014_GEIH_V01_M_V03_A_GLD_ALL
...
clear all
use "`path_in_stata'\GEIH_2014_1.dta"

forvalues i=2/12 {
    append using "`path_in_stata'\GEIH_2014_`i'.dta", force
}
...
append using "`path_in_stata'\amazonia\GEIH_AMA_2014.dta"

***San andrés
append using "`path_in_stata'\SA_2014.dta"

tempfile general_2014
save `general_2014'
...
*save "`path_in'\migration_2014.dta", replace
tempfile migration_2014
save `migration_2014'

*full set
use "`general_2014'",clear
...
merge 1:1 directorio secuencia_p orden  using "`migration_2014'", assert(master match) nogen
...
save "`path_in_stata'\data_2014_final.dta", replace
*/

use "`path_in_stata'\data_2014_final.dta", clear
