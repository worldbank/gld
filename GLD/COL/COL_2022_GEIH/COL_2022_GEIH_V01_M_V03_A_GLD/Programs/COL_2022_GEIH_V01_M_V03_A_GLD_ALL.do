...
<_Program name_>				COL_2022_GLD_GEIH_V02 </_Program name_>
...
<_Country_>					COL </_Country_>
<_Survey Title_>				Gran Encuesta Integrada de Hogares - GEIH </_Survey Title_>
...
<_Source of dataset_> 				Departamento Administrativo Nacional de Estadistica - DANE </_Source of dataset_>
<_Sample size (HH)_> 				919,459 </_Sample size (HH)_>
<_Sample size (IND)_> 				304,459 </_Sample size (IND)_>
...
* Date: 2025-12-16 - Changes to subnatid variables
* Date: 2026-06-22 - Change icls_v and empstat
...
clear all
use "`path_in_stata'\GEIH_2022_1.dta"

forvalues i=2/12 {
    append using "`path_in_stata'\GEIH_2022_`i'.dta", force
}

rename *, lower
drop _merge
save "`path_in_stata'\data_2022_final.dta", replace
*/

use "`path_in_stata'\data_2022_final.dta", clear

drop mes 
gen periodo_str = string(periodo, "%08.0f")
gen mes_str = substr(periodo_str, 5, 2)
gen mes = real(mes_str)
...
*/
	* Identificación de hogar 
rename id id_geih
sort directorio secuencia_p mes
egen id = group(directorio secuencia_p mes)

local vars "directorio secuencia_p mes"     
if "`vars'"!="" {
	gen hhid = ""
	local zero "0"
...
*<_subnatid1_>
	...
	replace subnatid1 = "1 - Caribe" if subnatid1 == "8" | subnatid1 == "13" | subnatid1 == "20" | subnatid1 == "23" | subnatid1 == "44" | subnatid1 == "47" | subnatid1 == "70"
	
	replace subnatid1 = "2 - Oriental" if subnatid1 == "15" | subnatid1 == "25" | subnatid1 == "50" | subnatid1 == "54" | subnatid1 == "68"
	
	replace subnatid1 = "3 - Central" if subnatid1 == "5" | subnatid1== "17" | subnatid1 == "18" | subnatid1 == "41" | subnatid1 == "63" | subnatid1 == "66"  | subnatid1 == "73"
	...
	replace subnatid1 = "6 - Aamazonia y Orinoquia" if subnatid1 == "81" | subnatid1 == "85" | subnatid1 == "86"  | subnatid1 == "91" | subnatid1 == "94" | subnatid1 == "95" | subnatid1 == "97" | subnatid1 == "99"
	
	replace subnatid1= "7 - San Andrés" if subnatid1 == "88"
...
*<_subnatid2_>
	...
	replace subnatid2 = "81 - Arauca" if subnatid2 == "81" //reg orinoquía
	replace subnatid2 = "85 - Casanare" if subnatid2 == "85" //reg orinoquía
	replace subnatid2 = "86 - Putumayo" if subnatid2 == "86" //reg amazónica
	replace subnatid2 = "88 - San Andres" if subnatid2 == "88" //reg insular
	replace subnatid2 = "91 - Amazonas" if subnatid2 == "91" //reg amazónica
	replace subnatid2 = "94 - Guainia" if subnatid2 == "94" // reg amazónica
	replace subnatid2 = "95 - Guaviare" if subnatid2 == "95" // reg amazónica
	replace subnatid2 = "97 - Vaupes" if subnatid2 == "97" // reg amazónica
	replace subnatid2 = "99 - Vichada" if subnatid2 == "99" //reg orinoquía
...
*<_subnatid3_>
	gen str subnatid3 = ""
	replace subnatid3 = "005 - Medellin - Valle de Aburra"                if area == "05"
	replace subnatid3 = "008 - Barranquilla - Soledad"                    if area == "08"
	replace subnatid3 = "011 - Bogota D.C."                               if area == "11"
	replace subnatid3 = "013 - Cartagena"                                 if area == "13"
	replace subnatid3 = "015 - Tunja"                                     if area == "15"
	replace subnatid3 = "017 - Manizales - Villamaria"                    if area == "17"
	replace subnatid3 = "018 - Florencia"                                 if area == "18"
	replace subnatid3 = "019 - Popayan"                                   if area == "19"
	replace subnatid3 = "020 - Valledupar"                                if area == "20"
	replace subnatid3 = "023 - Monteria"                                  if area == "23"
	replace subnatid3 = "027 - Quibdo"                                    if area == "27"
	replace subnatid3 = "041 - Neiva"                                     if area == "41"
	replace subnatid3 = "044 - Riohacha"                                  if area == "44"
	replace subnatid3 = "047 - Santa Marta"                               if area == "47"
	replace subnatid3 = "050 - Villavicencio"                             if area == "50"
	replace subnatid3 = "052 - Pasto"                                     if area == "52"
	replace subnatid3 = "054 - Cucuta - Area Metropolitana"               if area == "54"
	replace subnatid3 = "063 - Armenia"                                   if area == "63"
	replace subnatid3 = "066 - Pereira - Dosquebradas - La Virginia"      if area == "66"
	replace subnatid3 = "068 - Bucaramanga - Area Metropolitana"          if area == "68"
	replace subnatid3 = "070 - Sincelejo"                                 if area == "70"
	replace subnatid3 = "073 - Ibague"                                    if area == "73"
	replace subnatid3 = "076 - Cali - Yumbo"                              if area == "76"
	replace subnatid3 = "081 - Arauca"                    if area == "81"
	replace subnatid3 = "085 - Yopal"                     if area == "85"
	replace subnatid3 = "086 - Mocoa"                     if area == "86"
	replace subnatid3 = "088 - San Andres"                if area == "88" 
	replace subnatid3 = "091 - Leticia"                   if area == "91"
	replace subnatid3 = "094 - Inirida"                   if area == "94"
	replace subnatid3 = "095 - San Jose del Guaviare"     if area == "95"
	replace subnatid3 = "097 - Mitu"                      if area == "97"
	replace subnatid3 = "099 - Puerto Carreno"            if area == "99"
...
/* <_subnatidsurvey_note>
	...
	*egen subnatidsurvey = concat(subnatid2 urban), p(" ")
	gen subnatidsurvey = ""
	replace subnatidsurvey = subnatid3 if !missing(subnatid3)
	replace subnatidsurvey = subnatid2 if missing(subnatidsurvey) //other
...
/* <_subnatid1_prev_note>
	...
	gen subnatid1_prev_aux =string(dpto)
	gen subnatid1_prev = ""
	replace subnatid1_prev = "1 - Atlantica" if subnatid1_prev_aux == "8" | subnatid1_prev_aux == "13" | subnatid1_prev_aux == "20" | subnatid1_prev_aux == "23" | subnatid1_prev_aux == "44" | subnatid1_prev_aux == "47" | subnatid1_prev_aux == "70"
	replace subnatid1_prev = "2 - Oriental" if subnatid1_prev_aux == "15" | subnatid1_prev_aux == "25" | subnatid1_prev_aux == "50" | subnatid1_prev_aux == "54" | subnatid1_prev_aux == "68"
	replace subnatid1_prev = "3 - Central" if subnatid1_prev_aux == "5" | subnatid1_prev_aux== "17" | subnatid1_prev_aux == "18" | subnatid1_prev_aux == "41" | subnatid1_prev_aux == "63" | subnatid1_prev_aux == "66" | subnatid1_prev_aux == "66" | subnatid1_prev_aux == "73"
	replace subnatid1_prev = "4 - Pacifica" if subnatid1_prev_aux == "19" | subnatid1_prev_aux == "27" | subnatid1_prev_aux == "52" | subnatid1_prev_aux == "76"
	replace subnatid1_prev_aux = "5 - Santa Fe de Bogota" if subnatid1_prev_aux == "11"
...
*<_subnatid2_prev_>
	gen subnatid2_prev = ""
	gen subnatid2_prev_aux = string(dpto)
	replace subnatid2_prev = "5 - Antioquia" if subnatid2_prev_aux == "5"
	replace subnatid2_prev = "8 - Atlántico" if subnatid2_prev_aux == "8"
	replace subnatid2_prev = "11 - Bogotá, D.C." if subnatid2_prev_aux == "11"
	replace subnatid2_prev = "13 - Bolívar" if subnatid2_prev_aux == "13"
	replace subnatid2_prev = "15 - Boyacá" if subnatid2_prev_aux == "15"
	replace subnatid2_prev = "17 - Caldas" if subnatid2_prev_aux == "17"
	replace subnatid2_prev = "18 - Caquetá" if subnatid2_prev_aux == "18"
	replace subnatid2_prev = "19 - Cauca" if subnatid2_prev_aux == "19"
	replace subnatid2_prev = "20 - Cesar" if subnatid2_prev_aux == "20"
	replace subnatid2_prev = "23 - Córdoba" if subnatid2_prev_aux == "23"
	replace subnatid2_prev = "25 - Cundinamarca" if subnatid2_prev_aux == "25"
	replace subnatid2_prev = "27 - Chocó" if subnatid2_prev_aux == "27"
	replace subnatid2_prev = "41 - Huila" if subnatid2_prev_aux == "41"
	replace subnatid2_prev = "44 - La Guajira" if subnatid2_prev_aux == "44"
	replace subnatid2_prev = "47 - Magdalena" if subnatid2_prev_aux == "47"
	replace subnatid2_prev = "50 - Meta" if subnatid2_prev_aux == "50"
	replace subnatid2_prev = "52 - Nariño" if subnatid2_prev_aux == "52"
	replace subnatid2_prev = "54 - Norte de Santander" if subnatid2_prev_aux == "54"
	replace subnatid2_prev = "63 - Quindío" if subnatid2_prev_aux == "63"
	replace subnatid2_prev = "66 - Risaralda" if subnatid2_prev_aux == "66"
	replace subnatid2_prev = "68 - Santander" if subnatid2_prev_aux == "68"
	replace subnatid2_prev = "70 - Sucre" if subnatid2_prev_aux == "70"
	replace subnatid2_prev = "73 - Tolima" if subnatid2_prev_aux == "73"
	replace subnatid2_prev = "76 - Valle del Cauca" if subnatid2_prev_aux == "76"
...
*<_hsize_>
	gen a=1 if (p6050!=11 & p6050!=12 & p6050!=13)  //instead of gen a=1 of p6050!=6 (taking out pensionista, trabajador and Otro no pariente)
...
*<_relationharm_>
	...
	recode relationharm (6 7 8 9 = 5) (10 11 12 13 = 6) //added
...
*<_eye_dsablty_>
	gen eye_dsablty = p1906s3
	replace eye_dsablty = 5 - eye_dsablty
...
*<_hear_dsablty_>
	gen hear_dsablty = p1906s1
	replace hear_dsablty = 5 - hear_dsablty
...
*<_walk_dsablty_>
	gen walk_dsablty = p1906s4
	replace walk_dsablty = 5 - walk_dsablty
	label define dsablty 1 "No – no difficulty" 2 "Yes – some difficulty" 3 "Yes – a lot of difficulty" 4 "Cannot do at all", replace
...
*<_conc_dsord_>
	gen conc_dsord = p1906s6
	replace conc_dsord = 5 - conc_dsord
	label define dsablty 1 "No – no difficulty" 2 "Yes – some difficulty" 3 "Yes – a lot of difficulty" 4 "Cannot do at all", replace
...
*<_slfcre_dsablty_>
	gen slfcre_dsablty  = p1906s7
	replace slfcre_dsablty = 5 - slfcre_dsablty
	label define dsablty 1 "No – no difficulty" 2 "Yes – some difficulty" 3 "Yes – a lot of difficulty" 4 "Cannot do at all", replace
...
*<_comm_dsablty_>
	gen comm_dsablty = p1906s2
	replace comm_dsablty = 5 - comm_dsablty
	label define dsablty 1 "No – no difficulty" 2 "Yes – some difficulty" 3 "Yes – a lot of difficulty" 4 "Cannot do at all", replace
...
*<_migrated_from_urban_>
	gen migrated_from_urban = p3383 if migrated_binary
...
*<_migrated_from_cat_>
	...
	destring p3382s1, replace
	gen subnatid1_mig =string(p3382s1)
	replace subnatid1_mig = "1 - Caribe" if subnatid1_mig == "8" | subnatid1_mig == "13" | subnatid1_mig == "20" | subnatid1_mig == "23" | subnatid1_mig == "44" | subnatid1_mig == "47" | subnatid1_mig == "70"
	
	replace subnatid1_mig = "2 - Oriental" if subnatid1_mig == "15" | subnatid1_mig == "25" | subnatid1_mig == "50" | subnatid1_mig == "54" | subnatid1_mig == "68"
	
	replace subnatid1_mig = "3 - Central" if subnatid1_mig == "5" | subnatid1_mig== "17" | subnatid1_mig == "18" | subnatid1_mig == "41" | subnatid1_mig == "63" | subnatid1_mig == "66"  | subnatid1_mig == "73"
	
	replace subnatid1_mig = "4 - Pacifica" if subnatid1_mig == "19" | subnatid1_mig == "27" | subnatid1_mig == "52" | subnatid1_mig == "76"
	
	replace subnatid1_mig = "5 - Bogota DC" if subnatid1_mig == "11"
	
	replace subnatid1_mig = "6 - Orinoquia, Amazonia e Insular" if subnatid1_mig == "81" | subnatid1_mig == "85" | subnatid1_mig == "86" | subnatid1_mig == "88" | subnatid1_mig == "91" | subnatid1_mig == "94" | subnatid1_mig == "95" | subnatid1_mig == "97" | subnatid1_mig == "99"
	
	
	replace migrated_from_cat = 5 if p3382 == 4 
	replace migrated_from_cat = 4 if subnatid1_mig != subnatid1 & missing(migrated_from_cat)
	replace migrated_from_cat = 3 if subnatid1_mig == subnatid1 & dpto != p3382s1 & missing(migrated_from_cat)
	replace migrated_from_cat = 2 if dpto == p3382s1 & missing(migrated_from_cat)
...
*<_migrated_from_code_>
	...
	replace migrated_from_code = subnatid1_mig if migrated_from_cat == 4
	
	gen subnatid2_mig = string(p3382s1)
	replace subnatid2_mig = "5 - Antioquia" if subnatid2_mig == "5"
	replace subnatid2_mig = "8 - Atlántico" if subnatid2_mig == "8"
	replace subnatid2_mig = "11 - Bogotá, D.C." if subnatid2_mig == "11"
	replace subnatid2_mig = "13 - Bolívar" if subnatid2_mig == "13"
	replace subnatid2_mig = "15 - Boyacá" if subnatid2_mig == "15"
	replace subnatid2_mig = "17 - Caldas" if subnatid2_mig == "17"
	replace subnatid2_mig = "18 - Caquetá" if subnatid2_mig == "18"
	replace subnatid2_mig = "19 - Cauca" if subnatid2_mig == "19"
	replace subnatid2_mig = "20 - Cesar" if subnatid2_mig == "20"
	replace subnatid2_mig = "23 - Córdoba" if subnatid2_mig == "23"
	replace subnatid2_mig = "25 - Cundinamarca" if subnatid2_mig == "25"
	replace subnatid2_mig = "27 - Chocó" if subnatid2_mig == "27"
	replace subnatid2_mig = "41 - Huila" if subnatid2_mig == "41"
	replace subnatid2_mig = "44 - La Guajira" if subnatid2_mig == "44"
	replace subnatid2_mig = "47 - Magdalena" if subnatid2_mig == "47"
	replace subnatid2_mig = "50 - Meta" if subnatid2_mig == "50"
	replace subnatid2_mig = "52 - Nariño" if subnatid2_mig == "52"
	replace subnatid2_mig = "54 - Norte de Santander" if subnatid2_mig == "54"
	replace subnatid2_mig = "63 - Quindío" if subnatid2_mig == "63"
	replace subnatid2_mig = "66 - Risaralda" if subnatid2_mig == "66"
	replace subnatid2_mig = "68 - Santander" if subnatid2_mig == "68"
	replace subnatid2_mig = "70 - Sucre" if subnatid2_mig == "70"
	replace subnatid2_mig = "73 - Tolima" if subnatid2_mig == "73"
	replace subnatid2_mig = "76 - Valle del Cauca" if subnatid2_mig == "76"
	replace subnatid2_mig = "81 - Arauca" if subnatid2_mig == "81" //reg orinoquía
	replace subnatid2_mig = "85 - Casanare" if subnatid2_mig == "85" //reg orinoquía
	replace subnatid2_mig = "86 - Putumayo" if subnatid2_mig == "86" //reg amazónica
	replace subnatid2_mig = "88 - San Andrés y Providencia" if subnatid2_mig == "88" //reg insular
	replace subnatid2_mig = "91 - Amazonas" if subnatid2_mig == "91" //reg amazónica
	replace subnatid2_mig = "94 - Guainía" if subnatid2_mig == "94" // reg amazónica
	replace subnatid2_mig = "95 - Guaviare" if subnatid2_mig == "95" // reg amazónica
	replace subnatid2_mig = "97 - Vaupes" if subnatid2_mig == "97" // reg amazónica
	replace subnatid2_mig = "99 - Vichada" if subnatid2_mig == "99" //reg orinoquía
	
	replace migrated_from_code = subnatid2_mig if migrated_from_cat == 3
...
*<_migrated_from_country_>
	merge m:1 p3382s3 using "`path_in_stata'\migration\mig_countries.dta", keep(1 3) nogenerate
	gen migrated_from_country = mig_iso3_country
	replace migrated_from_country = "" if migrated_binary != 1 | migrated_from_cat != 5
...
/* <_educy_note>
	...
	gen byte educy = .
	replace educy = 0 if inlist(p3042,1,2) | (p3042 == 3 & p3042s1 == 0)
	replace educy = p3042s1 if (p3042 == 3 & inlist(p3042s1,1,2,3,4,5))
	replace educy = 5 + p3042s1 if p3042 == 4
	replace educy = 9 + p3042s1 if inlist(p3042,5,6)
	replace educy = 11 if p3042 == 7 & inlist(p3042s1,0,1)
	replace educy = 12 if p3042 == 7 & inlist(p3042s1,2,3)
	replace educy = 13 if p3042 == 7 & inlist(p3042s1,4,5)
	
	replace educy = 11 if p3042 == 8 & inrange(p3042s1,0,1)
	replace educy = 12 if p3042 == 8 & inrange(p3042s1,2,3)
	replace educy = 13 if p3042 == 8 & inrange(p3042s1,4,12)
	
	replace educy = 11 if p3042 == 9 & inrange(p3042s1,0,1)
	replace educy = 12 if p3042 == 9 & inrange(p3042s1,2,3)
	replace educy = 13 if p3042 == 9 & inrange(p3042s1,4,5)
	replace educy = 14 if p3042 == 9 & inrange(p3042s1,4,12)
	
	replace educy = 11 if p3042 == 10 & inrange(p3042s1,0,1)
	replace educy = 12 if p3042 == 10 & inrange(p3042s1,2,3)
	replace educy = 13 if p3042 == 10 & inrange(p3042s1,4,5)
	replace educy = 14 if p3042 == 10 & inrange(p3042s1,6,7)
	replace educy = 15 if p3042 == 10 & inrange(p3042s1,8,9)
	replace educy = 16 if p3042 == 10 & inrange(p3042s1,10,28)
	
	replace educy = 17 if p3042 == 11 
	replace educy = 18 if p3042 == 12
	replace educy = 21 if p3042 == 13
...
*<_educat7_>
	...
	replace educat7 = 2 if inrange(educy,1,4)
	replace educat7 = 3 if educy == 5 & p3042 == 3
	replace educat7 = 4 if p3042 == 4
	replace educat7 = 5 if inlist(p3042,5,6)
	replace educat7 = 6 if inlist(p3042,7,8,9)
	replace educat7 = 7 if inlist(p3042,10,11,12,13)
...
*<_educat_orig_>
	*Concat grade and level
	tostring p3042, gen(grade) format(%02.0f)
	tostring p3042s1, gen(level) format(%02.0f)
	egen educat_orig = concat(grade level), punct("-")
...
*<_educat_isced_>
	gen educat_isced = .
	replace educat_isced = 100 if inlist(educat7,2,3)
	replace educat_isced = 244 if educat7 == 4
	replace educat_isced = 344 if p3042 == 5
	replace educat_isced = 354 if p3042 == 6
	replace educat_isced = 444 if p3042 == 7
	replace educat_isced = 554 if inlist(p3042,8,9)
	replace educat_isced = 666 if p3042 == 10
	replace educat_isced = 767 if inlist(p3042,11,12)
...
*For unemployed and inactive that report some kind of labor earning on the last month
	...
	*lstatus_extra identifies unemployed and inactive that report labor earnings on the last month (sub-employment)
	gen lstatus_extra = p7422==1
	replace lstatus_extra =. if oci==1
	tab lstatus_extra
	tab lstatus_extra,m
	tab lstatus_extra dsi,m
	tab lstatus_extra lstatus if lstatus == 3,m
...
*<_underemployment_>
	gen byte underemployment = p6810 == 1
...
*<_unempldur_l_>
	gen byte unempldur_l=int(p7250/4.3)
...
*<_unempldur_u_>
	gen byte unempldur_u=int(p7250/4.3)
...
*<_industry_orig_>
	...
	replace industry_orig="" if rama4d_r4=="0000" | rama4d_r4=="0006" | rama4d_r4=="4747" | rama4d_r4=="5251"  | rama4d_r4=="7110" | rama4d_r4=="9710"  //not valid codes (there are a small proportion)
...
*<_industrycat_isic_>
	...
	*Adpted codes : https://clasificaciones.dane.gov.co/ciiu4-0/ciiu4_dispone
	...
	replace industrycat_isic = 2817 if rama4d_r4 == 2817
	...
	replace industrycat_isic = 4640 if rama4d_r4 == 4645
	...
	replace industrycat_isic = 4730 if rama4d_r4 == 4731 | rama4d_r4 == 4732
	...
	replace industrycat_isic = 4774 if rama4d_r4 == 4773 | rama4d_r4 == 4775
	...
	replace industrycat_isic = 4923 if rama4d_r4 == 4923
	...
	replace industrycat_isic = 5210 if rama4d_r4 == 5210
	...
	replace industrycat_isic = 8423 if rama4d_r4 == 8411 | rama4d_r4 == 8423 | rama4d_r4 == 8424
	...
	replace industrycat_isic = 8790 if rama4d_r4 == 8790
	...
	replace industrycat_isic = 9523 if rama4d_r4 == 9523
...
*<_occup_isco_>
* Note: Colombia uses and adaptation of ISCO-08, correlation with international version in: https://www.dane.gov.co/files/sen/nomenclatura/ciuo/CIUO_08_AC_2015_07_21.pdf  . see from page 322
	gen occup_isco = string(oficio_c8, "%04.0f")
	replace occup_isco = "" if occup_isco == "0000" | occup_isco == "." | lstatus != 1
	
	replace occup_isco = "7313" if inlist(occup_isco,"7361","7362","7363")
	replace occup_isco = "7317" if inlist(occup_isco,"7341","7342","7351","7352")
	replace occup_isco = "7318" if inlist(occup_isco,"7331","7332","7333","7370")
	replace occup_isco = "7319" if inlist(occup_isco,"7391","7392","7393","7399")
	replace occup_isco = "8322" if inlist(occup_isco,"8323","8324")
	replace occup_isco = "9623" if inlist(occup_isco,"9625","9626")
...
*<_occup_>
	* Note: Colombia uses and adaptation of ISCO-08
...
*<_whours_>
	gen whours = p6850 //last week
	replace whours = p6800 if inlist(p6850,0,.) //on average
...
/* <_wage_total_note>
	...
	*Replace wage for self-employed, employers, others
	...
	gen wage_total = wage_principal_2*wmonths
...
*<_firmsize_l_>
	gen byte firmsize_l = p3069
	recode firmsize_l 3=4 4=6 5=11 6=20 7=31 8=51 9=101 10=201
	label var firmsize_l "Firm size (lower bracket) primary job 7 day recall"
*</_firmsize_l_>


*<_firmsize_u_>
	gen byte firmsize_u= p3069
	recode firmsize_u 2=3 3=5 4=10 5=19 6=30 7=50 8=100 9=200 10=.
...
*<_ocusec_2_>
	gen byte ocusec_2 = p7050
	recode ocusec_2 2=1 1 3 4 5/9=2
	replace ocusec_2 = . if p7040 != 1 
...
*<_wage_no_compen_2_>
	...
	replace wage_no_compen_2 = . if p7040 != 1
...
*<_whours_2_>
	gen whours_2 = p7045 if p7040 == 1 & !inlist(p7045,.,0)
...
*<_firmsize_l_2_>
	...
	recode firmsize_l_2 3=6 4=11
	label var firmsize_l_2 "Firm size (lower bracket) secondary job 7 day recall"
*</_firmsize_l_2_>


*<_firmsize_u_2_>
	gen firmsize_u_2 = p7075
	recode firmsize_u_2 2=5 3=10 4=.
...
*<_njobs_>
	gen njobs = 1 if lstatus == 1 & p7040 == 2
	replace njobs = 2 if lstatus == 1 & p7040 == 1
