...
<_Program name_>				COL_2025_GEIH_V01_M_V01_A_GLD</_Program name_>
<_Application_>					Stata 19 <_Application_>
<_Author(s)_>					World Bank Jobs Group (gld@worldbank.org) </_Author(s)_>
<_Date created_>				2026-06-16 </_Date created_>
...
<_Data collection from_>			[01/2025] </_Data collection from_>
<_Data collection to_>				[12/2025] </_Data collection to_>
<_Source of dataset_> 				Departamento Administrativo Nacional de Estadistica - DANE </_Source of dataset_>
<_Sample size (HH)_> 				292,942 </_Sample size (HH)_>
<_Sample size (IND)_> 				829,683 </_Sample size (IND)_>
...
/*
use "`path_in_stata'\GEIH_2025_1.dta"

forvalues i=2/12 {
    append using "`path_in_stata'\GEIH_2025_`i'.dta", force
}

rename *, lower
drop _merge
save "`path_in_stata'\data_2025_final.dta", replace
*/

/*
use "`path_in_stata'\TOTAL_25.dta", clear
rename *, lower
tostring mes , format(%02.0f) replace 
merge 1:1 directorio secuencia_p orden mes dpto using "`path_in_stata'\data_2025_final.dta", keep(1 3)
*/

use "`path_in_stata'\data_2025_final.dta", clear
...
*<_migrated_from_country_>
	...
	replace migrated_from_country = "ZWE" if p3382s3 == 716
...
*<_industrycat_isic_>
	...
	*Adpted codes : https://clasificaciones.dane.gov.co/ciiu4-0/ciiu4_dispone
	...
	replace industrycat_isic = 3211 if rama4d_r4 == 3211
	replace industrycat_isic = 3211 if rama4d_r4 == 3212
...
*<_occup_isco_>
* Note: Colombia uses and adaptation of ISCO-08, correlation in: https://www.dane.gov.co/files/sen/nomenclatura/ciuo/CIUO_08_AC_2015_07_21.pdf  . see from page 322
	...
	replace occup_isco = "" if inlist(occup_isco,"0612","5629") // 2 obs
