...
<_Program name_>				COL_2010_GLD_v01_M_V04_A_GLD_ALL
...
*** append monthly data
clear all
use "`path_in_stata'\GEIH_2010_1.dta"

forvalues i=2/12 {
    append using "`path_in_stata'\GEIH_2010_`i'.dta", force
}

drop _merge
rename *, lower
tempfile general_2010
save `general_2010'
...
rename *, lower
merge 1:1 directorio secuencia_p orden using "`general_2010'", force assert(master match) keep(match) nogen

save "`path_in_stata'\data_2010_final.dta", replace
*/

use "`path_in_stata'\data_2010_final.dta", clear
