...
<_Program name_>				COL_2011_GLD_v01_M_V04_A_GLD_ALL
...
<_Data collection from_>			01/2011
...
<_Sample size (HH)_> 				230,499 </_Sample size (HH)_>
<_Sample size (IND)_> 				827,522
...
<_Currency_> 				Pesos colombianos </_Currency_>
...
*** append monthly data
clear all
use "`path_in_stata'\GEIH_2011_1.dta"

forvalues i=2/12 {
    append using "`path_in_stata'\GEIH_2011_`i'.dta", force
}

drop _merge
rename *, lower
tempfile general_2011
save `general_2011'
...
rename *, lower
merge 1:1 directorio secuencia_p orden using "`general_2011'", force assert(master match) keep(match) nogen

save "`path_in_stata'\data_2011_final.dta", replace

*/

use "`path_in_stata'\data_2011_final.dta", clear
