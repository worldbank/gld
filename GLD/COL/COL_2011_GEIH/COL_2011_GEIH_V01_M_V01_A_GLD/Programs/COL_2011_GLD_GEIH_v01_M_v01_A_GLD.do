...
<_Program name_>				COL_2011_GLD_v01_M_v01_A_GLD_ALL
...
local path_in "Z:\GLD-Harmonization\582018_AQ\COL\COL_2011_GEIH\COL_2011_GEIH_v01_M\Data\Stata\" 
local path_output "Z:\GLD-Harmonization\582018_AQ\COL\COL_2011_GEIH\COL_2011_GEIH_v01_M_v01_A_GLD\Data\Harmonized\"
...
*** append monthly data
clear all
use "`path_in'\GEIH_2011_1.dta"

forvalues i=2/12 {
    append using "`path_in'\GEIH_2011_`i'.dta", force
}
keep if _merge==3
drop _merge
rename *, lower
save "`path_in'\GEIH_2011.dta", replace
...
rename *, lower
merge 1:m directorio secuencia_p orden using "`path_in'\GEIH_2011.dta", force
keep if _merge==3
drop _merge 

save "`path_in'\data_2011_final.dta", replace
...
*<_int_year_>
	gen int_year = 2011 //instead of intv_year=ano
