...
clear all
use "`path_in_stata'\GEIH_2021_1.dta"

forvalues i=2/12 {
    append using "`path_in_stata'\GEIH_2021_`i'.dta", force
}
...
save "`path_in_stata'\data_2021_final.dta", replace
*/
use "`path_in_stata'\data_2021_final.dta", clear
