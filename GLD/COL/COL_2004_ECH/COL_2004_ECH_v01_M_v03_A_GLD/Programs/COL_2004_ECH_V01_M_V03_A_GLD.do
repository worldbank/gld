...
local path_output "Z:\GLD-Harmonization\582018_AQ\COL\COL_2004_ECH\COL_2004_ECH_v01_M_V03_A_GLD\Data\Harmonized"

*----------1.3: Database assembly------------------------------*

** DATABASE ASSEMBLENT

use "`path_in'/ECH_2004_1.dta"

forvalues i=2/12 {
    append using "`path_in'\ECH_2004_`i'.dta", force
}

save "`path_in'/ECH_2004.dta", replace
...
save "`path_output'/COL_2004_ECH_V01_M_V03_A_GLD_ALL.dta", replace
