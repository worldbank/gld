...
<_Program name_>				BLZ_1993_LFS_V01_M_V01_A_GLD.do </_Program name_>
<_Application_>					STATA 17 <_Application_>
<_Author(s)_>					World Bank Jobs Group (gld@worldbank.org) </_Author(s)_>				  Sizhen Fang (sfang2@worldbank.org)
<_Date created_>				2026-05-01 </_Date created_>

-------------------------------------------------------------------------

<_Country_>						Belize (BLZ) </_Country_>
...
<_Sample size (HH)_> 			2,991 </_Sample size (HH)_>
<_Sample size (IND)_> 			14,122 </_Sample size (IND)_>
...
<_Currency_> 					Belize dollar (BZD) </_Currency_>

-----------------------------------------------------------------------


<_ICLS Version_>              13th ICLS </_ICLS Version_>
<_ISCED Version_>             ISCED 1997 </_ISCED Version_>
<_ISCO Version_>              ISCO-88 </_ISCO Version_>
<_OCCUP National_>            Following ISCO-88 </_OCCUP National_>
<_ISIC Version_>              ISIC Rev. 3 / BCEA </_ISIC Version_>
<_INDUS National_>            BCEA - Belize Classification of Economic Activities </_INDUS National_>
...
* harmonized output in a single file
	...
	use "`path_in_stata'\bel93_base.dta", clear
	rename qid id
	format id %15.0g
	rename p00 com
	sort id com

	merge id com using "`path_in_stata'\bel93_cedlas.dta"
	tab _merge
	rename id qid
	rename com p00
	drop _merge
...
/* <_hhid_note>
	...
	gen double hhid = qid
	tostring hhid, replace format(%15.0g)
	label var hhid "Household ID"
*</_hhid_>


*<_pid_>
	tostring(p00), replace
	gen pid = hhid+p00
	
	duplicates t pid, g(f) //14 dups dropped
	drop if f>0
...
/* <_subnatid1_note>
	...
	gen str subnatid1 = ""
	replace subnatid1 = "1 - Corozal"        if region == 1
	replace subnatid1 = "2 - Orange Walk"   if region == 2
	replace subnatid1 = "3 - Belize"     if region == 3
	replace subnatid1 = "4 - Cayo"  if region == 4
	replace subnatid1 = "5 - Stann-Creek"  if region == 5
	replace subnatid1 = "6 - Toledo"      if region == 6
...
*<_hsize_>
	gen z=1
	bys hhid: gen byte hsize=sum(z) if relacion==7
	label var hsize "Household size"

	gen h=(relacion==1)
	recode h 0=.
	bysort hhid: egen count=count(h)
	drop if count!=1
*</_hsize_>
...
*<_relationharm_>
	...
	recode relationharm 6=4 4 7=5 8=6 9=.
...
*<_educat7_>
	...
	replace educat7=7 if nivel==5 | nivel==6
...
*<_vocational_field_orig_>
	gen str vocational_field_orig = string(p10)
...
*<_ocusec_>
	gen byte ocusec = .
	replace ocusec=4 if empresa==3
	replace ocusec=2 if empresa!=3 & empresa!=.
...
*<_industry_orig_>
	gen industry_orig = p29a
	label var industry_orig "Original survey industry code, main job 7 day recall"
*</_industry_orig_>


*<_industrycat_isic_>
	gen industrycat_isic = string(p29a)
	replace industrycat_isic = "" if lstatus != 1
	replace industrycat_isic = "" if industrycat_isic == "." | industrycat_isic == "0"
...
*<_industrycat10_>
	...
	replace industrycat10=1 if sector1d==1 | sector1d==2
	replace industrycat10=2 if sector1d==3
	replace industrycat10=3 if sector1d==4 
	replace industrycat10=4 if sector1d==5
	replace industrycat10=5 if sector1d==6
	replace industrycat10=6 if sector1d==7 | sector1d==8
	replace industrycat10=7 if sector1d==9
	replace industrycat10=8 if sector1d==10 | sector1d==11
	replace industrycat10=9 if sector1d==12 | sector1d==13 | sector1d==14 | sector1d==15
	replace industrycat10=10 if sector1d==16 | sector1d==17
...
*<_occup_>
	gen byte occup = floor(p28a/1000)
	recode occup 0=10
...
*<_wage_no_compen_>
	gen double wage_no_compen = wage
	replace wage_no_compen = income if missing(wage)
...
/* <_unitwage_note>
	...
	gen byte unitwage=9 if lstatus==1 &!missing(wage)
	replace unitwage=5 if lstatus==1 & missing(wage) & !missing(income)
...
*<_firmsize_l_>
	gen firmsize_l = 1 if p27a == 1
	replace firmsize_l = 5 if p27a == 2
	replace firmsize_l = 10 if p27a == 3
	replace firmsize_l = 4 if p27a == 4
...
*<_firmsize_u_>
	gen firmsize_u = 4 if p27a == 1
	replace firmsize_u = 9 if p27a == 2
	replace firmsize_u = 19 if p27a == 3
...
{
*<_empstat_2_>
	gen byte empstat_2 = p26b
	recode empstat_2 1=3 2=4 3/5=1 6=2 9=.
...
*<_industrycat10_2_>
	gen byte industrycat10_2 = floor(p29b/100)
	recode industrycat10_2 2 5=1 10/14=2 15/37=3 40 41=4 45=5 50/55=6 60/64=7 65/74=8 75=9 80/99=10 0=.
...
*<_occup_2_>
	gen byte occup_2 = floor(p28b/1000)
	recode occup_2 0=10
