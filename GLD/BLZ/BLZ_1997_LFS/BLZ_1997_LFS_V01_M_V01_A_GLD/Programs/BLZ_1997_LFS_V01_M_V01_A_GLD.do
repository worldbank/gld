...
<_Program name_>				BLZ_1997_LFS_V01_M_V01_A_GLD.do </_Program name_>
...
<_Sample size (HH)_> 			3,175 </_Sample size (HH)_>
<_Sample size (IND)_> 			14,781 </_Sample size (IND)_>
...
* harmonized output in a single file
	...
	use "`path_in_stata'\bel97_base.dta", clear
	rename qid id
	format id %15.0g
	rename p00 com
	sort id com

	merge id com using "`path_in_stata'\bel97_cedlas.dta"
	tab _merge
	rename id qid
	rename com p00
	drop _merge
