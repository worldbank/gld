...
*NSO shared dataset. it contains weight variable employed by the official report
use "`path_in_stata'/SOM_LFS_2019_V1.dta", clear
rename birthdate B4A
rename age B4B
rename maritals B5
rename hh B2
rename goods E06B
...
rename end_time END_TIME
rename hh_no HH_NO
rename interview_date INTERVIEW_DATE
rename sampling_unit SAMPLING_UNIT
rename weight_final_pes2014_hh WEIGHT_FINAL_PES2014_HH
rename index1 n_persona

tempfile nso_dataset
save `nso_dataset'

*merge dataset with NSO shared dataset
use "`path_in_stata'/SOMLFS2019HH_ind.dta", clear

*Convert string to numeric if it is possible
ds
foreach var of varlist `r(varlist)' {
    capture confirm numeric variable `var'
    if _rc {
        gen double _num_`var' = real(`var')
        capture assert missing(`var') == missing(_num_`var') | `var' == string(_num_`var')
        if !_rc {
            drop `var'
...
merge 1:1 B4A B4B B5 B2 E06B E03B START_TIME END_TIME HH_NO INTERVIEW_DATE SAMPLING_UNIT WEIGHT_FINAL_PES2014_HH n_persona using `nso_dataset', keepusing(weight_final_pes2014_sex region district a8 eakey)
...
*<_int_month_>
	gen str8 date_str = string(INTERVIEW_DATE, "%08.0f")
	gen int_month = real(substr(date_str, 5, 2))
...
*<_pid_>
	tostring n_persona ,gen(n_person_str) format(%02.0f)
	egen pid = concat(hhid n_person_str)
	label var pid "Individual ID"
*</_pid_>


*<_weight_>
	gen weight = weight_final_pes2014_sex
...
*<_subnatid2_>
	egen subnatid2 = concat(district), punct(" - ")
	label var subnatid2 "Subnational ID at Second Administrative Level"
*</_subnatid2_>


*<_subnatid3_>
	encode a8, gen(a8_int)
	egen subnatid3 = concat(a8_int a8), punct(" - ")
...
*/
	...
	*(1) respondent originally coded `head'
	gen relationharm = B2
	recode relationharm (4 = 3) (6 8 = 5) (7 = 4) (9 = 6)
	...
	*If household has no head:
	...
	fre number_heads
		...
		--------------+--------------------------------------------
		Valid   0     |        230       0.84       0.84       0.84
				1     |      27181      99.16      99.16     100.00
				Total |      27411     100.00     100.00           
		-----------------------------------------------------------
	
	
	unique hhid if number_heads == 0
		Number of unique values of hhid is  39
		Number of records is  230

	There are 39 households (230 individuals) with no household head
	*/
...
*<_relationcs_>
	gen relationcs = ""
	replace relationcs = "Head"           if B2 == 1
	replace relationcs = "Spouse"         if B2 == 2
	replace relationcs = "Son"            if B2 == 3
	replace relationcs = "Daughter"       if B2 == 4
	replace relationcs = "Brother"        if B2 == 5
	replace relationcs = "Sister"         if B2 == 6
	replace relationcs = "Parent"         if B2 == 7
	replace relationcs = "Other Relative" if B2 == 8
	replace relationcs = "Not Related"    if B2 == 9
...
/*
1	Job transfer/arranged job
2	Looking for better agriculture land/grazing land
3	Business opportunity
4	Looking for paid work
5	Join spouse/marriage/family
6	Attending school
7	Natural disaster/insecurity
8	Death related/illness rellated
9	Others
*/
	gen migrated_reason = B19D
	recode migrated_reason (1 3 4 = 3) (2 = 5) (5 8 9 = 1) (6 = 2) (7 = 4)
...
*<_educy_>
	gen byte educy = .
	replace educy = 0 if B7 == 3
	replace educy = 2 if B8 == 1 // is attending grades 1-4, assume he is in grade 2 
	replace educy = 4 if B9 == 1
	replace educy = 6 if B8 == 2
	replace educy = 8 if B9 == 2
	replace educy = 10 if B8 == 3
	replace educy = 12 if B9 == 3
	replace educy = 13 if B8 == 4
	replace educy = 14 if B9 == 4
	replace educy = 14 if B8 == 5
	replace educy = 16 if B9 == 5
...
*<_educat7_>
	gen byte educat7 = .
	replace educat7 = 1 if B7 == 3
	replace educat7 = 2 if B8 == 1 & missing(educat7)
	replace educat7 = 3 if B9 == 1 & missing(educat7)
	replace educat7 = 4 if B8 == 2 | B9 == 2 & missing(educat7)
	replace educat7 = 5 if B8 == 3 | B9 == 3 & missing(educat7)
	replace educat7 = 5 if B8 == 4 | B9 == 4 & missing(educat7) // SECONDARY VOCATIONAL
	replace educat7 = 7 if B8 == 5 | B9 == 5 & missing(educat7)
...
*<_educat_orig_>
	...
	replace educat_orig = "Lower Primary (1-4) In Course" if B8 == 1
	replace educat_orig = "Upper Primary (5-8) In Course" if B8 == 2
	replace educat_orig = "Secondary In Course"           if B8 == 3
	replace educat_orig = "Vocational In Course"          if B8 == 4
	replace educat_orig = "University In Course"          if B8 == 5
	replace educat_orig = "Other In Course"               if B8 == 6
	
	replace educat_orig = "Lower Primary (1-4)"   if B9 == 1
	replace educat_orig = "Upper Primary (5-8)"   if B9 == 2
	replace educat_orig = "Secondary"             if B9 == 3
	replace educat_orig = "Vocational"            if B9 == 4
	replace educat_orig = "University"            if B9 == 5
	replace educat_orig = "Other"                 if B9 == 6
...
*<_vocational_type_>
	gen vocational_type = B15
	recode vocational_type (1 2 4 5 = 2) (3 = 1)
...
*<_vocational_length_l_>
	gen vocational_length_l = B13
	recode vocational_length_l (1 = .) (2 = 1) (4 = 6) (5 = 12) (6 = 3)
	label var vocational_length_l "Length of training in months, lower limit"
*</_vocational_length_l_>


*<_vocational_length_u_>
	gen vocational_length_u = B13
	recode vocational_length_u (1 6 = .) (2 = 3) (3 = 6) (4 = 12) (5 = 36)
...
*<_vocational_field_orig_>
	...
	replace vocational_field_orig = "Electrical"        if B12 == 1
	replace vocational_field_orig = "Plumbing"          if B12 == 2
	replace vocational_field_orig = "Carpentry"         if B12 == 3
	replace vocational_field_orig = "Auto Mechanic"     if B12 == 4
	replace vocational_field_orig = "Agricultural"      if B12 == 5
	replace vocational_field_orig = "Computer"          if B12 == 6
	replace vocational_field_orig = "Secretarial"       if B12 == 7
	replace vocational_field_orig = "Bookkeeping"       if B12 == 8
	replace vocational_field_orig = "Teacher training"  if B12 == 9
	replace vocational_field_orig = "Nursing"           if B12 == 10
	replace vocational_field_orig = "Tailoring"         if B12 == 11
	replace vocational_field_orig = "Pastry"            if B12 == 12
	replace vocational_field_orig = "Beauty Salon"      if B12 == 13
	replace vocational_field_orig = "Masonry"           if B12 == 14
	replace vocational_field_orig = "Other"             if B12 == 98
...
*<_lstatus_>
	...
	*employed
	replace lstatus = 1 if C01 == 1 | D02 == 3 | inlist(D03,1,2) | inlist(D04,1,2) | D05 == 1
	
	*unemployed
	gen active = (H01 == 1 | H02 == 1)
	gen passive = (H11 == 1 | H12 == 1)
	gen future_starter = (H09==4 & inlist(H10,1,2))
	replace lstatus = 2 if active == 1 & passive == 1 & missing(lstatus)
	replace lstatus = 2 if future_starter == 1 & passive == 1 & missing(lstatus)
...
*<_underemployment_>
	...
	replace underemployment = 1 if G15 == 1 & G16 == 1
...
*<_nlfreason_>
	gen nlfreason_aux = H14
	
	recode nlfreason_aux (3 6 7 = 5) (4 = 3) (5 = 4)
	
	gen nlfreason = .
	replace nlfreason = nlfreason_aux 
...
*<_empstat_>
	gen byte empstat = .
	replace empstat = 1 if E07 == 1
	replace empstat = 2 if inlist(E08,2,3) | inlist(E07,4,5)
	replace empstat = 3 if E09 == 1
	replace empstat = 4 if E09 == 2
...
*<_industry_orig_>
	gen industry_orig = string(E06B) if lstatus == 1
...
*<_industrycat_isic_>
	gen str4 industrycat_isic = string(E06B, "%02.0f") + "00"
...
*<_industrycat10_>
	gen byte industrycat10 = E06B if lstatus == 1
...
*<_occup_orig_>
	gen occup_orig = string(E03B) if lstatus == 1
...
*<_occup_isco_>
	gen str4 occup_isco = string(E03B, "%02.0f") + "00"
	replace occup_isco = "" if lstatus != 1
	replace occup_isco = "" if occup_isco == ".00"
	replace occup_isco = "0000" if occup_isco == "9700" //armed forces
	replace occup_isco = "9000" if occup_isco == "9800" //others
...
*<_wage_no_compen_>
	gen double wage_no_compen = E11B3 if lstatus == 1
...
/* <_unitwage_note>
	...
	gen byte unitwage = E11B4 if lstatus == 1
	recode unitwage (1 = 9) (2 = 1) (3 = 2) (4 = 5) (5 6 7 = 10)
...
*<_whours_>
	gen whours = G07 if lstatus == 1 & inrange(G07,1,168)
	replace whours = G01 if lstatus == 1 & inrange(G01,0,168) & missing(whours)
...
*<_contract_>
	gen byte contract = E11C if lstatus == 1
	recode contract (2 = 0) (3 = .)
...
*<_firmsize_l_>
	gen firmsize_l = E12B if lstatus == 1
...
*<_firmsize_u_>
	gen firmsize_u = E12B if lstatus == 1
...
{
*<_empstat_2_>
	gen byte empstat_2 = . //only 14 obs
	tab F04
	replace empstat_2 = 1 if F04 == 1
	replace empstat_2 = 2 if inlist(F04,3,4,5)
	replace empstat_2 = 3 if inlist(F05,1)
	replace empstat_2 = 4 if inlist(F05,2)
...
*<_industry_orig_2_>
	gen industry_orig_2 = string(F03B)
...
*<_industrycat_isic_2_>
	gen str4 industrycat_isic_2 = string(F03B, "%02.0f") + "00"
...
*<_occup_isco_2_>
	gen str4 occup_isco_2 = string(F02B, "%02.0f") + "00"
	replace occup_isco_2 = "" if occup_isco_2 == ".00"
	replace occup_isco_2 = "0000" if occup_isco_2 == "9700" //armed forces
	replace occup_isco_2 = "" if occup_isco_2 == "9800" //others
...
*<_occup_2_>
	...
	recode occup_2 (0 = 10)
	replace occup_2 = 99 if F02B == 98 // others
...
*<_whours_2_>
	gen whours_2 = G09 if empstat_2 != . & inrange(G09,1,998)
	replace whours_2 = G10 if empstat_2 != . & inrange(G09,1,998) & missing(whours_2)
