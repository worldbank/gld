...
<_Program name_>				[KEN_2019_KCHSP_V01_M_V01_A_GLD] </_Program name_>
...
<_Sample size (HH)_> 				[20,691] </_Sample size (HH)_>
<_Sample size (IND)_> 				[86,647] </_Sample size (IND)_>
...
local path_in "Z:\GLD-Harmonization\582018_AQ\KEN\KEN_2019_KCHSP\KEN_2019_KCHSP_v01_M\Data\Stata"
local path_output "Z:\GLD-Harmonization\582018_AQ\KEN\KEN_2019_KCHSP\KEN_2019_KCHSP_v01_M_v01_A_GLD\Data\Harmonized\"
...
use "`path_in'\2019_KCHSP_individual_level.dta"
merge m:1 hhid quarter clid using "`path_in'\2019 KCHSP_household_level.dta", force assert(master match) 
...
/* <_hhid_note>
	...
	tostring quarter, gen(qrt_str) format (%01.0f)
	drop hhid
...
*<_pid_>
	tostring hhid_id, gen(b_str) format (%02.0f)
...
*<_migrated_years_>
	gen migrated_years = round(2019-b12_year)
...
*<_migrated_reason_>
	...
	recode migrated_reason 1/3=3 4=5 5/6=1 7=2 8/9=5 10=5 11=4 96=5
...
*<_empstat_2_>
	...
	*jua cali (traders)
	replace empstat_2=4 if d13_helper==1
...
save "`path_output'\KEN_2019_KCHSP_V01_M_V01_A_GLD_ALL.dta", replace 
