...
/* -----------------------------------------------------------------------
<_Program name_>				IDN_2014_Sakernas_v01_M_v01_A_GLD.do </_Program name_>
...
year 1995 and 2014 and East Timor is the only province missing among the 27
provinces.
...
According to isced-2014 mappings, there are day care centre, playgroup, and
...
Note that although in 2014, variable b4r11a is not explicitly labeled as "average"
...
save "`output'\IDN_2014_QLFS_v01_M_v01_A_GLD_ALL.dta", replace
