...
/* -----------------------------------------------------------------------
<_Program name_>				IDN_2002_Sakernas_v01_M_v03_A_GLD.do </_Program name_>
...
* Date: [2022-08-23] File: [As in Program name above] -[Recode employment status:Agricultural & non-agricultual casual worker recoded to "paid employee"; recode "occup_skill" and "occup"; change path to the intermediate file] 
...
*<_industry_orig_>
	...
	replace industry_orig = int(b4cr7/100) if b4cr7>9999
	replace industry_orig = int(b4cr7/10) if industry_orig>999
...
*<_occup_orig_>
	...
	replace occup_orig = int(b4cr8/10) if b4cr8>999
...
save "`output'\IDN_2002_SAKERNAS_v01_M_v03_A_GLD_ALL.dta", replace
