...
<_ISCED Version_>				ISCED-2002 </_ISCED Version_>
...
*<_subnatid2_>
	...
	merge n:1 b1r2 using "`gld'\Work\district_list_2013.dta"
	drop if _merge==2
...
The original industrial classification used in 2002, "b4p7", is KBLI 2000 which is based on ISIC Rev.3 .
...
Similarly here, the original occupational classification used in 2002, "b4cr8", is KBJI 1982 which is based on ISCO 1968.
