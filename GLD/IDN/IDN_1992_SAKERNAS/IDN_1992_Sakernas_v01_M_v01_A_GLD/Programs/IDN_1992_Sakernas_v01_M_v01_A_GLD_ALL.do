...
/* -----------------------------------------------------------------------
<_Program name_>				IDN_1992_Sakernas_v01_M_v01_A_GLD.do </_Program name_>
...
<_Sample size (HH)_> 			78,162 </_Sample size (HH)_>
...
* harmonized output in a single file
	...
	use "`input'\sakernas92.dta", clear
...
Note that 174,140 observations' or 46,651 households' number of household member do
...
------------+-----------------------------------
          0 |    108,402       38.37       38.37
          1 |    174,140       61.63      100.00
------------+-----------------------------------
...
hhsize_larg |
         er |      Freq.     Percent        Cum.
------------+-----------------------------------
          0 |    151,613       53.66       53.66
          1 |     22,527        7.97       61.63
          . |    108,402       38.37      100.00
------------+-----------------------------------
      Total |    282,542      100.00
...
-----------+-------------------------------------------------------+----------
       Yes |         0      4,703     11,933          0      2,556 |    19,192
        No |         0     61,617     44,317      5,993     19,448 |   131,375
         . |   131,953         15          5          1          1 |   131,975
-----------+-------------------------------------------------------+----------
     Total |   131,953     66,335     56,255      5,994     22,005 |   282,542
...
-----------+---------------------------------+----------
       Yes |         0          0     19,192 |    19,192
        No |     2,887    128,488          0 |   131,375
         . |         0          0    131,975 |   131,975
-----------+---------------------------------+----------
     Total |     2,887    128,488    151,167 |   282,542
...
most time in the past |        the past one week
             one week |       Yes         No          . |     Total
----------------------+---------------------------------+----------
                 Work |         0          0    131,953 |   131,953
        Attend school |        58     61,559      4,718 |    66,335
         Housekeeping |     1,225     43,092     11,938 |    56,255
Unable to do activiti |         0      5,993          1 |     5,994
               Others |     1,604     17,844      2,557 |    22,005
----------------------+---------------------------------+----------
                Total |     2,887    128,488    151,167 |   282,542
...
-----------+----------------------+----------
       Yes |         0     54,277 |    54,277
        No |         0    220,364 |   220,364
         9 |         0          3 |         3
         . |     7,898          0 |     7,898
-----------+----------------------+----------
     Total |     7,898    274,644 |   282,542
...
Note that in the raw dataset, the variable b4p12jh used for "whours" is not explicitly
...
hours of all jobs in the past 7 days varifies that b4p12jh refers to the past 7 days.

Although 55 observations have higher values of working hours of primary job,
...
save "`output'\IDN_1992_QLFS_v01_M_v01_A_GLD_ALL.dta", replace
