...
/* -----------------------------------------------------------------------
<_Program name_>				IDN_2001_Sakernas_v01_M_v01_A_GLD.do </_Program name_>
<_Application_>					Stata MP 16.1 <_Application_>
<_Author(s)_>					Wolrd Bank Job's Group </_Author(s)_>
<_Date created_>				2021-08-05 </_Date created_>
-------------------------------------------------------------------------
...
* harmonized output in a single file
	...
	use "`input'\sakernas01.dta", clear
...
Note that 63,160 observations' or 20,141 households' number of household member do
...
------------+-----------------------------------
          0 |     56,775       47.34       47.34
          1 |     63,160       52.66      100.00
------------+-----------------------------------
...
*<_hhid_>
	sort b1p01 b1p02 b1p05 b1p07 b1p10
	egen hhid=group(b1p01 b1p02 b1p05 b1p07 b1p10)
...
year 1995 and 2001 and East Timor is the only province missing among the 27
provinces.
...
Note that although in 2001, variable b4r11a is not explicitly labeled as "average"
...
save "`output'\IDN_2001_QLFS_v01_M_v01_A_GLD_ALL.dta", replace
