...
/* -----------------------------------------------------------------------
<_Program name_>				IDN_2004_Sakernas_v01_M_v01_A_GLD.do </_Program name_>
...
* harmonized output in a single file
	...
	use "`input'\sakernas04.dta", clear
...
Note that 134,627 observations' or 48,700  households' number of household member do
...
------------+-----------------------------------
          0 |     74,853       35.73       35.73
          1 |    134,627       64.27      100.00
------------+-----------------------------------
...
year 1995 and 2004 and East Timor is the only province missing among the 27
provinces.
...
Original code list of variable "b4p1a" (or "educ" which is the same) in the dataset:
...
Note that although in 2004, variable b4r11a is not explicitly labeled as "average"
...
save "`output'\IDN_2004_QLFS_v01_M_v01_A_GLD_ALL.dta", replace
