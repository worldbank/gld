...
/* -----------------------------------------------------------------------
<_Program name_>				IDN_2004_Sakernas_v01_M_v06_A_GLD.do </_Program name_>
...
* Date: [2023-04-06] File: [IDN_2004_Sakernas_v01_M_v06_A_GLD.do] - [Updated "occup" and helper data file; set employed and unemployed observations' non-labor force reason to missing; added variable "empstat"; set "wage_no_compen" to missing for unpaid workers and zero values.]
* Date: [2026-04-21] File: [IDN_2004_Sakernas_V01_M_V07_A_GLD.do] - [Revise "subnatidsurvey"; new template]
...
* Merge with 2 digit one by updating (same var that is missing in master will take using value)
	...
	tab b4p8 kji1982_2d if missing(option_1) [iw=weight], cell nofreq
