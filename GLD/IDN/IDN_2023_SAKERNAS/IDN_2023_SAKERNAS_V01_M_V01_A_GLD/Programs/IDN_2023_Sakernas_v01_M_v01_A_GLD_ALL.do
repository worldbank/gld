...
/* -----------------------------------------------------------------------
<_Program name_>				IDN_2023_Sakernas_v01_M_v01_A_GLD.do </_Program name_>
...
<_Study ID_>					IDN_2023_Sakernas_v01_M </_Study ID_>
...
* harmonized output in a single file
	...
	use "`path_in_stata'\sakernas23aug.dta", clear
...
*<_pid_>
	duplicates report rowindex	// rowindex is unique
	tostring rowindex, gen(pid) format(%07.0f)
...
*<_wage_no_compen_>
	gen wage_no_compen=r15_uang+r15_brg if empstat==1
