...
/* -----------------------------------------------------------------------
<_Program name_>				IDN_2000_Sakernas_v01_M_v06_A_GLD.do </_Program name_>
...
* Date: [2026-04-20] File: [IDN_2000_Sakernas_V01_M_V07_A_GLD.do] - [Revise "subnatidsurvey"; recode occup as missing; new template]
...
The distribution of occup in 2000 appears to be an outlier compared with the years before and after. This may be due to the occupation coding in 2000 being KBJI 2000 at the 3-digit level, whereas the surrounding years use the 1982 classification at the 1-digit level. To avoid potential inconsistencies or confusion across years, we set the occupation variable for 2000 to missing.
