...
/* -----------------------------------------------------------------------
<_Program name_>				IDN_2007_Sakernas_v01_M_v01_A_GLD.do </_Program name_>
...
* harmonized output in a single file
	...
	use "`input'\sakernas07aug.dta", clear
...
No original household size to doublecheck the hhid creation.

<_hhid_>*/


*<_hhid_>
	sort b1p01 b1p02 b1p03 b1p04 b1p05 b1p07 b1p10
	egen hhid=group(b1p01 b1p02 b1p03 b1p04 b1p05 b1p07 b1p10)
...
year 1995 and 2007 and East Timor is the only province missing among the 27
provinces.
...
Original code list of variable "b4p1a" in the dataset (in Indonesian):
...
Note that although in 2007, variable b4r11a is not explicitly labeled as "average"
...
save "`output'\IDN_2007_QLFS_v01_M_v01_A_GLD_ALL.dta", replace
