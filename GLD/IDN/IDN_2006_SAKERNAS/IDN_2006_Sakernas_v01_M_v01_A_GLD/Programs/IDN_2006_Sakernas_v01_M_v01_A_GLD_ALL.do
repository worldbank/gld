...
/* -----------------------------------------------------------------------
<_Program name_>				IDN_2006_Sakernas_v01_M_v01_A_GLD.do </_Program name_>
...
* harmonized output in a single file
	...
	use "`input'\sakernas06aug.dta", clear
...
Note that 123,417 observations' or 45,002 households' number of household member do
not match the original household size variable "b1p12.
...
------------+-----------------------------------
          0 |     70,279       36.28       36.28
          1 |    123,417       63.72      100.00
------------+-----------------------------------
...
*<_hhid_>
	sort prop b1p02 b1p05 b1p07 b1p10
	egen hhid=group(prop b1p02 b1p05 b1p07 b1p10)
...
year 1995 and 2006 and East Timor is the only province missing among the 27
provinces.
...
Note that although in 2006, variable b4r11a is not explicitly labeled as "average"
...
save "`output'\IDN_2006_QLFS_v01_M_v01_A_GLD_ALL.dta", replace
