...
/* -----------------------------------------------------------------------
<_Program name_>				IDN_2017_Sakernas_v02_M_v01_A_GLD.do </_Program name_>
...
<_Study ID_>					IDN_2017_Sakernas_v02_M </_Study ID_>
...
* Date: [2023-04-08] File: [IDN_2017_Sakernas_v01_M_v08_A_GLD.do] - [Updated "occup"; set employed and unemployed observations' non-labor force reason to missing; added variable "empstat"; set "wage_no_compen" to missing for unpaid workers and zero values.]
* Date: [2026-04-22] File: [IDN_2017_Sakernas_v02_M_v01_A_GLD.do] - [add new data on 4 digit isco code, update occup_orig and occup based on the new data; revise subnatidsurvey; update occup to use the 2014 kbji code; new template]
...
* harmonized output in a single file
	...
	use "`path_in_stata'\sak201708_15_20180228_kemenkoperekonomian.dta", clear
...
*<_subnatid2_>
	...
	tostring kode_prov, g(kode_prov_str)
	gen code_subnatid2 = kode_prov_str+kode_kab
...
*<_lstatus_>
	gen lstatus = .
	replace lstatus = 1 if !missing(b5_r35)
...
Variable "b5_r24_2014" uses KBJI 2014 and it has one digit and 10 categories in total.
Note that in the raw dataset variable "b5_r24_2014" does not have labels.

<_occup_orig_note_>*/

*<_occup_orig_>
	gen occup_orig = b5_r24_2014
