...
* Date: [2026-3-12] File: [IDN_2017_Sakernas_v02_M_v01_A_GLD.do] - [add new data on 4 digit isco code, update occup_orig and occup based on the new data; revise subnatidsurvey; update occup to use the 2014 kbji code]
