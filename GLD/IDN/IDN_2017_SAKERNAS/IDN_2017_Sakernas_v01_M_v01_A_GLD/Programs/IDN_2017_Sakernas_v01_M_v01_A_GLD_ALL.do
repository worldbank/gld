...
/* -----------------------------------------------------------------------
<_Program name_>				IDN_2017_Sakernas_v01_M_v01_A_GLD.do </_Program name_>
...
* harmonized output in a single file
	...
	use "`input'\sakernas17aug.dta", clear
...
161 duplicated observations in total.
<_pid_>*/
...
year 1995 and 2017 and East Timor is the only province missing among the 27
provinces.
...
According to isced-2017 mappings, there are day care centre, playgroup, and
...
Note that although in 2017, variable b4r11a is not explicitly labeled as "average"
...
save "`output'\IDN_2017_QLFS_v01_M_v01_A_GLD_ALL.dta", replace
