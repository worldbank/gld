...
/* -----------------------------------------------------------------------
<_Program name_>				IDN_2016_Sakernas_v02_M_v01_A_GLD.do </_Program name_>
...
<_Study ID_>					IDN_2016_Sakernas_v02_M </_Study ID_>
...
* Date: [2023-04-08] File: [IDN_2016_Sakernas_v01_M_v07_A_GLD.do] - [Updated "occup"; corrected "nlfreason" (was using a wrong variable previously); set employed and unemployed observations' non-labor force reason to missing; added variable "empstat"; set "wage_no_compen" to missing for unpaid workers and zero values.]
* Date: [2025-12-12] File: [IDN_2016_Sakernas_v02_M_v01_A_GLD.do] - [add new data on 4 digit isco code, update occup_orig and occup based on the new data; update to occup to use the 2014 kbji code]
...
* harmonized output in a single file
	...
	use "`path_in_stata'\sak201608_15_20180228_kemenkoperekonomian.dta", clear
...
*<_nlfreason_>
	...
	recode nlfreason (6=2) (7=1) (11=4) (1/5 8/10 12=5)
...
Variable "b5_r20_2014" uses KBJI 2014 and it has one digit and 10 categories in total.
Note that in the raw dataset variable "b5_r20_2014" does not have labels.

<_occup_orig_note_>*/


*<_occup_orig_>
	gen occup_orig = b5_r20_2014 
