...
/* -----------------------------------------------------------------------
<_Program name_>				IDN_2016_Sakernas_v01_M_v01_A_GLD.do </_Program name_>
<_Application_>					Stata MP 16.1 <_Application_>
<_Author(s)_>					Wolrd Bank Job's Group </_Author(s)_>
<_Date created_>				2021-08-015 </_Date created_>
-------------------------------------------------------------------------
...
* harmonized output in a single file
	...
	use "`input'\sakernas16aug.dta", clear
...
year 1995 and 2016 and East Timor is the only province missing among the 27
provinces.
...
According to isced-2016 mappings, there are day care centre, playgroup, and
...
Note that although in 2016, variable b4r11a is not explicitly labeled as "average"
...
save "`output'\IDN_2016_QLFS_v01_M_v01_A_GLD_ALL.dta", replace
