...
* Date: [2023-04-08] File: [IDN_2016_Sakernas_v01_M_v07_A_GLD.do] - [Corrected "nlfreason" (was using a wrong variable previously); set employed and unemployed observations' non-labor force reason to missing; added variable "empstat"; set "wage_no_compen" to missing for unpaid workers and zero values.]
