...
/* -----------------------------------------------------------------------
<_Program name_>				IDN_1999_Sakernas_v01_M_v07_A_GLD.do </_Program name_>
...
* Date: [2023-04-04] File: [IDN_1999_Sakernas_v01_M_v07_A_GLD.do] - [Updated "occup" and helper data file； set employed and unemployed observations' non-labor force reason to missing; set "wage_no_compen" to missing for unpaid workers and zero values.]
* Date: [2026-04-21] File: [IDN_1999_Sakernas_V01_M_V08_A_GLD.do] - [Revise "subnatidsurvey"； update to new template]
