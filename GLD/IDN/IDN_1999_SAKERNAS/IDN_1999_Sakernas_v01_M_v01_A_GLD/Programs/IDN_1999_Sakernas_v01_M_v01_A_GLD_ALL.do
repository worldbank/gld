...
*<_subnatid2_>
	...
	merge n:1 b1p2 using "`gld'\Work\district_list_2013.dta"
	drop if _merge==2
...
The original industrial classification used in 1999, "b4p6", is KBLI 1997 which is based on ISIC Rev.3 .
...
Similarly here, the original occupational classification used in 1999, "b4p7", is KBJI 1982 which is based on ISCO 1968.
...
save "`output'\IDN_1999_SAKERNAS_v01_M_v01_A_GLD_ALL.dta", replace
