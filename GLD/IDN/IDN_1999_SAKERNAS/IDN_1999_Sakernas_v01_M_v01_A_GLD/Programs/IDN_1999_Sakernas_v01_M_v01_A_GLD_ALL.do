...
/* -----------------------------------------------------------------------
<_Program name_>				IDN_1999_Sakernas_v01_M_v01_A_GLD.do </_Program name_>
...
Note that 81,517 observations' or 24,940 households' number of household member do
...
------------+-----------------------------------
          0 |     74,055       47.60       47.60
          1 |     81,517       52.40      100.00
------------+-----------------------------------
...
year 1995 and 1999 and East Timor is the only province missing among the 27
provinces.
...
Note that although in 1999, variable b4r11a is not explicitly labeled as "average"
...
save "`output'\IDN_1999_QLFS_v01_M_v01_A_GLD_ALL.dta", replace
