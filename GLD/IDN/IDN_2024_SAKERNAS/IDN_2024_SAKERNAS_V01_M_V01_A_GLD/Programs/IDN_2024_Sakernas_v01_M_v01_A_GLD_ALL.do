...
/* -----------------------------------------------------------------------
<_Program name_>				IDN_2024_Sakernas_v01_M_v01_A_GLD.do </_Program name_>
<_Application_>					Stata MP 16.1 <_Application_>
<_Author(s)_>					Wolrd Bank Job's Group </_Author(s)_>
<_Date created_>				2026-01-23 </_Date created_>
-------------------------------------------------------------------------
...
<_Survey Year_>					2026 </_Survey Year_>
<_Study ID_>					IDN_2024_Sakernas_v01_M </_Study ID_>
...
*<_pid_>
	duplicates report urutan	// urutan is unique
	tostring urutan, gen(pid) format(%06.0f)
*</_pid_>
...
*<_urban_>
	recode klasifikas (2=0), gen(urban)
...
*<_relationharm_>
	recode k3 (4 5=3) (6 8=5) (7=4) (9/11=6), gen(relationharm)
...
*<_educat7_>
	gen byte educat7 = r6a
	recode educat7 (1=2) (2=3) (3=4) (4/6=5) (7/8=6) (9/12=7)
...
*<_lstatus_>
	gen lstatus=1 if r10a==1 | r10b==1 | r10c==1 | r11==1
	recode lstatus (.=2) if r38a==1 | r38b==1
	recode lstatus (.=3) if r38a==2 & r38b==2
...
*<_unempldur_l_>
	gen byte unempldur_l = r33a_kbli2*12+r33b_kbji1
...
*<_unempldur_u_>
	gen byte unempldur_u = r33a_kbli2*12+r33b_kbji1
...
{
*<_empstat_>
	recode r14a (1 2=4) (4/6=1) (7=2), gen(empstat)
...
*<_industrycat10_>
	gen byte industrycat10 = r15a_kbli2
...
*<_wage_no_compen_>
	gen wage_no_compen=r16_1+r16_2 if empstat==1
...
*<_unitwage_>
	gen unitwage = 5 if !missing(wage_no_compen)
...
*<_contract_>
	gen byte contract = r26a
	recode contract (1 2 3=1) (4=0) (5=.)
...
*<_healthins_>
	gen byte healthins = r25a
	recode healthins (3=.) (2=0)
...
*<_socialsec_>
	gen byte socialsec = .
	replace socialsec = 1 if r25d == 4 | r25e == 1 | r25g ==1
	replace socialsec = 0 if r25d == 5 & r25e == 2 & r25g == 2
...
*<_industry_orig_2_>
	gen industry_orig_2 = r33a_kbli2
...
*<_industrycat10_2_>
	gen byte industrycat10_2 = r33a_kbli2
	recode industrycat10_2 (5=4) (6=5) (7 9=6) (8 10=7) (11 12 13=8) (14=9) (15 16 17=10) (0=.)
...
*<_occup_skill_2_>
	gen occup_skill_2 = r33b_kbji1
	recode occup_skill_2 (1/3=3) (4/8=2) (9=1) (0=.)
	replace occup_skill_2 = . if r29!=1
	label var occup_skill_2 "Skill based on ISCO standard secondary job 7 day recall"
*</_occup_skill_2_>


*<_occup_2_>
	gen occup_2 = r15b_kbji2
	replace occup_2 = 10 if occup_2==0
	replace occup_2 = . if r29!=1
...
*<_firmsize_l_2_>
	gen byte firmsize_l_2 = r32c
	label var firmsize_l_2 "Firm size (lower bracket) secondary job 7 day recall"
*</_firmsize_l_2_>


*<_firmsize_u_2_>
	gen byte firmsize_u_2 = r32c
