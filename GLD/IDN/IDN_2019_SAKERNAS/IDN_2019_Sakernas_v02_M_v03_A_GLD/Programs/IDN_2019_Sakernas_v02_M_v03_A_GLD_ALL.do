...
local 	gld 	"`year'\\`cty'_`surv_yr'_Sakernas_v02_M_v03_A_GLD"
local 	i2d2	"`year'\\`cty'_`surv_yr'_Sakernas_v02_M_v03_A_I2D2"
...
save "`output'\IDN_2019_SAKERNAS_v02_M_v03_A_GLD_ALL.dta", replace
