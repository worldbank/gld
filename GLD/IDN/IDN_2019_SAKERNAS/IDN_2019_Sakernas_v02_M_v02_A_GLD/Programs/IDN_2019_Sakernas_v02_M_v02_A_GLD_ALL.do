...
/* -----------------------------------------------------------------------
<_Program name_>				IDN_2019_Sakernas_v02_M_v02_A_GLD.do </_Program name_>
...
* Date: [2022-07-21] File: [As in Program name above] - [Master dataset switched to backcasted SAKERNAS 2019 August]
...
local 	gld 	"`year'\\`cty'_`surv_yr'_Sakernas_v02_M_v02_A_GLD"
local 	i2d2	"`year'\\`cty'_`surv_yr'_Sakernas_v02_M_v02_A_I2D2"
...
* harmonized output in a single file
	...
	use "`input'\sakernas19aug_backcasting.dta", clear
...
1)available but not searching (b5_r19==1 & b5_r12a==2 & b5_r12b==2 ) or
2)searching but not immediately available to work (b5_r19==2 & ((b5_r12a==1) | (b5_r12b==1)))
...
*<_potential_lf_>
	...
	replace potential_lf = 1 if [ b5_r19==1 & b5_r12a==2 & b5_r12b==2 ] | [b5_r19==2 & ((b5_r12a==1) | (b5_r12b==1))]
	replace potential_lf = 0 if [b5_r19==1 & (b5_r12a==1 | b5_r12b==1)] | [b5_r19==2 & b5_r12a==2 & b5_r12b==2]
...
save "`output'\IDN_2019_SAKERNAS_v02_M_v02_A_GLD_ALL.dta", replace
