...
/* -----------------------------------------------------------------------
<_Program name_>				IDN_2021_Sakernas_v01_M_v01_A_GLD.do </_Program name_>
...
<_Study ID_>					IDN_2021_Sakernas_v01_M </_Study ID_>
...
*<_hhid_>
	tostring no_dsrt, gen(no_dsrt_str) format(%02.0f)
	tostring psu, gen(psu_str) format(%09.0f)
	gen hhid=psu_str+no_dsrt_str
	label var hhid "Household id"
*</_hhid_>


*<_pid_>
	tostring k1, gen(k1_str) format(%02.0f)
...
*<_subnatid1_>
// 	tostring prov, gen(prov_num)
// 	decode province, gen(prov_name)
// 	gen subnatid1 = prov_num + " - " + prov_name
// 	replace subnatid1 = "18-Lampung" if kode_prov==18
...
*<_lstatus_>
	gen lstatus=1 if r9a==1 | r9b==1 | r9c==1 | r10a==1
	recode lstatus (.=2) if r29a==1 | r29b==1
	recode lstatus (.=3) if r29a==2 & r29b==2
...
in IDN 2021, there's variables showing whether the person has searched for work but no variable for whether this person was available.
...
*<_industrycat10_>
	recode kbli2020_1 (5=4) (6=5) (7 9=6) (8 10=7) (11/13=8) (14=9) (15/17=10), gen(industrycat10)
...
*<_wage_no_compen_>
	gen wage_no_compen=r14a_uang+r14a2_brg if empstat==1
...
*<_wage_total_>
	gen wage_total = (r14a_uang+r14a2_brg)*12 if empstat==1
	recode wage_total (0=.)
...
*<_socialsec_>
	gen byte socialsec = .
	replace socialsec = 1 if r23d == 4 | r23e == 1 | r23g ==1
	replace socialsec = 0 if r23d == 5 & r23e == 2 & r23g == 2
