...
/* -----------------------------------------------------------------------
<_Program name_>				IDN_2022_Sakernas_v02_M_v06_A_GLD.do </_Program name_>
<_Application_>					Stata MP 16.1 <_Application_>
<_Author(s)_>					Wolrd Bank Job's Group </_Author(s)_>
<_Date created_>				2026-01-16 </_Date created_>
-------------------------------------------------------------------------
...
<_Study ID_>					IDN_2022_Sakernas_v01_M </_Study ID_>
...
* harmonized output in a single file
	...
	use "`path_in_stata'\sakernas22aug.dta", clear
...
*<_pid_>
	...
	tostring urutan, gen(pid) format(%07.0f)
...
*<_psu_>
	tostring kode_prov, gen(kode_prov_str) format(%02.0f)
	tostring kode_kab, gen(kode_kab_str) format(%02.0f)
	tostring psu, gen(psu_str) format(%05.0f)

	ren psu psu0
	gen psu=kode_prov_str+kode_kab_str+psu_str
...
*<_educat7_>
	recode r6a (1=2) (2=3) (3=4) (4 5 6=5) (7=6) (8 9 10 11 12=7), gen(educat7)
...
*<_lstatus_>
	gen lstatus=1 if r9a==1 | r9b==1 | r9c==1 | r10==1
	recode lstatus (.=2) if r31a==1 | r31b==1
	recode lstatus (.=3) if r31a==2 & r31b==2
...
*<_unempldur_l_>
	gen byte unempldur_l = r33_th*12+r33_bln
...
*<_unempldur_u_>
	gen byte unempldur_u = r33_th*12+r33_bln
...
{
*<_empstat_>
	recode r13a (1 2=4) (4/6=1) (7=2), gen(empstat)
...
*<_industrycat10_>
	gen byte industrycat10 = r14akatego
...
*<_wage_no_compen_>
	gen wage_no_compen=r15a_uang+r15a_brg if empstat==1
...
*<_socialsec_>
	gen byte socialsec = .
	replace socialsec = 1 if r24d == 4 | r24e == 1 | r24g ==1
	replace socialsec = 0 if r24d == 5 & r24e == 2 & r24g == 2
