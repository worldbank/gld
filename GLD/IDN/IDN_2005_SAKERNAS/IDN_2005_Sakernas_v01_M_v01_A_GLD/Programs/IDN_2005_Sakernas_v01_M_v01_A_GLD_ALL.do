...
/* -----------------------------------------------------------------------
<_Program name_>				IDN_2005_Sakernas_v01_M_v01_A_GLD.do </_Program name_>
...
* harmonized output in a single file
	...
	use "`input'\sakernas05feb.dta", clear
...
Note that 114,931 observations' or 36,586 households' number of household member do
...
------------+-----------------------------------
          0 |    100,844       46.74       46.74
          1 |    114,931       53.26      100.00
------------+-----------------------------------
...
hhsize_larg |
         er |      Freq.     Percent        Cum.
------------+-----------------------------------
          0 |    114,931       53.26       53.26
          . |    100,844       46.74      100.00
------------+-----------------------------------
      Total |    215,775      100.00
...
year 1995 and 2005 and East Timor is the only province missing among the 27
provinces.
...
Note that although in 2005, variable b4r11a is not explicitly labeled as "average"
...
save "`output'\IDN_2005_QLFS_v01_M_v01_A_GLD_ALL.dta", replace
