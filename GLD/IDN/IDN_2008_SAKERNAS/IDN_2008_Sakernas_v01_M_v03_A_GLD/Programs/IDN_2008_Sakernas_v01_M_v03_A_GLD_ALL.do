...
/* -----------------------------------------------------------------------
<_Program name_>				IDN_2008_Sakernas_v01_M_v03_A_GLD.do </_Program name_>
...
* Date: [2022-08-23] File: [As in Program name above] - [Recode employment status:Agricultural & non-agricultual casual worker recoded to "paid employee"; change path to the intermediate file]
...
*<_industry_orig_2_>
	...
	replace industry_orig_2 = int(b5p18/100) if b5p18>9999
	replace industry_orig_2 = int(b5p18/10) if industry_orig_2>999
...
save "`output'\IDN_2008_SAKERNAS_v01_M_v03_A_GLD_ALL.dta", replace
