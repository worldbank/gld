...
<_Sample size (HH)_> 			NA  </_Sample size (HH)_>
...
Only provicne, district, city, and urban/rural status available.
...
year 1995 and 2009 and East Timor is the only province missing among the 27
provinces.
...
Note that although in 2009, variable b4r11a is not explicitly labeled as "average"
...
save "`output'\IDN_2009_QLFS_v01_M_v01_A_GLD_ALL.dta", replace
