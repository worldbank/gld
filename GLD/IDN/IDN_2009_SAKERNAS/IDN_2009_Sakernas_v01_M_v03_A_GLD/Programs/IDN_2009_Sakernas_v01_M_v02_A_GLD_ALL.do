...
/* -----------------------------------------------------------------------
<_Program name_>				IDN_2009_Sakernas_v01_M_v03_A_GLD.do </_Program name_>
...
* Date: [2022-08-22] File: [As in Program name above] - [Recode employment status:Agricultural & non-agricultual casual worker recoded to "paid employee"; change path to the intermediate file]
...
* harmonized output in a single file
	...
	use "`input'\sakernas09aug.dta", clear
...
*<_subnatid2_>
	...
	merge n:1 b1p02 using "`input'\district_list_2013.dta"
	drop if _merge==2
...
*<_educat7_>
	...
	recode educat7 (4/7=5) (8/9=6) (10/11=7)
...
*<_industry_orig_>
	...
	replace industry_orig = int(b5p7/100) if b5p7>9999
	replace industry_orig = int(b5p7/10) if industry_orig>999
...
*<_occup_orig_>
	gen occup_orig = b5p8
	replace occup_orig = int(b5p8/10) if b5p8>999
...
*<_industry_orig_2_>
	...
	replace industry_orig_2 = int(b5p17/100) if b5p17>9999
	replace industry_orig_2 = int(b5p17/10) if industry_orig_2>999
...
save "`output'\IDN_2009_SAKERNAS_v01_M_v03_A_GLD_ALL.dta", replace
