...
/* -----------------------------------------------------------------------
<_Program name_>				IDN_2015_Sakernas_v01_M_v01_A_GLD.do </_Program name_>
...
* harmonized output in a single file
	...
	use "`input'\sakernas15aug.dta", clear
...
year 1995 and 2015 and East Timor is the only province missing among the 27
provinces.
...
According to isced-2015 mappings, there are day care centre, playgroup, and
...
Note that although in 2015, variable b4r11a is not explicitly labeled as "average"
...
save "`output'\IDN_2015_QLFS_v01_M_v01_A_GLD_ALL.dta", replace
