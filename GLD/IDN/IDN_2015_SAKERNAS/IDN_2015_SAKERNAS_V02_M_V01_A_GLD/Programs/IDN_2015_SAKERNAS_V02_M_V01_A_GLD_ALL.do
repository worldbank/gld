...
/* -----------------------------------------------------------------------
<_Program name_>				IDN_2015_Sakernas_v02_M_v01_A_GLD.do </_Program name_>
...
<_Study ID_>					IDN_2015_Sakernas_v02_M </_Study ID_>
...
* Date: [2026-04-22] File: [IDN_2015_Sakernas_v02_M_v01_A_GLD.do] - [add new data on 4 digit isco code, update occup_orig and occup based on the new data; reivse subnatidsurvey; new template]
...
* harmonized output in a single file
	...
	use "`path_in_stata'\sak201508_15_20180228_kemenkoperekonomian.dta", clear
...
*<_occup_orig_>
	gen occup_orig = b5_r10
	label var occup_orig "Original occupation record primary job 7 day recall"
*</_occup_orig_>


*<_occup_isco_>
	tostring b5_r10, gen(occup_isco3)
