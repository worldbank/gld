...
/* -----------------------------------------------------------------------
<_Program name_>				IDN_1997_Sakernas_v01_M_v03_A_GLD.do </_Program name_>
...
* Date: [2022-08-24] File: [As in Program name above] - [Recode "occup_skill" and "occup"; change path to the intermediate file]
...
31/32/33    Primary school junior high
...
*<_educat7_>
	...
	recode educat7 (0=1) (1=2) (2=3) (4/6=5) (7/8=6) (9=7)
...
save "`output'\IDN_1997_SAKERNAS_v01_M_v03_A_GLD_ALL.dta", replace
