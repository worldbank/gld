...
/* -----------------------------------------------------------------------
<_Program name_>				IDN_1997_Sakernas_v01_M_v07_A_GLD.do </_Program name_>
...
* Date: [2023-04-04] File: [IDN_1997_Sakernas_v01_M_v07_A_GLD.do] - [Updated "occup" and helper data file； set "industry_orig" to missing as the original variable only has two unknown categories; set employed and unemployed observations' non-labor force reason to missing; added variable "empstat"; set "wage_no_compen" to missing for unpaid workers and zero values]
* Date: [2026-04-20] File: [IDN_1997_Sakernas_V01_M_V08_A_GLD.do] - [Revise "subnatidsurvey"; update to new template]
</_Version Control_>
...
In the questionnaire this question has 5 categories:

1.Self-employed
2.Self-employed assisted by workers/temporary workers /unpaid workers/temporary
3.Self-employed assisted by workers/permanent employees
4.Worker/employee/paid worker
5.Unpaid worker
...
*<_empstat_>
	gen byte empstat = b4p11
	recode empstat (1/3=4) (4=1) (5=2)
...
*<_wage_no_compen_>
	...
	replace wage_no_compen = . if lstatus!=1 | wage_no_compen==0 | empstat == 2
