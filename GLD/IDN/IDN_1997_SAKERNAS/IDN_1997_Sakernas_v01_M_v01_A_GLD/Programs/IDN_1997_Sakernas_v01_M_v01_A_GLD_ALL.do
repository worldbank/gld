...
/* ----------------------------------------------------------------------- 
<_Program name_>				IDN_1997_Sakernas_v01_M_v01_A_GLD.do </_Program name_> 
...
* harmonized output in a single file
	...
	use "`input'\sakernas97.dta", clear
...
Note that 121,324  observations' or 35,994 households' number of household member do 
...
year 1995 and 1997 and East Timor is the only province missing among the 27 
provinces. 
...
Note that although in 1997, variable b4r11a is not explicitly labeled as "average"
...
save "`output'\IDN_1997_QLFS_v01_M_v01_A_GLD_ALL.dta", replace
