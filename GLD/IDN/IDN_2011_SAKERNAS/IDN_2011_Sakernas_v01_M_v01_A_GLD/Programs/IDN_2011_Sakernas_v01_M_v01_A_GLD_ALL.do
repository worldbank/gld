...
/* -----------------------------------------------------------------------
<_Program name_>				IDN_2011_Sakernas_v01_M_v01_A_GLD.do </_Program name_>
...
And the original variable is already names "weight".
...
year 1995 and 2011 and East Timor is the only province missing among the 27
provinces.
...
Note that although in 2011, variable b4r11a is not explicitly labeled as "average"
...
save "`output'\IDN_2011_QLFS_v01_M_v01_A_GLD_ALL.dta", replace
