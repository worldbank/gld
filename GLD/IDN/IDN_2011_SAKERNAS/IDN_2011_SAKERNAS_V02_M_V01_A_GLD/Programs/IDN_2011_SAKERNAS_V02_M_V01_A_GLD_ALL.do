...
/* -----------------------------------------------------------------------
<_Program name_>				IDN_2011_Sakernas_v02_M_v01_A_GLD.do </_Program name_>
...
<_Study ID_>					IDN_2011_Sakernas_v02_M </_Study ID_>
...
* Date: [2023-04-08] File: [IDN_2011_Sakernas_v01_M_v06_A_GLD.do] - [Set employed and unemployed observations' non-labor force reason to missing; added variable "empstat"; set "wage_no_compen" to missing for unpaid workers and zero values.]
* Date: [2026-04-22] File: [IDN_2011_Sakernas_v02_M_v01_A_GLD.do] - [add new data on 4 digit isco code, update occup_orig and occup based on the new data; revise subnatidsurvey; new template]
...
*<_occup_orig_>
	gen occup_orig = b5p10
	label var occup_orig "Original occupation record primary job 7 day recall"
*</_occup_orig_>


*<_occup_isco_>
	tostring b5p10, gen(occup_isco3)
