...
The original industrial classification used in 1998, "b4p6", is KBLI 1997 which is based on ISIC Rev.3 .
...
Similarly here, the original occupational classification used in 1998, "b4p7", is KBJI 1982 which is based on ISCO 1968.
