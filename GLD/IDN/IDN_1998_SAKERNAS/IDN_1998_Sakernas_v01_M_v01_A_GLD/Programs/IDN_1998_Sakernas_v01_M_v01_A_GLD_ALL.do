...
* harmonized output in a single file
	...
	use "`input'\sakernas98.dta", clear
...
Note that 89,319 observations' or 26,706 households' number of household member do
...
*<_hhid_>
	sort b1p1 b1p2 b1p5 b1p9 b1p10
	egen hhid=group(b1p1 b1p2 b1p5 b1p9 b1p10)
...
The two duplicatede observations were kept, considering their ages, 62 and 11,
tend to have missing values for variables like occupation.
...
year 1995 and 1998 and East Timor is the only province missing among the 27
provinces.
...
Note that although in 1998, variable b4r11a is not explicitly labeled as "average"
...
save "`output'\IDN_1998_QLFS_v01_M_v01_A_GLD_ALL.dta", replace
