...
<_Sample size (IND)_> 			247,199 </_Sample size (IND)_>
...
* harmonized output in a single file
	...
	use "`input'\sakernas96.dta", clear
...
*<_hhid_>
	sort b1r1 b1r2 b1r5 b1r9 b1r10
	egen hhid=group(b1r1 b1r2 b1r5 b1r9 b1r10)
...
9 observations were duplicated (18 observations in total). We cannot decide
whether the duplicated observations are results of coincidence or are errors.
5 out of 9 are attending school, 2 are housekeeping and 2 are working. None was
dropped.
...
Note that although in 1996, variable b4r11a is not explicitly labeled as "average"
...
save "`output'\IDN_1996_QLFS_v01_M_v01_A_GLD_ALL.dta", replace
