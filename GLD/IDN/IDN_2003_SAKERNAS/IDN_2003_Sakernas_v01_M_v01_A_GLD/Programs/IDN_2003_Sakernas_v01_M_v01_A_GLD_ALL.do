...
/* -----------------------------------------------------------------------
<_Program name_>				IDN_2003_Sakernas_v01_M_v01_A_GLD.do </_Program name_>
...
* harmonized output in a single file
	...
	use "`input'\sakernas03.dta", clear
...
Note that 124,640 observations' or 41,663 households' number of household member do
...
------------+-----------------------------------
          0 |    107,826       46.38       46.38
          1 |    124,640       53.62      100.00
------------+-----------------------------------
...
hhsize_larg |
         er |      Freq.     Percent        Cum.
------------+-----------------------------------
          0 |    122,066       52.51       52.51
          1 |      2,574        1.11       53.62
          . |    107,826       46.38      100.00
------------+-----------------------------------
      Total |    232,466      100.00
...
year 1995 and 2003 and East Timor is the only province missing among the 27
provinces.
...
Note that although in 2003, variable b4r11a is not explicitly labeled as "average"
...
save "`output'\IDN_2003_QLFS_v01_M_v01_A_GLD_ALL.dta", replace
