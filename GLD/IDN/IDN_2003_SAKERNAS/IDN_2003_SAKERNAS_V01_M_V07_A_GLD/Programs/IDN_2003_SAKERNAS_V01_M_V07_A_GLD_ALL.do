...
* Date: [2023-04-04] File: [IDN_2003_Sakernas_v01_M_v06_A_GLD.do] - [Updated "occup" and helper data file； set employed and unemployed observations' non-labor force reason to missing； set "wage_no_compen" to missing for unpaid workers and zero values]
* Date: [2026-04-20] File: [IDN_2003_Sakernas_V01_M_V07_A_GLD.do] - [Revise "subnatidsurvey"； new template]
