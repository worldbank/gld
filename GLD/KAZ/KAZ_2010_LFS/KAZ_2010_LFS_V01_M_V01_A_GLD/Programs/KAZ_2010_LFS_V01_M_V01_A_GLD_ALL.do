...
<_Program name_>				KAZ_2010_LFS_V01_M_V01_GLD_ALL.do </_Program name_>
...
<_Sample size (HH)_> 			85,747 </_Sample size (HH)_>
<_Sample size (IND)_> 			206,862 </_Sample size (IND)_>
...
use "`path_in_stata'/sbor_baz_year2010_q1throughq4_labelled_withnewvars_s12.dta", clear
...
*There is already existing hhid variable. Need to rename this
	...
	tostring VOPR_02, gen(v02)
	tostring VOPR_03, gen(v03)
	tostring VOPR_04, gen(v04)
...
* There is variable "pid" added in the dataset. Use this!
	ren pid pid_given
	gen pid_str = string(pid_given, "%02.0f")
...
*<_relationharm_>
* Can't use the HBS one. Doesn't check out! 9 categories vs 10 in HBS 
...
* No detailed industry codes here
	...
	replace industrycat_isic = "" if missing(q17_code) | lstatus != 1
