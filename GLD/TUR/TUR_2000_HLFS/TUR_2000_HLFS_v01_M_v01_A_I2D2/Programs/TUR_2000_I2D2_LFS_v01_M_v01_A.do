...
** UNIT OF ANALYSIS	 urban/rural
** INPUT DATABASES	C:\Users\wb582018\OneDrive - WBG\Surveys\TUR\TUR_2000_HLFS\TUR_2000_HLFS_v01_M\Data\Stata\LFS2000-lab.dta
** RESPONSIBLE	Alexandra Quiñones
** Created	9/28/2011
** Modified	7/19/2021
** NUMBER OF HOUSEHOLDS	74356
** NUMBER OF INDIVIDUALS	288735
** EXPANDED POPULATION	66187032
**                                                                                                  **
******************************************************************************************************
*****************************************************************************************************/
...
** DIRECTORY
	*local path "D:\__I2D2\Turkey\2000\LFS"
...
** LOG FILE
*	log using "`path'\Processed\TUR_2000_I2D2_LFS_v01_M_v01_A.log",replace
...
** RUN SETTINGS
	...
	local 	main	"`year'\\`cty3'_2000_HLFS_v01_M"
	local 	stata	"`main'\data\stata"
	local 	gld 	"`year'\\`cty3'_2000_HLFS_v01_M_v01_A_GLD"
	local 	i2d2	"`year'\\`cty3'_2000_HLFS_v01_M_v01_A_I2D2"
...
*Note: The idh and idp variables were not provided by the NSO, they were generated by the harmonizer using info from the survey.
...
** EDUCATIONAL LEVEL 1
	*the questionaire has other categories not clear about secondary incomplete.
...
** OCCUPATION CLASSIFICATION
	gen occup=s22kod
	recode occup (4 5 =5) (2=1) (1=2) (3=4) (6 7 8 9=.)
...
** DELETE MISSING VARIABLES
 ...
 save "`id_data'\TUR_2000_LFS_v01_M_v01_A_I2D2.dta", replace
