...
** UNIT OF ANALYSIS	
** INPUT DATABASES	Z:\GLD-Harmonization\582018_AQ\TUR\TUR_2011_HLFS\TUR_2011_HLFS_v01_M\Data\Stata\2011yil.dta
** RESPONSIBLE	Alexandra Quiñones
** Created	
** Modified	8/02/2021
** NUMBER OF HOUSEHOLDS	144361
** NUMBER OF INDIVIDUALS 517076	
** EXPANDED POPULATION 72376230
**                                                                                                  **
******************************************************************************************************
*****************************************************************************************************/
...
** DIRECTORY
	...
	local 	surv_yr `"2011"'	// set this to the survey year 
...
** RUN SETTINGS
	...
	local 	main	"`year'\\`cty3'_2011_HLFS_v01_M"
	local 	stata	"`main'\data\stata"
	local 	gld 	"`year'\\`cty3'_2011_HLFS_v01_M_v01_A_GLD"
	local 	i2d2	"`year'\\`cty3'_2011_HLFS_v01_M_v01_A_I2D2"
...
*	save "`path'\Processed\TUR_2010_I2D2_LFS_v01_M_v01_A.dta", replace
*	save "D:\__CURRENT\TUR_2010_I2D2_LFS_v01_M_v01_A.dta", replace
*	log close

 save "`id_data'\TUR_2011_LFS_v01_M_v01_A_I2D2.dta", replace
