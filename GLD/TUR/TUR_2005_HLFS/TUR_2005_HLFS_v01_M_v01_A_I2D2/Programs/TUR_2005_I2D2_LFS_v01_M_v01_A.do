...
** UNIT OF ANALYSIS	
** INPUT DATABASES	Z:\GLD-Harmonization\582018_AQ\TUR\TUR_2005_HLFS\TUR_2005_HLFS_v01_M\Data\Stata\2005YIL.dta
** RESPONSIBLE	Alexandra Quiñones
** Created	9/28/2011
** Modified	8/02/2021
** NUMBER OF HOUSEHOLDS	126704
** NUMBER OF INDIVIDUALS	490040
** EXPANDED POPULATION	67226759
**                                                                                                  **
******************************************************************************************************
*****************************************************************************************************/
...
** RUN SETTINGS
	...
	local 	main	"`year'\\`cty3'_2005_HLFS_v01_M"
	local 	stata	"`main'\data\stata"
	local 	gld 	"`year'\\`cty3'_2005_HLFS_v01_M_v01_A_GLD"
	local 	i2d2	"`year'\\`cty3'_2005_HLFS_v01_M_v01_A_I2D2"
...
** REASONS NOT IN THE LABOR FORCE
	...
	replace nlfreason=2 if s94==6|s94==8
	replace nlfreason=3 if s94==7
	replace nlfreason=4 if s94==10
	replace nlfreason=5 if s94>=1 & s94<=4
	recode nlfreason (.=5) if s94==9 |s94>=11 & s94<=13
...
** OCCUPATION CLASSIFICATION
	gen occup=s38kod
	replace occup=. if age<lb_mod_age & age!=.
...
** DELETE MISSING VARIABLES
 ...
 save "`id_data'\TUR_2005_LFS_v01_M_v01_A_I2D2.dta", replace
