...
/* -----------------------------------------------------------------------
<_Program name_> 			TUR_2004_HLFS_V01_M_V04_A_GLD_ALL.do </_Program name_>
...
*<_educat4_>
	gen byte educat4 = .
	replace educat4 = 1 if inlist(s10, 0, 1)
	replace educat4 = 2 if s10 == 2
	replace educat4 = 3 if inlist(s10, 3, 4, 5)
	replace educat4 = 4 if s10 == 6
...
*<_occup_orig_>
	gen str1 occup_orig = string(s33kod)
	replace occup_orig="" if s33kod==.
...
/* <_wage_no_compen_note>
	...
	gen wage_no_compen =s69
	format wage_no_compen %20.0f
