...
/* -----------------------------------------------------------------------
<_Program name_>				TUR_2006_HLFS_V01_M_V02_A_GLD_ALL.do </_Program name_>
...
<_Sample size (HH)_> 			 129527 </_Sample size (HH)_>
<_Sample size (IND)_> 			 497137 </_Sample size (IND)_>
...
local path_in "Z:\GLD-Harmonization\582018_AQ\TUR\TUR_2006_HLFS\TUR_2006_HLFS_V01_M\Data\Stata"
local path_output "Z:\GLD-Harmonization\582018_AQ\TUR\TUR_2006_HLFS\TUR_2006_HLFS_V01_M_V02_A_GLD\Data\Harmonized"

*----------1.3: Database assembly------------------------------*

* All steps necessary to merge datasets (if several) to have all elements needed to produce
* harmonized output in a single file
use "`path_in'\2006YIL.dta"
rename*, lower
...
*three observations had incorrectly labeled the reference person as a 2 or a 3 in the household order (s1).
replace s1=1 in 199297
replace s1=1 in 385597
replace s1=1 in 409649
...
save "`path_output'\TUR_2006_HLFS_V01_M_V02_A_GLD_ALL.dta", replace
