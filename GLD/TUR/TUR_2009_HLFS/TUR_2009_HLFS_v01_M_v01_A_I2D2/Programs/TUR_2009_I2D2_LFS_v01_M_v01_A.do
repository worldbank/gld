...
** UNIT OF ANALYSIS	
** INPUT DATABASES	Z:\GLD-Harmonization\582018_AQ\TUR\TUR_2009_HLFS\TUR_2009_HLFS_v01_M\Data\Stata\2009lfs.dta
** RESPONSIBLE	Alexandra Quiñones
** Created	9/28/2011
** Modified	8/02/2021
** NUMBER OF HOUSEHOLDS	135891
** NUMBER OF INDIVIDUALS	503329
** EXPANDED POPULATION	70541760
**                                                                                                  **
******************************************************************************************************
*****************************************************************************************************/
...
** DIRECTORY
	...
	local 	surv_yr `"2009"'	// set this to the survey year 
...
** RUN SETTINGS
	...
	local 	main	"`year'\\`cty3'_2009_HLFS_v01_M"
	local 	stata	"`main'\data\stata"
	local 	gld 	"`year'\\`cty3'_2009_HLFS_v01_M_v01_A_GLD"
	local 	i2d2	"`year'\\`cty3'_2009_HLFS_v01_M_v01_A_I2D2"
...
** EMPLOYMENT STATUS
	...
	recode empstat(.=2) if s39==4
	recode empstat(.=3) if s39==2
	recode empstat (.=4 ) if s39==3
...
** INDUSTRY CLASSIFICATION
	...
	replace industry=9 if s33kodr2==84
...
** OCCUPATION CLASSIFICATION
	gen occup=s38kod
	recode occup (1=.) (11/13=1) (21/24=2) (31/34=3) (41/42=4) (51/52=5) (61/62=6) (71/74=7) (81/83=8) (91/93=9) 
...
** DELETE MISSING VARIABLES
 ...
 save "`id_data'\TUR_2009_LFS_v01_M_v01_A_I2D2.dta", replace
