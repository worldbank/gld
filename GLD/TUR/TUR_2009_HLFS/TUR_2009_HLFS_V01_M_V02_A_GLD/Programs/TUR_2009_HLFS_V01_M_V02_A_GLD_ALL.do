...
/* -----------------------------------------------------------------------
<_Program name_>				TUR_2009_HLFS_V01_M_V02_A_GLD_ALL.do </_Program name_>
...
<_ISIC Version_>				ISIC Rev.4 / ISIC Rev.3  </_ISIC Version_>
...
local path_output "Z:\GLD-Harmonization\582018_AQ\TUR\TUR_2009_HLFS\TUR_2009_HLFS_V01_M_V02_A_GLD\Data\Harmonized"
...
*<_industrycat_isic_>
	...
	gen helper_1 = string(s33kodr2,"%02.0f")
	gen helper_2 = "00"
...
*<_industrycat10_>
	...
	replace industrycat10=1 if inrange(s33kodr2,1,3)
	replace industrycat10=2 if inrange(s33kodr2,5,9)
	replace industrycat10=3 if inrange(s33kodr2,10,33)
	replace industrycat10=4 if inrange(s33kodr2,35,39)
	replace industrycat10=5 if inrange(s33kodr2,41,43)
	replace industrycat10=6 if inrange(s33kodr2,45,47)
	replace industrycat10=6 if inrange(s33kodr2,55,56)
	replace industrycat10=7 if inrange(s33kodr2,49,53)
	replace industrycat10=7 if inrange(s33kodr2,58,63)
	replace industrycat10=8 if inrange(s33kodr2,64,66)
	replace industrycat10=8 if s33kodr2==68
	replace industrycat10=9 if s33kodr2==84
	replace industrycat10=8 if inrange(s33kodr2,69,82)
	replace industrycat10=10 if inrange(s33kodr2,85,99)
...
*<_occup_>
	...
	replace occup=1 if inrange(s38kod,11,13)
	replace occup=2 if inrange(s38kod,21,24)
	replace occup=3 if inrange(s38kod,31,34)
	replace occup=4 if inrange(s38kod,41,42)
	replace occup=5 if inrange(s38kod,51,52)
	replace occup=6 if inrange(s38kod,61,62)
	replace occup=7 if inrange(s38kod,71,74)
	replace occup=8 if inrange(s38kod,81,83)
	replace occup=9 if inrange(s38kod,91,93)
...
save "`path_output'\TUR_2009_HLFS_V01_M_V02_A_GLD_ALL.dta", replace
