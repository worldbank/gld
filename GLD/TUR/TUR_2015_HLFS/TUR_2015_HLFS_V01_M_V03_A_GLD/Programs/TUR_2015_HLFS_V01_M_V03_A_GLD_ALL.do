...
use "`path_in_stata'\TUR_2015_HLFS_raw_from_datalibweb.dta "
rename*, lower
...
*<_educat4_>
	gen byte educat4 = .
	replace educat4 = 1 if s13 == 0
	replace educat4 = 2 if s13 == 1
	replace educat4 = 3 if inlist(s13, 2, 31, 32)
	replace educat4 = 4 if inrange(s13, 4, 5)
