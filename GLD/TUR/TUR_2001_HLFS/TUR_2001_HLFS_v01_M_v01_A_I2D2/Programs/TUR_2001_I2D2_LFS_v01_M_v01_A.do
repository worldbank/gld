...
** UNIT OF ANALYSIS	
** INPUT DATABASES	Z:\GLD-Harmonization\582018_AQ\TUR\TUR_2001_HLFS\TUR_2001_HLFS_v01_M\Data\Stata\LFS2001-lab.dta
...
** RUN SETTINGS
	...
	local 	main	"`year'\\`cty3'_2001_HLFS_v01_M"
	local 	stata	"`main'\data\stata"
	local 	gld 	"`year'\\`cty3'_2001_HLFS_v01_M_v01_A_GLD"
	local 	i2d2	"`year'\\`cty3'_2001_HLFS_v01_M_v01_A_I2D2"
...
** REASONS NOT IN THE LABOR FORCE
	gen nlfreason=.
	replace nlfreason=1 if s37==5
	replace nlfreason=2 if s37==6
	replace nlfreason=3 if s37==9
	replace nlfreason=4 if s37==7
	replace nlfreason=5 if s37>=1 & s37<=4
	recode nlfreason (.=5) if s37==8 |s37>=4 & s37<=13
...
** DELETE MISSING VARIABLES
 ...
 save "`id_data'\TUR_2001_LFS_v01_M_v01_A_I2D2.dta", replace
