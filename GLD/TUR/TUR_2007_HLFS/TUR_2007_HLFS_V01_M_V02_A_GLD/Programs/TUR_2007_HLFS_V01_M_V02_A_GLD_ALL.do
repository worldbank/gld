...
/* -----------------------------------------------------------------------
<_Program name_>				TUR_2007_HLFS_V01_M_V02_A_GLD_ALL.do </_Program name_>
...
<_Sample size (HH)_> 			 128036 </_Sample size (HH)_>
<_Sample size (IND)_> 			 481605 </_Sample size (IND)_>
...
local path_output "Z:\GLD-Harmonization\582018_AQ\TUR\TUR_2007_HLFS\TUR_2007_HLFS_V01_M_V02_A_GLD\Data\Harmonized"
...
*three observations had incorrectly labeled the reference person as a 2 or a 3 in the household order (s1).
	replace s1=1 in 27814
	replace s1=1 in 151651
	replace s1=1 in 463056
...
save "`path_output'\TUR_2007_HLFS_V01_M_V02_A_GLD_ALL.dta", replace
