...
** UNIT OF ANALYSIS	
** INPUT DATABASES	Z:\GLD-Harmonization\582018_AQ\TUR\TUR_2008_HLFS\TUR_2008_HLFS_v01_M\Data\Stata\2008lfs.dta
** RESPONSIBLE	Alexandra Quiñones
** Created	9/28/2011
** Modified	8/02/2021
** NUMBER OF HOUSEHOLDS	129266
** NUMBER OF INDIVIDUALS	481154
** EXPANDED POPULATION	69723748
**                                                                                                  **
******************************************************************************************************
*****************************************************************************************************/
...
** DIRECTORY
	...
	local 	surv_yr `"2008"'	// set this to the survey year 
...
** RUN SETTINGS
	...
	local 	main	"`year'\\`cty3'_2008_HLFS_v01_M"
	local 	stata	"`main'\data\stata"
	local 	gld 	"`year'\\`cty3'_2008_HLFS_v01_M_v01_A_GLD"
	local 	i2d2	"`year'\\`cty3'_2008_HLFS_v01_M_v01_A_I2D2"
...
** MARITAL STATUS
	...
	replace marital=4 if s19==5|s19==3
	replace marital=5 if s19==4
...
** CAN READ AND WRITE
	gen literacy=s13 if age>=ed_mod_age
	recode literacy (2=0)
...
** DELETE MISSING VARIABLES
 ...
 save "`id_data'\TUR_2008_LFS_v01_M_v01_A_I2D2.dta", replace
