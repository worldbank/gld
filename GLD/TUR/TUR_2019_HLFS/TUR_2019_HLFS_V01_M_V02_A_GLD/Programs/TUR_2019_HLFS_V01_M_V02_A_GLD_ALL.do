...
/* -----------------------------------------------------------------------
<_Program name_>				TUR_2019_HLFS_V01_M_V02_A_GLD_ALL.do </_Program name_>
...
local path_output "Z:\GLD-Harmonization\582018_AQ\TUR\TUR_2019_HLFS\TUR_2019_HLFS_V01_M_V02_A_GLD\Data\Harmonized"
...
*<_educy_>
	...
	replace educy=12 if okul_biten_k==31
	replace educy=12 if okul_biten_k==32
	replace educy=19 if okul_biten_k==4
	replace educy=19 if okul_biten_k==5
...
/* <_whours_note>
	...
	* expect 7 replacements
	replace whours=. if esas_hafsaat_genel>84
...
*<_whours_2_>
	...
	recode whours_2 0=.
	replace whours_2=. if ekis_fiili>56
...
save "`path_output'\TUR_2019_HLFS_V01_M_V02_A_GLD_ALL.dta", replace
