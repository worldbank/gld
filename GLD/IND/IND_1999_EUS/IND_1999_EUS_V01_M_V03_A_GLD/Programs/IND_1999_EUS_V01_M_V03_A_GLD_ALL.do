...
<_Program name_> 			IND_1999_EUS_V01_M_V03_A_GLD_ALL.do </_Program name_>
...
* Start with Block 5.3 as this has several lines per individual
	use "`path_in_stata'\Block53-sch10-and-10dot1-Records-combined.dta", clear
	...
	* activity, 2.173 of them have two.
	use "`path_in_stata'\Block52-sch10-and-10dot1-Records-combined.dta", clear
	...
	* Start process with individual block 4
	use "`path_in_stata'\Block4-sch10-and-10dot1-Records-combined.dta", clear
	...
	* Same issue with merge errors in Lakshadweep.
	merge 1:1 Key_prsn using "`path_in_stata'\Block51-sch10-and-10dot1-Records-combined.dta", keep(match master) nogen
