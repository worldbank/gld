...
<_Program name_> 			IND_2004_EUS_V01_M_V03_A_GLD_ALL.do </_Program name_>
...
use "`path_in_stata'\Block_5pt3_level_06", clear
...
merge 1:1 PID using "`path_in_stata'/Block_5pt1_level_04.dta", assert(match) nogen

* Merge with subsidary activity status
tempfile subsidiary
preserve
	use "`path_in_stata'/Block_5pt2_level_05.dta", clear
...
* Merge with block 4
merge m:1 PID using "`path_in_stata'/Block_4_level_03", assert(match) nogen
...
merge m:1 HHID using "`path_in_stata'/Block_1_2_and_3_level_01.dta", keep(master match) nogen
...
preserve
	...
	* Brief issue with Block 6
	use "`path_in_stata'/Block_6_level_07.dta", clear
...
preserve
	tempfile block7
	use "`path_in_stata'/Block_7pt1_level_08.dta", clear
...
preserve
	tempfile block72
	use "`path_in_stata'/Block_7pt2_level_09.dta", clear
	duplicates drop PID, force
...
*<_subnatid2_>
	...
	egen subnatid2 = concat(State Region), punct(-)
	label var subnatid2 "Admin 2 - NSS Region"
*</_subnatid2_>


*<_subnatid3_>
	egen subnatid3 = concat(State Region District), punct(-)
	label var subnatid3 "Admin 3 - District"
*</_subnatid3_>
...
/* <_subnatid1_prev_note>
	...
	gen subnatid1_prev = ""
	replace subnatid1_prev = "9 - Uttar Pradesh" if subnatid1 == "5 - Uttaranchal" | subnatid1 == "9 - Uttar Pradesh"
	replace subnatid1_prev = "23 - Madhya Pradesh" if subnatid1 == "22 - Chhattisgarh" | subnatid1 == "23 - Madhya Pradesh"
	replace subnatid1_prev = "10 - Bihar" if subnatid1 == "20 - Jharkhand" | subnatid1 == "10 - Bihar"
...
*</_lstatus_year_note> */
  ...
  * Get rid of codes that are not feasible (wrong input)
  replace Usual_subsidary_activity_status = "" if !inrange(Usual_subsidary_activity_status,"11","99")
...
*<_empstat_year_>
	...
	destring Usual_subsidary_activity_status, gen(empstat_y2)
...
*<_ocusec_year_>
  ...
  replace ocusec_year = 2 if  inrange(Enterprise_type,1,4) | inrange(Enterprise_type,6,9)

  destring Enterprise_type, replace
  replace ocusec_year = 1 if Enterprise_type==5 & adders == 1
  replace ocusec_year = 2 if  (inrange(Enterprise_type,1,4) | inrange(Enterprise_type,6,9)) & adders == 1
...
*<_industry_orig_year_>
  ...
  replace industry_orig_year = V22 if adders == 1
...
*<_occup_orig_year_>
  ...
  replace occup_orig_year = V23 if adders == 1
...
*<_socialsec_year_>
  ...
  replace socialsec_year = 1 if inrange(Availability_of_social_security2, 1, 7) & adders == 1
  replace socialsec_year = 0 if Availability_of_social_security2 == 8 & adders == 1
...
*<_firmsize_l_year_>
  destring No_of_workers_in_enterprises, replace
  gen byte firmsize_l_year = .
  replace firmsize_l_year = 1 if No_of_workers_in_enterprises == 1
  replace firmsize_l_year = 6 if No_of_workers_in_enterprises == 2
  replace firmsize_l_year = 10 if No_of_workers_in_enterprises == 3
  replace firmsize_l_year = 20 if No_of_workers_in_enterprises == 4
  replace firmsize_l_year = . if No_of_workers_in_enterprises == 9

  destring No_of_workers_in_the_enterprise2, replace
  replace firmsize_l_year = 1 if No_of_workers_in_the_enterprise2 == 1 & adders == 1
  replace firmsize_l_year = 6 if No_of_workers_in_the_enterprise2 == 2 & adders == 1
  replace firmsize_l_year = 10 if No_of_workers_in_the_enterprise2 == 3 & adders == 1
  replace firmsize_l_year = 20 if No_of_workers_in_the_enterprise2 == 4 & adders == 1
  replace firmsize_l_year = . if No_of_workers_in_the_enterprise2 == 9 & adders == 1
...
*<_firmsize_u_year_>
  ...
  replace firmsize_u_year = 6 if No_of_workers_in_enterprises == 1
  replace firmsize_u_year = 9 if No_of_workers_in_enterprises == 2
  replace firmsize_u_year = 20 if No_of_workers_in_enterprises == 3
  replace firmsize_u_year = . if (No_of_workers_in_enterprises == 4 | No_of_workers_in_enterprises == 9)

  replace firmsize_u_year = 6 if No_of_workers_in_the_enterprise2 == 1 & adders == 1
  replace firmsize_u_year = 9 if No_of_workers_in_the_enterprise2 == 2 & adders == 1
  replace firmsize_u_year = 20 if No_of_workers_in_the_enterprise2 == 3 & adders == 1
  replace firmsize_u_year = . if (No_of_workers_in_the_enterprise2 == 4 | No_of_workers_in_the_enterprise2 == 9)
...
*<_empstat_2_year_>
  destring Usual_subsidary_activity_status, gen(empstat_2_year)  force
  ...
  replace empstat_2_year = . if seconds != 1
	...
	* Some off codes
	replace empstat_2_year = . if inlist(empstat_2_year,1,2,25)
...
*<_industry_orig_2_year_>
	gen industry_orig_2_year = V22 if seconds == 1
...
*<_occup_orig_2_year_>
	gen occup_orig_2_year = V23 if seconds == 1
...
*<_firmsize_l_2_year_>
  ...
  replace firmsize_l_2_year=1 if No_of_workers_in_the_enterprise2 == 1 & seconds == 1
  replace firmsize_l_2_year=6 if No_of_workers_in_the_enterprise2 == 2 & seconds == 1
  replace firmsize_l_2_year=10 if No_of_workers_in_the_enterprise2 == 3 & seconds == 1
  replace firmsize_l_2_year=20 if No_of_workers_in_the_enterprise2 == 4 & seconds == 1
  replace firmsize_l_2_year=. if No_of_workers_in_the_enterprise2 == 9 & seconds == 1
...
*<_firmsize_u_2_year_>
  ...
  replace firmsize_u_2_year=6 if No_of_workers_in_the_enterprise2 == 1 & seconds == 1
  replace firmsize_u_2_year=9 if No_of_workers_in_the_enterprise2 == 2 & seconds == 1
  replace firmsize_u_2_year=20 if No_of_workers_in_the_enterprise2 == 3 & seconds == 1
  replace firmsize_u_2_year=. if (No_of_workers_in_the_enterprise2 == 4 | No_of_workers_in_the_enterprise2 == 9) & seconds == 1
