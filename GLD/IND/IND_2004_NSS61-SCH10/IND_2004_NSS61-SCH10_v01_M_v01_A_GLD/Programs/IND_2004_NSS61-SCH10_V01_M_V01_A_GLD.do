...
<_Program name_>				IND_2004_NSS61-SCH10_V01_M_V01_A_GLD.do </_Program name_> 
...
areas, the list of 2001 census villages constitut ed the sampling frame for selection 
...
global path_in "C:\Users\Angelo Santos\OneDrive - George Mason University\Summer 2021\510859_AS\IND\IND_2004_NSS61-SCH10\IND_2004_NSS61-SCH10_v01_M\Data\Stata"
global path_output "C:\Users\Angelo Santos\OneDrive - George Mason University\Summer 2021\510859_AS\IND\IND_2004_NSS61-SCH10\IND_2004_NSS61-SCH10_v01_M_v01_A_GLD\Data\Harmonized"
...
merge 1:1 PID using "$path_in/Block_5pt1_level_04.dta", keep(master match) nogen

* Merge with subsidary activity status
merge 1:1 PID using "$path_in/Block_5pt2_level_05.dta", keep(master match) nogen

* Merge with block 4
merge m:1 PID using "$path_in/Block_4_level_03" , keep(master match) nogen
...
* Merge with block 6
merge 1:1 PID using "$path_in/Block_6_level_07.dta", keep(master match) nogen
...
merge 1:1 PID using `block7', keep(master match) nogen
...
merge 1:1 PID using `block72', keep(master match) nogen

* Not merge blocks 8 and 9 bec these are not relevant on the GLD pov

******************************************************************************	
* TO DELETE THIS ONCE DONE
save "C:\Users\Angelo Santos\OneDrive - George Mason University\Summer 2021\510859_AS\IND\IND_2004_NSS61-SCH10\IND_2004_NSS61-SCH10_v01_M_v01_A_GLD\Work\merge_2004b.dta", replace
******************************************************************************	
...
******************************************************************************	
* TO DELETE THIS ONCE DONE
use "C:\Users\Angelo Santos\OneDrive - George Mason University\Summer 2021\510859_AS\IND\IND_2004_NSS61-SCH10\IND_2004_NSS61-SCH10_v01_M_v01_A_GLD\Work\merge_2004b.dta", clear 
******************************************************************************	
...
*<_educy_>
	...
	* Correct if General_education incorrect (e.g., a five year old high schooler)
...
*<_industry_orig_>
	gen industry_orig =  Current_activity_NIC1998_1
...
*<_industrycat10_>
	gen red_indus =substr(Current_activity_NIC1998_1,1,2)
...
*<_occup_>
	gen code_68 = Current_activity_NCO_1968
	...
	merge m:1 code_68 using "$path_in/IND_2004_NSS61-SCH10_NCO_68_to_2004_conversion.dta"
...
*<_wage_no_compen_>
	gen double wage_no_compen = Total_cash_1
...
*<_industrycat10_2_>
	destring Current_activity_NIC1998_2, gen(red_indus)
...
*<_wage_no_compen_2_>
	gen double wage_no_compen_2 = Total_cash_2
...
*<_underemployment_year_>
	...
	replace underemployment_year = 0 if Sought_available_for_additional == "3" & lstatus_year == 1
...
*<_unempldur_l_year_>
	...
	replace unempldur_l_year=0 if inlist(Duration_spell_of_unemployment,"1","2","3")
	replace unempldur_l_year=1 if Duration_spell_of_unemployment=="4"
	replace unempldur_l_year=2 if Duration_spell_of_unemployment=="5"
	replace unempldur_l_year=3 if Duration_spell_of_unemployment=="6"
	replace unempldur_l_year=6 if Duration_spell_of_unemployment=="7"
	replace unempldur_l_year=12 if Duration_spell_of_unemployment=="8"
	replace unempldur_l_year=. if missing(Duration_spell_of_unemployment)
...
*<_unempldur_u_year_>
	...
	replace unempldur_u=1 if inlist(Duration_spell_of_unemployment,"1","2","3")
...
*<_industrycat10_year_>
	gen red_indus =substr(Usual_principal_activity_NIC_5_d,1,2)
	destring red_indus, replace 
	
	gen red_indus_s =substr(V22,1,2)
...
*<_occup_year_>
	...
	gen code_68 = Usual_principal_activity_NCO_3_d
	...
	merge m:1 code_68 using "$path_in/IND_2004_NSS61-SCH10_NCO_68_to_2004_conversion.dta", nogen
...
save "$path_output\IND_2004_NSS61-SCH10_V01_M_V01_A_GLD.dta", replace
