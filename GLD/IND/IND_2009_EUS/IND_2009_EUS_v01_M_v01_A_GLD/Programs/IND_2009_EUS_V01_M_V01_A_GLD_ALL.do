...
<_Program name_>				IND_2009_EUS_V01_M_V01_A_GLD_ALL.do </_Program name_>
...
local path_in "C:\Users\wb529026\OneDrive - WBG\Documents\Country Work\IND\IND_2009_EUS\IND_2009_EUS_v01_M\Data\Stata"
local path_output "C:\Users\wb529026\OneDrive - WBG\Documents\Country Work\IND\IND_2009_EUS\IND_2009_EUS_v01_M_v01_A_GLD\Data\Harmonized"
...
use "`path_in'/Block_5_2_Usual subsidiary economic activity particulars of household members.dta", clear
	...
	keep HHID Person_Serial_No Type_of_Job_Contract2 Usual_Subsidiary_Activity_Status	Usual_SubsidiaryActivity_NIC2004 Usual_SubsidiaryActivity_NCO2004 No_of_Workers_in_Enterprise2 Enterprise_Type2
...
* Merge with Block 6
merge 1:1 HHID Person_Serial_No using "`path_in'/Block_6_Follow-up questions for persons unemployed on all the 7 days of the week.dta", assert(match master) nogen //using dta has 6740 obs only

* Merge with Block 7_1
merge 1:1 HHID Person_Serial_No using "`path_in'/Block_7_1_Follow-up questions on availability for work to persons working in the usual principal or subsidiary status.dta", assert(match master) nogen

* Merge with Block 7_2
merge 1:1 HHID Person_Serial_No using "`path_in'/Block_7_2_Follow-up questions on change of nature of work and_ or establishment to persons working in the usual principal status or subsidiary status.dta", assert(match master) nogen
...
*<_educat7_>
	...
	replace educat7 = 5 if genedulev == 8 | genedulev == 10 & educy >= 12  // Secondary complete
...
*<_ocusec_year_>
	...
	replace ocusec_year=. if  Enterprise_Type==9 | missing(empstat_year)
...
*<_industry_orig_year_>
	...
	replace industry_orig_year = Usual_SubsidiaryActivity_NIC2004 if missing(Usual_Principal_Activity_NIC2004)
...
*<_contract_year_>
	...
	replace contract_year = 1 if Type_of_Job_Contract != "1"
	replace contract_year = 0 if Type_of_Job_Contract == "1"
	replace contract_year = . if Type_of_Job_Contract == "0" | missing(empstat_year)
...
*<_socialsec_year_>
	...
	replace socialsec_year = . if missing(empstat_year) | Social_Security_Benefits== 0
...
*<_ocusec_2_year_>
	...
	replace ocusec_2_year=4 if Enterprise_Type==6
...
*<_firmsize_l_2_year_>
	...
	replace firmsize_l_2_year=1 if No_of_Workers_in_Enterprise2 ==1
	replace firmsize_l_2_year=6 if No_of_Workers_in_Enterprise2 ==2
	replace firmsize_l_2_year=10 if No_of_Workers_in_Enterprise2==3
	replace firmsize_l_2_year=20 if No_of_Workers_in_Enterprise2==4
	replace firmsize_l_2_year=. if No_of_Workers_in_Enterprise2==9
...
*<_firmsize_u_2_year_>
	...
	replace firmsize_u_2_year=6 if No_of_Workers_in_Enterprise2==1
	replace firmsize_u_2_year=9 if No_of_Workers_in_Enterprise2==2
	replace firmsize_u_2_year=20 if No_of_Workers_in_Enterprise2==3
	replace firmsize_u_2_year=. if No_of_Workers_in_Enterprise2==4 |No_of_Workers_in_Enterprise2==9
...
save "`path_output'\IND_2009_EUS_V01_M_V01_A_GLD_ALL.dta", replace
