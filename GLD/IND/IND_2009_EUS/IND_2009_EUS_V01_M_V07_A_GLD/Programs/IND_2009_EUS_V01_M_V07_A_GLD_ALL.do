...
<_Program name_> 			IND_2009_EUS_V01_M_V07_A_GLD_ALL.do </_Program name_>
...
<_Survey Title_>				         National Sample survey 2007 Schedule 10 - Round 66 </_Survey Title_>
<_Survey Year_>					         2009 </_Survey Year_>
<_ICLS Version_>				         Does not seem to follow ICLS-13 </_ICLS Version_>
<_Study ID_>					           DDI-IND-MOSPI-NSSO-66-10-2011 </_Study ID_>
<_Data collection from (M/Y)_>	 06/2009 </_Data collection from (M/Y)_>
<_Data collection to (M/Y)_>	   07/2010 </_Data collection to (M/Y)_>
<_Source of dataset_> 			     http://microdata.gov.in/nada43/index.php/catalog/124 </_Source of dataset_>
<_Sample size (HH)_> 			       100,957 </_Sample size (HH)_>
<_Sample size (IND)_> 			     459,784 </_Sample size (IND)_>
<_Sampling method_> 			The sample design adopted for this round of survey was similar to that
followed in the past surveys in its general aspects. The general scheme was a two stage stratified design
with the first stage units being villages in the rural areas and urban frame survey blocks(UFS) in the urban areas.
The second stage units were the households. 	</_Sampling method_>
...
* Date: 2023-09-21 - Update vars contract_year, socialsec_year
...
* IN the 2009 round, Block 5 is subdivided into three datasets: principal activity,
...
* Transform this data into wide format
...
reshape wide Status NIC_2004_Code Operation Intensity* Total_no_days_in_each_activity Wage_* Mode_of_Payment, i(HHID Person_Serial_No) j(runner)

* Merge these three datasets
merge 1:1 HHID Person_Serial_No using `sa', assert(match master) nogen
merge 1:1 HHID Person_Serial_No using `pa', assert(match) nogen
...
* Merge with Block 6
merge 1:1 HHID Person_Serial_No using "`path_in_stata'/Block_6_Follow-up questions for persons unemployed on all the 7 days of the week.dta", assert(match master) nogen //using dta has 6740 obs only

* Merge with Block 7_1
merge 1:1 HHID Person_Serial_No using "`path_in_stata'/Block_7_1_Follow-up questions on availability for work to persons working in the usual principal or subsidiary status.dta", assert(match master) nogen

* Merge with Block 7_2
merge 1:1 HHID Person_Serial_No using "`path_in_stata'/Block_7_2.dta", assert(match master) nogen
...
*<_int_year_>
	gen int_year=.
	replace int_year = 2009 if inlist(Sub_Round,"1","2")
	replace int_year = 2010 if inlist(Sub_Round,"3","4")
...
*<_subnatid2_>
	...
	replace subnatid2 = "35-01 - South Andaman" if subnatid2 == "35-01"
	replace subnatid2 = "35-02 - Nicobars" if subnatid2 == "35-02"
	replace subnatid2 = "35-03 - North and Middle Andaman" if subnatid2 == "35-03"
	...
	replace subnatid2 = "12-14 - Anjaw" if subnatid2 == "12-14"
	replace subnatid2 = "12-15 - Kurungkumey" if subnatid2 == "12-15"
	replace subnatid2 = "12-16 - Lower Dibang  Valley" if subnatid2 == "12-16"
	replace subnatid2 = "18-12 - Lakshadweephimpur" if subnatid2 == "18-12"
	...
	replace subnatid2 = "18-23 - HaiLakshadweepandi" if subnatid2 == "18-23"
	...
	replace subnatid2 = "18-24 - Chirang" if subnatid2 == "18-24"
	replace subnatid2 = "18-25 - Baksa" if subnatid2 == "18-25"
	replace subnatid2 = "18-26 - Guwahati" if subnatid2 == "18-26"
	...
	replace subnatid2 = "10-25 - Lakshadweephisarai" if subnatid2 == "10-25"
	...
	replace subnatid2 = "26-01 - Dadra and Nagar Havelira     &  NH" if subnatid2 == "26-01"
	...
	replace subnatid2 = "06-20 - Mewat" if subnatid2 == "06-20"
	...
	replace subnatid2 = "20-19 - Latehar" if subnatid2 == "20-19"
	replace subnatid2 = "20-20 - Simdega" if subnatid2 == "20-20"
	replace subnatid2 = "20-22 - Saraikela Khareswan" if subnatid2 == "20-22"
	replace subnatid2 = "20-21 - Jamtara" if subnatid2 == "20-21"
	...
	replace subnatid2 = "32-06 - PaLakshadweepkad" if subnatid2 == "32-06"
	...
	replace subnatid2 = "23-47 - Anuppur" if subnatid2 == "23-47"
	replace subnatid2 = "23-48 - Burhampur" if subnatid2 == "23-48"
	replace subnatid2 = "23-46 - Ashoknagar" if subnatid2 == "23-46"
	...
	replace subnatid2 = "13-10 - Longleng" if subnatid2 == "13-10"
	...
	replace subnatid2 = "03-18 - S.A.S. nagar (Mohali)" if subnatid2 == "03-18"
	...
	replace subnatid2 = "33-31 - Krishnagiri" if subnatid2 == "33-31"
	...
	replace subnatid2 = "09-68 - S.R.Nagar    Bhadoh" if subnatid2 == "09-68"
	...
	replace subnatid2 = "05-05 - Dehradun (P)" if subnatid2 == "05-05"
	...
	replace subnatid2 = "05-11 - Nainital (P)" if subnatid2 == "05-11"
	replace subnatid2 = "05-12 - Udham Singh Nagar" if subnatid2 == "05-12"
	replace subnatid2 = "05-13 - Hardwar" if subnatid2 == "05-13"
	replace subnatid2 = "05-14 - Nainital (H)" if subnatid2 == "05-14"
	replace subnatid2 = "05-15 - Dehradun (H)" if subnatid2 == "05-15"
	...
	replace subnatid2 = "19-15 - Paschim Midnapur" if subnatid2 == "19-15"
	replace subnatid2 = "19-19 - Purba Midnapur" if subnatid2 == "19-19"
*</_subnatid2_>
...
*<_educat_isced_>
	...
	replace educat_isced = 300 if genedulev == 8 | genedulev == 10 | genedulev == 11
...
*<_vocational_>
	gen vocational = 1 if inlist(Vocational_Training, "1", "2", "3", "4", "5", "6")
	replace vocational = 0 if Vocational_Training == "7"
...
*<_unempldur_u_>
	...
	replace unempldur_u=. if Duration_Spell_of_Unemployment=="8" | missing(Duration_Spell_of_Unemployment)
...
*<_industry_orig_>
	gen industry_orig = Current_Weekly_Activity_NIC_2004
...
This year uses NIC 2004. The intro to NIC 2004 says the codes are identical to ISIC 3.1 at 
four digits, but this is not true for the following cases:
...
*<_industry_orig_2_>
	gen industry_orig_2 = NIC_2004_Code2
...
*<_wage_no_compen_2_>
	...
	replace wage_no_compen_2=. if missing(empstat_2) | (age < minlaborage & age != .)
...
*<_industry_orig_year_>
	gen industry_orig_year = Usual_Principal_Activity_NIC2004
...
*<_industrycat10_year_>
	...
	la de lblindustrycat10_year 1 "Agriculture" 2 "Mining" 3 "Manufacturing" 4 "Public utilities" 5 "Construction"  6 "Commerce" 7 "Transport and Comnunications" 8 "Financial and Business Services" 9 "Public Administration" 10 "Other Services, Unspecified", replace
...
*<_occup_year_>
	...
	la de lbloccup_year 1 "Managers" 2 "Professionals" 3 "Technicians" 4 "Clerks" 5 "Service and market sales workers" 6 "Skilled agricultural" 7 "Craft workers" 8 "Machine operators" 9 "Elementary occupations" 10 "Armed forces"  99 "Others", replace
...
*<_union_year_>
	gen byte union_year = .
	replace union_year = 0 if !missing(empstat_year)
	replace union_year = 1 if Member_of_Union_Association == "1"
...
* A "true" second job is if they have a primary ^and^ a secondary --> if primary_help == 1 & secondary_help == 1
