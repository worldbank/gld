...
<_Author(s)_>					Mario Gronert & Angelo Santos </_Author(s)_> 
...
global path_in "C:\Users\Angelo Santos\OneDrive - George Mason University\Summer 2021\510859_AS\IND\IND_1999_NSS55-SCH10\IND_1999_NSS55-SCH10_v01_M\Data\Stata"
global path_output "C:\Users\Angelo Santos\OneDrive - George Mason University\Summer 2021\510859_AS\IND\IND_1999_NSS55-SCH10\IND_1999_NSS55-SCH10_v01_M_v01_A_GLD\Data\Harmonized"
...
duplicates drop PID B53_q4, force
...
********************************************************************************
********************************************************************************
keep runner B53_q4 B53_q5 B53_q14 B53_q15 B53_q16 B53_q17 B53_q18 B53_q19 B53_q20 B53_q21  B53_q22 Key_Hhold Key_PRSN Hhold_Slno Prsn_Slno_B53_q1 State
reshape wide B53_q4 B53_q5 B53_q14 B53_q15 B53_q16 B53_q17 B53_q18, i(Key_PRSN) j(runner)
...
*<_educat7_>
	...
	replace educat7 = 6 if genedulev == 9  // Secondary complete
...
*<_industry_orig_>
	gen industry_orig = B53_q21 if B53_q41 == B53_q20
...
*<_industrycat10_>
	...
	replace industrycat10=. if lstatus != 1 | (age < minlaborage & age != .) | (B53_q41 != B53_q20)
...
*<_occup_orig_>
	gen occup_orig = B53_q22 if B53_q41 == B53_q20
...
*<_occup_>
	...
	gen occup = .
	replace occup = code_04 if lstatus == 1 & (age >= minlaborage & age != .) & B53_q41 == B53_q20
	replace occup = 99 if x_indic == 1 & lstatus == 1 & (age >= minlaborage & age != .) & B53_q41 == B53_q20
