...
local path_in "C:\Users\wb529026\OneDrive - WBG\Documents\Country Work\IND\IND_1993_NSS50-SCH10\IND_1993_NSS50-SCH10_v01_M\Data\Stata"
local path_output "C:\Users\wb529026\OneDrive - WBG\Documents\Country Work\IND\IND_1993_NSS50-SCH10\IND_1993_NSS50-SCH10_v01_M_v01_A_GLD\Data\Harmonized"
...
bys Hhold_Key Prsn_slno: gen runner = _n
...
* First: correct if there is no first activity but there is a second and the second is equal to the weekly activity code (q19), replace 1 with 2, drop 2
gen condition = missing(B5_q41) & !missing(B5_q42) & (B5_q42 == B5_q19) & missing(B5_q43) & missing(B5_q44) & missing(B5_q45)
replace B5_q41 = B5_q42 if condition == 1
replace B5_q51 = B5_q52 if condition == 1 
replace B5_q141 = B5_q142 if condition == 1 
replace B5_q151 = B5_q152 if condition == 1 
replace B5_q161 = B5_q162 if condition == 1 
replace B5_q171 = B5_q172 if condition == 1
replace B5_q42 = ""  if condition == 1
replace B5_q52 = "" if condition == 1
replace B5_q142 = . if condition == 1
replace B5_q152 = . if condition == 1
replace B5_q162 = . if condition == 1
replace B5_q172 = . if condition == 1

drop condition

* Second: if first activity has most time spent on but neither activity nor industry are listed, paste in from weekly status
egen week_max_work = rowmax(B5_q141 B5_q142 B5_q143 B5_q144 B5_q145)
gen condition = (missing(B5_q41) & missing(B5_q51)) & (B5_q141 == week_max_work)
replace B5_q41 = B5_q19 if condition == 1
replace B5_q51 = substr(B5_q20,1,1) if condition == 1 
drop condition week_max_work

count if missing(B5_q41)
* Still have 25 cases with the info missing, but in a 564,740 sample that seems OK. Plus all these
* have no weekly info (q19, q20) so there is little to correct.
...
merge 1:1 Hhold_Key Prsn_slno using `weekly_act', assert(match) nogen
...
*<_unempldur_l_>
	gen unempldur_l=.
	replace unempldur_l=0 if inlist(B6_q8,"1","2","3")
	...
	replace unempldur_l=. if missing(B6_q8)
...
*<_unempldur_u_>
	gen unempldur_u=.
	replace unempldur_u=1 if inlist(B6_q8,"1","2","3")
	...
	replace unempldur_u=. if B6_q8=="8" | missing(B6_q8)
...
*<_industrycat10_>
	gen red_indus =substr(B5_q20,1,2)
...
*<_occup_>
	...
	merge m:1 code_68 using "`path_in'\IND_1993_NSS50-SCH10_NCO_68_to_2004_conversion.dta", nogen
...
*<_industrycat10_2_>
	gen industrycat10_2 = .
	replace industrycat10_2=1 if B5_q52 == "0"
	replace industrycat10_2=2 if B5_q52 == "1"
	replace industrycat10_2=3 if B5_q52 == "2" | B5_q52 == "3"
	replace industrycat10_2=4 if B5_q52 == "4" 
	replace industrycat10_2=5 if B5_q52 == "5"
	replace industrycat10_2=6 if B5_q52 == "6"
	replace industrycat10_2=7 if B5_q52 == "7"
	replace industrycat10_2=8 if B5_q52 == "8"
	replace industrycat10_2=9 if  B5_q52 == "9"
	replace industrycat10_2=10 if B5_q52 == "X"
...
*<_t_hours_others_>
	...
	gen fifth_h = B5_q145*8 if inlist(B5_q45, "11", "12", "21", "31", "51", "61", "62", "71", "72")
	egen t_hours_others = rowtotal(third_h fourth_h B5_q143 fifth_h), missing
...
*<_t_wage_nocompen_others_>
	...
	gen fifth_h = B5_q155*8 if inlist(B5_q45, "11", "12", "21", "31", "51", "61", "62", "71", "72")
	egen t_wage_nocompen_others = rowtotal(third_h fourth_h B5_q143 fifth_h), missing 
...
/* <_lstatus_year_note>
	...
	destring B4_q12, gen(lstatus_year)
...
*<_empstat_year_>
	destring B4_q12, gen(empstat_year)
...
*<_industry_orig_year_>
	...
	replace industry_orig_year = B4_q20 if missing(B4_q14)
...
*<_industrycat10_year_>
	gen red_indus =substr(B4_q14,1,2)
	gen x_indic = regexm(red_indus, "x|X|y|Y")
	replace red_indus = "99" if x_indic == 1
	drop x_indic
	destring red_indus, replace 
	
	gen red_indus_s =substr(B4_q20,1,2)
...
*<_occup_orig_year_>
	...
	replace occup_orig_year = B4_q21 if missing(B4_q15)
...
/* <_wmonths_year_note>
	...
	replace wmonths_year = 12 - B7_q10 if B7_q9 == "2"
...
/* <_wmonths_year_note>
	...
	gen byte union_year = .
	replace union_year = 0 if B7_q17 == "2"
	replace union_year = 0 if B7_q17 == "1" & B7_q18 == "2"
	replace union_year = 1 if B7_q17 == "1" & B7_q18 == "1"
	replace wmonths_year = . if missing(empstat_year)
...
*<_industry_orig_2_year_>
	gen industry_orig_2_year = B4_q20
...
*<_industrycat10_2_year_>
	gen red_indus =substr(B4_q20,1,2)
	gen x_indic = regexm(red_indus, "x|X|y|Y")
	replace red_indus = "99" if x_indic == 1
	drop x_indic
	destring red_indus, replace 
...
save "`path_output'\IND_1993_NSS50-SCH10_V01_M_V01_A_GLD.dta", replace
