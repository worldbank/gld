...
<_Program name_>				IND_2011_EUS_V01_M_V01_A_GLD_ALL.do </_Program name_>
...
local path_in "C:\Users\wb529026\OneDrive - WBG\Documents\Country Work\IND\IND_2011_EUS\IND_2011_EUS_v01_M\Data\Stata"
local path_output "C:\Users\wb529026\OneDrive - WBG\Documents\Country Work\IND\IND_2011_EUS\IND_2011_EUS_v01_M_v01_A_GLD\Data\Harmonized"
...
*<_occup_orig_year_>
	...
	replace occup_orig_year = Usual_SubsidiaryActivity_NCO2004 if missing(Usual_Principal_Activity_NCO2004)
...
*<_ocusec_2_year_>
	...
	replace ocusec_year=1 if Enterprise_Type2==5
	replace ocusec_year=2 if  Enterprise_Type2>=1 & Enterprise_Type2<=4 | Enterprise_Type2 == 7
	replace ocusec_year=2 if  Enterprise_Type2==8
	replace ocusec_year=4 if Enterprise_Type==6
	replace ocusec_year=. if  Enterprise_Type2==9 | missing(empstat_2_year)
...
save "`path_output'\IND_2011_EUS_V01_M_V01_A_GLD_ALL.dta", replace
