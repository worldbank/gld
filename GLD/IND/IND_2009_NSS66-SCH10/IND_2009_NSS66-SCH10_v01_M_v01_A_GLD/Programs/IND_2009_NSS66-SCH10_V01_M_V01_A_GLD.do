...
<_Data collection from (M/Y)_>	MM/2009 </_Data collection from (M/Y)_>
<_Data collection to (M/Y)_>	MM/2010 </_Data collection to (M/Y)_>
...
global path_in "C:\Users\Angelo Santos\OneDrive - George Mason University\Summer 2021\510859_AS\IND\IND_2009_NSS66-SCH10\IND_2009_NSS66-SCH10_v01_M\Data\Stata"
global path_output "C:\Users\Angelo Santos\OneDrive - George Mason University\Summer 2021\510859_AS\IND\IND_2009_NSS66-SCH10\IND_2009_NSS66-SCH10_v01_M_v01_A_GLD\Data\Harmonized"
...
reshape wide Status NIC_2004 Operation Intensity* Total_no Wage_* Mode_, i(HHID Person_Serial) j(runner)
...
* Merge with Block 6
merge 1:1 HHID Person_Serial using "$path_in/Block_6_Follow-up questions for persons unemployed on all the 7 days of the week.dta", nogen //using dta has 6740 obs only

* Merge with Block 7
merge 1:1 HHID Person_Serial using "$path_in/Block_7_1_Follow-up questions on availability for work to persons working in the usual principal or subs.dta", nogen
******************************************************************************
* TO DELETE THIS ONCE DONE
*save "/Users/angelogabriellesantos/OneDrive - George Mason University/Summer 2021/510859_AS/IND/IND_2009_NSS66-SCH10/IND_2009_NSS66-SCH10_v01_M_v01_A_GLD/Work/merge_2009.dta", replace
******************************************************************************
...
******************************************************************************
* TO DELETE THIS ONCE DONE
*use "/Users/angelogabriellesantos/OneDrive - George Mason University/Summer 2021/510859_AS/IND/IND_2009_NSS66-SCH10/IND_2009_NSS66-SCH10_v01_M_v01_A_GLD/Work/merge_2009.dta", clear
******************************************************************************
...
*<_vocational_>
	gen vocational = 1 if inlist(Vocational, "1", "2", "3", "4", "5", "6")
	replace vocational = 0 if Vocational == "7"
...
*<_vocational_length_l_>
	gen vocational_length_l = Duration_of_Training/4
	label var vocational_length_l "Length of training, lower limit"
*</_vocational_length_l_>

*<_vocational_length_u_>
	gen vocational_length_u = Duration_of_Training/4
...
*<_unempldur_l_>
	gen unempldur_l=.
	replace unempldur_l=0 if inlist(Duration_Spell,"1","2","3")
	replace unempldur_l=1 if Duration_Spell=="4"
	replace unempldur_l=2 if Duration_Spell=="5"
	replace unempldur_l=3 if Duration_Spell=="6"
	replace unempldur_l=6 if Duration_Spell=="7"
	replace unempldur_l=12 if Duration_Spell=="8"
	replace unempldur_l=. if missing(Duration_Spell)
...
*<_unempldur_u_>
	gen unempldur_u=.
	replace unempldur_u=1 if inlist(Duration_Spell,"1","2","3")
	replace unempldur_u=2 if Duration_Spell=="4"
	replace unempldur_u=3 if Duration_Spell=="5"
	replace unempldur_u=6 if Duration_Spell=="6"
	replace unempldur_u=12 if Duration_Spell=="7"
	replace unempldur_u=. if Duration_Spell=="8" | missing(Duration_Spell)
...
*<_industrycat10_>
	gen red_indus =substr(Current_Weekly_Activity_NIC_2004,1,2)
...
/* <_occup_note>
	...
	There are 1,530 observations that are employed but have occupations equal to "000"
	In the 2004 NCO, value = 000 has no equivalent occupation
	These are recoded to 99

</_occup_note> */

	replace occup = 99 if x_indic == 1 & lstatus == 1 & (age >= minlaborage & age != .) | occup == 0
...
*<_wage_no_compen_>
	gen double wage_no_compen = Wage_and_Salary_Earnings_Kind1
...
*<_industrycat10_2_>
	gen red_indus =substr(NIC_2004_Code2,1,2)
	gen x_indic = regexm(red_indus, "x|X|y|y")
	replace red_indus = "99" if x_indic == 1
	destring red_indus, replace force
...
*<_industrycat10_year_>
	gen red_indus =substr(Usual_Principal_Activity_NIC2004,1,2)
...
*<_occup_year_>
	...
	gen code_04_s = Usual_SubsidiaryActivity_NCO2004
	replace code_04_s = substr(code_04_s,1,1)
...
/*<_occup_year_note>
	...
	There are 12,116 employed individuals in past 12 months with occupational category = 0
	Recode to others
	...
	replace occup_year = 99 if x_indic == 1 & lstatus_year == 1 & (age >= minlaborage & age != .) | occup_year == 0
	label var occup_year "1 digit occupational classification, primary job 12 month recall"
	la de lbloccup_year 1 "Managers" 2 "Professionals" 3 "Technicians" 4 "Clerks" 5 "Service and market sales workers" 6 "Skilled agricultural" 7 "Craft workers" 8 "Machine operators" 9 "Elementary occupations" 10 "Armed forces"  99 "Others"
	label values occup_year lbloccup_year
	drop  code_04 x_indic
*</_occup_year_>
...
save "$path_output\IND_2009_NSS66-SCH10_V01_M_V01_A_GLD.dta", replace
