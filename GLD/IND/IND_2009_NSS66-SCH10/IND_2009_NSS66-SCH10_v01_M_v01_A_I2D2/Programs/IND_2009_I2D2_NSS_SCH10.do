...
** DIRECTORY
	local path "D:\__I2D2\India\2009\NSS_SCH10"
...
** YEARS OF EDUCATION COMPLETED
	recode c4_7 ( 1/4= 0) (5 = 1) (6=5) (7=8) (8 =10) (10=12) (11=13) (12=15) (13=17), gen(educy)
...
** EDUCATIONAL LEVEL 1
	gen edulevel1=.
	replace edulevel1=1 if c4_7==1
	replace edulevel1=2 if c4_7==5
	replace edulevel1=3 if c4_7==6
	replace edulevel1=4 if c4_7==7|c4_7==8
	replace edulevel1=5 if c4_7==10
	replace edulevel1=7 if c4_7>=11 & c4_7!=.
	replace edulevel1=8 if c4_7==2 |c4_7==3|c4_7==4
...
** NUMBER OF ADDITIONAL JOBS
	...
	replace njobs=1 if c52_3!=. & lstatus==1
...
**SURVEY SPECIFIC INDUSTRY CLASSIFICATION
	destring c51_5, gen(industry_orig)
...
** SURVEY SPECIFIC OCCUPATION CLASSIFICATION
	destring c51_6, gen(occup_orig) force
...
** WAGES TIME UNIT - SECOND JOB
	gen unitwage_2=.
	replace unitwage_2=1 if  c53_182==1| c53_182==16
	replace unitwage_2=2 if  c53_182==2| c53_182==17
	replace unitwage_2=3 if  c53_182==3| c53_182==18
	replace unitwage_2=5 if  c53_182==4| c53_182==19
...
** DELETE MISSING VARIABLES
	...
	save "`path'\Processed\IND_2009_I2D2_NSS_SCH10.dta", replace
