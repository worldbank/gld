...
<_Program name_>				IND_1983_EUS_V01_M_V01_A_GLD.do </_Program name_>
...
global path_in "C:\Users\wb529026\OneDrive - WBG\Documents\Country Work\IND\IND_1983_EUS\IND_1983_EUS_v01_M\Data\Stata"
global path_output "C:\Users\wb529026\OneDrive - WBG\Documents\Country Work\IND\IND_1983_EUS\IND_1983_EUS_v01_M_v01_A_GLD\Data\Harmonized"
...
*<_industrycat10_>
	...
	replace industrycat10=1 if B41_q15 == "0"
	replace industrycat10=2 if B41_q15 == "1"
	replace industrycat10=3 if B41_q15 == "2" | B41_q15 == "3"
	replace industrycat10=4 if B41_q15 == "4"
	replace industrycat10=5 if B41_q15 == "5"
	replace industrycat10=6 if B41_q15 == "6"
	replace industrycat10=7 if B41_q15 == "7"
	replace industrycat10=8 if B41_q15 == "8"
	replace industrycat10=10 if B41_q15 == "9"
...
*<_industrycat_isic_2_>	
	...
	gen industrycat_isic_2 = isic_68
...
*<_lstatus_year_>
	...
	recode lstatus_year 11/51=1 81 82=2 1/4 91/99=3
...
*<_empstat_year_>
	...
	recode empstat_year (11=4) (12=3) (61 62 21=2) (31 41 42 51 52 71 72 =1) (1/4 81/98 99=.)
	destring B6_q7, gen(secondary_help)
	recode secondary_help  (11=4) (21=2) (31 41 51 = 1) (0/10 12/20 29 30 32/40 43 50 55 64 80 = .)	
...
*<_industry_orig_year_>
	...
	replace industry_orig_year = B6_q10 if missing(B6_q5) & lstatus_year == 1
...
*<_occup_orig_year_>
	...
	replace occup_orig_year = B6_q11 if missing(B6_q6)
...
*<_industry_orig_2_year_>
	gen industry_orig_2_year = B6_q10
...
save "$path_output\IND_1983_EUS_V01_M_V01_A_GLD_ALL.dta", replace
