...
<_Program name_>				IND_2017_PLFS_V01_M_V01_A_GLD_ALL.do </_Program name_>
<_Application_>					Stata 16 <_Application_>
<_Author(s)_>					  World Bank Jobs Group (gld@worldbank.org) </_Author(s)_>
<_Date created_>				2021-10-18 </_Date created_>
...
local path_in "C:\Users\wb529026\OneDrive - WBG\Documents\Country Work\IND\IND_2017_PLFS\IND_2017_PLFS_v01_M\Data\Stata"
local path_output "C:\Users\wb529026\OneDrive - WBG\Documents\Country Work\IND\IND_2017_PLFS\IND_2017_PLFS_v01_M_v01_A_GLD\Data\Harmonized"

*----------1.3: Database assembly------------------------------*

use "`path_in'\IND_2017_PLFS_raw_IND_Stata.dta", clear
...
use "`path_in'\IND_2017_PLFS_raw_HH_Stata.dta", clear
...
*<_int_year_>
	gen int_year= .
	replace int_year = 2011 if inlist(quarter,"Q1","Q2")
	replace int_year = 2012 if inlist(quarter,"Q3","Q4")
...
*<_int_month_>
	...
	replace int_month = . if !inrange(month,1,3) & quarter == "Q1"
	replace int_month = . if !inrange(month,4,6) & quarter == "Q2"
	replace int_month = . if !inrange(month,7,9) & quarter == "Q3"
	replace int_month = . if !inrange(month,10,12) & quarter == "Q4"
...
*<_subnatid1_>
	...
	label de lblsubnatid1 28 "28 - Andhra Pradesh" 12 "12 - Arunachal Pradesh" 18 "18 - Assam" 10 "10 - Bihar" 30 "30 - Goa" 24 "24 - Gujrat" 6 "6 - Haryana" 2 "2 - Himachal Pradesh" 1 "1 - Jammu & Kashmir" 29 "29 - Karnataka" 32 "32 - Kerala" 23 "23 - Madhya Pradesh" 27 "27 - Maharastra" 14 "14 - Manipur" 17 "17 - Meghalaya" 15 "15 - Mizoram" 13 "13 - Nagaland" 21 "21 - Orissa" 3 "3 - Punjab" 8 "8 - Rajasthan" 11 "11 - Sikkim" 33 "33 - Tamil Nadu" 16 "16 - Tripura" 9 "9 - Uttar Pradesh" 19 "19 - West Bengal" 35 "35 - Andaman & Nicober" 4 "4 - Chandigarh" 26 "26 - Dadra & Nagar Haveli" 25 "25 - Daman & Diu" 7 "7 - Delhi" 31 "31 - Lakshadweep" 34 "34 - Pondicheri" 22 "22 - Chhattisgarh" 20 "20 - Jharkhand" 5 "5 - Uttaranchal" 36 "36 - Telangana"
...
*<_literacy_>
	...
	replace literacy = 1 if general_ed != 1
...
*<_educat7_>
	...
	replace educat7 = 4 if inrange(general_ed,7,8)
	replace educat7 = 5 if general_ed == 10
...
*<_vocational_field_>
	gen vocational_field = field_training
	label var vocational_field "Field of training - As in original data"
*</_vocational_field_>
...
*<_nlfreason_>
	gen nlfreason = cws
	recode nlfreason (11/82 98=.) (91=1) (92 93=2) (94=3) (95=4) (96 97=5)
...
*<_ocusec_year_>
	...
	replace ocusec_year=2 if inlist(help_1,1,2,3,4,10,11,12)
	replace ocusec_year=3 if inlist(help_1,6,7,8)
	replace ocusec_year=1 if help_1==19
...
*<_contract_year_>
	...
	replace contract_year = 0 if inrange(help_1,2,4)
...
*<_ocusec_2_year_>
	...
	replace ocusec_2_year=2 if inlist(s_ent_type_code ,1,2,3,4,10,11,12)
	replace ocusec_2_year=3 if inlist(s_ent_type_code ,6,7,8)
	replace ocusec_2_year=1 if s_ent_type_code==19
...
save "`path_output'\IND_2017_PLFS_V01_M_V01_A_GLD_ALL.dta", replace
