...
<_Program name_>				IND_2024_PLFS_V01_M_V01_A_GLD_ALL.do </_Program name_>
...
<_Source of dataset_> 			https://microdata.gov.in/NADA/index.php/catalog/284 </_Source of dataset_>
<_Sample size (HH)_> 			270472 </_Sample size (HH)_>
<_Sample size (IND)_> 			1148634 </_Sample size (IND)_>
<_Sampling method_> 			See IND_2024_PLFS_V01_M/Doc/Technical materials. </_Sampling method_>
...
/* <_hhid_note>
	...
	omitting it creates duplicate IDs.
...
*<_unempldur_l_year_>
	...
	replace unempldur_l_year = . if lstatus != 2
...
*<_unempldur_u_year_>
	...
	replace unempldur_u_year = . if lstatus != 2
