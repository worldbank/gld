...
<_Program name_> 				IND_2021_PLFS_V01_M_V06_A_GLD_ALL.do </_Program name_>
<_Application_>					Stata 17 <_Application_>
<_Author(s)_>					World Bank Jobs Group (gld@worldbank.org) </_Author(s)_>
<_Date created_>				2026-03-03 </_Date created_>
...
* Date: 2023-11-13 - Update subnatid1_prev
* Date: 2024-01-05 - Update vars subnatid2, subnatid3
* Date: 2024-02-12 - Update go straight to district as admin2, just codes
* Date: 2024-04-17 - Update vars subnatid1
* Date: 2024-04-17 - Correct ISCO version and variables related to ISCO
...
local path_output   "C:/Users/wb529026/WBG/GLD - Focal Point/Countries/IND/IND_2017-2023_PLFS-Urban-Panel/IND_2017-2023_PLFS-Urban-Panel_V02_M/Data/Stata"
...
*<_subnatid1_>
	...
	label de lblsubnatid1 28 "28 - Andhra Pradesh" 12 "12 - Arunachal Pradesh" 18 "18 - Assam" 10 "10 - Bihar" 30 "30 - Goa" 24 "24 - Gujarat" 6 "6 - Haryana" 2 "2 - Himachal Pradesh" 1 "1 - Jammu & Kashmir" 29 "29 - Karnataka" 32 "32 - Kerala" 23 "23 - Madhya Pradesh" 27 "27 - Maharastra" 14 "14 - Manipur" 17 "17 - Meghalaya" 15 "15 - Mizoram" 13 "13 - Nagaland" 21 "21 - Odisha" 3 "3 - Punjab" 8 "8 - Rajasthan" 11 "11 - Sikkim" 33 "33 - Tamil Nadu" 16 "16 - Tripura" 9 "9 - Uttar Pradesh" 19 "19 - West Bengal" 35 "35 - Andaman & Nicober" 4 "4 - Chandigarh" 25 "25 - Dadra & Nagar Haveli and Daman & Diu" 7 "7 - Delhi" 31 "31 - Lakshadweep" 34 "34 - Pondicheri" 22 "22 - Chhattisgarh" 20 "20 - Jharkhand" 5 "5 - Uttaranchal" 36 "36 - Telangana" 37 "37 - Ladakh"
...
/* <_subnatid1_prev_note>
	...
	Two new changes. 
	1) The Union Territory (UT) of Ladakh was created out of land formerly part of JK.
	2) Dadra and Nagar Haveli has been joined into a single UT with Daman and Diu
...
*<_occup_isco_>
	gen occup_isco = cws_noc + "0" if !mi(cws_noc)
...
*<_occup_isco_year_>
	gen occup_isco_year = occup_orig_year + "0" if !mi(occup_orig_year)
...
*<_occup_isco_2_year_>
	gen occup_isco_2_year = occup_orig_2_year + "0" if !mi(occup_orig_2_year)
