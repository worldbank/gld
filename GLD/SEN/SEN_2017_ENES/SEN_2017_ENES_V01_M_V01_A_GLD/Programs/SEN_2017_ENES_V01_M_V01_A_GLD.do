...
/* <_subnatid1_note>
	...
	*Q4
	...
	replace subnatid1 = "1 - Dakar"         if inrange(dr_int, 1, 23)   & missing(subnatid1)
	replace subnatid1 = "2 - Ziguinchor"    if inrange(dr_int, 24, 38)  & missing(subnatid1)
	replace subnatid1 = "3 - Diourbel"      if inrange(dr_int, 39, 55)  & missing(subnatid1)
	replace subnatid1 = "4 - Saint-Louis"  if inrange(dr_int, 56, 73)  & missing(subnatid1)
	replace subnatid1 = "5 - Tambacounda"  if inrange(dr_int, 74, 88)  & missing(subnatid1)
	replace subnatid1 = "6 - Kaolack"      if inrange(dr_int, 89, 105) & missing(subnatid1)
	replace subnatid1 = "7 - Thies"        if inrange(dr_int, 106, 125)& missing(subnatid1)
	replace subnatid1 = "8 - Louga"        if inrange(dr_int, 126, 141)& missing(subnatid1)
	replace subnatid1 = "9 - Fatick"        if inrange(dr_int, 142, 156)& missing(subnatid1)
	replace subnatid1 = "10 - Kolda"         if inrange(dr_int, 157, 172)& missing(subnatid1)
	replace subnatid1 = "11 - Matam"         if inrange(dr_int, 173, 187)& missing(subnatid1)
	replace subnatid1 = "12 - Kaffrine"      if inrange(dr_int, 188, 201)& missing(subnatid1)
	replace subnatid1 = "13 - Kedougou"      if inrange(dr_int, 202, 212)& missing(subnatid1)
	replace subnatid1 = "14 - Sedhiou"       if inrange(dr_int, 213, 225)& missing(subnatid1)
