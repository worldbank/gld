...
*<_educat7_>
	gen byte educat7 = .
	replace educat7 = 1 if inrange(b30, 2, 3)
	replace educat7 = 2 if b33 == 1
	replace educat7 = 3 if b33 == 2
	replace educat7 = 4 if inrange(b33, 3, 4)
	replace educat7 = 5 if inrange(b33, 5, 6)
	replace educat7 = 7 if inrange(b33, 7, 8)
	label var educat7 "Level of education 1"
	la de lbleducat7 1 "No education" 2 "Primary incomplete" 3 "Primary complete" 4 "Secondary incomplete" 5 "Secondary complete" 6 "Higher than secondary but not university" 7 "University incomplete or complete", replace
...
*<_lstatus_>
	...
	*c5c includes people working on their own things at home , there is no information on whether they sell or not.
	replace lstatus = 1 if c1c==1 | c2c==1 | c3c==1 | c5c==1 
	* Interns or apprentices not binary questions
	replace lstatus = 1 if inrange(c4c, 1, 2)
	...
	** Unemployed **
	...
	gen passive = (g8 == 1)
	gen starters = (g5 == 16) //future starter (technically if soon, no follow up, is OK)
...
*<_empstat_>
	...
	recode empstat (1/3 7 = 1) (4 = 3) (6 = 4) (5 = 2)
