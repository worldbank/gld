...
<_Program name_>				MNG_2016_LFS_V01_M_V01_A_GLD_ALL.do </_Program name_>
...
<_Sample size (IND)_> 			43680 </_Sample size (IND)_>
...
use "`path_in_stata'/AXC_2016-eng data", clear
...
*<_wave_>
	* There is quarter - month inconsistency
	...
	la de lblwave 1 "January-March 2016" 2 "April-June 2016" 3 "July-September 2016" 4 "October-December 2016"
...
*<_occup_isco_2_>
	...
	* Replace the codes to 3-digit
	...
	replace occup_isco_2 = "9620" if occup_isco_2 == "9625"
...
*<_occup_isco_2_year_>
	...
	* Replace the codes to 3-digit
	...
	replace occup_isco_2_year = "9620" if occup_isco_2_year == "9625"
