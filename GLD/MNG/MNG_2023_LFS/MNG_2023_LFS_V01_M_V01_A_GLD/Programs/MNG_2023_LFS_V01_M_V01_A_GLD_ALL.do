...
<_Program name_>				MNG_2023_LFS_V01_M_V01_A_GLD_ALL.do </_Program name_>
...
<_Sample size (HH)_> 			6,582 unique households in the harmonized file </_Sample size (HH)_>
<_Sample size (IND)_> 			49,903 person-quarter records in the harmonized file </_Sample size (IND)_>
...
use "`path_in_stata'/LFS_2023_eng.dta", clear
rename *, upper
...
The 2023 LFS raw file identifies the province or capital city directly through
...
The raw 2023 code list is almost entirely ISIC-4 compliant but still contains
...
The questionnaire identifies occupation as ISCO-08, but the raw 2023 code list
