...
<_Program name_>				MNG_2008_LFS_V01_M_V01_A_GLD_ALL.do </_Program name_>
...
<_Data collection from_>		07/2008 </_Data collection from_>
...
<_Sample size (IND)_> 			24940 </_Sample size (IND)_>
...
use "`path_in_stata'/8. LFS 2008-2009_eng.dta", clear
...
*<_int_year_>
	...
	recode int_year 1 2=2008 3 4=2009
...
*<_nlfreason_>
	gen byte nlfreason= IV104 if IV104!=1
	recode nlfreason (3 = 1) (7 8 9 10 11 12= 5) (4 5 = 3) (6 = 4)
...
*<_empstat_>
	gen byte empstat=. 
	replace empstat=1 if II58==1  |  II58==2
	replace empstat=2 if II58==6
	replace empstat=3 if II58 == 2
	replace empstat=4 if inlist(II58,  3, 5)
...
*<_ocusec_>
	...
	replace ocusec=3 if II62==40 | II62==50 // state enterprise
...
*<_occup_>
	...
	replace occup=9 if II53>9000 & II53<9629
	replace occup=99 if inrange(II53, 9630, 9999)
...
*<_industrycat_isic_2_>
	...
	replace industrycat_isic_2 = "" if missing(industry_orig_2) | industrycat_isic_2 == "9800" | industrycat_isic_2 == "9900"
...
*<_empstat_2_year_>
	...
	replace empstat_2_year=5 if V127==4 | V127==7
