...
<_Program name_>				MNG_2012_LFS_V01_M_V01_A_GLD_ALL.do </_Program name_>
...
<_Sample size (IND)_> 			45442 </_Sample size (IND)_>
...
use "`path_in_stata'/14. LFS 2012_eng.dta", clear
...
*<_pid_>
	...
	* There are duplicates based on pid (turns out they are exact match : same age, hh rel, sex, etc...)
...
*<_wave_>
	gen wave = QUARTER
	la de lblwave 1 "January-March 2012" 2 "April-June 2012" 3 "July-September 2012" 4 "October-December 2012"
...
*<_lstatus_>
	...
	replace lstatus=2 if lstatus !=1  & (V90 ==1 & V92 ==1)
...
*<_occup_isco_>
	...
	* Replace the codes to 3-digit
	...
	replace occup_isco = "2130" if occup_isco == "2139"
	replace occup_isco = "9310" if occup_isco == "9314"
	replace occup_isco = "9310" if occup_isco == "9317"
	replace occup_isco = "9310" if occup_isco == "9316"
...
*<_occup_isco_2_>
	...
	* Replace the codes to 3-digit
	...
	replace occup_isco_2 = "4410" if occup_isco_2 == "4417"
	replace occup_isco_2 = "9310" if occup_isco_2 == "9317"
	replace occup_isco_2 = "9310" if occup_isco_2 == "9314"
	replace occup_isco_2 = "8160" if occup_isco_2 == "8161"
...
*<_occup_isco_year_>
	...
	* Replace the codes to 3-digit
	...
	replace occup_isco_year = "2120" if occup_isco_year == "212"
	replace occup_isco_year = "2110" if occup_isco_year == "211"
	replace occup_isco_year = "9620" if occup_isco_year == "9627"
	replace occup_isco_year = "3110" if occup_isco_year == "311"
	replace occup_isco_year = "3130" if occup_isco_year == "313"
...
*<_empstat_2_year_>
	...
	replace empstat_2_year=5 if VI114==4 | VI114==7
...
*<_occup_isco_2_year_>
	...
	* Replace the codes to 3-digit
	...
	replace occup_isco_2_year = "8160" if occup_isco_2_year == "8161"
