...
<_Program name_>				MNG_2010_LFS_V01_M_V01_A_GLD_ALL.do </_Program name_>
...
<_Sample size (IND)_> 			47493 </_Sample size (IND)_>
...
use "`path_in_stata'/10. LFS 2010_eng.dta", clear
...
*<_wave_>
	gen wave = QUARTER
	la de lblwave 1 "January-March 2010" 2 "April-June 2010" 3 "July-September 2010" 4 "October-December 2010"
...
*<_migrated_reason_>
	...
	recode migrated_reason (1 2 = 3) (3 = 2) (4 = 1) (5 8 = 1) (6 = 4) (7  9 10 11 12= 5)
...
*<_vocational_field_orig_>
	tostring I21A, gen(vocational_field_orig)
...
*<_lstatus_>
	gen byte lstatus=.
	replace lstatus=1 if (II37>=1 & II37!=.) |(II53==1 & II37==0)
	replace lstatus=2 if lstatus !=1  & (IV103 ==1 & IV104 ==1)
...
*<_potential_lf_>
	...
	replace potential_lf = 1 if (IV103 == 1 & IV104 != 1) | (IV104 == 1 & IV103!= 1)
...
*<_underemployment_>
	...
	replace underemployment = 1 if IV103 == 1
...
*<_unempldur_l_>
	...
	replace unempldur_l=0 if IV107==1
	replace unempldur_l=1 if IV107==2
	replace unempldur_l=3 if IV107==3
	replace unempldur_l=7 if IV107==4
	replace unempldur_l=12 if IV107==5
	replace unempldur_l=36 if IV107==6
...
*<_unempldur_u_>
	...
	replace unempldur_u=1 if IV107==1
	replace unempldur_u=2 if IV107==2
	replace unempldur_u=6 if IV107==3
	replace unempldur_u=11 if IV107==4
	replace unempldur_u=24 if IV107==5
	replace unempldur_u=. if IV107==6
...
*<_empstat_>
	gen byte empstat=. 
	replace empstat=1 if II59==1 
	replace empstat=2 if II59==6
	replace empstat=3 if II59==2
	replace empstat=4 if inlist(II59, 3, 5)
	replace empstat=5 if II59==4 | II59==7
...
*<_industry_orig_>
	...
	replace industry_orig = 140 if II59 == 5
...
*<_industrycat_isic_>
	...
	* Replace the codes to 2-digit
	...
	replace industrycat_isic = "1300" if industrycat_isic == "1324"
...
*<_occup_>
	gen byte occup=.
	replace occup=1 if II54>1000 & II54<2000
	replace occup=2 if II54>2000 & II54<3000
	replace occup=3 if II54>3000 & II54<4000
	replace occup=4 if II54>4000 & II54<5000
	replace occup=5 if II54>5000 & II54<6000
	replace occup=6 if II54>6000 & II54<7000
	replace occup=7 if II54>7000 & II54<8000
	replace occup=8 if II54>8000 & II54<9000
	replace occup=9 if II54>9000 & II54<9629
	replace occup=99 if inrange(II54, 9630, 9999)
...
*<_whours_>
	gen whours=  II55 if lstatus==1 & ( II55>=1 &  II55!=.) 
...
*<_empstat_2_>
	gen byte empstat_2= . 
	replace empstat_2=1 if II84==1
	replace empstat_2=2 if II84==6
	replace empstat_2=4 if II84==3
	replace empstat_2=3 if II84==2
	replace empstat_2=4 if II84==3
...
*<_ocusec_2_>
	gen byte ocusec_2 = .
	replace ocusec_2=1 if II87==50 // local govt enterprise
	replace ocusec_2=1 if II87==60 // budget organization - receives budget allocation from govt
	replace ocusec_2=2 if II87==70 | II87==80
	replace ocusec_2=3 if II87==40 // state enterprise
...
*<_industrycat_isic_2_>
	...
	* Replace the codes to 2-digit
	...
	replace industrycat_isic_2 = "1300" if industrycat_isic_2 == "1321"
	replace industrycat_isic_2 = "1300" if industrycat_isic_2 == "1324"
	replace industrycat_isic_2 = "1300" if industrycat_isic_2 == "1323"
...
*<_occup_2_>
	...
	replace occup_2=9 if II81>9000 & II81<9629
	replace occup_2=99 if inrange(II81, 9630, 9999)
...
*<_wage_no_compen_2_>
	...
	* Gets paid in cash
	replace wage_no_compen_2= II98A
	
	* Gets paid in kind
	replace wage_no_compen_2 = II98B
	
	* Gets paid in cash and inkind
	replace wage_no_compen_2 = II98A + II98B if !missing(II98A) & !missing(II98B)
...
*<_firmsize_l_2_>
	gen firmsize_l_2 = .
	replace firmsize_l_2=1 if II97==1
	replace firmsize_l_2=5 if II97==2
...
*<_firmsize_u_2_>
	gen firmsize_u_2 = .
	replace firmsize_u_2=4 if II97==1
	replace firmsize_u_2=. if II97==2
...
* Only asked if economically active (employed/unemployed) or employed most of the time. Assume unemployed if economically active and not employed most of the time
	...
	replace lstatus_year = 1 if V113 == 1
	replace lstatus_year = 2 if V113 == 2 & V111 == 1
	replace lstatus_year = 3 if V111 == 2
...
*<_unempldur_l_year_>
	...
	replace unempldur_l_year = 0 if V115 == 1
	replace unempldur_l_year = 4 if V115 == 2
	replace unempldur_l_year = 7 if V115 == 3
	replace unempldur_l_year = 12 if V115 == 4
	replace unempldur_l_year = 36 if V115 == 5
	replace unempldur_l_year = 60 if V115 == 6
...
*<_unempldur_u_year_>
	...
	replace unempldur_u_year = 3 if V115 == 1
	replace unempldur_u_year = 6 if V115 == 2
	replace unempldur_u_year = 11 if V115 == 3
	replace unempldur_u_year = 24 if V115 == 4
	replace unempldur_u_year = 48 if V115 == 5
	replace unempldur_u_year = . if V115 == 6
...
*<_empstat_year_>
	...
	replace empstat_year=1 if V126==1 
	replace empstat_year=2 if V126==6
	replace empstat_year=3 if V126==2
	replace empstat_year=4 if inlist(V126, 3, 5)
	replace empstat_year=5 if V126==4 | V126==7
...
*<_industrycat_isic_year_> 
	...
	* Replace the codes to 2-digit
	...
	replace industrycat_isic_year = "1300" if industrycat_isic_year == "1324"
...
* For the usual activity status, wages are either reported monthly or daily
	...
	* Create month wage
	gen month_wage_year = V122A
	replace month_wage_year = . if month_wage_year == 0
	
	* Day wage
	gen day_wage_year = V122B
...
*<_empstat_2_year_>
	...
	replace empstat_2_year=1 if V126==1 
	replace empstat_2_year=2 if V126==6
	replace empstat_2_year=3 if V126==2
	replace empstat_2_year=4 if inlist(V126, 3, 5)
	replace empstat_2_year=5 if V126==4 | V126==7
...
*<_industrycat_isic_2_year_>
	...
	* Replace the codes to 2-digit
	...
	replace industrycat_isic_2_year = "1300" if industrycat_isic_2_year == "1324"
	replace industrycat_isic_2_year = "1300" if industrycat_isic_2_year == "1323"
	replace industrycat_isic_2_year = "1300" if industrycat_isic_2_year == "1329"
...
* But we can impute secondary activity earnings by subtracting primary from all
	...
	gen diff_month = V129A - V122A
	gen diff_day = V129B - V122B
