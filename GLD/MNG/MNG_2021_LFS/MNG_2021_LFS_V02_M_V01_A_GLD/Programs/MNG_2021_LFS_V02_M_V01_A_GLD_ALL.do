...
<_Program name_>				MNG_2021_LFS_V02_M_V01_A_GLD_ALL.do </_Program name_>
...
<_Sample size (HH)_> 			6,158 unique households in the harmonized file </_Sample size (HH)_>
<_Sample size (IND)_> 			46,875 person-quarter records in the harmonized file </_Sample size (IND)_>
...
use "`path_in_stata'/LFS_2021_eng.dta", clear
rename *, upper
...
The 2021 V02_M raw file identifies the province or capital city directly through
...
The raw 2021 V02_M code list is almost entirely ISIC-4 compliant but still contains
...
The questionnaire identifies occupation as ISCO-08, but the raw 2021 V02_M code list
