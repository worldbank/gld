...
<_Program name_>				MNG_2006_LFS_V01_M_V01_A_GLD_ALL.do </_Program name_>
...
<_Survey Title_>				Mongolia Labor Force Survey 2006 - 2007 </_Survey Title_>
...
<_Sample size (HH)_> 			12286 </_Sample size (HH)_>
<_Sample size (IND)_> 			48108 </_Sample size (IND)_>
...
<_ISIC Version_>				ISIC Version 3.1 </_ISIC Version_>
<_INDUS National_>				ISIC Version 3.1 </_INDUS National_>
...
import spss using "`path_in_other'/LFS 2006-2007.sav", clear
save   "`path_in_stata'/LFS 2006-2007.dta", replace
*/


use "`path_in_stata'/LFS 2006-2007.dta", clear
...
*<_int_month_>
	gen int_month= StartMonth
	* Weird, there are some respondents where FinishMonth/FinishYear occurs before StartMonth/StartYear
	count if FinishYear<StartYear
	* The QUARTER variable is consistent with the FinishMonth, so when this condition holds, replace with FinishMonth
	replace int_month = FinishMonth if FinishYear<StartYear
...
*<_hhid_>
	* It seems that the data is unique at the stratum - substratum - FSU - SSU - HH # - Ind # level
	...
	gen ssstrata_str = string(SSSTRATA)
	gen fsu_str = string(FSU, "%04.0f")
	gen ssu_str = string(SSU, "%02.0f")
	gen hh_str = string(HHNUM, "%04.0f")
	
	egen hhid = concat(stratum_str ssstrata_str fsu_str ssu_str  hh_str)
...
*<_wave_>
	gen wave = QUARTER
	la de lblwave 1 "July-September 2006" 2 "October-December 2006" 3 "January-March 2007" 4 "April-June 2007"
...
*<_potential_lf_>
	...
	replace potential_lf = 1 if (IV82 == 1 & IV83 != 1) | (IV83 == 1 & IV82!= 1)
...
*<_underemployment_>
	...
	replace underemployment = 1 if III78 == 1
...
*<_nlfreason_>
	gen byte nlfreason= V91
	recode nlfreason (3 7 8 9 10= 5) (4 = 3) (6 = 4) 
...
*<_unempldur_l_>
	...
	replace unempldur_l=0 if IV86==1
	replace unempldur_l=1 if IV86==2
	replace unempldur_l=3 if IV86==3
	replace unempldur_l=7 if IV86==4
	replace unempldur_l=12 if IV86==5
	replace unempldur_l=36 if IV86==6
...
*<_unempldur_u_>
	...
	replace unempldur_u=1 if IV86==1
	replace unempldur_u=2 if IV86==2
	replace unempldur_u=6 if IV86==3
	replace unempldur_u=11 if IV86==4
	replace unempldur_u=24 if IV86==5
	replace unempldur_u=. if IV86==6
...
*<_empstat_>
	gen byte empstat= . 
	replace empstat=1 if II57==1 |  II57==2 
	replace empstat=2 if II57==6
	replace empstat=3 if II57==3
	replace empstat=4 if II57==5
	replace empstat=5 if II57 == 7 |  II57==4
...
*<_ocusec_>
	gen byte ocusec=2
	replace ocusec=4 if II58==31
	replace ocusec=3 if inlist(II58, 40, 50)
	replace ocusec=1 if II58 == 60
	replace ocusec=. if II58==.
...
*<_industrycat_isic_>
	gen industrycat_isic = subinstr(industry_orig, ".", "0", .) 
	replace industrycat_isic = industrycat_isic + "0" if length(industrycat_isic) == 3
	replace industrycat_isic = industrycat_isic + "00" if length(industrycat_isic) == 2
	replace industrycat_isic = industrycat_isic + "000" if length(industrycat_isic) == 1
	
	* Replace the codes to 3-digit
	replace industrycat_isic = "6420" if industrycat_isic == "6421"
	replace industrycat_isic = "5510" if industrycat_isic == "5511"
	replace industrycat_isic = "5520" if industrycat_isic == "5521"
	replace industrycat_isic = "6420" if industrycat_isic == "6426"
	replace industrycat_isic = "6420" if industrycat_isic == "6422"
	replace industrycat_isic = "5510" if industrycat_isic == "5512"
	replace industrycat_isic = "4520" if industrycat_isic == "4521"
	replace industrycat_isic = "5520" if industrycat_isic == "5522"
	replace industrycat_isic = "6590" if industrycat_isic == "6593"
	replace industrycat_isic = "6300" if industrycat_isic == "6305"
	replace industrycat_isic = "6120" if industrycat_isic == "6121"
	replace industrycat_isic = "6420" if industrycat_isic == "6425"
	replace industrycat_isic = "6110" if industrycat_isic == "6111"
	replace industrycat_isic = "6110" if industrycat_isic == "6112"
	replace industrycat_isic = "6300" if industrycat_isic == "6306"
	replace industrycat_isic = "6420" if industrycat_isic == "6423"
	replace industrycat_isic = "6420" if industrycat_isic == "6424"
	replace industrycat_isic = "7430" if industrycat_isic == "7431"
	
	* Replace the codes to 2-digit
	replace industrycat_isic = "6100" if industrycat_isic == "6141"
	replace industrycat_isic = "1100" if industrycat_isic == "1153"
	
	* These codes were set to missing because not in isic_3.1
	replace industrycat_isic = "" if industrycat_isic == "0300" | missing(industry_orig)
...
*<_industrycat10_>
	gen isic3d = substr(industrycat_isic, 1, 3)
	destring  isic3d, gen(ind_num)
	gen byte industrycat10=.
	replace industrycat10=1 if (ind_num>=10 & ind_num<=50)
	replace industrycat10=2 if (ind_num>=100 & ind_num<150) 
	replace industrycat10=3 if (ind_num>=150 & ind_num<380)
	replace industrycat10=4 if (ind_num>=400 & ind_num<420)
	replace industrycat10=5 if (ind_num>=450 & ind_num<500)
	replace industrycat10=6 if (ind_num>=500 & ind_num<600)
	replace industrycat10=7 if (ind_num>=600 & ind_num<650)
	replace industrycat10=8 if (ind_num>=650 & ind_num<750)
	replace industrycat10=9 if (ind_num>=750 & ind_num<760)
	replace industrycat10 = 10 if (ind_num>=760 & ind_num<999)
...
*<_occup_isco_>
	...
	* Replace the codes to 2-digit
	replace occup_isco = "1100" if occup_isco == "1153"
	replace occup_isco = "5200" if occup_isco == "5250"
	replace occup_isco = "1300" if occup_isco == "1332"
	* Replace the codes to 1-digit
	...
	replace occup_isco = "9000" if occup_isco == "9422"
...
*<_wage_no_compen_>
	...
	* Gets paid in cash
	replace wage_no_compen= II74A
	
	* Gets paid in kind
	replace wage_no_compen = II74B
	
	* Gets paid in cash and inkind
	replace wage_no_compen = II74A + II74B if !missing(II74A) & !missing(II74B)
...
*<_whours_>
	gen whours=  II52 if lstatus==1 & ( II52>=1 &  II52!=.) 
...
*<_firmsize_l_>
	gen byte firmsize_l= .
	replace firmsize_l=1 if II61==2
	replace firmsize_l=5 if II61==3
	replace firmsize_l=10 if II61==4
...
*<_firmsize_u_>
	gen byte firmsize_u=.
	replace firmsize_u=4 if II61==2
	replace firmsize_u=9 if II61==3
	replace firmsize_u=. if II61==4
...
*<_empstat_2_>
	gen byte empstat_2= . 
	replace empstat_2=1 if II68==1 |  II68==2 
	replace empstat_2=2 if II68==6
	replace empstat_2=3 if II68==3
	replace empstat_2=4 if II68==5
	replace empstat_2=5 if II68 == 7 |  II68==4
	replace empstat_2=. if II62 == 2 & II63 == 2
...
*<_ocusec_2_>
	gen byte ocusec_2 = 2
	replace ocusec_2=4 if II69==31
	replace ocusec_2=3 if II69==50
	replace ocusec_2=3 if II69==40
	replace ocusec_2=1 if II69==60
	replace ocusec_2=. if II69==.
...
*<_industrycat_isic_2_>
	...
	replace industrycat_isic_2 = "6300" if industrycat_isic_2 == "6305"
...
*<_occup_isco_2_>
	gen occup_isco_2 = occup_orig_2 if !missing(occup_orig_2)
	replace occup_isco_2 = "9000" if occup_isco_2 == "9888"
...
*<_occup_2_>
	gen byte occup_2=.
	replace occup_2=1 if II64>1000 & II64<2000
	replace occup_2=2 if II64>2000 & II64<3000
	replace occup_2=3 if II64>3000 & II64<4000
	replace occup_2=4 if II64>4000 & II64<5000
	replace occup_2=5 if II64>5000 & II64<6000
	replace occup_2=6 if II64>6000 & II64<7000
	replace occup_2=7 if II64>7000 & II64<8000
	replace occup_2=8 if II64>8000 & II64<9000
	replace occup_2=9 if II64>9000 & II64<10000
	replace occup_2=99 if II64==9999
...
*<_wage_no_compen_2_>
	...
	* Gets paid in cash
	replace wage_no_compen_2= II75A
	
	* Gets paid in kind
	replace wage_no_compen_2 = II75B
	
	* Gets paid in cash and inkind
	replace wage_no_compen_2 = II75A + II75B if !missing(II75A) & !missing(II75B)
	replace wage_no_compen_2 = wage_no_compen_2*1000 if !missing(wage_no_compen_2)
...
*<_firmsize_l_2_>
	gen firmsize_l_2 = .
	replace firmsize_l_2=1 if II72==2
	replace firmsize_l_2=5 if II72==3
	replace firmsize_l_2=10 if II72==4
...
*<_firmsize_u_2_>
	gen firmsize_u_2 = .
	replace firmsize_u_2=4 if II72==2
	replace firmsize_u_2=9 if II72==3
	replace firmsize_u_2=. if II72==4
...
*<_lstatus_year_>
	...
	replace lstatus_year = 1 if V92 == 1
	replace lstatus_year = 2 if V92 == 2 & V90 == 1
	replace lstatus_year = 3 if V90 == 2
...
*<_unempldur_l_year_>
	...
	replace unempldur_l_year = 0 if V94 == 1
	replace unempldur_l_year = 4 if V94 == 2
	replace unempldur_l_year = 7 if V94 == 3
	replace unempldur_l_year = 12 if V94 == 4
	replace unempldur_l_year = 36 if V94 == 5
	replace unempldur_l_year = 60 if V94 == 6
...
*<_unempldur_u_year_>
	...
	replace unempldur_u_year = 3 if V94 == 1
	replace unempldur_u_year = 6 if V94 == 2
	replace unempldur_u_year = 11 if V94 == 3
	replace unempldur_u_year = 24 if V94 == 4
	replace unempldur_u_year = 48 if V94 == 5
	replace unempldur_u_year = . if V94 == 6
...
*<_empstat_year_>
	...
	replace empstat_year=1 if V98==1 |  V98==2 
	replace empstat_year=2 if V98==6
	replace empstat_year=3 if V98==3
	replace empstat_year=4 if V98==5
...
*<_industrycat_isic_year_>
	gen industrycat_isic_year = industry_orig_year if !missing(industry_orig_year)

	* Replace the codes to 3-digit
	replace industrycat_isic_year = "6420" if industrycat_isic_year == "6421"
	replace industrycat_isic_year = "5510" if industrycat_isic_year == "5511"
	replace industrycat_isic_year = "5520" if industrycat_isic_year == "5521"
	replace industrycat_isic_year = "6420" if industrycat_isic_year == "6426"
	replace industrycat_isic_year = "6420" if industrycat_isic_year == "6422"
	replace industrycat_isic_year = "5510" if industrycat_isic_year == "5512"
	replace industrycat_isic_year = "4520" if industrycat_isic_year == "4521"
	replace industrycat_isic_year = "5520" if industrycat_isic_year == "5522"
	replace industrycat_isic_year = "6300" if industrycat_isic_year == "6305"
	replace industrycat_isic_year = "6590" if industrycat_isic_year == "6593"
	replace industrycat_isic_year = "6420" if industrycat_isic_year == "6425"
	replace industrycat_isic_year = "6300" if industrycat_isic_year == "6306"
	replace industrycat_isic_year = "6420" if industrycat_isic_year == "6423"
	replace industrycat_isic_year = "6420" if industrycat_isic_year == "6424"
	replace industrycat_isic_year = "6110" if industrycat_isic_year == "6113"
	replace industrycat_isic_year = "7430" if industrycat_isic_year == "7431"
	* Replace the codes to 2-digit
	replace industrycat_isic_year = "6100" if industrycat_isic_year == "6141"
	replace industrycat_isic_year = "9300" if industrycat_isic_year == "9313"
	label var industrycat_isic_year "ISIC code of primary job 12 month recall"
*</_industrycat_isic_year_>

*<_industrycat10_year_>
	gen byte industrycat10_year = .
	gen isic3d_year = substr(industrycat_isic_year, 1, 3)
...
*<_occup_isco_year_>
	gen occup_isco_year = occup_orig_year
	...
	* Replace the codes to 3-digit
	...
	replace occup_isco_year = "9310" if occup_isco_year == "9319"
	replace occup_isco_year = "4130" if occup_isco_year == "4134"
	
	* Replace the codes to 2-digit
	replace occup_isco_year = "1300" if occup_isco_year == "1332"
	...
	* Replace the codes to 1-digit
	...
	replace occup_isco_year = "9000" if occup_isco_year == "9422"
...
* For the usual activity status, wages are either reported monthly or daily
	...
	* Create month wage
	gen month_wage_year = V101A
	replace month_wage_year = . if month_wage_year == 0
	
	* Day wage -- not available in the data!
	/* gen day_wage_year = V101B
	replace day_wage_year = . if day_wage_year == 0 */
	

	replace wage_no_compen_year = month_wage_year
	replace wage_no_compen_year = wage_no_compen_year * 1000 if !missing(wage_no_compen_year)
...
*<_empstat_2_year_>
	...
	replace empstat_2_year=1 if V105==1 |  V105==2 
	replace empstat_2_year=2 if V105==6
	replace empstat_2_year=3 if V105==3
	replace empstat_2_year=4 if V105==5
	replace empstat_2_year=5 if V105 == 7 |  V105==4
...
*<_industrycat_isic_2_year_>
	gen industrycat_isic_2_year = industry_orig_2_year if !missing(industry_orig_2_year)
	
	* Replace the codes to 3-digit
	replace industrycat_isic_2_year = "4520" if industrycat_isic_2_year == "4521"
...
*<_occup_orig_2_year_>
	tostring V103, gen(occup_orig_2_year)
...
* But we can impute secondary activity earnings by subtracting primary from all
	...
	gen diff_month = V108A - V101A
	
	replace  wage_no_compen_2_year = diff_month
	replace wage_no_compen_2_year = . if missing(empstat_2_year)
	
	replace wage_no_compen_2_year = wage_no_compen_2_year * 1000 if !missing(wage_no_compen_2_year)
