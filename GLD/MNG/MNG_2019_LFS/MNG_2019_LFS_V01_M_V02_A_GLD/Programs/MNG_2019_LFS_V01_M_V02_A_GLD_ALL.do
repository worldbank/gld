...
<_Program name_> 			MNG_2019_LFS_V01_M_V02_A_GLD_ALL.do </_Program name_>
<_Application_>					Stata 17 <_Application_>
<_Author(s)_>					World Bank Jobs Group (gld@worldbank.org) </_Author(s)_>
<_Date created_>				2023-07-09 </_Date created_>
...
<_Sample size (HH)_> 			5,922 </_Sample size (HH)_>
<_Sample size (IND)_> 			20,388 </_Sample size (IND)_>
...
* Date: 2023-09-15 - Update vars whours, socialsec
...
use "`path_in_stata'/3.-LFSdata_2019_eng.dta", clear
...
*<_hhid_>
* Here we can form a panel across quarters within a year
* But the same HHID and PID are re-used in the next years leading to confusion that
* the same HH is interviewed over multiple years, when the panel can only be formed 
* within a year. The rotation seems to be refreshed after every LFS year

	gen psu_str= string(PSU, "%03.0f")
	gen ssu_str= string(SSU, "%02.0f")
	gen year_str = string(SYR)
...
*<_migrated_binary_>
	...
	recode migrated_binary (2=1) (3 = 0)
...
*<_migrated_from_cat_>
	...
	replace migrated_from_cat = 2 if A20 == AD
...
*<_migrated_reason_>
	...
	recode migrated_reason (1 2 3= 3) (4 5= 2) (6 7 = 1) (9 = 4) (8 10 11 12 13= 5)
...
*<_lstatus_>
	...
	* E6: Engaged in farming, fishing or logging mostly for sale
...
*<_industrycat_isic_>
	...
	* Replace the codes to 2-digit
	replace industrycat_isic = "2300" if industrycat_isic == "2342"
...
*<_occup_isco_>
	...
	* Replace the codes to 3-digit
	...
	replace occup_isco = "2610" if occup_isco == "2613"
...
*<_socialsec_>
	gen byte socialsec=.
	replace socialsec = 1 if E19 == 1
	replace socialsec = 0 if !missing(E19) & E19 != 1
