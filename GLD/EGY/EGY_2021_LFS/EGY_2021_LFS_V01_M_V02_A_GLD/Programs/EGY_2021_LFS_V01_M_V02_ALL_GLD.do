...
<_Program name_>				[EGY_2021_LFS_V01_M_V02_A_GLD_ALL.do] </_Program name_>
<_Application_>					[STATA 16] <_Application_>
<_Author(s)_>					World Bank Jobs Group (gld@worldbank.org) </_Author(s)_>
<_Date created_>				2026-06-24 </_Date created_>
...
<_ISIC Version_>				ISI- 4 </_ISIC Version_>
...
use "`path_in_stata'\Egypt 2021-LFS HH-V2.dta"


*Merge to individual file
merge 1:m caseser using "`path_in_stata'\Egypt 2021-LFS IND-V2.dta"
...
*<_occup_orig_>
	gen occup_orig = string(occ_isco08_4, "%04.0f")
...
*<_occup_isco_>
	gen occup_isco = string(occ_isco08_4,"%04.0f")
	replace occup_isco="" if occ_isco08_4==.
	replace occup_isco="" if occ_isco08_4==9999
...
*<_occup_skill_>
	gen byte occup_skill = (occ_isco08_4/1000)
	replace occup_skill = . if occ_isco08_4 == 9999
...
*<_occup_>
	gen byte occup = (occ_isco08_4/1000)
	replace occup = . if occ_isco08_4 == 9999
	recode occup  0=.
...
/* <_wage_no_compen_note>
	...
	empinc: Total monthly income (for employers) from the main job
	sempinc: Total monthly income (for self-employed) from the main job
</_wage_no_compen_note> */

	gen double wage_no_compen = round(totwag)
	replace wage_no_compen = round(irrgwag) if missing(wage_no_compen)
	replace wage_no_compen = round(empinc) if missing(wage_no_compen)
	replace wage_no_compen = round(sempinc) if missing(wage_no_compen)
...
/* <_unitwage_note>
	...
	gen byte unitwage = 5
	replace unitwage = 1 if !missing(irrgwag)
...
*<_occup_orig_2_>
	gen occup_orig_2 = string(occsc_isco08_4, "%04.0f")
	replace occup_orig_2 = "" if occsc_isco08_4==.
	label var occup_orig_2 "Original occupation record secondary job 7 day recall"
*</_occup_orig_2_>


*<_occup_isco_2_>
	gen occup_isco_2 = string(occsc_isco08_4,"%04.0f")
	replace occup_isco_2="" if occsc_isco08_4==.
	replace occup_isco_2="" if occsc_isco08_4==9999
...
*<_occup_skill_2_>
	gen     occup_skill_2 = floor(occsc_isco08_4/1000)
	replace occup_skill_2 = . if occsc_isco08_4 == 9999
	recode  occup_skill_2 (1/3=3) (4/8=2) (9=1) (0=.)
	la de lblskill2 1 "Low skill" 2 "Medium skill" 3 "High skill", replace
...
*<_occup_2_>
	gen byte occup_2 = floor(occsc_isco08_4/1000)
	replace occup = . if occsc_isco08_4 == 9999
...
*<_njobs_>
gen njobs_helper_1= secjob==1
	gen njobs_helper_2= inrange(emps,1,4) | emps == 99 
