...
<_Program name_>				[EGY_2020_LFS_V01_M_V02_A_GLD_ALL.do] </_Program name_>
...
use "`path_in_stata'\Egypt 2020-LFS HH-V2.dta"


*Merge to individual file
merge 1:m caseser using "`path_in_stata'\Egypt 2020-LFS IND-V2.dta"
...
*<_occup_orig_>
	gen occup_orig = string(occ_isco08_4)
...
*<_occup_isco_>
	...
	replace occup_isco="9100" if occ_isco08_4==9152
