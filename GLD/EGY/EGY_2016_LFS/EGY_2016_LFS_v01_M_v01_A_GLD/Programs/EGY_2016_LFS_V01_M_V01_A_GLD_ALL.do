...
<_Program name_>				[EGY_2016_LFS_V01_M_V01_A_GLD_ALL.do] </_Program name_>
...
*local path_in "Z:\GLD-Harmonization\582018_AQ\EGY\EGY_2016_LFS\EGY_2016_LFS_v01_M\Data\Stata"
local path_in "/Users/aleqn/Desktop/2016"
*local path_output "Z:\GLD-Harmonization\582018_AQ\EGY\EGY_2016_LFS\EGY_2016_LFS_v01_M_v01_A_GLD\Data\Harmonized"
local path_output"/Users/aleqn/Desktop/2016/Harmonized"
...
*use "`path_in'\Egypt 2016-LFS HH-V1.dta"
use "`path_in'/Egypt 2016-LFS HH-V1.dta"

*Merge to individual file
*merge 1:m caseser using "`path_in'\Egypt 2016-LFS IND-V1.dta"
merge 1:m caseser using "`path_in'/Egypt 2016-LFS IND-V1.dta"
drop _merge
...
/* <_hhid_note>
	...
	tostring caseser, gen(hhid) format(%13.0f)
...
*save "`path_output'\EGY_2016_LFS_V01_M_V01_A_GLD_ALL.dta", replace
save "`path_output'/EGY_2016_LFS_V01_M_V01_A_GLD_ALL.dta", replace
