...
<_Program name_>				[EGY_2016_LFS_V02_M_V01_A_GLD_ALL.do] </_Program name_>
...
use "`path_in_stata'\Egypt 2016-LFS HH-V2.dta"

rename *, lower

save "`path_in_stata'\Egypt 2016-LFS HH-V2.dta", replace

clear 

use "`path_in_stata'\Egypt 2016-LFS IND-V2.dta"
rename *, lower

save "`path_in_stata'\Egypt 2016-LFS IND-V2.dta", replace

clear 
use "`path_in_stata'\Egypt 2016-LFS HH-V2.dta"

*Merge to individual file
merge 1:m caseser using "`path_in_stata'\Egypt 2016-LFS IND-V2.dta"
