...
<_Program name_>				[EGY_2019_LFS_V02_M_V01_A_GLD_ALL.do] </_Program name_>
...
<_Sample size (HH)_> 			80,825	 </_Sample size (HH)_>
<_Sample size (IND)_> 		 322,957 </_Sample size (IND)_>
...
* Date: [2022-09-15] - [change in variable occup_skill]
...
use "`path_in_stata'\Egypt 2019-LFS HH-V2.dta"

rename *, lower

save "`path_in_stata'\Egypt 2019-LFS HH-V2.dta", replace

clear 

use "`path_in_stata'\Egypt 2019-LFS IND-V2.dta"
rename *, lower

save "`path_in_stata'\Egypt 2019-LFS IND-V2.dta", replace

clear 
use "`path_in_stata'\Egypt 2019-LFS HH-V2.dta"

*Merge to individual file
merge 1:m caseser using "`path_in_stata'\Egypt 2019-LFS IND-V2.dta"
...
*<_occup_isco_>
	...
	replace occup_isco="8300" if occ_isco88_4==83
...
*<_occup_orig_2_>
	gen occup_orig_2 = occsc_isco88_4
	label var occup_orig_2 "Original occupation record secondary job 7 day recall"
*</_occup_orig_2_>


*<_occup_isco_2_>
	gen occup_isco_2 = string(occsc_isco88_4, "%04.0f") if !mi(occsc_isco88_4)
	replace occup_isco_2 = "" if inlist(occup_isco_2, "9999", "0000", "0091")
