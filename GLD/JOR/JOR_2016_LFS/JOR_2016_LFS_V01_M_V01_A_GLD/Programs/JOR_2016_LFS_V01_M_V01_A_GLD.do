...
<_Program name_>				[JOR_2016_LFS_V01_M_V01_A_GLD] </_Program name_>
<_Application_>					[Stata 18] <_Application_>
<_Author(s)_>					World Bank Jobs Group (gld@worldbank.org) </_Author(s)_>
<_Date created_>				2026-01-02 </_Date created_>

-------------------------------------------------------------------------

<_Country_>					[Hashemite Kingdom of Jordan (JOR)] </_Country_>
<_Survey Title_>				[LFS] </_Survey Title_>
<_Survey Year_>					[2016] </_Survey Year_>
<_Study ID_>					[n/a] </_Study ID_>
<_Data collection from_>			[2016] </_Data collection from_>
<_Data collection to_>				[2016] </_Data collection to_>
<_Source of dataset_> 				[JOR NSO] </_Source of dataset_>
<_Sample size (HH)_> 				[N/A] </_Sample size (HH)_>
<_Sample size (IND)_> 				[202,272] </_Sample size (IND)_>
<_Sampling method_> 				[n/a] </_Sampling method_>
<_Geographic coverage_> 			[National] </_Geographic coverage_>
<_Currency_> 					[Jordan Dinar] </_Currency_>
...
* Special case: override paths for wb582018 whose OneDrive structure differs
...
use "`path_in_stata'/LFS2016.dta", clear
...
/* <_subnatid1_note>
	...
	gen str subnatid1 =""
	replace subnatid1 = "1 - Central" if inrange(q101,11,14)
	replace subnatid1 = "2 - North" if inrange(q101,21,24)
	replace subnatid1 = "3 - South" if inrange(q101,31,34)
...
*<_subnatid2_>
	gen subnatid2=""
	replace subnatid2 = "1 - Amman" if q101==11
	replace subnatid2 = "2 - Balqa" if q101==12
	replace subnatid2 = "3 - Zarqa" if q101==13
	replace subnatid2 = "4 - Madaba" if q101==14
	replace subnatid2 = "5 - Irbid" if q101==21
	replace subnatid2 = "6 - Mafraq" if q101==22
	replace subnatid2 = "7 - Jerash" if q101==23
	replace subnatid2 = "8 - Ajloun" if q101==24
	replace subnatid2 = "9 - Karak" if q101==31
	replace subnatid2 = "10 - Tafilah" if q101==32
	replace subnatid2 = "11 - Ma'an" if q101==33
	replace subnatid2 = "12 - Aqaba" if q101==34
...
*<_relationharm_>
	gen relationharm =q203
	recode relationharm 1=2 2=3 3=4 4/6=5 7/8=6 0=1
...
*<_marital_>
	gen byte marital = q212
	recode marital 2=1 1=2 3=4 4=5 5=4
...
*<_educat7_>
	gen byte educat7 = q210
	replace educat7 = 1 if q210 == 1
	replace educat7 = 2 if q210 == 2 
	replace educat7 = 3 if q210 == 3
	replace educat7 = 4 if q210 == 4
	replace educat7 = 5 if q210 == 5 | q210==6
	replace educat7 = 6 if q210 == 7 | q210==8
	replace educat7 = 7 if q210 == 9 | q210==10 | q210==11 | q210==12
...
{
*<_lstatus_>
	gen byte lstatus = 1 if q213==1 
	replace lstatus=1 if q214==1
	replace lstatus=2 if q217==1 | q227==1 | q226==1
...
*<_nlfreason_>
	gen byte nlfreason = q232
	recode nlfreason 3=5 
...
{
*<_empstat_>
	gen byte empstat = q223
	recode empstat 2=3 3=4 4=2 5=2
...
*<_ocusec_>
	gen byte ocusec = q219
	replace ocusec = 1 if q219==1
	replace ocusec = 2 if q219==2 | q219==3
...
*<_industry_orig_>
	gen industry_help=round(q221)
	gen industry_orig = string(industry_help)
...
*<_industrycat_isic_>
	gen indus_help1=string(industry_help, "%03.0f")
	gen str4 indus_help2= indus_help1 + "0"
	gen industrycat_isic = indus_help2
	replace industrycat_isic="" if industrycat_isic==".0"
	replace industrycat_isic = "" if lstatus != 1
	replace industrycat_isic="0300" if industrycat_isic=="0310"
	replace industrycat_isic="3300" if industrycat_isic=="3320"
	replace industrycat_isic="4300" if industrycat_isic=="4320" | industrycat_isic=="4330"
	replace industrycat_isic="4700" if industrycat_isic=="4710" | industrycat_isic=="4720" | industrycat_isic=="4730" | industrycat_isic=="4740" | industrycat_isic=="4750" | industrycat_isic=="4760" | industrycat_isic=="4770" | industrycat_isic=="4780" |industrycat_isic=="4790" 
	replace industrycat_isic="5300" if industrycat_isic=="5310" | industrycat_isic=="5320" 
	replace industrycat_isic="5600" if industrycat_isic=="5610" | industrycat_isic=="5630" 
	replace industrycat_isic="6300" if industrycat_isic=="6390"
	replace industrycat_isic="8200" if industrycat_isic=="8230" | industrycat_isic=="8290" 
	replace industrycat_isic="8400" if industrycat_isic=="8410" | industrycat_isic=="8420" | industrycat_isic=="8430"
	...
	*https://github.com/worldbank/gld/tree/main/Support/Z%20-%20GLD%20Ecosystem%20Tools/ISIC%20ISCO%20universe%20check
	...
	assert `r(N)' == 0
	restore 
	drop industry_help indus_help1 indus_help2
...
*<_wage_no_compen_>
	*wages are categories not continous
