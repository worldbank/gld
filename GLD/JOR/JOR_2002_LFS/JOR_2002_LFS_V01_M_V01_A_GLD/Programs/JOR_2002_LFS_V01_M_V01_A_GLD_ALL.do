...
<_Program name_>				[JOR_2002_LFS_V01_M_V01_A_GLD] </_Program name_>
...
<_Sample size (HH)_> 				[223,921] </_Sample size (HH)_>
<_Sample size (IND)_> 				[38,228] </_Sample size (IND)_>
...
*<_literacy_>
	gen byte literacy = .
	replace literacy=0 if q212==1		
	replace literacy=1 if q212!=1
...
*<_educy_>
	...
	replace educy=25 if (educy==26 | educy==27)
...
*<_lstatus_>
	gen byte lstatus = .
	replace lstatus=1 if q215==1 | q216==1
	replace lstatus=2 if (q215==2 & q228==1) & missing(lstatus)
...
*<_occup_>
	...
	replace occup = 2 if inrange(occup_isco, "2002", "2999")
...
*no restriction
	gen whours=.
	replace whours = q218 if lstatus ==1
