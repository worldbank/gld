...
<_Program name_>				[JOR_2009_LFS_V01_M_V01_A_GLD] </_Program name_>
<_Application_>					[Stata 18] <_Application_>
<_Author(s)_>					World Bank Jobs Group (gld@worldbank.org) </_Author(s)_>
<_Date created_>				2026-04-21 </_Date created_>

-------------------------------------------------------------------------

<_Country_>					[Kingdom of Jordan (JOR)] </_Country_>
<_Survey Title_>				[LFS] </_Survey Title_>
<_Survey Year_>					[2009] </_Survey Year_>
<_Study ID_>					[n/a] </_Study ID_>
<_Data collection from_>			[February 2009] </_Data collection from_>
<_Data collection to_>				[November 2009] </_Data collection to_>
<_Source of dataset_> 				[Jordan Department of Statistics] </_Source of dataset_>
<_Sample size (HH)_> 				[49,231] </_Sample size (HH)_>
<_Sample size (IND)_> 				[254,388] </_Sample size (IND)_>
<_Sampling method_> 				[stratified multi-stage cluster sampling method] </_Sampling method_>
<_Geographic coverage_> 			[national,governorates, urban/rural] 
<_Currency_> 					[Jordina Dinar] </_Currency_>
...
local out_file     "`level_2_harm'_ALL"  
...
use "`path_in_stata'/Jordan09-LFS IND-V1.dta"
...
/* <_hhid_note>
	...
	egen  hhid = concat(caseser), format(%20.0f) p(-)
	label var hhid "Household ID"
*</_hhid_>


*<_pid_>
	egen pid = concat(caseser  pnum), format(%20.0f) p(-)
...
/* <_subnatid1_note>
	...
	gen subnatid1 = ""
replace subnatid1 = "1 - Amman"    if reg == 400011
replace subnatid1 = "2 - Balqa"    if reg == 400012
replace subnatid1 = "3 - Zarqa"    if reg == 400013
replace subnatid1 = "4 - Madaba"   if reg == 400014
replace subnatid1 = "5 - Irbid"    if reg == 400021
replace subnatid1 = "6 - Mafraq"   if reg == 400022
replace subnatid1 = "7 - Jarash"   if reg == 400023
replace subnatid1 = "8 - Ajloun"   if reg == 400024
replace subnatid1 = "9 - Karak"    if reg == 400031
replace subnatid1 = "10 - Tafileh" if reg == 400032
replace subnatid1 = "11 - Ma'an"   if reg == 400033
replace subnatid1 = "12 - Aqaba"   if reg == 400034
...
*<_marital_>
	gen byte marital = mart_d
	recode marital (200 300=1) (100=2) (410 420=4) (500=5)
...
*<_educat7_>
	gen byte educat7 = .
	replace educat7 = 1 if everattd == 0
	replace educat7 = 3 if educ_d == 210
	replace educat7 = 4 if educ_d == 220
	replace educat7 = 5 if educ_d == 230 | educ_d == 310 | educ_d == 320
	replace educat7 = 6 if educ_d == 400
	replace educat7 = 7 if educ_d == 500 | educ_d == 610 | educ_d == 620 | educ_d == 630
...
*<_nlfreason_>
	gen byte nlfreason = .
	replace nlfreason=1 if mas==4 & lstatus==3
	replace nlfreason=2 if mas==3 & lstatus==3
	replace nlfreason=3 if mas==5 & lstatus==3
...
*<_empstat_>
	...
	replace empstat=1 if emps==1
	replace empstat=2 if emps==4 | emps==6
	replace empstat=3 if emps==2
	replace empstat=4 if emps==3
...
*<_ocusec_>
	gen byte ocusec = .
	replace ocusec=1 if sector==2
	replace ocusec=2 if sector==3 | sector==5
...
*<_industry_orig_>
	gen industry_orig = string(ind_isic3_3) + "0"
replace industry_orig= "0" + industry_orig if length(industry_orig) < 4
replace industry_orig = "" if industry_orig == "99990"
...
replace industrycat10 = 1  if inrange(industrycat_isic, "0100", "0599")
replace industrycat10 = 2  if inrange(industrycat_isic, "1000", "1499")
replace industrycat10 = 3  if inrange(industrycat_isic, "1500", "3799")
replace industrycat10 = 4  if inrange(industrycat_isic, "4000", "4199")
replace industrycat10 = 5  if inrange(industrycat_isic, "4500", "4599")
replace industrycat10 = 6  if inrange(industrycat_isic, "5000", "5599")
replace industrycat10 = 7  if inrange(industrycat_isic, "6000", "6499")
replace industrycat10 = 8  if inrange(industrycat_isic, "6500", "7499")
replace industrycat10 = 9  if inrange(industrycat_isic, "7500", "7599")
replace industrycat10 = 10 if inrange(industrycat_isic, "8000", "9999")
...
*<_occup_>
	...
	replace occup = 2 if inrange(occup_isco, "2009", "2999")
...
*<_wage_no_compen_>
	gen double wage_no_compen = totwag
...
*no restriction
	gen whours=hrswk
	replace whours = hrswk if lstatus ==1
