...
<_Program name_>				[JOR_2005_LFS_V01_M_V01_A_GLD] </_Program name_>
...
<_Sample size (HH)_> 				[38,760] </_Sample size (HH)_>
<_Sample size (IND)_> 				[216,636] </_Sample size (IND)_>
<_Sampling method_> 				[national] </_Sampling method_>
<_Geographic coverage_> 			[n/a] </_Geographic coverage_>
...
/* <_hhid_note>
	...
	egen  hhid = concat(q101  q102 q103  q104 q105 q106  q107  q108 q109 q113 q115), format(%20.0f) p(-)
	label var hhid "Household ID"
*</_hhid_>


*<_pid_>
	egen pid = concat(hhid q201), format(%20.0f) p(-)
...
/* <_subnatid1_note>
	...
	gen subnatid1 = ""
replace subnatid1 = "1 - Amman"   if q101 == 11
replace subnatid1 = "2 - Balqa"   if q101 == 12
replace subnatid1 = "3 - Zarqa"   if q101 == 13
replace subnatid1 = "4 - Madaba"  if q101 == 14
replace subnatid1 = "5 - Irbid"   if q101 == 21
replace subnatid1 = "6 - Mafraq"  if q101 == 22
replace subnatid1 = "7 - Jarash"  if q101 == 23
replace subnatid1 = "8 - Ajloun"  if q101 == 24
replace subnatid1 = "9 - Karak"   if q101 == 31
replace subnatid1 = "10 - Tafileh" if q101 == 32
replace subnatid1 = "11 - Ma'an"  if q101 == 33
replace subnatid1 = "12 - Aqaba"  if q101 == 34
...
*<_hsize_>
	bys hhid: egen byte hsize=count(q203) if q203>=0 & q203<=6
...
*<_relationharm_>
	...
	recode relationharm (0=1) (1=2) (2=3) (3=4) (4/6=5) (7/8=6)
...
*<_marital_>
	gen byte marital = q214
	recode marital 1=2 2=1 3=4 4=5 5=4
...
*<_literacy_>
	gen byte literacy = .
	replace literacy=0 if q210==1		
	replace literacy=1 if q210!=1
...
*<_educy_>
	gen byte educy = q209
	replace educy=. if educy==27
	label var educy "Years of education"
*</_educy_>


*<_educat7_>
	gen byte educat7 = q212
	replace educat7=1 if q212==1 | q212==2 
	replace educat7=2 if q212==3 | q212==4
	replace educat7=3 if q212==5 
	replace educat7=4 if q212==6
	replace educat7=5 if q212==7
	replace educat7=6 if q212==8
	replace educat7=7 if q212>=9  & q212!=.
...
*<_lstatus_>
	gen byte lstatus = .
	replace lstatus=1 if q213==1 | q214==1
	replace lstatus=2 if (q213==2 & q226==1) & missing(lstatus)
...
*<_unempldur_l_>
	gen byte unempldur_l = q230m+ (12*q230y)
...
*<_unempldur_u_>
	gen byte unempldur_u = q230m+ (12*q230y)
...
{
*<_empstat_>
	gen byte empstat = q222
	recode empstat 2=3 3=4 4=2 5=2 9=5 .=5
...
*<_industry_orig_>
	gen industry_orig = string(q220)
replace industry_orig = "0" + industry_orig if length(industry_orig) == 2
replace industry_orig = industry_orig + "0"
replace industry_orig = "" if industry_orig == "9990"
...
*<_industrycat_isic_>
	...
	replace industrycat_isic = "9000" if industrycat_isic=="9130"
...
*<_occup_orig_>
	gen occup_orig = string(q221)
	replace occup_orig = occup_orig + "0"
	replace occup_orig = "" if occup_orig == "9990"
...
*<_occup_>
	...
	replace occup = 2 if inrange(occup_isco, "2005", "2999")
...
*<_whours_>
	gen whours=.
	replace whours = q216 if lstatus ==1
