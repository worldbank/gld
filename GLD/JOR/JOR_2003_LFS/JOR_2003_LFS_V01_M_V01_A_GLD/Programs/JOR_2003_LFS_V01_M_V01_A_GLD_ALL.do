...
<_Program name_>				[JOR_2003_LFS_V01_M_V01_A_GLD] </_Program name_>
...
<_Sample size (HH)_> 				[38,183] </_Sample size (HH)_>
<_Sample size (IND)_> 				[220,636] </_Sample size (IND)_>
...
/* <_hhid_note>
	...
	egen  hhid = concat(q101  q102 q103  q104 q105 q106  q107  q110 q112), format(%20.0f) p(-)
...
*<_occup_>
	...
	replace occup = 2 if inrange(occup_isco, "2003", "2999")
