...
<_Program name_>				[JOR_2010_LFS_V01_M_V01_A_GLD] </_Program name_>
...
<_Data collection from_>			[February 2010] </_Data collection from_>
...
<_Sample size (HH)_> 				[49,065] </_Sample size (HH)_>
<_Sample size (IND)_> 				[247,537] </_Sample size (IND)_>
...
use "`path_in_stata'/Jordan10-LFS IND-V1.dta"
...
*<_industry_orig_>
	gen industry_orig = string(ind_isic4_3) + "0"
...
replace industrycat10 = 1  if inrange(industrycat_isic, "0100", "0390")  // 
replace industrycat10 = 2  if inrange(industrycat_isic, "0500", "0990")  // 
replace industrycat10 = 3  if inrange(industrycat_isic, "1000", "3390")  // 
...
replace industrycat10 = 6  if inrange(industrycat_isic, "4500", "4790")  // 
replace industrycat10 = 6  if inrange(industrycat_isic, "5500", "5630")  // 
replace industrycat10 = 7  if inrange(industrycat_isic, "4900", "5390")  // 
replace industrycat10 = 7  if inrange(industrycat_isic, "5800", "6390")  //
replace industrycat10 = 8  if inrange(industrycat_isic, "6400", "8290")  // 
replace industrycat10 = 9  if inrange(industrycat_isic, "8400", "8430")  //
