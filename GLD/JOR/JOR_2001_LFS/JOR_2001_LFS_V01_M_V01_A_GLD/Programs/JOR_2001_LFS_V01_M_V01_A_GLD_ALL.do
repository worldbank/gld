...
<_Program name_>				[JOR_2001_LFS_V01_M_V01_A_GLD] </_Program name_>
...
<_Sample size (HH)_> 				[32,540] </_Sample size (HH)_>
<_Sample size (IND)_> 				[195,220] </_Sample size (IND)_>
...
/* <_hhid_note>
	...
	egen  hhid = concat(q101  q102 q103  q104 q105 q106  q109  q110 q112), format(%20.0f) p(-)
...
*<_relationharm_>
	...
	recode relationharm (0=1) (1=2) (2=3) (3=4) (4/6=5) (7/9=6)
...
*<_lstatus_>
	...
	replace lstatus=2 if (q215==2 & q221==1) & missing(lstatus)
...
*<_occup_>
	...
	replace occup = 2 if inrange(occup_isco, "2001", "2999")
