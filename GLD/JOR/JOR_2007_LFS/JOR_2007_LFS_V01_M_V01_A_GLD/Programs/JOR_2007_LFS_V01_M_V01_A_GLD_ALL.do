...
<_Program name_>				[JOR_2007_LFS_V01_M_V01_A_GLD] </_Program name_>
...
<_Sample size (HH)_> 				[49,584] </_Sample size (HH)_>
<_Sample size (IND)_> 				[265,275] </_Sample size (IND)_>
<_Sampling method_> 				[stratified multi-stage cluster sampling method] </_Sampling method_>
<_Geographic coverage_> 			[national,governorates, urban/rural] </_Geographic coverage_>
...
use "`path_in_stata'/Jordan07-LFS IND-V1.dta"
...
*<_occup_>
	...
	replace occup = 2 if inrange(occup_isco, "2007", "2999")
