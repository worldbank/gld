...
<_Program name_>				BIH_2006_LFS_V01_M_V01_A_GLD_ALL.do </_Program name_>
...
<_Data collection to_>			04/2006 </_Data collection to_>
<_Source of dataset_> 			Agency of Statistics </_Source of dataset_>
<_Sample size (HH)_> 			9,196 </_Sample size (HH)_>
<_Sample size (IND)_> 			30,145 </_Sample size (IND)_>
...
use "`path_in_stata'/bih_lfs_raw_dlw_2006.dta", clear
...
/* <_hhid_note>
	...
	gen mas_hhid_aux = string(hhid, "%05.0f")
...
*<_lstatus_>
	...
	*ICLS-13 DEFINITION: "The employed comprise all persons above a specified age who, during a specified brief period, either:
	...
	replace lstatus = 1 if aktivnos == 1 | posao == 1
...
*<_industrycat_isic_>
*They use NACE 1 which is in line with ISIC rev 3 at 2 digits level
	...
	replace industrycat_isic = "" if industrycat_isic == "9700" | industrycat_isic == "9600"
...
*<_occup_isco_>
	...
	replace occup_isco = "1110" if occup_isco=="1112"
	replace occup_isco = "1110" if occup_isco=="1113"
	replace occup_isco = "1110" if occup_isco=="1114"
	replace occup_isco = "1110" if occup_isco=="1115"
	replace occup_isco = "1110" if occup_isco=="1119"
	replace occup_isco = "1120" if occup_isco=="1121"
	replace occup_isco = "1120" if occup_isco=="1122"
	replace occup_isco = "1120" if occup_isco=="1123"
	replace occup_isco = "2310" if occup_isco=="2311"
	replace occup_isco = "2310" if occup_isco=="2312"
	replace occup_isco = "2310" if occup_isco=="2313"
	replace occup_isco = "2310" if occup_isco=="2314"
	replace occup_isco = "2310" if occup_isco=="2315"
	replace occup_isco = "2310" if occup_isco=="2316"
	replace occup_isco = "2320" if occup_isco=="2321"
	replace occup_isco = "2320" if occup_isco=="2322"
	replace occup_isco = "2320" if occup_isco=="2323"
	replace occup_isco = "2320" if occup_isco=="2324"
	replace occup_isco = "2320" if occup_isco=="2325"
	replace occup_isco = "2320" if occup_isco=="2326"
	replace occup_isco = "3310" if occup_isco=="3311"
	replace occup_isco = "3310" if occup_isco=="3312"
	replace occup_isco = "3440" if occup_isco=="3445"
	replace occup_isco = "3470" if occup_isco=="3479"
	replace occup_isco = "4130" if occup_isco=="4134"
	replace occup_isco = "5220" if occup_isco=="5221"
	replace occup_isco = "5220" if occup_isco=="5222"
	replace occup_isco = "7130" if occup_isco=="7139"
	replace occup_isco = "8280" if occup_isco=="8287"
...
*<_wage_no_compen_>
	...
	*individuals who answered intervals, use the middle point
	...
	gen wage_no_compen = wage_ranges
...
*<_whours_>
	...
	replace whours = . if radili_r == 999
...
*<_empstat_year_>
	gen byte empstat_year = polozaj3
...
*<_industrycat_isic_year_>
	...
	replace industrycat_isic_year = "" if industrycat_isic_year == "9600" | industrycat_isic_year == "9700"
...
*<_industrycat10_year_>
	...
	recode industrycat10_year (1/5 = 1) (10/14 = 2) (15/37 = 3) (40/41 = 4) (45 = 5) (50/52 55 = 6) (60/64 = 7) (65/67 70/74 = 8) (75 = 9) (80/99 = 10)
