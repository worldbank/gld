...
<_Program name_> 			BIH_2011_LFS_V01_M_V02_A_GLD_ALL.do </_Program name_>
...
<_Data collection to_>			04/2011 </_Data collection to_>
<_Source of dataset_> 			Agency of Statistics </_Source of dataset_>
<_Sample size (HH)_> 			9,191 </_Sample size (HH)_>
<_Sample size (IND)_> 			27,422 </_Sample size (IND)_>
...
use "`path_in_stata'/bih_lfs_raw_dlw_2011.dta", clear
...
*They use NACE 1 which is in line with ISIC rev 3 at 2 digits level
	...
	replace industrycat_isic = "" if industrycat_isic == "9600" 
