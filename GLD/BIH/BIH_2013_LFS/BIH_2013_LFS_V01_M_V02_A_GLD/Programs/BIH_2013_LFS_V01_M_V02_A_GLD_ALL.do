...
<_Program name_> 			BIH_2013_LFS_V01_M_V02_A_GLD_ALL.do </_Program name_>
...
<_Sample size (HH)_> 			9,027 </_Sample size (HH)_>
<_Sample size (IND)_> 			26,765 </_Sample size (IND)_>
...
use "`path_in_stata'/bih_lfs_raw_dlw_2013.dta", clear
