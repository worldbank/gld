...
<_Program name_> 			BIH_2010_LFS_V01_M_V02_A_GLD_ALL.do </_Program name_>
...
<_Data collection to_>			04/2010 </_Data collection to_>
<_Source of dataset_> 			Agency of Statistics </_Source of dataset_>
<_Sample size (HH)_> 			9,332 </_Sample size (HH)_>
<_Sample size (IND)_> 			28,527 </_Sample size (IND)_>
...
use "`path_in_stata'/bih_lfs_raw_dlw_2010.dta", clear
...
*They use NACE 1 which is in line with ISIC rev 3 at 2 digits level
	...
	replace industrycat_isic = "" if industrycat_isic == "9700" 
...
*<_wage_no_compen_>
	*Some respondents agreed to report their exact salary, while others did not. For those who declined, a question about their salary range was asked instead, put them missing
	...
	replace wage_no_compen = . if iznospla == 0
...
*<_industrycat_isic_year_>
	...
	replace industrycat_isic_year = "" if industrycat_isic_year == "9600"
