...
<_Program name_> 			BIH_2017_LFS_V01_M_V02_A_GLD_ALL.do </_Program name_>
...
<_Data collection to_>			04/2017 </_Data collection to_>
<_Source of dataset_> 			Agency of Statistics </_Source of dataset_>
<_Sample size (HH)_> 			7,925 </_Sample size (HH)_>
<_Sample size (IND)_> 			21,311 </_Sample size (IND)_>
...
use "`path_in_stata'/bih_lfs_raw_dlw_2017.dta", clear
...
*/
	...
	replace educy = 23 if diploma == 15
...
*<_educat7_>
	...
	* 2. Primary incomplete (both 8-year and 9-year schemes, partial)
	...
	* 4. Secondary incomplete 
	replace educat7 = 4 if diploma == 6

	* 5. Secondary complete (completed secondary of 1–2, 3, or 4+ years)
	replace educat7 = 5 if inlist(diploma, 7, 8, 9)

	* 6. Higher than secondary, not university
	replace educat7 = 6 if inlist(diploma, 10, 11)

	* 7. University (any cycle) incl. postgraduate/PhD
