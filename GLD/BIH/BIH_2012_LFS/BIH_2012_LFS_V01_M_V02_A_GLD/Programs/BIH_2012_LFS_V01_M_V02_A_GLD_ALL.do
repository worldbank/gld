...
<_Program name_> 			BIH_2012_LFS_V01_M_V02_A_GLD_ALL.do </_Program name_>
...
<_Data collection to_>			04/2012 </_Data collection to_>
<_Source of dataset_> 			Agency of Statistics </_Source of dataset_>
<_Sample size (HH)_> 			9,099 </_Sample size (HH)_>
<_Sample size (IND)_> 			26,936 </_Sample size (IND)_>
...
use "`path_in_stata'/bih_lfs_raw_dlw_2012.dta", clear
...
/* <_hhid_note>
	...
	*egen hhid = concat( [Elements] )
	...
	gen hhid = string(hhid_aux, "%05.0f")
