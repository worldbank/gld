...
<_Program name_> 			BIH_2019_LFS_V01_M_V02_A_GLD_ALL.do </_Program name_>
...
<_Data collection from_>		04/2019 </_Data collection from_>
<_Data collection to_>			04/2019 </_Data collection to_>
<_Source of dataset_> 			Agency of Statistics </_Source of dataset_>
<_Sample size (HH)_> 			7,806 </_Sample size (HH)_>
<_Sample size (IND)_> 			19,203 </_Sample size (IND)_>
...
use "`path_in_stata'/lfs_raw_dlw_2019.dta", clear
...
/* <_hhid_note>
	...
	*egen hhid = concat( [Elements] )
	gen hhid = string(hhid_mass, "%05.0f")
