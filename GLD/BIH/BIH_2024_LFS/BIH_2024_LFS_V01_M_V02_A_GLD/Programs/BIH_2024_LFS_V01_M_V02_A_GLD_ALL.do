...
<_Program name_> 			BIH_2024_LFS_V01_M_V02_A_GLD_ALL.do </_Program name_>
...
import spss using "`path_in_other'\WB_BIH_LFS_2024.sav", clear
...
*and re-surveyed in two more consecutive quarters (rotation scheme 2 (-2) 2).
	* hhid for cross-sectional analysis: hhid = hhid + quarter
	egen hhid = concat(COEFFQ RefQuarter), punct("Q")
