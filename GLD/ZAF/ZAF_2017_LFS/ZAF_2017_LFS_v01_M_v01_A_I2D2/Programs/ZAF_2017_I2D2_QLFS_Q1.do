...
** DIRECTORY
	local path "D:\__I2D2\South Africa\2017\QLFS_Q1"


** LOG FILE
	log using "`path'\Processed\ZAF_2017_I2D2_QLFS_Q1.log", replace
...
** DATABASE ASSEMBLENT
	...
	use "`path'\Original\QLFS 2017_1 Worker 1.0 Stata11.dta"
...
** HOUSEHOLD SIZE
	bys idh: egen byte hhsize=count(year)
...
/*
Not asked, all we know is that the person with personal number equal to 1 is the head, the problem is that in some cases that person is not present, probably because he/she didn't spend four nights or more in is household. In those cases I will assigned the eldest person present as the household head.
*/
...
** YEARS OF EDUCATION COMPLETED
	...
	replace educy=13 if inrange(Q17EDUCATION,21,22)
	replace educy=16 if inlist(Q17EDUCATION,23,25)
	replace educy=19 if inlist(Q17EDUCATION,24,26,27,28)
...
** UNEMPLOYMENT DURATION: MONTHS LOOKING FOR A JOB
	...
	recode unempldur_u 1=3 2=6 3=9 4=12 5=35 6=60 7 8=.
...
*SURVEY SPECIFIC INDUSTRY CLASSIFICATION
	*gen industry_orig=Q43INDUSTRY
	local my_industry_orig Q43INDUSTRY                                                                          
...
* SURVEY SPECIFIC OCCUPATION CLASSIFICATION
	*gen occup_orig=Q42OCCUPATION
	local my_occup_orig Q42OCCUPATION                                                       
...
** FIRM SIZE
	...
	recode firmsize_l 4=6 5=11 6=21 7=51 8=.
	replace firmsize_l=. if lstatus!=1
	label var firmsize_l "Firm size (lower bracket)"

	gen byte firmsize_u=Q416NRWORKERS
	recode firmsize_u 3=5 4=10 5=20 6=50 7 8=.
...
/*
Information not contained in data
*/
	gen double wage=.
...
** HEALTH INSURANCE
	gen byte healthins=Q47B1PDSICK
...
** DELETE MISSING VARIABLES
	...
	save "`path'\Processed\ZAF_2017_I2D2_QLFS_Q1.dta", replace
	save "D:\__CURRENT\ZAF_2017_I2D2_QLFS_Q1.dta", replace
