...
/* -----------------------------------------------------------------------
<_Program name_>				ZAF_2017_QLFS_v01_M_v05_A_GLD_ALL.do </_Program name_>
...
<_Study ID_>					ZAF_2017_LMDSA_v01_M </_Study ID_>
...
<_Sample size (HH)_> 			39,418 </_Sample size (HH)_>
<_Sample size (IND)_> 			132,713 </_Sample size (IND)_>
...
* Date: [2022-04-14] File: [ZAF_2017_QLFS_v01_M_v02_A_GLD_ALL.do] - [Adding wage variable]
* Date: [2022-07-06] File: [ZAF_2017_QLFS_v01_M_v03_A_GLD_ALL.do] - [Adding new GLD variables: isced_version/isco_version/isic_version/educat_orig/vocational_field_orig]
* Date: [2022-09-22] File: [ZAF_2017_QLFS_v01_M_v04_A_GLD_ALL.do] - [Correcting occupation skill level; correcting typo (631 to 621 in the ISCO88 code list); coding 5164 to category "Service and market sales workers"]
* Date: [2022-11-03] File: [ZAF_2017_QLFS_v01_M_v05_A_GLD_ALL.do] - [Update ICLS V, was excluding non market as employment all along]
* Date: [2023-01-05] File: [ZAF_2017_QLFS_v01_M_v06_A_GLD_ALL.do] - [Recoding educat7]
...
* harmonized output in a single file
	...
	use "`path_in_stata'\lmdsa-2017-1.0-stata11.dta", clear
...
Note: 222 observations are under 18 (or not adult) yet are household heads because
