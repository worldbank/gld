...
/* -----------------------------------------------------------------------
<_Program name_>				ZAF_2020_QLFS_v02_M_v02_A_GLD_ALL.do </_Program name_>
...
local 	gld 	"`year'\\`cty'_`surv_yr'_LFS_v02_M_v02_A_GLD"
local 	i2d2	"`year'\\`cty'_`surv_yr'_LFS_v02_M_v02_A_I2D2"
...
save "`output'\ZAF_2020_QLFS_v02_M_v02_A_GLD_ALL.dta", replace
