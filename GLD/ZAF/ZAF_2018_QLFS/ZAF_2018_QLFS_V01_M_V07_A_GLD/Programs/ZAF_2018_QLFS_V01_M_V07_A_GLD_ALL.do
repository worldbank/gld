...
/* -----------------------------------------------------------------------
<_Program name_>				ZAF_2018_QLFS_V01_M_V07_A_GLD_ALL.do </_Program name_>
...
* Date: [2022-04-16] File: [ZAF_2018_QLFS_v01_M_v02_A_GLD_ALL.do] - [Adding wage variable]
* Date: [2022-07-06] File: ZAF_2018_QLFS_v01_M_v03_A_GLD_ALL.do] - [Adding new GLD variables: isced_version/isco_version/isic_version/educat_orig/vocational_field_orig]
* Date: [2022-09-22] File: [ZAF_2018_QLFS_v01_M_v04_A_GLD_ALL.do] - [Correcting occupation skill level; correcting typo (631 to 621 in the ISCO88 code list); coding 5164 to category "Service and market sales workers"]
* Date: [2022-11-03] File: [ZAF_2018_QLFS_v01_M_v05_A_GLD_ALL.do] - [Update ICLS V, was excluding non market as employment all along]
* Date: [2023-01-23] File: [ZAF_2018_QLFS_v01_M_v06_A_GLD_ALL.do] - [Recoding educat7]
* Date: [2026-06-24] File: [ZAF_2018_QLFS_v01_M_v07_A_GLD_ALL.do] - [V06 brought back mistake on ICLS V - corrected]
...
* harmonized output in a single file
	...
	use "`path_in_stata'\lmdsa-2018-v1.0.dta", clear
