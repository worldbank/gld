...
** DIRECTORY
	local path_input "C:\Users\IrIs_\OneDrive\Desktop\WB\Jobs Group\GLD\GLD\ZAF\ZAF_2014_LFS\ZAF_2014_LFS_v01_M\Data\Stata"
	local path_output "C:\Users\IrIs_\OneDrive\Desktop\WB\Jobs Group\GLD\GLD\ZAF\ZAF_2014_LFS\ZAF_2014_LFS_v01_M_v01_A_I2D2\Data\Harmonized"
/*	
	local 	drive 	`"C"'		// set this to where you mapped the GLD drive on your work computer
	local 	cty 	`"ZAF"' 	// set this to the three letter country/economy abbreviation
	local 	usr		`"573465_JT"' // set this to whatever Mario named your folder
	local 	surv_yr `"2014"'	// set this to the survey year 
	local 	year 		"`drive':\GLD-Harmonization\\`usr'\\`cty'\\`cty'_`surv_yr'_LFS" // top data folder
	local 	main		"`year'\\`cty'_1997_LFS_v01_M"
	local 	stata		"`main'\data\stata"
	local 	gld 		"`year'\\`cty'_1997_LFS_v01_M_v01_A_GLD"
	local 	i2d2		"`year'\\`cty'_1997_LFS_v01_M_v01_A_I2D2"
	local 	code 		"`i2d2'\Programs"
	local 	id_data 	"`i2d2'\Data\Harmonized"
*/

** LOG FILE
	log using "C:\Users\IrIs_\OneDrive\Desktop\WB\Jobs Group\GLD\GLD\ZAF\ZAF_2014_LFS\ZAF_2014_LFS_v01_M_v01_A_I2D2\Data\Harmonized\ZAF_2014__LFS_V01_M_v01_A_I2D2", replace
...
** DATABASE ASSEMBLENT
	...
	use "`path_input'\lmdsa-2014-v1-stata", clear
...
/*
Not asked, all we know is that the person with personal number equal to 1 is the head, the problem is that in some cases that person is not present, probably because he/she didn't spend four nights or more in this household. In those cases I will assigned the eldest male present as the household head.
*/
...
** UNEMPLOYMENT DURATION: MONTHS LOOKING FOR A JOB
	...
	recode unempldur_u 1=3 2=6 3=9 4=12 5=36 6=60 7 8=.
...
** DELETE MISSING VARIABLES
	...
	save "`path_output'\ZAF_2014_LFS_v01_M_v01_A_I2D2.dta", replace
