...
/* -----------------------------------------------------------------------
<_Program name_>				ZAF_2014_QLFS_v01_M_v05_A_GLD_ALL.do </_Program name_>
...
* Date: [2022-04-08] File: [ZAF_2014_QLFS_v01_M_v02_A_GLD_ALL.do - [Adding wage variable]
* Date: [2022-07-06] File: [ZAF_2014_QLFS_v01_M_v03_A_GLD_ALL.do] - [Adding new GLD variables: isced_version/isco_version/isic_version/educat_orig/vocational_field_orig]
* Date: [2022-09-22] File: [ZAF_2014_QLFS_v01_M_v04_A_GLD_ALL.do] - [Correcting occupation skill level; correcting typo (631 to 621 in the ISCO88 code list); coding 5164 to category "Service and market sales workers"]
* Date: [2022-11-03] File: [ZAF_2014_QLFS_v01_M_v05_A_GLD_ALL.do] - [Update ICLS V, was excluding non market as employment all along
* Date: [2023-01-05] File: [ZAF_2014_QLFS_v01_M_v06_A_GLD_ALL.do] - [Recoding educat7]
...
* harmonized output in a single file
	...
	use "`path_in_stata'\lmdsa-2014-v1-stata", clear
...
Note: 300 observations are under 18 (or not adult) yet are household heads because
...
because they have two different ages in different quarters, i.e., 31 in one Q and
8 in the other. 

11800056000002230103
61900298000001501205
...
114 observations' years of education exceed their age.
...
-----------+------------------------------------------------------------------+----------
        ...
        18 |         0          0          0          0          0          0 |         1 
-----------+------------------------------------------------------------------+----------
     Total |         2         30         23         16         17         20 |       114 

Individual |           Highest education level
       age | NTC III/N  Bachelors  Honours D  Higher De |     Total
-----------+--------------------------------------------+----------
         6 |         0          0          0          0 |        31 
         7 |         0          0          0          0 |        30 
         8 |         0          0          0          0 |        25 
