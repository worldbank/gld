...
/* -----------------------------------------------------------------------
<_Program name_>				ZAF_2013_QLFS_v01_M_v03_A_GLD_ALL.do </_Program name_>
...
local 	gld 	"`year'\\`cty'_`surv_yr'_LFS_v01_M_v03_A_GLD"
local 	i2d2	"`year'\\`cty'_`surv_yr'_LFS_v01_M_v03_A_I2D2"
...
save "`output'\ZAF_2013_QLFS_v01_M_v03_A_GLD_ALL.dta", replace
