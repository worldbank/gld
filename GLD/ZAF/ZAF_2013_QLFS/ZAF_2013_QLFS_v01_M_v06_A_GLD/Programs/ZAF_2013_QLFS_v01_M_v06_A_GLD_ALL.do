...
/* -----------------------------------------------------------------------
<_Program name_>				ZAF_2013_QLFS_v01_M_v05_A_GLD_ALL.do </_Program name_>
...
<_Study ID_>					ZAF_2013_LMDSA_v01_M </_Study ID_>
...
<_Source of dataset_> 			DataFirst </_Source of dataset_>
								https://www.datafirst.uct.ac.za/dataportal/index.php/catalog/516
<_Sample size (HH)_> 			46,440 </_Sample size (HH)_>
<_Sample size (IND)_> 			166,387 </_Sample size (IND)_>
...
* Date: [2022-04-07] File: [ZAF_2013_QLFS_v01_M_v02_A_GLD_ALL.do] - [Adding wage variable]
* Date: [2022-07-06] File: [ZAF_2013_QLFS_v01_M_v03_A_GLD_ALL.do] - [Adding new GLD variables: isced_version/isco_version/isic_version/educat_orig/vocational_field_orig]
* Date: [2022-09-22] File: [ZAF_2013_QLFS_v01_M_v04_A_GLD_ALL.do] - [Correcting occupation skill level; correcting typo (631 to 621 in the ISCO88 code list); coding 5164 to category "Service and market sales workers"]
* Date: [2022-11-03] File: [ZAF_2013_QLFS_v01_M_v05_A_GLD_ALL.do] - [Update ICLS V, was excluding non market as employment all along]
* Date: [2023-01-05] File: [ZAF_2013_QLFS_v01_M_v06_A_GLD_ALL.do] - [REGIONALecoding educat7]
...
* harmonized output in a single file
	...
	use "`path_in_stata'\lmdsa_2013_v1_20150407.dta", clear
...
176 observations were dropped due to no male memeber or multiple same old male (or female) members.
...
------------------+-----------------------------------
 1 - Western Cape |         18       10.23       10.23
 2 - Eastern Cape |         36       20.45       30.68
3 - Northern Cape |          7        3.98       34.66
   4 - Free State |         11        6.25       40.91
5 - KwaZulu-Natal |         37       21.02       61.93
   6 - North West |          3        1.70       63.64
      7 - Gauteng |         20       11.36       75.00
   8 - Mpumalanga |         17        9.66       84.66
      9 - Limpopo |         27       15.34      100.00
------------------+-----------------------------------
            Total |        176      100.00

Note: 367 observations are under 18 (or not adult) yet are household heads because
they are originally asigned as the head --- their PERSONNO is 1.

But there are 2 observations that are assigned as the head and they are under 18 
because they have two different ages in different quarters, i.e., 51 in one Q and
12 in the other. 

17102389000001580105
91300085000000820102
...
81 observations' years of education exceed their age.

Individual |                Highest education level
       age | Grade 7/S  Grade 8/S  Grade 9/S  Grade 10/  Grade 11/ |     Total
-----------+-------------------------------------------------------+----------
         6 |         7          9          8          3          0 |        30 
         7 |         0          9          8          3          4 |        25 
         8 |         0          0          6          3          3 |        15 
        ...
        18 |         0          0          0          0          0 |         1 
-----------+-------------------------------------------------------+----------
     Total |         7         18         22         12          8 |        81 
	 
Individual |                Highest education level
       age | Grade 12/  Diploma w  Post High  Bachelors  Bachelors |     Total
-----------+-------------------------------------------------------+----------
         6 |         3          0          0          0          0 |        30 
         7 |         1          0          0          0          0 |        25 
         8 |         1          0          0          0          1 |        15 
...
*<_educat7_>
	...
	replace educat7=4 if inrange(Q17EDUCATION,8,11)|inrange(Q17EDUCATION,13,14)|inrange(Q17EDUCATION,19,20)
	replace educat7=5 if Q17EDUCATION==15|Q17EDUCATION==12
	replace educat7=6 if inrange(Q17EDUCATION,16,18)|inrange(Q17EDUCATION,21,22)
...
*<_wage_no_compen_>
	...
	replace wage_no_compen=Q57a_monthly if mi(wage_no_compen)
...
0.17% of people who have jobs spend more time on their second job.

      first |      Freq.     Percent        Cum.
------------+-----------------------------------
          0 |        152        0.17        0.17
          1 |     86,819       99.83      100.00
------------+-----------------------------------
      Total |     86,971      100.00
