...
/* -----------------------------------------------------------------------
<_Program name_> 			TZA_2014_ILFS-TAN_V01_M_V03_A_GLD_ALL.do </_Program name_>
...
* Date: 2023-10-01 - Update vars contract
...
*<_contract_>
	gen byte contract = .
	* Set to no if empstat (only ones asked about contract status)
	replace contract = 0 if empstat == 1
	* Replace as yes if contract is written
	replace contract = 1 if empstat == 1 & L2Q18D_TYPE == 1
