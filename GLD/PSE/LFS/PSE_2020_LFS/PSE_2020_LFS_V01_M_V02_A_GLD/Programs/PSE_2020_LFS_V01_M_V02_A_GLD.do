...
<_Program name_>				[PSE_2020_LFS_V01_M_V02_A_GLD] </_Program name_>
...
<_Sample size (HH)_> 				[19,923] </_Sample size (HH)_>
<_Sample size (IND)_> 				[90,838] </_Sample size (IND)_>
...
* Try to use the file
use "`path_in_stata'/LFS20Q1.dta", clear

	gen quarter=1
save `q1'

* Q2
use "`path_in_stata'/LFS20Q2.dta", clear
		gen quarter=2
save `q2'

* Q3
use "`path_in_stata'/LFS20Q3.dta", clear
		gen quarter=3
save `q3'

* Q4
use "`path_in_stata'/LFS20Q4.dta", clear
		gen quarter=4
save `q4'
...
* Annual file 
use "`path_in_stata'/LFS20_Y.dta", clear
...
*<_weight_>
*scaling to population 10 plus using WDI, consult CSD.
	quietly summarize FWP if !missing(FWP), meanonly
local k = 3474674 / r(sum)
generate double weight = FWP * `k'
