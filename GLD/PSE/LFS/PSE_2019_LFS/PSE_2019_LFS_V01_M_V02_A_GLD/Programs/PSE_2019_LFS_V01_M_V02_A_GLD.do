...
<_Program name_>				[PSE_2019_LFS_V01_M_V02_A_GLD] </_Program name_>
...
<_Sample size (HH)_> 				[14,469] </_Sample size (HH)_>
<_Sample size (IND)_> 				[92,592] </_Sample size (IND)_>
...
* Try to use the file
use "`path_in_stata'/LFS19Q1.dta", clear

merge 1:1 IDSAM HR0A using "`path_in_stata'/LFS_Q1_2019_weights.dta"
    drop if _merge == 1
    drop RW
    rename weight RWP
    drop _merge
...
* Q2
use "`path_in_stata'/LFS19Q2.dta", clear
merge 1:1 IDSAM HR0A using "`path_in_stata'/LFS_Q2_2019_weights.dta"
    drop if _merge == 1
    drop RW
    rename weight RWP
    drop _merge
...
* Q3
use "`path_in_stata'/LFS19Q3.dta", clear
merge 1:1 IDSAM HR0A using "`path_in_stata'/LFS_Q3_2019_weights.dta"
    drop if _merge == 1
    drop rw
    rename weight RWP
    drop _merge
...
* Q4
use "`path_in_stata'/LFS19Q4.dta", clear
merge 1:1 IDSAM HR0A using "`path_in_stata'/LFS_Q4_2019_weights.dta"
    drop if _merge == 1
    drop RW
    rename weight RWP
    drop _merge
...
* Annual file 
use "`path_in_stata'/LFS19_Y.dta", clear
