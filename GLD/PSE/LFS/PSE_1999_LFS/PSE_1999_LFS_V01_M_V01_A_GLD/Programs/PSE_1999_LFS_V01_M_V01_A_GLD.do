...
<_Program name_>				[PSE_1999_LFS_V01_M_V01_A_GLD] </_Program name_>
...
<_Data collection from_>			[01/1999] </_Data collection from_>
<_Data collection to_>				[12/1999] </_Data collection to_>
<_Source of dataset_> 				[PCBS] </_Source of dataset_>
<_Sample size (HH)_> 				[27,397] </_Sample size (HH)_>
<_Sample size (IND)_> 				[93,031] </_Sample size (IND)_>
...
use "`path_in_stata'/LFS99Q1.dta", clear
gen quarter=1
append using  "`path_in_stata'/LFS99Q2.dta"
replace quarter=2 if quarter==.
append using  "`path_in_stata'/LFS99Q3.dta"
replace quarter=3 if quarter==.
append using  "`path_in_stata'/LFS99Q4.dta"
