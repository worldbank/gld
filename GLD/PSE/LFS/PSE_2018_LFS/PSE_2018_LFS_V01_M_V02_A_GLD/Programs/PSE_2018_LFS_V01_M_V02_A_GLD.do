...
<_Program name_>				[PSE_2018_LFS_V01_M_V02_A_GLD] </_Program name_>
...
<_Sample size (HH)_> 				[13,770] </_Sample size (HH)_>
<_Sample size (IND)_> 				[90,994] </_Sample size (IND)_>
...
* Try to use the file
use "`path_in_stata'/LFS18Q1.dta", clear

merge 1:1 IDSAM HR0A using "`path_in_stata'/LFS_Q1_2018_weights.dta"
    drop if _merge == 1
    drop RW
    rename weight RWP
    drop _merge
...
* Q2
use "`path_in_stata'/LFS18Q2.dta", clear
merge 1:1 IDSAM HR0A using "`path_in_stata'/LFS_Q2_2018_weights.dta"
    drop if _merge == 1
    drop RW
    rename weight RWP
    drop _merge
...
* Q3
use "`path_in_stata'/LFS18Q3.dta", clear
merge 1:1 IDSAM HR0A using "`path_in_stata'/LFS_Q3_2018_weights.dta"
    drop if _merge == 1
    drop RW
    rename weight RWP
    drop _merge
...
* Q4
use "`path_in_stata'/LFS18Q4.dta", clear
merge 1:1 IDSAM HR0A using "`path_in_stata'/LFS_Q4_2018_weights.dta"
    drop if _merge == 1
    drop RW
    rename weight RWP
    drop _merge
...
* Annual file 
use "`path_in_stata'/LFS18_Y.dta", clear
