...
<_Program name_>				[PSE_2004_LFS_V01_M_V01_A_GLD] </_Program name_>
...
<_Sample size (HH)_> 				[14,483] </_Sample size (HH)_>
<_Sample size (IND)_> 				[65,760] </_Sample size (IND)_>
...
use "`path_in_stata'/LFS04Q1.dta", clear
gen quarter=1
append using  "`path_in_stata'/LFS04Q2.dta"
replace quarter=2 if quarter==.
append using  "`path_in_stata'/LFS04Q3.dta"
replace quarter=3 if quarter==.
append using  "`path_in_stata'/LFS04Q4.dta"
...
*<_relationharm_>
	...
	*replace relationharm=1 if pid=="0601386-002-4" & relationharm==3
