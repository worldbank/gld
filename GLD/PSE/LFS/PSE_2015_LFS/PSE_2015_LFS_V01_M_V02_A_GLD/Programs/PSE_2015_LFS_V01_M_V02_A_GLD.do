...
<_Program name_>				[PSE_2015_LFS_V01_M_V02_A_GLD] </_Program name_>
...
<_Sample size (HH)_> 				[14,536] </_Sample size (HH)_>
<_Sample size (IND)_> 				[98,862] </_Sample size (IND)_>
...
* Try to use the file
use "`path_in_stata'/LFS15Q1.dta", clear

merge 1:1 IDSAM HR0A using "`path_in_stata'/LFS_Q1_2015_weights.dta"
    drop if _merge == 1
    drop RW
    rename weight RWP
    drop _merge
...
* Q2
use "`path_in_stata'/LFS15Q2.dta", clear
merge 1:1 IDSAM HR0A using "`path_in_stata'/LFS_Q2_2015_weights.dta"
    drop if _merge == 1
    drop RW
    rename weight RWP
    drop _merge
...
* Q3
use "`path_in_stata'/LFS15Q3.dta", clear
merge 1:1 IDSAM HR0A using "`path_in_stata'/LFS_Q3_2015_weights.dta"
    drop if _merge == 1
    drop RW
    rename weight RWP
    drop _merge
...
* Q4
use "`path_in_stata'/LFS15Q4.dta", clear
merge 1:1 IDSAM HR0A using "`path_in_stata'/LFS_Q4_2015_weights.dta"
    drop if _merge == 1
    drop RW
    rename weight RWP
    drop _merge
...
* Annual file 
use "`path_in_stata'/LFS15_Y.dta", clear
