...
<_Program name_>				[PSE_2006_LFS_V01_M_V01_A_GLD] </_Program name_>
...
<_Sample size (HH)_> 				[15,460] </_Sample size (HH)_>
<_Sample size (IND)_> 				[68,674] </_Sample size (IND)_>
...
use "`path_in_stata'/LFS06Q1.dta", clear
gen quarter=1
append using  "`path_in_stata'/LFS06Q2.dta"
replace quarter=2 if quarter==.
append using  "`path_in_stata'/LFS06Q3.dta"
replace quarter=3 if quarter==.
append using  "`path_in_stata'/LFS06Q4.dta"
...
*<_relationharm_>
	...
	/*
	replace relationharm=2 if pid=="742760-02-2" & relationharm==1
	replace relationharm=2 if pid=="760206-02-4" & relationharm==1
	replace relationharm=5 if pid=="743044-03-3" & relationharm==1
	replace relationharm=5 if pid=="760114-02-3" & relationharm==1
	replace relationharm=2 if pid=="760202-09-4" & relationharm==1
	replace relationharm=5 if pid=="760444-02-4" & relationharm==1
	replace relationharm=5 if pid=="760728-07-3" & relationharm==1
	replace relationharm=5 if pid=="780102-02-4" & relationharm==1
	replace relationharm=2 if pid=="780382-02-4" & relationharm==1
	replace relationharm=5 if pid=="781396-05-4" & relationharm==1
	replace relationharm=5 if pid=="860744-02-4" & relationharm==1
	replace relationharm=2 if pid=="861670-02-4" & relationharm==1
	replace relationharm=5 if pid=="861670-03-4" & relationharm==1
	replace relationharm=2 if pid=="861670-04-4" & relationharm==1
