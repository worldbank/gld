...
<_Program name_>				[PSE_2002_LFS_V01_M_V01_A_GLD] </_Program name_>
...
<_Sample size (HH)_> 				[14,437] </_Sample size (HH)_>
<_Sample size (IND)_> 				[65,185] </_Sample size (IND)_>
...
use "`path_in_stata'/LFS02Q1.dta", clear
gen quarter=1
append using  "`path_in_stata'/LFS02Q2.dta"
replace quarter=2 if quarter==.
append using  "`path_in_stata'/LFS02Q3.dta"
replace quarter=3 if quarter==.
append using  "`path_in_stata'/LFS02Q4.dta"
...
bysort hhid_1 pid_1 quarter (age): gen in_split = dupflag & _n > 1
...
egen pid = concat(hhid_new pid_1)
