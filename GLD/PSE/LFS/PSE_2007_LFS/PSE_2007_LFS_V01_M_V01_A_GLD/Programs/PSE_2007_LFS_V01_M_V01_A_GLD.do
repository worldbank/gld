...
<_Program name_>				[PSE_2007_LFS_V01_M_V01_A_GLD] </_Program name_>
...
<_Sample size (HH)_> 				[14,907] </_Sample size (HH)_>
<_Sample size (IND)_> 				[66,663] </_Sample size (IND)_>
...
* Standardize variable names in each dataset
use "`path_in_stata'/LFS07Q1.dta", clear
rename _all, lower
save "`path_in_stata'/LFS07Q1_lower.dta", replace

use "`path_in_stata'/LFS07Q2.dta", clear
rename _all, lower
save "`path_in_stata'/LFS07Q2_lower.dta", replace

use "`path_in_stata'/LFS07Q3.dta", clear
rename _all, lower
save "`path_in_stata'/LFS07Q3_lower.dta", replace

use "`path_in_stata'/LFS07Q4.dta", clear
rename _all, lower
save "`path_in_stata'/LFS07Q4_lower.dta", replace

* Now append the standardized datasets
use "`path_in_stata'/LFS07Q1_lower.dta", clear
gen quarter=1
append using "`path_in_stata'/LFS07Q2_lower.dta"
replace quarter=2 if quarter==.
append using "`path_in_stata'/LFS07Q3_lower.dta"
replace quarter=3 if quarter==.
append using "`path_in_stata'/LFS07Q4_lower.dta"
