...
<_Program name_>				[PSE_2003_LFS_V01_M_V01_A_GLD] </_Program name_>
...
<_Sample size (HH)_> 				[14,928] </_Sample size (HH)_>
<_Sample size (IND)_> 				[68,466] </_Sample size (IND)_>
...
use "`path_in_stata'/LFS03Q1.dta", clear
gen quarter=1
append using  "`path_in_stata'/LFS03Q2.dta"
replace quarter=2 if quarter==.
append using  "`path_in_stata'/LFS03Q3.dta"
replace quarter=3 if quarter==.
append using  "`path_in_stata'/LFS03Q4.dta"
...
*<_relationharm_>
	...
	*replace relationharm=1 if pid=="0542482-002-4" & relationharm==5
	*replace relationharm=1 if pid=="0520008-002-4 " & relationharm==5
	*replace relationharm=1 if pid=="0522976-009-4" & relationharm==5
