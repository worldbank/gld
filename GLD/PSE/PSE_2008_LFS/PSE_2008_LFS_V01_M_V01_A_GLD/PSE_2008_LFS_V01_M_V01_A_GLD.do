...
<_Program name_>				[PSE_2008_LFS_V01_M_V01_A_GLD] </_Program name_>
...
<_Sample size (HH)_> 				[14,723] </_Sample size (HH)_>
<_Sample size (IND)_> 				[67,372] </_Sample size (IND)_>
...
use "`path_in_stata'/LFS08Q1.dta", clear
rename _all, lower
save "`path_in_stata'/LFS08Q1_lower.dta", replace

use "`path_in_stata'/LFS08Q2.dta", clear
rename _all, lower
save "`path_in_stata'/LFS08Q2_lower.dta", replace

use "`path_in_stata'/LFS08Q3.dta", clear
rename _all, lower
save "`path_in_stata'/LFS08Q3_lower.dta", replace

use "`path_in_stata'/LFS08Q4.dta", clear
rename _all, lower
save "`path_in_stata'/LFS08Q4_lower.dta", replace

* Now append the standardized datasets
use "`path_in_stata'/LFS08Q1_lower.dta", clear
gen quarter=1
append using "`path_in_stata'/LFS08Q2_lower.dta"
replace quarter=2 if quarter==.
append using "`path_in_stata'/LFS08Q3_lower.dta"
replace quarter=3 if quarter==.
append using "`path_in_stata'/LFS08Q4_lower.dta"
