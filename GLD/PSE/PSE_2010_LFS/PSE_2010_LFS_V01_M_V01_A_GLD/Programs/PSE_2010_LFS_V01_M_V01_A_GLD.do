...
<_Program name_>				[PSE_2010_LFS_V01_M_V01_A_GLD] </_Program name_>
...
<_Sample size (HH)_> 				[15,897] </_Sample size (HH)_>
<_Sample size (IND)_> 				[68,045] </_Sample size (IND)_>
...
use "`path_in_stata'/LFS10Q1.dta", clear
rename _all, lower
save "`path_in_stata'/LFS10Q1_lower.dta", replace

use "`path_in_stata'/LFS10Q2.dta", clear
rename _all, lower
save "`path_in_stata'/LFS10Q2_lower.dta", replace

use "`path_in_stata'/LFS10Q3.dta", clear
rename _all, lower
save "`path_in_stata'/LFS10Q3_lower.dta", replace

use "`path_in_stata'/LFS10Q4.dta", clear
rename _all, lower
save "`path_in_stata'/LFS10Q4_lower.dta", replace


* Annual file 
use "`path_in_stata'/LFS10-Y.dta", clear
...
use "`path_in_stata'/LFS10Q1_lower.dta", clear
gen quarter=1
append using "`path_in_stata'/LFS10Q2_lower.dta"
replace quarter=2 if quarter==.
append using "`path_in_stata'/LFS10Q3_lower.dta"
replace quarter=3 if quarter==.
append using "`path_in_stata'/LFS10Q4_lower.dta"
