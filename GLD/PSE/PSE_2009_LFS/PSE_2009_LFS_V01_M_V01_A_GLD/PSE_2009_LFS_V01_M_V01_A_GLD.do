...
<_Program name_>				[PSE_2009_LFS_V01_M_V01_A_GLD] </_Program name_>
...
<_Sample size (HH)_> 				[15,613] </_Sample size (HH)_>
<_Sample size (IND)_> 				[68,801] </_Sample size (IND)_>
...
use "`path_in_stata'/LFS09Q2.dta", clear
rename _all, lower
save "`path_in_stata'/LFS09Q2_lower.dta", replace

use "`path_in_stata'/LFS09Q3.dta", clear
rename _all, lower
save "`path_in_stata'/LFS09Q3_lower.dta", replace

use "`path_in_stata'/LFS09Q4.dta", clear
rename _all, lower
save "`path_in_stata'/LFS09Q4_lower.dta", replace


* Annual file 
use "`path_in_stata'/LFS09-Y.dta", clear
...
use "`path_in_stata'/LFS09Q1_lower.dta", clear
gen quarter=1
append using "`path_in_stata'/LFS09Q2_lower.dta"
replace quarter=2 if quarter==.
append using "`path_in_stata'/LFS09Q3_lower.dta"
replace quarter=3 if quarter==.
append using "`path_in_stata'/LFS09Q4_lower.dta"
