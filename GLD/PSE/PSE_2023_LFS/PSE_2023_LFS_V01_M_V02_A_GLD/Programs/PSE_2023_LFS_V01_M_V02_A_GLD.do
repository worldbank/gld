...
<_Program name_>				[PSE_2023_LFS_V01_M_V02_A_GLD] </_Program name_>
<_Application_>					[Stata 18] <_Application_>
<_Author(s)_>					World Bank Jobs Group (gld@worldbank.org) </_Author(s)_>
<_Date created_>				2025-12-17 </_Date created_>
...
<_Sample size (HH)_> 				[14,028] </_Sample size (HH)_>
<_Sample size (IND)_> 				[84,548] </_Sample size (IND)_>
...
* Date: [2026-02-18] - [Updated variables]
...
* Create tempfiles for each quarter
...
* Try to use the file
use "`path_in_stata'/LFS23Q1.dta", clear

	gen quarter=1
save `q1'

* Q2
use "`path_in_stata'/LFS23Q2.dta", clear

		gen quarter=2
save `q2'

* Q3
use "`path_in_stata'/LFS23Q3.dta", clear

		gen quarter=3
save `q3'

* Q4
use "`path_in_stata'/LFS23Q4.dta", clear
		gen quarter=4
save `q4'

* Annual file 
use "`path_in_stata'/LFS23_Y.dta", clear
...
* Now append all quarters together
use `q1', clear
append using `q2'
append using `q3'
append using `q4'
...
*<_countrycode_>
	gen str4 countrycode = "PSE"
	label var countrycode "Country code"
*</_countrycode_>


*<_survname_>
	gen survname = "Labour Force Survey"
...
*<_weight_>
	* Make quarterly weight annual based on obs per quarter
	...
	gen help_w_4 = help_w_3/help_w_2
	
	gen weight = FWP*help_w_4
...
/* <_subnatid1_note>
	...
	gen str subnatid1 =""
	replace subnatid1 = "1- West Bank" if wbgs==1
	replace subnatid1 = "2- Gaza Strip" if wbgs==2
	label var subnatid1 "Subnational ID at First Administrative Level"
*</_subnatid1_>


*<_subnatid2_>
	gen str subnatid2 = governorate
...
*<_literacy_>
	gen byte literacy = .
	replace literacy=1 if inrange(Pr4,2,10)
	replace literacy=0 if Pr4==1
...
*<_educat7_>
	gen byte educat7 = .
	replace educat7 = 1 if Pr4 == 1
	replace educat7 = 2 if Pr4 == 2 
	replace educat7 = 3 if Pr4 == 3
	replace educat7 = 4 if Pr4 == 4
	replace educat7 = 5 if Pr4 == 5
	replace educat7 = 6 if Pr4 == 6
	replace educat7 = 7 if inrange(Pr4, 7, 10) 
...
*<_potential_lf_>
	gen byte potential_lf = .
		replace potential_lf = 1 if (PW16==2 & PW19 ==1) 
	replace potential_lf = 1 if  (PW16==1 & PW19 ==2)
...
*<_nlfreason_>
	gen byte nlfreason = PW18
	recode nlfreason (1/2=5) (3=1) (4=5) (6=4) (7/13=5) (14=3) (15/19=5)
...
*<_ocusec_>
	gen byte ocusec = .
	replace ocusec = 1 if inrange(PW50, 1, 5)
	replace ocusec = 2 if inrange(PW50, 6, 9)
...
*<_industrycat_isic_>
	* Information is at two digits for 83% of respondents. At five digits (with the
	* last digit seemingly some local version) for the remainder. Cannot seem to 
	* figure out what it is about
	gen indus_help1 = ""
	replace indus_help1 = string(PW37, "%02.0f") if PW37 < 100
	replace indus_help1 = indus_help1 + "00" if !mi(indus_help1)
	
	gen indus_help2 = string(PW37, "%05.0f") if inrange(PW37, 100, 999999)
	replace indus_help2 = substr(indus_help2, 1, 4)
	
	gen industrycat_isic = indus_help1
	replace industrycat_isic = indus_help2 if mi(industrycat_isic)
...
*<_occup_isco_>
	* Similar thing as with industry for occupation
	gen help_occ_1 = string(PW39, "%02.0f") if PW39 < 100
	replace help_occ_1 = help_occ_1 + "00" if !mi(help_occ_1)
	
	gen help_occ_2 = string(PW39, "%05.0f") if inrange(PW39, 100, 99999999)
	replace help_occ_2 = substr(help_occ_2, 1, 4)
	
	gen occup_isco = help_occ_1
	replace occup_isco = help_occ_2 if mi(occup_isco)
...
*<_wage_no_compen_>
	*Note: We dont have the daily wage variable from which this one was created (PW84)
...
*<_contract_>
	gen byte contract = PW41
	recode contract 2=1 3=1 4=1 5=0
...
*<_healthins_>
	gen byte healthins = .
	replace healthins=1 if PW47_1==1 | PW47_2==1
	replace healthins=0 if missing(healthins) & lstatus==1
...
*<_firmsize_l_>
	gen firmsize_l = .
	replace firmsize_l =1 if PW54==1
	replace firmsize_l =2 if PW54==2
	replace firmsize_l =5 if PW54==3
...
*<_firmsize_u_>
	gen firmsize_u = .
	replace firmsize_u = 10 if PW54==4
	replace firmsize_u = 20 if PW54==5
...
*<_ocusec_2_>
	gen byte ocusec_2 = .
	replace ocusec_2 = 1 if inrange(PW77, 1, 5)
	replace ocusec_2 = 2 if inrange(PW77, 6, 9)
...
*<_industry_orig_2_>
	gen industry_orig_2 = string(PW66)
...
*<_industrycat_isic_2_>
	gen indus_help1 = ""
	replace indus_help1 = string(PW66, "%02.0f") if PW66 < 100
	replace indus_help1 = indus_help1 + "00" if !mi(indus_help1)
	
	gen indus_help2 = string(PW66, "%05.0f") if inrange(PW66, 100, 999999)
	replace indus_help2 = substr(indus_help2, 1, 4)
	
	gen industrycat_isic_2 = indus_help1
	replace industrycat_isic_2 = indus_help2 if mi(industrycat_isic_2)
...
*<_industrycat10_2_>
	...
	replace industrycat10_2=1 if inrange(industrycat_isic_2, "0100","0300")
	replace industrycat10_2=2 if inrange(industrycat_isic_2, "0500","0900")
	replace industrycat10_2=3 if inrange(industrycat_isic_2, "1000","3300")
	replace industrycat10_2=4 if inrange(industrycat_isic_2, "3500", "3900")
	replace industrycat10_2=5 if inrange(industrycat_isic_2, "4100", "4300")
	replace industrycat10_2=6 if inrange(industrycat_isic_2, "4500", "4700") | inrange(industrycat_isic_2, "5500", "5600")
	replace industrycat10_2=7 if inrange(industrycat_isic_2, "4900", "5300") | inrange(industrycat_isic_2, "5800", "6300")
	replace industrycat10_2=8 if inrange(industrycat_isic_2, "6400" , "8200")
	replace industrycat10_2=9 if inrange(industrycat_isic_2, "8400" , "8400")
...
*<_occup_orig_2_>
	gen occup_orig_2 = string(PW68)
	label var occup_orig_2 "Original occupation record secondary job 7 day recall"
*</_occup_orig_2_>


*<_occup_isco_2_>
	gen help_occ_1 = string(PW68, "%02.0f") if PW68 < 100
	replace help_occ_1 = help_occ_1 + "00" if !mi(help_occ_1)
	
	gen help_occ_2 = string(PW68, "%05.0f") if inrange(PW68, 100, 99999999)
	replace help_occ_2 = substr(help_occ_2, 1, 4)
	
	gen occup_isco_2 = help_occ_1
	replace occup_isco_2 = help_occ_2 if mi(occup_isco_2)
...
*<_firmsize_l_2_>
	gen firmsize_l_2 = .
	replace firmsize_l_2 =1 if PW80==1
	replace firmsize_l_2 =2 if PW80==2
	replace firmsize_l_2 =5 if PW80==3
...
*<_firmsize_u_2_>
	gen firmsize_u_2 = .
	replace firmsize_u_2 = 10 if PW80==4
	replace firmsize_u_2 = 20 if PW80==5
