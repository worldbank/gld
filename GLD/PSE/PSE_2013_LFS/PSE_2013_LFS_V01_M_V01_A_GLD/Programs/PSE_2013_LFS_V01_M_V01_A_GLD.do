...
<_Program name_>				[PSE_2013_LFS_V01_M_V01_A_GLD] </_Program name_>
...
use "`path_in_stata'/LFS13Q1.dta", clear
rename _all, lower
save "`path_in_stata'/LFS13Q1_lower.dta", replace

use "`path_in_stata'/LFS13Q2.dta", clear
rename _all, lower
save "`path_in_stata'/LFS13Q2_lower.dta", replace

use "`path_in_stata'/LFS13Q3.dta", clear
rename _all, lower
save "`path_in_stata'/LFS13Q3_lower.dta", replace

use "`path_in_stata'/LFS13Q4.dta", clear
rename _all, lower
save "`path_in_stata'/LFS13Q4_lower.dta", replace


* Annual file 
use "`path_in_stata'/LFS13-Y.dta", clear
...
use "`path_in_stata'/LFS13Q1_lower.dta", clear
gen quarter=1
append using "`path_in_stata'/LFS13Q2_lower.dta"
replace quarter=2 if quarter==.
append using "`path_in_stata'/LFS13Q3_lower.dta"
replace quarter=3 if quarter==.
append using "`path_in_stata'/LFS13Q4_lower.dta"
...
*<_relationharm_>
	...
	replace relationharm = 2 if relationharm==1 & pid=="1382270-002-2"
...
*<_industrycat_isic_>
	...
	replace industrycat_isic="" if industrycat_isic==".00"
			replace industrycat_isic="8000" if industrycat_isic=="8300"
			replace industrycat_isic="" if industrycat_isic=="00"
