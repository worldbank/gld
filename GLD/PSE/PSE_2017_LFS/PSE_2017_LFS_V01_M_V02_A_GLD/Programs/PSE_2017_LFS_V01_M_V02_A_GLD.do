...
<_Program name_>				[PSE_2017_LFS_V01_M_V02_A_GLD] </_Program name_>
...
<_Sample size (HH)_> 				[13,466] </_Sample size (HH)_>
<_Sample size (IND)_> 				[91,230] </_Sample size (IND)_>
...
*In discussion with NSO regardingt weights, so for now we cannot harmonize this year. The codes below should work with the appro
...
* Try to use the file
use "`path_in_stata'/LFS17Q1.dta", clear
...
* Q2
use "`path_in_stata'/LFS17Q2.dta", clear
...
* Q3
use "`path_in_stata'/LFS17Q3.dta", clear
...
* Q4
use "`path_in_stata'/LFS17Q4.dta", clear
...
* Annual file 
use "`path_in_stata'/LFS17_Y.dta", clear
