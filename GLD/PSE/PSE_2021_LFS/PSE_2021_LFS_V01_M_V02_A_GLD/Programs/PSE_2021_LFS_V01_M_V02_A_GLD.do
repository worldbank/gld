...
<_Program name_>				[PSE_2021_LFS_V01_M_V02_A_GLD] </_Program name_>
...
<_Sample size (HH)_> 				[14,851] </_Sample size (HH)_>
<_Sample size (IND)_> 				[94,632] </_Sample size (IND)_>
...
* DDate: [2026-02-18] - [Updated variables]
...
* Try to use the file
use "`path_in_stata'/LFS21Q1.dta", clear
	gen quarter=1
save `q1'

* Q2
use "`path_in_stata'/LFS21Q2.dta", clear
		gen quarter=2
save `q2'

* Q3
use "`path_in_stata'/LFS21Q3.dta", clear
		gen quarter=3
save `q3'

* Q4
use "`path_in_stata'/LFS21Q4.dta", clear
		gen quarter=4
save `q4'

* Annual file 
use "`path_in_stata'/LFS21_Y.dta", clear
...
*<_pid_>
	gen pid = string(HR0A, "%02.0f")
	label var pid "Individual ID"
	
	* One repeat on quarter, hhid, pid
	duplicates tag hhid pid quarter, gen(dup)
	*br if IDSAM == 1882128
	* The one person off is 
	* IDSAM		HR0A HR2	Pr1	quarter
	* 1882128	1	 Male	26	1
	replace hhid = "9999999" if IDSAM == 1882128 & HR0A == 1 & HR2 == 1 & Pr1 == 26 & quarter == 1
*</_pid_>
