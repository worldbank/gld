...
<_Program name_>				TUN_2010_ENPE_V01_M_V01_A_GLD_ALL.do </_Program name_>
<_Application_>					Stata 17 <_Application_>
<_Author(s)_>					World Bank Jobs Group (gld@worldbank.org) </_Author(s)_>
<_Date created_>				2024-04-21 </_Date created_>
...
<_Data collection from_>		04/2010 </_Data collection from_>
<_Data collection to_>			06/2010 </_Data collection to_>
<_Source of dataset_> 			African Development Bank </_Source of dataset_>
<_Sample size (HH)_> 			137878 </_Sample size (HH)_>
<_Sample size (IND)_> 			548456 </_Sample size (IND)_>
...
use "`path_in_stata'/Individus_T2.dta", clear

* There are individuals with missing values for all resposes, incl weight:
tempvar x
duplicates tag V_10 Num_Men V_201, gen(x)
drop if x>1
drop x
/*%%=============================================================================================
	2: Survey & ID
...
/* <_hhid_note>
	...
	gen str_psu = string(V_10, "%02.0f")
	gen str_hhn = string(Num_Men, "%04.0f")
	gen str_person = string(V_201, "%02.0f")
	gen hhid = str_psu + str_hhn
	label var hhid "Household ID"
*</_hhid_>


*<_pid_>
	gen  pid = hhid + str_person
	duplicates tag pid, gen(x)
	* Resulting duplicates
	drop pid x
	
	** Count number of HH heads
	tempvar head tothead neg_age neg_male 
	...
	sort hhid `neg_male' `neg_age'
	by hhid: gen roster = _n
	
	gen str_roster = string(roster, "%02.0f")
	
	gen pid = hhid + str_roster
	isid pid
...
*<_subnatid1_>
	gen str subnatid1 = ""
	replace subnatid1 = "1 - Central Tunis" if V_10 == 11 | V_10 == 12 | V_10 == 13 | V_10 == 14
	replace subnatid1 = "2 - North East" if V_10 == 15 | V_10 == 16 | V_10 == 17
	replace subnatid1 = "3 - North West" if V_10 == 21 | V_10 == 22 | V_10 == 23 | V_10 == 24
	replace subnatid1 = "4 - Central East" if V_10 == 31 | V_10 == 32 | V_10 == 33 | V_10 == 34
	replace subnatid1 = "5 - Central West" if V_10 == 41 | V_10 == 42 | V_10 == 43
	replace subnatid1 = "6 - South East" if V_10 == 51 | V_10 == 52 | V_10 == 53
	replace subnatid1 = "7 - South West" if V_10 == 61 | V_10 == 62 | V_10 == 63
...
*<_subnatid2_>
	gen str subnatid2 = ""
	sdecode V_10, gen(temp_sn1)
	replace temp_sn1 = proper(temp_sn1)
	replace subnatid2 = str_psu + " - " + temp_sn1
...
*<_relationcs_>
	gen relationcs = V_203
	label var relationcs "Relationship to the head of household - Country original"
*</_relationcs_>


*<_marital_>
	gen byte marital = V_225
...
{
*<_lstatus_>
	gen byte lstatus = V_288
	recode lstatus(2 = 1) (1 = 3) (3 = 2)
	replace lstatus = 3 if missing(V_288) & age>=minlaborage
...
*<_nlfreason_>
	gen byte nlfreason= V_284
	recode nlfreason (1 2 3 4 5 = .) (6 7 11 12 14 = 5) (8 = 2) (9 = 1) (10 = 3)
...
*<_industrycat10_>
	...
	recode industrycat10 (0 = 1) (10 20 30 40 50 60  = 3) (65 66 = 2) (67 68 = 4) (69 = 5) (72 79 = 6) (76 77 = 7) (82 85 = 8) (89 98 = 10) (93 = 9)
...
* Raw occup is only available at single digit. Occup_isco will be equal to occup. Leave missing!
	gen occup_isco = ""
	gen helper = string(occup_orig, "%02.0f")
	replace occup_isco = helper + "00" if inrange(occup_orig, 11, 93)
...
*<_contract_>
	gen byte contract = inlist(V_360, 1, 2)
...
*<_occup_isco_2_>
	gen occup_isco_2 = ""
	tostring occup_orig_2, gen(helper)
	replace helper = "" if occup_orig_2 == 0
	replace occup_isco_2 = helper + "00" if inrange(occup_orig_2, 11, 93)
