...
<_Program name_>				TUN_2005_ENPE_V01_M_V01_A_GLD_ALL.do </_Program name_>
...
<_Data collection from_>		04/2005 </_Data collection from_>
<_Data collection to_>			06/2005 </_Data collection to_>
<_Source of dataset_> 			African Development Bank </_Source of dataset_>
<_Sample size (HH)_> 			63443 </_Sample size (HH)_>
<_Sample size (IND)_> 			288586 </_Sample size (IND)_>
...
use "`path_in_stata'/Individu_emploi_2005.dta", clear
...
/* <_hhid_note>
	...
	* Create string versions
	gen str_rgn = string(V_015, "%02.0f")
...
*<_subnatid1_>
	...
	gen str subnatid1 = ""
	replace subnatid1 = "1 - Central Tunis"  if V_015 == 0
	replace subnatid1 = "2 - North East" if V_015 == 1
	replace subnatid1 = "3 - North West" if V_015 == 2
	replace subnatid1 = "4 - Central East" if V_015 == 3
	replace subnatid1 = "5 - Central West" if V_015 == 4
	replace subnatid1 = "6 - South East" if V_015 == 5
	replace subnatid1 = "7 - South West" if V_015 == 6
