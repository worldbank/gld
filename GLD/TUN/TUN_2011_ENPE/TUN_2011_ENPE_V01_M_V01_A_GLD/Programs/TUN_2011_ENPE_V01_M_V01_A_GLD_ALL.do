...
use "`path_in_stata'/individu-T2-2011.dta", clear
...
*<_subnatid1_>
	...
	gen str subnatid1 = ""
	replace subnatid1 = "1 - Central Tunis"  if V_15 == 0
	replace subnatid1 = "2 - North East" if V_15 == 1
	replace subnatid1 = "3 - North West" if V_15 == 2
	replace subnatid1 = "4 - Central East" if V_15 == 3
	replace subnatid1 = "5 - Central West" if V_15 == 4
	replace subnatid1 = "6 - South East" if V_15 == 5
	replace subnatid1 = "7 - South West" if V_15 == 6
	label var subnatid1 "Subnational ID at First Administrative Level"
*</_subnatid1_>


*<_subnatid2_>
* Only governorat of previous employment
	gen str subnatid2 = ""
...
{
*<_lstatus_>
	gen byte lstatus = V_550    
	replace lstatus = 3 if missing(V_550) & age>=minlaborage
...
*<_occup_>
	...
	replace occup = . if occup_orig ==0 | lstatus != 1 | occup_orig == -1
