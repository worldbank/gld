...
<_Program name_>				BRA_2001_PNAD_V01_M_V03_A_GLD_ALL.do </_Program name_>
...
<_Study ID_> 				BRA_2001_PNAD_v01_M </_Study ID_>
<_Data collection from_> 	09/2001 </_Data collection from_>
<_Data collection to_> 		09/2001 </_Data collection to_>
...
*----------1.3 Merge Household and People files--------------------------------*
	...
	use "`path_in_stata'\pd2001.dta"
	merge 1:m id_dom using "`path_in_stata'\pp2001.dta"
	keep if _merge==3
	drop _merge
...
/* <_lstatus_note>
	...
	gen lstatus = .
	replace lstatus = 1 if V4764 == 1 & age >= minlaborage
	replace lstatus = 2 if V4764 == 2 & age >= minlaborage
	replace lstatus = 3 if V4754 == 2 & age >= minlaborage
	recast byte lstatus
...
/* <_lstatus_year_note>
	...
	gen lstatus_year = .
	replace lstatus_year = 1 if V4764 == 1 & age >= minlaborage
	replace lstatus_year = 2 if V4764 == 2 & age >= minlaborage
	replace lstatus_year = 3 if V4763 == 2 & age >= minlaborage
	recast byte lstatus
