...
<_Program name_>				BRA_1995_PNAD_V01_M_V03_A_GLD_ALL.do </_Program name_>
...
<_Study ID_> 				BRA_1995_PNAD_v01_M </_Study ID_>
<_Data collection from_> 	09/1995 </_Data collection from_>
<_Data collection to_> 		09/1995 </_Data collection to_>
...
* Get some of what you did in the transformation and put it here
	...
	use "`path_in_stata'\individuals_1995.dta"


	preserve

	use "`path_in_stata'\households_1995.dta", clear
...
/* <_hhid_note>
	...
	1995-2012: V0102 has 6-digits rather than 8-digits (lacking UF digits at begining)
...
/* <_weight_note>
	...
	1995-1995: contains "-1", which should be changed to missing (.)
...
*<_subnatid2_>
	...
	Until 1995: not standardised
	Until 1995: TO (17) part of GO (52), though created in 1988 (changes region/subnatid1)
...
/* <_school_note>
	...
	As of 1995: "Pre-school" and "School" are considered separately
...
/* <_educy_note>
	...
	Unti 1995: one set of values for each of 0-8, 9-11 and 12+
	As of 1995: 0-16
...
/* <_educat7_note>
	...
	As of 1995: "Classe de alfabetização" category is added
	1981 & 1995: "Alfabetização de adultos" exists
...
*<_educat_isced_>
	...
	label variable educat_isced "ISCED 1995 standardised level of education"
...
/* <_educat_orig_note>
	...
	1995: "Classe de alfabetização" category is added
	1981 & 1995: "Alfabetização de adultos" exists
...
/* <__note>
	...
	1995: A broader definition of "work" was adopted, that includes
...
/* <_empstat_note>
	...
	Comparability throughout the years is compromised:
	Until 1995: "funcionários públicos estatutários" (public servants) and "militares" (army) could not be identified
	Until 1995: "trabalhadores domésticos" (domestic workers) inexisted
	Until 1995: "empregados" (workers) contained both "com carteira" and "sem carteira" (formal and informal)
	As of 1995: "production for own consumption" and "construction for own use" exist
	As of 1995: "empregado sem declaração de carteira" (probably) became "empregados sem carteira"
	As of 1995: "trabalhador doméstico sem declaração de carteira" (probably) became "trabalhadores domésticos sem carteira"
...
*<_socialsec_>
	rename V9059 socialsec // [1995: 4761]
