...
<_Program name_>				BRA_2011_PNAD_V01_M_V03_A_GLD_ALL.do </_Program name_>
...
<_Study ID_> 				BRA_2011_PNAD_v01_M </_Study ID_>
<_Data collection from_> 	09/2011 </_Data collection from_>
<_Data collection to_> 		09/2011 </_Data collection to_>
...
<_Sample size (HH)_> 		111,763 </_Sample size (HH)_>
<_Sample size (IND)_> 		358,919 </_Sample size (IND)_>
...
*----------1.3 Merge Household and People files--------------------------------*
	...
	use "`path_in_stata'\pd2011.dta"
	merge 1:m id_dom using "`path_in_stata'\pp2011.dta"
	keep if _merge==3
	drop _merge
...
/* <__note>
	...
	Vars we need for other years are not present in this year
...
/* <_educy_note>
	...
	replace educy = 17 if V6007 == 9 & V0610 == 2
	replace educy = 18 if V6007 == 9 & V0610 == 3
	replace educy = 19 if V6007 == 9 & V0610 >= 4 & V0610 <= 8	
*</_educy_>
...
/* <_educat7_note>
	...
	As of 2007: "Classe de alfabetização" category is added
	1981 & 1992: "Alfabetização de adultos" exists
	
</_educat7_note> */
	gen educat7 = .
	replace educat7 = 1 if educy == 0
	replace educat7 = 2 if (educy >= 1 & educy <= 7) | (V6003 == 1 | V6003 == 3 | V6003 == 6 | V6003 == 7  | V6003 == 8 | V6003 == 9)
	replace educat7 = 3 if educy == 8
	replace educat7 = 4 if (educy >= 9 & educy <= 10) | (V6003 == 2 | V6003 == 4 )
	replace educat7 = 5 if educy == 11
	replace educat7 = 7 if (educy >= 12 & educy <= 15) | (V6003 == 5 | V6003 == 11)
...
*<_educat_isced_>
	...
	label variable educat_isced "ISCED 2011 standardised level of education"
...
/* <_educat_orig_note>
	...
	2007: "Classe de alfabetização" category is added
	1981 & 1992: "Alfabetização de adultos" exists
...
/* <_lstatus_note>
	...
	gen lstatus = .
	replace lstatus = 1 if V4805 == 1 & age >= minlaborage
	replace lstatus = 2 if V4805 == 2 & age >= minlaborage
...
/* <_empstat_note>
	...
	As of 2007: "empregado sem declaração de carteira" (probably) became "empregados sem carteira"
	As of 2007: "trabalhador doméstico sem declaração de carteira" (probably) became "trabalhadores domésticos sem carteira"
...
/* <_occup_isco_note>
	...
	merge m:1 v9996 using "`path_in_stata'\isco_88_cbo_dom_DD.dta"
	drop if _merge == 2
...
/* <_lstatus_year_note>
	...
	gen lstatus_year = .
	replace lstatus_year = 1 if V4814 == 1 & age >= minlaborage
	replace lstatus_year = 2 if V4814 == 2 & age >= minlaborage
...
/* <_empstat_year_note>
	...
	recode empstat_year (1/7 = 1) (11 = 2) (10 = 3) (9 12/13 = 4)
...
/* <_industrycat_isic_year_note>
	...
	gen industrycat_isic_year = substr(industry_orig_year,1,2)
...
/* <_contract_year_note>
	...
	recode contract_year (1/3 = 1) (4 6/7 9/13 = 0)
...
/* <_occup_skill_2_year_note>
	...
	replace occup_skill_2_year = 1 if lstatus_year == 1 & (substr(string(occup_isco_2_year), 1, 1) == "1" | substr(string(occup_isco_2_year), 1, 1) == "2" | substr(string(occup_isco_2_year), 1, 1) == "3")
	replace occup_skill_2_year = 2 if lstatus_year == 1 & (substr(string(occup_isco_2_year), 1, 1) == "4" | substr(string(occup_isco_2_year), 1, 1) == "5" | substr(string(occup_isco_2_year), 1, 1) == "6" | substr(string(occup_isco_2_year), 1, 1) == "7" | substr(string(occup_isco_2_year), 1, 1) == "8")
	replace occup_skill_2_year = 3 if lstatus_year == 1 & substr(string(occup_isco_2_year), 1, 1) == "9"
...
/* <_occup_2_year_note>
	...
	gen occup_2_year = .
	replace occup_2_year = 1 if lstatus_year == 1 & substr(string(occup_isco_2_year), 1, 1) == "1"
	replace occup_2_year = 2 if lstatus_year == 1 & substr(string(occup_isco_2_year), 1, 1) == "2"
	replace occup_2_year = 3 if lstatus_year == 1 & substr(string(occup_isco_2_year), 1, 1) == "3"
	replace occup_2_year = 4 if lstatus_year == 1 & substr(string(occup_isco_2_year), 1, 1) == "4"
	replace occup_2_year = 5 if lstatus_year == 1 & substr(string(occup_isco_2_year), 1, 1) == "5"
	replace occup_2_year = 6 if lstatus_year == 1 & substr(string(occup_isco_2_year), 1, 1) == "6"
	replace occup_2_year = 7 if lstatus_year == 1 & substr(string(occup_isco_2_year), 1, 1) == "7"
	replace occup_2_year = 8 if lstatus_year == 1 & substr(string(occup_isco_2_year), 1, 1) == "8"
	replace occup_2_year = 9 if lstatus_year == 1 & substr(string(occup_isco_2_year), 1, 1) == "9"
	replace occup_2_year = 0 if lstatus_year == 1 & substr(string(occup_isco_2_year), 1, 1) == "10"
