...
<_Program name_>				BRA_1998_PNAD_V01_M_V04_A_GLD_ALL.do </_Program name_>
...
<_Study ID_> 				BRA_1998_PNAD_v01_M </_Study ID_>
<_Data collection from_> 	09/1998 </_Data collection from_>
<_Data collection to_> 		09/1998 </_Data collection to_>
...
* Date: 2023 / 01 / 11 - Correct out of range values 8, 14 for empstat
...
* Get some of what you did in the transformation and put it here
	...
	use "`path_in_stata'\individuals_1998.dta"


	preserve

	use "`path_in_stata'\households_1998.dta", clear
...
/* <_hhid_note>
	...
	1998-2012: V0102 has 6-digits rather than 8-digits (lacking UF digits at begining)
...
/* <_weight_note>
	...
	1998-1998: contains "-1", which should be changed to missing (.)
...
*<_subnatid2_>
	...
	Until 1998: not standardised
	Until 1998: TO (17) part of GO (52), though created in 1988 (changes region/subnatid1)
...
*<_migrated_binary_>
	...
	replace migrated_binary = 0 if V0501 & V0504 == 4 & V0510 == 2 & V0511 == 3
...
/* <_migrated_from_cat_note>
	...
	* UF (V0504 is yes) we have last UF (code V5090) that can be compared 
...
/* <_ed_mod_age_note>
	...
	As of 1998: asked to all ages

	Comparability throughout the years is compromised:
	1998: skip pattern introduced
...
/* <_school_note>
	...
	As of 1998: "Pre-school" and "School" are considered separately
...
/* <_educy_note>
	...
	Unti 1998: one set of values for each of 0-8, 9-11 and 12+
	As of 1998: 0-16
...
/* <_educat7_note>
	...
	As of 1998: "Classe de alfabetização" category is added
	1981 & 1998: "Alfabetização de adultos" exists

</_educat7_note> */
	gen educat7 = .
	replace educat7 = 1 if educy == 0
	replace educat7 = 2 if (educy >= 1 & educy <= 7) | (V0603 == 1 | V0603 == 3 | V0603 == 6 | V0603 == 7 )
	replace educat7 = 3 if educy == 8
	replace educat7 = 4 if (educy >= 9 & educy <= 10) | (V0603 == 2 | V0603 == 4 )
	replace educat7 = 5 if educy == 11
	replace educat7 = 7 if (educy >= 12 & educy <= 15) | (V0603 == 5 | V0603 == 9)
...
*<_educat_isced_>
	...
	label variable educat_isced "ISCED 1998 standardised level of education"
...
/* <_educat_orig_note>
	...
	1998: "Classe de alfabetização" category is added
	1981 & 1998: "Alfabetização de adultos" exists
...
/* <__note>
	...
	1998: A broader definition of "work" was adopted, that includes
...
/* <_lstatus_note>
	...
	Until 2006 (except 1998 & 1998): "employed" could be answered by people 5 years or older
...
/* <_empstat_note>
	...
	Comparability throughout the years is compromised:
	Until 1998: "funcionários públicos estatutários" (public servants) and "militares" (army) could not be identified
	Until 1998: "trabalhadores domésticos" (domestic workers) inexisted
	Until 1998: "empregados" (workers) contained both "com carteira" and "sem carteira" (formal and informal)
	As of 1998: "production for own consumption" and "construction for own use" exist
	As of 1998: "empregado sem declaração de carteira" (probably) became "empregados sem carteira"
	As of 1998: "trabalhador doméstico sem declaração de carteira" (probably) became "trabalhadores domésticos sem carteira"
...
*<_socialsec_>
	rename V9059 socialsec // [1998: 4761]
