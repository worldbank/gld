...
<_Program name_>				BRA_1997_PNAD_V01_M_V03_A_GLD_ALL.do </_Program name_>
...
<_Study ID_> 				BRA_1997_PNAD_v01_M </_Study ID_>
<_Data collection from_> 	09/1997 </_Data collection from_>
<_Data collection to_> 		09/1997 </_Data collection to_>
...
* Get some of what you did in the transformation and put it here
	...
	use "`path_in_stata'\individuals_1997.dta"


	preserve

	use "`path_in_stata'\households_1997.dta", clear
...
/* <_hhid_note>
	...
	1997-2012: V0102 has 6-digits rather than 8-digits (lacking UF digits at begining)
...
/* <_weight_note>
	...
	1997-1997: contains "-1", which should be changed to missing (.)
...
*<_subnatid2_>
	...
	Until 1997: not standardised
	Until 1997: TO (17) part of GO (52), though created in 1988 (changes region/subnatid1)
...
/* <_ed_mod_age_note>
	...
	As of 1997: asked to all ages

	Comparability throughout the years is compromised:
	1997: skip pattern introduced
...
/* <_school_note>
	...
	As of 1997: "Pre-school" and "School" are considered separately
...
/* <_educy_note>
	...
	Unti 1997: one set of values for each of 0-8, 9-11 and 12+
	As of 1997: 0-16
...
/* <_educat7_note>
	...
	As of 1997: "Classe de alfabetização" category is added
	1981 & 1997: "Alfabetização de adultos" exists
...
*<_educat_isced_>
	...
	label variable educat_isced "ISCED 1997 standardised level of education"
...
/* <_educat_orig_note>
	...
	1997: "Classe de alfabetização" category is added
	1981 & 1997: "Alfabetização de adultos" exists
...
/* <__note>
	...
	1997: A broader definition of "work" was adopted, that includes
...
/* <_lstatus_note>
	...
	Until 2006 (except 1997 & 1997): "employed" could be answered by people 5 years or older
...
/* <_empstat_note>
	...
	Comparability throughout the years is compromised:
	Until 1997: "funcionários públicos estatutários" (public servants) and "militares" (army) could not be identified
	Until 1997: "trabalhadores domésticos" (domestic workers) inexisted
	Until 1997: "empregados" (workers) contained both "com carteira" and "sem carteira" (formal and informal)
	As of 1997: "production for own consumption" and "construction for own use" exist
	As of 1997: "empregado sem declaração de carteira" (probably) became "empregados sem carteira"
	As of 1997: "trabalhador doméstico sem declaração de carteira" (probably) became "trabalhadores domésticos sem carteira"
...
*<_socialsec_>
	rename V9059 socialsec // [1997: 4761]
