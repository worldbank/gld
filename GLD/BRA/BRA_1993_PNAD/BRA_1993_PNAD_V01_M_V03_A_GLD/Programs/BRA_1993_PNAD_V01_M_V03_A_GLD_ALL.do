...
<_Program name_>				BRA_1993_PNAD_V01_M_V03_A_GLD_ALL.do </_Program name_>
...
<_Study ID_> 				BRA_1993_PNAD_v01_M </_Study ID_>
<_Data collection from_> 	09/1993 </_Data collection from_>
<_Data collection to_> 		09/1993 </_Data collection to_>
...
* Get some of what you did in the transformation and put it here
	...
	use "`path_in_stata'\individuals_1993.dta"


	preserve

	use "`path_in_stata'\households_1993.dta", clear
	...
	merge m:1 UF CONTROL V0103 using `hhs', nogen keep(1 3)
...
tostring CONTROL,  replace format(%05.0f) force

tostring V0103, replace format(%02.0f) force

egen id_dom = concat(UF CONTROL V0103)
...
/* <_hhid_note>
	...
	1993-2012: V0102 has 6-digits rather than 8-digits (lacking UF digits at begining)
...
/* <_weight_note>
	...
	1993-1993: contains "-1", which should be changed to missing (.)
...
*<_subnatid2_>
	...
	Until 1993: not standardised
	Until 1993: TO (17) part of GO (52), though created in 1988 (changes region/subnatid1)
...
/* <_school_note>
	...
	As of 1993: "Pre-school" and "School" are considered separately
...
/* <_educy_note>
	...
	Unti 1993: one set of values for each of 0-8, 9-11 and 12+
	As of 1993: 0-16
...
/* <_educat7_note>
	...
	As of 1993: "Classe de alfabetização" category is added
	1981 & 1993: "Alfabetização de adultos" exists
...
*<_educat_isced_>
	...
	label variable educat_isced "ISCED 1993 standardised level of education"
...
/* <_educat_orig_note>
	...
	1993: "Classe de alfabetização" category is added
	1981 & 1993: "Alfabetização de adultos" exists
...
/* <__note>
	...
	1993: A broader definition of "work" was adopted, that includes
...
/* <_empstat_note>
	...
	Comparability throughout the years is compromised:
	Until 1993: "funcionários públicos estatutários" (public servants) and "militares" (army) could not be identified
	Until 1993: "trabalhadores domésticos" (domestic workers) inexisted
	Until 1993: "empregados" (workers) contained both "com carteira" and "sem carteira" (formal and informal)
	As of 1993: "production for own consumption" and "construction for own use" exist
	As of 1993: "empregado sem declaração de carteira" (probably) became "empregados sem carteira"
	As of 1993: "trabalhador doméstico sem declaração de carteira" (probably) became "trabalhadores domésticos sem carteira"
...
*<_socialsec_>
	rename V9059 socialsec // [1993: 4761]
