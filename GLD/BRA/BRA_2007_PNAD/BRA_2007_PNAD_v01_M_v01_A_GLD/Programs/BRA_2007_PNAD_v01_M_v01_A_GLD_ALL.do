...
<_Program name_> 			BRA_2007_PNAD_v01_M_v01_A_GLD_ALL.do </_Program name_>
...
*----------1.2 Set directories-------------------------------------------------*
	...
	local path_input "Z:\GLD-Harmonization\564499_DD\BRA\BRA_2007_PNAD\BRA_2007_PNAD_v01_M\Data\Stata"
	local path_output "Z:\GLD-Harmonization\564499_DD\BRA\BRA_2007_PNAD\BRA_2007_PNAD_v01_M_v01_A_GLD\Data\Harmonized"

*----------1.3 Merge Household and People files--------------------------------*

	use "`path_input'\pd2007.dta"
	merge 1:m id_dom using "`path_input'\pp2007.dta"
	keep if _merge==3
	drop _merge
...
*<_% SAVE_>
	...
	save "`path_output'\BRA_2007_PNAD_v01_M_v01_A_GLD_ALL.dta", replace
	clear
