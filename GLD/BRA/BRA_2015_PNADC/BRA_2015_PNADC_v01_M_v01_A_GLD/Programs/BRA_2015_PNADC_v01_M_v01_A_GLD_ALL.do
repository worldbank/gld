...
<_Program name_> 			BRA_2014_PNAD_v01_M_v01_A_GLD_ALL.do </_Program name_>
...
<_Study ID_> 				BRA_2014_PNAD_v01_M </_Study ID_>
...
*----------1.2 Set directories-------------------------------------------------*
	...
	local path_input "Z:\GLD-Harmonization\564499_DD\BRA\BRA_2015_PNADC\BRA_2015_PNADC_v01_M\Data\Stata"
	local path_output "Z:\GLD-Harmonization\564499_DD\BRA\BRA_2015_PNADC\BRA_2015_PNADC_v01_M_v01_A_GLD\Data\Harmonized"

*----------1.3 Read People file--------------------------------*

	use "`path_input'\pnadc2015.dta", clear
	
*----------1.4.1: People file IDs & adjustments--------------------------------*
{
*----------1.4.1.1: Comparing weights------------------------------------------*
	
	* population estimate of 197,720,534 [169.4M, official data]
	gen count = 1
...
/* <_hhid_note>
	...
	1992-2014: V0102 has 6-digits rather than 8-digits (lacking UF digits at begining)
...
/* <_educat7_note>
	...
	replace educat7 = 2 if (educy >= 1 & educy <= 8) | (educy == 0 & (V3003 == 3 | V3003 == 4)) & int_month >= 1 & int_month <= 3
	replace educat7 = 2 if (educy >= 1 & educy <= 8) | (educy == 0 & (V3003A == 4 | V3003A == 5)) & int_month == 4
	replace educat7 = 3 if educy == 9
	replace educat7 = 4 if (educy >= 10 & educy <= 11) | (educy == 9 & (V3003 == 5 | V3003 == 6)) & int_month >= 1 & int_month <= 3
	replace educat7 = 4 if (educy >= 10 & educy <= 11) | (educy == 9 & (V3003A == 6 | V3003A == 7)) & int_month == 4
	replace educat7 = 5 if educy == 12
	replace educat7 = 7 if (educy >= 13 & educy == 16) | (educy == 12 & V3003 >= 7 & V3003 <= 11) & int_month >= 1 & int_month <= 3
	replace educat7 = 7 if (educy >= 13 & educy == 16) | (educy == 12 & V3003A >= 8 & V3003A <= 11) & int_month == 4
	recast byte educat7
...
*</_industry_orig_>
	...
	tostring V4013, replace format( "%04.0f")
	
	replace V4013 = "0"+V4013 if length(V4013) == 4
	...
	tostring industrycat_isic, replace format(%05.0f)
	replace industrycat_isic = substr(industrycat_isic,2,4)
	replace industrycat_isic = "5000" if industry_orig == "48060"
	replace industrycat_isic = "5100" if industry_orig == "48010" | industry_orig == "48020" | industry_orig == "48076" | industry_orig == "48078"
...
/* <_occup_orig_note>
	...
	*Classificação Brasileira de Ocupação (CBO)
	...
	gen str4 occup_orig = string(V4010, "%04.0f")
...
/* <_occup_isco_note>
	...
	tostring V4010, replace format("%04.0f")
	merge m:1 V4010 using "`path_input'\isco_88_cod_DD.dta"
	drop if _merge == 2
	gen occup_isco = isco_88 + "00" 
	label variable occup_isco "ISCO code of primary job 7 day recall"
	drop _merge V4010 isco_88
...
/* <_industrycat_isic_2_note>
	...
	tostring industrycat_isic_2, replace format(%05.0f)
	replace industrycat_isic_2 = substr(industrycat_isic_2,2,4)
	replace industrycat_isic_2 = "5000" if industry_orig_2 == "48060"
	replace industrycat_isic_2 = "5100" if industry_orig_2 == "48010" | industry_orig_2 == "48020" | industry_orig_2 == "48076" | industry_orig_2 == "48078"
...
/* <_occup_orig_2_note>
	...
	*Classificação Brasileira de Ocupação (CBO)
	...
	gen str4 occup_orig_2 = string(V4041, "%04.0f")
...
*<_% SAVE_>
	...
	save "`path_output'\BRA_2015_PNADC_v01_M_v01_A_GLD_ALL.dta", replace
	clear
