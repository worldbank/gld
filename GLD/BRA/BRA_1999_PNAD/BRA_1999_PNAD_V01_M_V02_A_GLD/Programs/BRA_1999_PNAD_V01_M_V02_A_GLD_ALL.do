...
<_Program name_> 			BRA_1999_PNAD_V01_M_V02_A_GLD_ALL.do </_Program name_>
...
*<_migrated_binary_>
	recode V504 (2 = 0) (4 = 1) (9 = .)
	recode V511 (1 = 0) (3 = 1) (9 = .)
	gen migrated_binary = -(V504*V511 - 1)
...
/* <_migrated_from_cat_note>
	...
	replace migrated_from_cat = 1 if V511 == 1
	replace migrated_from_cat = 2 if V504 == 1
	replace migrated_from_cat = 3 if V504 == 0 & substr(string(V5090), 1, 1) == string(subnatid1)
	replace migrated_from_cat = 4 if V504 == 0 & V5090 != 88 & V5090 != 98 & V5090 != . & substr(string(V5090), 1, 1) != string(subnatid1)
