...
<_Program name_>				BRA_2008_PNAD_V01_M_V03_A_GLD_ALL.do </_Program name_>
...
<_Study ID_> 				BRA_2008_PNAD_v01_M </_Study ID_>
<_Data collection from_> 	09/2008 </_Data collection from_>
<_Data collection to_> 		09/2008 </_Data collection to_>
...
<_Sample size (HH)_> 		117,895 </_Sample size (HH)_>
<_Sample size (IND)_> 		391,868 </_Sample size (IND)_>
...
*----------1.3 Merge Household and People files--------------------------------*
	...
	use "`path_in_stata'\pd2008.dta"
	merge 1:m id_dom using "`path_in_stata'\pp2008.dta"
	keep if _merge==3
	drop _merge
...
*<_educat_isced_>
	...
	label variable educat_isced "ISCED 2008 standardised level of education"
