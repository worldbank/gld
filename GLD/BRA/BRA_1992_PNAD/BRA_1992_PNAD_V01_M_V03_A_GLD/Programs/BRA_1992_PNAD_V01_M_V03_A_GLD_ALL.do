...
<_Program name_>				BRA_1992_PNAD_V01_M_V03_A_GLD_ALL.do </_Program name_>
...
<_Study ID_> 				BRA_1992_PNAD_v01_M </_Study ID_>
<_Data collection from_> 	09/1992 </_Data collection from_>
<_Data collection to_> 		09/1992 </_Data collection to_>
...
* Get some of what you did in the transformation and put it here
	...
	use "`path_in_stata'/individuals_1992.dta"


	preserve

	use "`path_in_stata'/households_1992.dta", clear
...
/* <_weight_note>
	...
	1992-1992: contains "-1", which should be changed to missing (.)
...
/* <_school_note>
	...
	As of 1992: "Pre-school" and "School" are considered separately
...
/* <_educat7_note>
	...
	As of 1992: "Classe de alfabetização" category is added
...
*<_educat_isced_>
	...
	label variable educat_isced "ISCED 1992 standardised level of education"
...
/* <_educat_orig_note>
	...
	1992: "Classe de alfabetização" category is added
	1981 & 1992: "Alfabetização de adultos" exists
...
/* <_empstat_note>
	...
	As of 1992: "empregado sem declaração de carteira" (probably) became "empregados sem carteira"
	As of 1992: "trabalhador doméstico sem declaração de carteira" (probably) became "trabalhadores domésticos sem carteira"
...
*<_socialsec_>
	rename V9059 socialsec // [1992: 4761]
