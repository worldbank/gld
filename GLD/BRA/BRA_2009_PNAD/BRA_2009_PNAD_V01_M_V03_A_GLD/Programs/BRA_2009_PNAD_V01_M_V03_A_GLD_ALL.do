...
<_Program name_>				BRA_2009_PNAD_V01_M_V03_A_GLD_ALL.do </_Program name_>
...
<_Study ID_> 				BRA_2009_PNAD_v01_M </_Study ID_>
<_Data collection from_> 	09/2009 </_Data collection from_>
<_Data collection to_> 		09/2009 </_Data collection to_>
...
<_Sample size (HH)_> 		120,910 </_Sample size (HH)_>
<_Sample size (IND)_> 		399,387 </_Sample size (IND)_>
...
*----------1.3 Merge Household and People files--------------------------------*
	...
	use "`path_in_stata'\pd2009.dta"
	merge 1:m id_dom using "`path_in_stata'\pp2009.dta"
	keep if _merge==3
	drop _merge
...
*<_educat_isced_>
	...
	label variable educat_isced "ISCED 2009 standardised level of education"
