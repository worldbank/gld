...
*----------1.2 Set directories-------------------------------------------------*
	...
	local path_input "Z:\GLD-Harmonization\564499_DD\BRA\BRA_2014_PNADC\BRA_2014_PNADC_v01_M\Data\Stata"
	local path_output "Z:\GLD-Harmonization\564499_DD\BRA\BRA_2014_PNADC\BRA_2014_PNADC_v01_M_v01_A_GLD\Data\Harmonized"

*----------1.3 Read People file--------------------------------*

	use "`path_input'\pnadc2014.dta", clear
...
/* <_educat7_note>
	...
	replace educat7 = 2 if (educy >= 1 & educy <= 8) | (educy == 0 & (V3003 == 3 | V3003 == 4))
	replace educat7 = 3 if educy == 9
	replace educat7 = 4 if (educy >= 10 & educy <= 11) | (educy == 9 & (V3003 == 5 | V3003 == 6))
	replace educat7 = 5 if educy == 12
	replace educat7 = 7 if (educy >= 13 & educy == 16) | (educy == 12 & V3003 >= 7 & V3003 <= 11)
	recast byte educat7
...
*<_% SAVE_>
	...
	save "`path_output'\BRA_2014_PNADC_v01_M_v01_A_GLD_ALL.dta", replace
	clear
