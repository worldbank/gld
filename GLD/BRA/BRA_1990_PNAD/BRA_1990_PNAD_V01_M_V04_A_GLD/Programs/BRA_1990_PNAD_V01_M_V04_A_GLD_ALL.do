...
<_Program name_>				BRA_1990_PNAD_V01_M_V04_A_GLD_ALL.do </_Program name_>
...
<_Study ID_> 				BRA_1990_PNAD_V1_M </_Study ID_>
<_Data collection from_> 	09/1990 </_Data collection from_>
<_Data collection to_> 		09/1990 </_Data collection to_>
...
* Date: 2023-02-21 Correct whours
...
* Get some of what you did in the transformation and put it here
	...
	use "`path_in_stata'/individuals_1990.dta"

	keep if V100 == 3

	preserve

	use "`path_in_stata'/households_1990.dta", clear
	...
	merge m:1 V102 V103 using `hhs', nogen keep(1 3)
...
cap gen count = 1
	...
	* population estimate of 119,7M
	tab count [iweight = V3091]

	* 0 instances where HH weight is missing
	count if V3091 == .

	* 259,054 cases family weight ≠ individual weight
	egen tag = diff(V1091 V3091)
	tab tag, missing
...
/* <_hhid_note>
	...
	1992-2012: V102 has 6-digits rather than 8-digits (lacking UF digits at begining)
...
sum V1091, de
	...
	label variable weight "Household sampling weight" // Check
*	drop V9981
*</_weight_>
...
*<_subnatidsurvey_>
	...
	* 9 metropolitan areas, then states, then subnatid1 for the four
	* smaller northern states not in the sample
...
/* <_hsize_note>
	...
	1992-1990: contains "-1", which should be changed to missing (.)
...
/* DATE OF BIRTH */
* Year of birth reports age when age is assumed.
* Replacing with missing.
recode V310 (0/98=.) if V309 == 20 | V309 == 30

* In some cases, year of birth and age are interchanged.
gen x1 = V310 if V310 < 800
gen x2 = V805 if V805 > 800
replace V310 = x2 if x1 ~= .
replace V805 = x1 if x2 ~= .
drop x1 x2
recode V310 (999=.)

* Adding the 1 in the year of birth
* People of presumed age do not have year of birth
gene x1 = 1
egen birth_year = concat(x1 V310) if V310 ~= .
drop x1 V310
destring birth_year, replace
label var birth_year "year of birth"

recode V308 (0 99=.)
rename V308 birth_day
* 0 (zero) would be presumed age, 99 without declaration

recode V309 (20 30 99 =.)
rename V309 birth_month
* 20 and 30 would be presumed age, 99 without declaration
...
/* <_school_note>
	...
	As of 1990: "Pre-school" and "School" are considered separately

</_school_note> */
	gen school = (V314 !=0) if V314 !=.
...
*<_literacy_>
	recode V311 (3 = 0) (1 = 1) (9 = .)
	rename V311 literacy
...
/* <_educy_note>
	...
	gen educy = V318 - 1 if V318 >= 1 & V318 < 9

	replace educy =1 if   V314==1 & V312==2
replace educy =2 if   V314==1 & V312==3
replace educy =3 if   V314==1 & V312==4

replace educy =4 if   V314==2 & V312==1
replace educy =5 if   V314==2 & V312==2
replace educy =6 if   V314==2 & V312==3
replace educy =7 if   V314==2 & V312==4

replace educy =8 if   V314==3 &  V312==1
replace educy =9 if   V314==3 &  V312==2
replace educy =10 if   V314==3 &  V312==3

replace educy =0 if   V314==4 & V312==1
replace educy =1 if   V314==4 & V312==2
replace educy =2 if   V314==4 & V312==3
replace educy =3 if   V314==4 & V312==4
replace educy =4 if   V314==4 & V312==5
replace educy =5 if   V314==4 & V312==6
replace educy =6 if   V314==4 & V312==7
replace educy =7 if   V314==4 & V312==8

replace educy =8 if   V314==5 &  V312==1
replace educy =9 if   V314==5 &  V312==2
replace educy =10 if   V314==5 &  V312==3
replace educy =11 if   V314==5 &  V312==4

replace educy =11 if   V314==6 & V312==1
replace educy =12 if   V314==6 & V312==2
replace educy =13 if   V314==6 & V312==3
replace educy =14 if   V314==6 & V312==4
replace educy =15 if   V314==6 & V312==5
replace educy =16 if   V314==6 & V312==6

replace educy =0 if   V314==7

replace educy =0 if   V314==8

replace educy =0 if   V314==9 &  V312==1
replace educy =1 if   V314==9 &  V312==2
replace educy =2 if   V314==9 &  V312==3
replace educy =3 if   V314==9 &  V312==4
replace educy =4 if   V314==9 &  V312==5
replace educy =5 if   V314==9 &  V312==6
replace educy =6 if   V314==9 &  V312==7
replace educy =7 if   V314==9 &  V312==8

replace educy =8 if   V314==10 &  V312==1
replace educy =9 if   V314==10 &  V312==2
replace educy =10 if   V314==10 &  V312==3

replace educy =0 if   V314==11 &  V312==1
replace educy =1 if   V314==11 &  V312==2
replace educy =2 if   V314==11 &  V312==3
replace educy =3 if   V314==11 &  V312==4
replace educy =4 if   V314==11 &  V312==5
replace educy =5 if   V314==11 &  V312==6
replace educy =6 if   V314==11 &  V312==7
replace educy =7 if   V314==11 &  V312==8

replace educy =8 if   V314==12 &  V312==1
replace educy =9 if   V314==12 &  V312==2
replace educy =10 if   V314==12 &  V312==3

replace educy =11 if   V314==14

replace educy =15 if   V314==15

/* pessoas que não freqüentam */
replace educy =1 if   V317==1 & V315==1
replace educy =2 if   V317==1 & V315==2
replace educy =3 if   V317==1 & V315==3
replace educy =4 if   V317==1 & V315==4
replace educy =4 if   V317==1 & V315==5

replace educy =5 if   V317==2 & V315==1
replace educy =6 if   V317==2 & V315==2
replace educy =7 if   V317==2 & V315==3
replace educy =8 if   V317==2 & V315==4
replace educy =8 if   V317==2 & V315==5

replace educy =9 if   V317==3 & V315==1
replace educy =10 if   V317==3 & V315==2
replace educy =11 if   V317==3 & V315==3
replace educy =11 if   V317==3 & V315==4

replace educy =1 if   V317==4 & V315==1
replace educy =2 if   V317==4 & V315==2
replace educy =3 if   V317==4 & V315==3
replace educy =4 if   V317==4 & V315==4
replace educy =5 if   V317==4 & V315==5
replace educy =6 if   V317==4 & V315==6
replace educy =7 if   V317==4 & V315==7
replace educy =8 if   V317==4 & V315==8

replace educy =9 if   V317==5 & V315==1
replace educy =10 if   V317==5 & V315==2
replace educy =11 if   V317==5 & V315==3
replace educy =11 if   V317==5 & V315==4

replace educy =12 if   V317==6 & V315==1
replace educy =13 if   V317==6 & V315==2
replace educy =14 if   V317==6 & V315==3
replace educy =15 if   V317==6 & V315==4
replace educy =16 if   V317==6 & V315==5
replace educy =17 if   V317==6 & V315==6

replace educy =17 if   V317==7 & V315==2
replace educy =18 if   V317==7 & V315==3
replace educy =19 if   V317==7 & V315>=4
replace educy =0 if   V312==0 & V314==0 & V315==0 & V317==0


	recast float educy
	label variable educy "Years of education"
	drop V312 V315 V317 V318
*</_educy_>
...
/* <_educat7_note>
	...
	As of 1990: "Classe de alfabetização" category is added
	1990 & 1992: "Alfabetização de adultos" exists

</_educat7_note> */
	gen educat7 = .

	replace educat7 = 1 if educy == 0
	replace educat7 = 2 if (educy >= 1 & educy <= 7) | (V314 == 1 | V314 == 2 | V314 == 4 | V314 == 7 | V314 == 8 | V314 == 9 | V314 == 11)
	replace educat7 = 3 if educy == 8
	replace educat7 = 4 if (educy >= 9 & educy <= 10) | (V314 == 14 | V314 == 12 | V314 == 10 | V314 == 5 | V314 == 3)
	replace educat7 = 5 if educy == 11
	replace educat7 = 7 if (educy >= 12 & educy <= 15) | (V314 == 13 | V314 == 6)
...
*<_educat_isced_>
	...
	label variable educat_isced "ISCED 1990 standardised level of education"
...
/* <_educat_orig_note>
	...
	1990: "Classe de alfabetização" category is added
	1990 & 1992: "Alfabetização de adultos" exists
...
recode V537 (9999999=.) if year >= 1990 & year <= 1984
recode V537 (999999999=.) if year >= 1985 & year <= 1990

/* RECODE: MONTHLY INCOME IN PRODUCTS/GOODS */
recode V538 (9999999=.) if year >= 1990 & year <= 1984
recode V538 (999999999=.) if year >= 1985 & year <= 1990

/* RECODE: MONTHLY INCOME IN CASH OTHER */
recode V549 (9999999=.) if year >= 1990 & year <= 1984
recode V549 (999999999=.) if year >= 1985 & year <= 1990

/* RECODE: MONTHLY INCOME IN PRODUCTS/GOODS OTHER */
recode V550 (9999999=.) if year >= 1990 & year <= 1984
recode V550 (999999999=.) if year >= 1985 & year <= 1990

/* RECODE: RETIREMENT PENSIONS */
recode V578 (9999999=.) if year >= 1990 & year <= 1984
recode V578 (999999999=.) if year >= 1985 & year <= 1990

/* RECODE: OTHER PENSIONS */
recode V579 (9999999=.) if year >= 1990 & year <= 1984
recode V579 (999999999=.) if year >= 1985 & year <= 1990

/* RECODE: PERMANENT ALLOWANCE */
recode V580 (9999999=.) if year >= 1990 & year <= 1984
recode V580 (999999999=.) if year >= 1985 & year <= 1990

/* RECODE: RENTAL AMOUNT RECEIVED */
recode V581 (9999999=.) if year >= 1990 & year <= 1984
recode V581 (999999999=.) if year >= 1985 & year <= 1990

/* RECODE: OTHERS */
recode V582 (9999999=.) if year >= 1990 & year <= 1984
recode V582 (999999999=.) if year >= 1985 & year <= 1990

/* RECODE: MONTHLY INCOME MAIN OCCUPATION */
recode V600 (9999999=.) if year >= 1990 & year <= 1984
recode V600 (999999999=.) if year >= 1985 & year <= 1990

/* RECODE: MONTHLY INCOME ALL JOBS */
recode V601 (9999999=.) if year >= 1990 & year <= 1984
recode V601 (999999999=.) if year >= 1985 & year <= 1990

/* RECODE: MONTHLY INCOME ALL SOURCES */
recode V602 (9999999=.) if year >= 1990 & year <= 1984
recode V602 (999999999=.) if year >= 1985 & year <= 1990
...
replace deflator = 0.636330/100000000000 if year == 1990
...
/* <_lstatus_note>
	...
	gen lstatus = .
	replace lstatus = 1 if (V501 == 1 | V501 == 2) & age >= minlaborage
	replace lstatus = 2 if (V501 == 3 | V513 == 1) & age >= minlaborage
	replace lstatus = 3 if (V501 == 4 | V501 == 5 | V501 == 6 | V501 == 7) & V513 == 3 & age >= minlaborage
	recast byte lstatus
...
*<_nlfreason_>
	gen nlfreason = V501 - 3 if V501 >= 4 & V501 <= 7
...
*<_unempldur_l_>
	gen unempldur_l = V516 if V516 >= 0 & V516 <= 24
	label variable unempldur_l "Unemployment duration (months) lower bracket"
*</_unempldur_l_>

*<_unempldur_u_>
	gen unempldur_u = unempldur_l // Check
...
/* <_empstat_note>
	...
	As of 1990: "empregado sem declaração de carteira" (probably) became "empregados sem carteira"
	As of 1990: "trabalhador doméstico sem declaração de carteira" (probably) became "trabalhadores domésticos sem carteira"
...
/* <_industry_orig_note>
	...
	*Classificação Nacional de Atividades Econômicas (CNAE)
	...
	gen str5 industry_orig = string(V504, "%05.0f")
...
/* <_industrycat_isic_note>
	...
	tostring V504, replace

	forv i = 1(1)99 {

		if `i' >= 1 & `i' <= 9 {
		replace V504 = "00`i'" if V504 == "`i'"
		}
		else if `i' >= 10 & `i' <= 99 {
		replace V504 = "0`i'" if V504 == "`i'"
		}
...
/* <_occup_orig_note>
	...
	*Classificação Brasileira de Ocupação (CBO)
	...
	gen str4 occup_orig = string(V503, "%04.0f")
...
tostring V503, replace

	forv i = 1(1)99 {

		if `i' >= 1 & `i' <= 9 {
		replace V503 = "00`i'" if V503 == "`i'"
		}
		else if `i' >= 10 & `i' <= 99 {
		replace V503 = "0`i'" if V503 == "`i'"
		}
	...
	gen v0503 = V503
merge m:1 v0503 using "`path_in_stata'\isco_88_cbo_80_DD.dta"
drop if _merge == 2
...
/* <_wage_no_compen_note>
	...
	rename V600 wage_no_compen // Check; A: Total Labor Income
...
*<_socialsec_>
	rename V511 socialsec // [1981: 4761]
...
/* <_industrycat_isic_2_note>
	...
	/*
cap	merge m:1 cnae_91 using "`path_in_stata'\isic_3_cnae_91.dta"
...
/* <_occup_isco_2_note>
	...
	gen occup_isco_2 = .
	/*
cap	merge m:1 cbo_91 using "`path_in_stata'\isco_88_cbo_91.dta"
cap	drop if _merge == 2
...
/* <_wage_no_compen_2_note>
	...
	replace V601 = 0 if V601 ==.
	g V600 = wage_no_compen
	replace V600 = 0 if V600 ==.

	gen wage_no_compen_2 = V601 - V600
