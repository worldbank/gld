...
*----------1.2 Set directories-------------------------------------------------*
	...
	local path_input "Y:\GLD\BRA\BRA_1987_PNAD\BRA_1987_PNAD_v01_M\Data\Stata"
	local path_output "Y:\GLD\BRA\BRA_1987_PNAD\BRA_1987_PNAD_v01_M_v01_A_GLD\Data\Harmonized"
...
*----------1.3 Merge Household and People files--------------------------------*
	...
	use "`path_input'\pnad1987.dta",clear
...
*<_% SAVE_>
	...
	save "`path_output'\BRA_1987_PNAD_v01_M_v01_A_GLD_ALL.dta", replace
	clear
