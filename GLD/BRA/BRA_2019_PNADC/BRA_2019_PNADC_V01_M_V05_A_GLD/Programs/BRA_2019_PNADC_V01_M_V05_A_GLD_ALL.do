...
<_Program name_> 			BRA_2019_PNADC_V01_M_V05_A_GLD_ALL.do </_Program name_>
...
<_Study ID_> 				BRA_2019_PNAD_v01_M </_Study ID_>
<_Data collection from_> 	2019 </_Data collection from_>
<_Data collection to_> 		2019 </_Data collection to_>
...
<_Sample size (HH)_> 		150,667 </_Sample size (HH)_>
<_Sample size (IND)_> 		443,790 </_Sample size (IND)_>
...
* Date: [2024-02-12] - Update firmsize, isco info, drop alternative isco, isic
...
* harmonized output in a single file
	...
	use "`path_in_stata'\pnadc2019.dta", clear
...
/* <_educy_note>
	...
	replace educy = 18 if V3009A == 11
	replace educy = 20 if V3009A == 12
*</_educy_>
...
*<_occup_isco_>
	* COD code is the same as ISCO 08 if not for some small changes (especially in armed forces)
	gen occup_isco = occup_orig
	replace occup_isco = "6220" if occup_isco == "6225"
	replace occup_isco = "5160" if occup_isco == "5168"
	replace occup_isco = "0000" if inrange(occup_isco, "0200", "0512")
...
*<_firmsize_l_>
	...
	replace firmsize_l = V40181 if V4018 == 1
	replace firmsize_l = V40182 if V4018 == 2
	replace firmsize_l = V40183 if V4018 == 3
...
*<_firmsize_u_>
	gen firmsize_u = .
	replace firmsize_u = V40181 if V4018 == 1
	replace firmsize_u = V40182 if V4018 == 2
	replace firmsize_u = V40183 if V4018 == 3
...
*<_occup_isco_2_>
	...
	replace occup_isco_2 = "6220" if occup_isco_2 == "6225"
	replace occup_isco_2 = "5160" if occup_isco_2 == "5168"
	replace occup_isco_2 = "0000" if inrange(occup_isco_2, "0200", "0512")
