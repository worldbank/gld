...
<_Program name_> 			BRA_2016_PNAD_v01_M_v01_A_GLD_ALL.do </_Program name_>
...
<_Study ID_> 				BRA_2016_PNAD_v01_M </_Study ID_>
...
*----------1.2 Set directories-------------------------------------------------*
	...
	local path_input "Z:\GLD-Harmonization\564499_DD\BRA\BRA_2016_PNADC\BRA_2016_PNADC_v01_M\Data\Stata"
	local path_output "Z:\GLD-Harmonization\564499_DD\BRA\BRA_2016_PNADC\BRA_2016_PNADC_v01_M_v01_A_GLD\Data\Harmonized"

*----------1.3 Read People file--------------------------------*

	use "`path_input'\pnadc2016.dta", clear
...
/* <_educat7_note>
	...
	replace educat7 = 2 if (educy >= 1 & educy <= 8) | (educy == 0 & (V3003A == 4 | V3003A == 5))
	replace educat7 = 3 if educy == 9
	replace educat7 = 4 if (educy >= 10 & educy <= 11) | (educy == 9 & (V3003A == 6 | V3003A == 7))
	replace educat7 = 5 if educy == 12
	replace educat7 = 7 if (educy >= 13 & educy == 16) | (educy == 12 & V3003A >= 8 & V3003A <= 11)
	recast byte educat7
...
*<_nlfreason_>
	gen nlfreason = VD4030
	recode nlfreason (2 = 1) (1 = 2) (4 = 3) (3 = 4) (5/6 = 5)
	replace nlfreason = .  if nlfreason == 3 & age >= 0 & age <= 29
...
*<_% SAVE_>
	...
	save "`path_output'\BRA_2016_PNADC_v01_M_v01_A_GLD_ALL.dta", replace
	clear
