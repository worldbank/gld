...
<_Program name_>				BRA_2006_PNAD_V01_M_V03_A_GLD_ALL.do </_Program name_>
...
<_Study ID_> 				BRA_2006_PNAD_v01_M </_Study ID_>
<_Data collection from_> 	09/2006 </_Data collection from_>
<_Data collection to_> 		09/2006 </_Data collection to_>
...
*----------1.3 Merge Household and People files--------------------------------*
	...
	use "`path_in_stata'\pd2006.dta"
	merge 1:m id_dom using "`path_in_stata'\pp2006.dta"
	keep if _merge==3
	drop _merge
...
/* <_educat7_note>
	...
	As of 2006: "Classe de alfabetização" category is added
...
*<_educat_isced_>
	...
	label variable educat_isced "ISCED 2006 standardised level of education"
...
/* <_educat_orig_note>
	...
	2006: "Classe de alfabetização" category is added
	1981 & 1992: "Alfabetização de adultos" exists
...
/* <_empstat_note>
	...
	As of 2006: "empregado sem declaração de carteira" (probably) became "empregados sem carteira"
	As of 2006: "trabalhador doméstico sem declaração de carteira" (probably) became "trabalhadores domésticos sem carteira"
