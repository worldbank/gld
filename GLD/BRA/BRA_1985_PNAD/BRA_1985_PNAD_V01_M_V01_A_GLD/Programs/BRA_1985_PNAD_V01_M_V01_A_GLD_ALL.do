...
*----------1.2 Set directories-------------------------------------------------*
	...
	local path_input "Y:\GLD\BRA\BRA_1985_PNAD\BRA_1985_PNAD_v01_M\Data\Stata"
	local path_output "Y:\GLD\BRA\BRA_1985_PNAD\BRA_1985_PNAD_v01_M_v01_A_GLD\Data\Harmonized"
...
* Get some of what you did in the transformation and put it here
	...
	use "`path_input'\pnad1985.dta",clear
...
*<_% SAVE_>
	...
	save "`path_output'\BRA_1985_PNAD_v01_M_v01_A_GLD_ALL.dta", replace
	clear
