...
** HOUSEHOLDS 			443,790
** INDIVIDUALS			150,667
** EXPANDED POPULATION	211,049,527 (from WB database)
**                                                                                                  **
******************************************************************************************************
*****************************************************************************************************/
...
** DIRECTORY
	local path "C:\Users\xxxx\OneDrive - WBG\Surveys\BRA\BRA_2019_PNADC\BRA_2019_PNADC_v01_M\Data\Stata"
	local save "C:\Users\xxxx\OneDrive - WBG\Surveys\BRA\BRA_2019_PNADC\BRA_2019_PNADC_v01_M_v01_A_I2D2"
** LOG FILE
	log using "`save'\Programs\BRA_2019_I2D2_PNAD_v01_M_v01_A.log", replace
...
** DATABASE ASSEMBLENT
	use "`path'\BRA_2019_PNADC_v01_M.dta", clear
...
** DELETE MISSING VARIABLES
	...
	keep ccode Year intv_year month  idh idp wgt strata psu `keep'
     ...
     save "`save'\Data\Harmonized\BRA_2019_I2D2_PNAD_v01_M_v01_A.dta", replace
	log close
