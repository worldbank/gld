...
<_Program name_> 			BRA_1981_PNAD_V01_M_V03_A_GLD_ALL.do </_Program name_>
...
<_Survey Year_> 			1981 </_Survey Year_>
<_Study ID_> 				BRA_1981_PNAD_v01_M </_Study ID_>
<_Data collection from_> 	09/1981 </_Data collection from_>
<_Data collection to_> 		09/1981 </_Data collection to_>
...
<_Sample size (HH)_> 		103,961 </_Sample size (HH)_>
<_Sample size (IND)_> 		482,611 </_Sample size (IND)_>
...
* Date: 2025-11-17 - Make subnatid2/3 into string, update subnatidsurvey
...
* Get some of what you did in the transformation and put it here
	...
	use "`path_in_stata'\pnad1981.dta", clear
...
sum v9991, de
	...
	label variable weight "Household sampling weight" // Check; A: Individual Weights
...
*<_psu_>
	* Census areas, not given in the data
	gen psu = .
...
* Change that so university incomplete is having had stepped in university
