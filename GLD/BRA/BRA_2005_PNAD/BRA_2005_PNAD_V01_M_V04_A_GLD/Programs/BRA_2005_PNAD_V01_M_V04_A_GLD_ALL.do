...
<_Program name_>				BRA_2005_PNAD_V01_M_V04_A_GLD_ALL.do </_Program name_>
...
* Date: 2023 / 01 / 11 - Update educat7 (and thus educat5, 4)
...
*----------1.3 Merge Household and People files--------------------------------*
	...
	use "`path_in_stata'\pd2005.dta"
	merge 1:m id_dom using "`path_in_stata'\pp2005.dta"
	keep if _merge==3
	drop _merge
