...
<_Program name_> 			BRA_2005_PNAD_v01_M_v01_A_GLD_ALL.do </_Program name_>
...
<_Study ID_> 				BRA_2005_PNAD_v01_M </_Study ID_>
<_Data collection from_> 	09/2005 </_Data collection from_>
<_Data collection to_> 		09/2005 </_Data collection to_>
...
*----------1.2 Set directories-------------------------------------------------*
	...
	local path_input "Z:\GLD-Harmonization\564499_DD\BRA\BRA_2005_PNAD\BRA_2005_PNAD_v01_M\Data\Stata"
	local path_output "Z:\GLD-Harmonization\564499_DD\BRA\BRA_2005_PNAD\BRA_2005_PNAD_v01_M_v01_A_GLD\Data\Harmonized"

*----------1.3 Merge Household and People files--------------------------------*

	use "`path_input'\pd2005.dta"
	merge 1:m id_dom using "`path_input'\pp2005.dta"
	keep if _merge==3
	drop _merge
...
/* <_educat7_note>
	...
	As of 2005: "Classe de alfabetização" category is added
	1981 & 1992: "Alfabetização de adultos" exists
	
</_educat7_note> */
	gen educat7 = .
	replace educat7 = 1 if ((V0602 == 4 & V0606 == 4) | (V0603 == 1 & V0605 == 1) | (V0603 == 3 & V0605 == 1) | 6 <= V0603 <= 9 | ((V0607 == 1 | V0607 == 6) & V0609 == 3) | (V0607 == 4 & V0609 == 3) | (V0607 == 6 & V0608 == 4 & V0611 == 3) | 10 <= V0607 <= 13) 
	replace educat7 = 2 if ((V0603 == 1 & 2 <= V0605 <= 8) | (V0603 == 3 & 2 <= V0605 <= 8) | (V0607 == 1 & 1 <= V0610 <= 6) | (V0607 == 2 & V0609 == 3) | (V0607 == 2 & 1 <= V0610 <= 3) | (V0607 == 2 & V0610 == 4 & V0611 == 3) | (V0607 == 2 & V0608 == 4 & V0611 == 3) | (V0607 == 4 & 1 <= V0610 <= 7) | (V0607 == 6 & 1 <= V0610 <= 7)) 
	replace educat7 = 3 if (((V0603 == 2 | V0603 == 4) & V0605 == 1) | (V0607 == 2 & V0610 == 4 & V0611 == 1) | (V0607 == 2 & V0610 == 5) | ((V0607 == 2 | V0607 == 6) & V0608 == 4 & V0611 == 1) | ((V0607 == 3 | V0607 == 5 | V0607 == 7) & V0609 == 3) | ((V0607 == 3 | V0607 == 7) & V0608 == 4 & V0611 == 3) | (V0607 == 4 & V0610 == 8) | (V0607 == 6 & V0610 == 8)) 
	replace educat7 = 4 if (((V0603 == 2 | V0603 == 4) & 2 <= V0605 <= 3) | ((V0607 == 3 | V0607 == 5 | V0607 == 7) & 1 <= V0610 <= 2)) 
	replace educat7 = 5 if ((V0603 == 2 & V0605 == 4) | (V0603 == 5 & V0605 == 1) | V0603 == 10 | ((V0607 == 3 | V0607 == 5) & 3 <= V0610 <= 4) | ((V0607 == 3 | V0607 == 7) & V0608 == 4 & V0611 == 1) | (V0607 == 7 & V0610 == 3) | (V0607 == 8 & V0609 == 3)) 
	replace educat7 = 6 if ((V0603 == 5 & 2 <= V0605 <= 6) | (V0607 == 8 & V0610 == 1) | (V0607 == 8 & 2 <= V0610 <= 5 & V0611 == 3)) 
	replace educat7 = 7 if (V0603 == 11 | (V0607 == 8 & 2 <= V0610 <= 5 & V0611 == 1) | (V0607 == 8 & V0610 == 6) | V0607 == 9) 
	replace educat7 = 8 if 3 <= V0603 <= 4 & V0604 == 4
...
*<_educat_isced_>
	...
	label variable educat_isced "ISCED 2005 standardised level of education"
...
/* <_educat_orig_note>
	...
	2005: "Classe de alfabetização" category is added
	1981 & 1992: "Alfabetização de adultos" exists
...
/* <_empstat_note>
	...
	As of 2005: "empregado sem declaração de carteira" (probably) became "empregados sem carteira"
	As of 2005: "trabalhador doméstico sem declaração de carteira" (probably) became "trabalhadores domésticos sem carteira"
...
*<_% SAVE_>
	...
	save "`path_output'\BRA_2005_PNAD_v01_M_v01_A_GLD_ALL.dta", replace
	clear
