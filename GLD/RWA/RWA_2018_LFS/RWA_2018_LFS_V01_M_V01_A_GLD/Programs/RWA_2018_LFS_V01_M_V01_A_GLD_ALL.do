...
<_Program name_>				RWA_2018_LFS_v01_M_v01_A_GLD_ALL </_Program name_>
...
<_Data collection from_>		02/2018 (Feb round); 08/2018 (Aug round) </_Data collection from_>
<_Data collection to_>			04/2018 (Feb round); 10/2018 (Aug round) </_Data collection to_>
<_Source of dataset_> 			National Institute of Statistics Rwanda </_Source of dataset_>
<_Sample size (HH)_> 			17,861 </_Sample size (HH)_>
<_Sample size (IND)_> 			76,670 </_Sample size (IND)_>
...
use "`path_in_stata'/rwa-nisr-lfs-2018.dta", clear
/*%%=============================================================================================
	2: Survey & ID
==============================================================================================%%*/
...
1. There are more responses here. 
	E.g., in Feb 2018 round, 4960 responses but only 397 for unavailability
...
*<_occup_isco_>
	...
	replace occup_isco = "" if occup_isco == "00" | lstatus !=1 | occup_isco == "0900"
...
*<_occup_>
	...
	replace occup = . if occup_isco == "0900" | lstatus !=1
