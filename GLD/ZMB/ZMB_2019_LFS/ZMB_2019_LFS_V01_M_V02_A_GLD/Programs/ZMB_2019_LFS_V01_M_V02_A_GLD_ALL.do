...
use "`path_in_stata'/2019LFS.dta", clear
...
/* <_subnatidsurvey_note>
	...
	Report states that, since only 343 of 520 EAs were covered, the sample
	is too small for provincial level indicators and thus at most
	urban/rural. I assume this is due to COVID but it is nowhere mentioned
	in the report.

</_subnatidsurvey_note> */
	gen subnatidsurvey = ""
	replace subnatidsurvey = "Urban" if urban==1
...
*<_migrated_from_country_>
	...
	replace migrated_from_country = "SLB" if j5_a_country == 158   // Solomon Islands
