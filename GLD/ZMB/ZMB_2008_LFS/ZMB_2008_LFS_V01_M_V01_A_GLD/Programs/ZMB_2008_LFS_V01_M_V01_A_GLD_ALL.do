...
*<_educat7_>
	gen byte educat7 =s2q3
	recode educat7 0=1 1/6=2 7=3 8/9=4 10/12=5 13/16=7
	* Add in those who never went to school as no education
	replace educat7 = 1 if s2q2 == 2
...
*<_lstatus_>
	...
	gen byte lstatus = .
	* Employed as anything that takes us to Q8
	replace lstatus=1 if s3q1 < 4 | s3q2 == 1 | s3q3 == 1 | s3q4 == 1 | s3q5 == 1 | s3q6 == 1 | s3q7 == 1
	* Those who are not employed are asked about the 12 month employment status, then unemployment is with
	* respect to that so we cannot code about other than employment here.
...
*<_empstat_>
	...
	recode empstat (1=4) (2=3) (3=1) (4=2) (7 = .)
...
*<_lstatus_year_>
	...
	replace lstatus_year  = 1 if s4q1 < 4 | s4q2 == 1 | s4q3 == 1 | s4q4 == 1 | s4q5 == 1 | s4q6 == 1 | s4q7 == 1
	replace lstatus_year = 2 if s6q1 == 1 & s6q3 == 1 & mi(lstatus_year)
	replace lstatus_year = 3 if mi(lstatus_year)
...
*<_potential_lf_year_>
	...
	replace potential_lf_year = 1 if (s6q1 == 1 & s6q3 == 2) | (s6q1 == 2 & s6q3 == 1)
...
*<_unempldur_l_year_>
	gen byte unempldur_l_year= s6q8
	recode unempldur_l_year (1 = 0) (2 = 3) (3 = 6) (4 = 12) (5 = 36)
...
*<_unempldur_u_year_>
	gen byte unempldur_u_year= s6q8
	recode unempldur_u_year (1 = 3) (2 = 6) (3 = 12) (4 = 36) (5 = 999)
