...
/* <_industrycat_isic_note>
	...
	They use the last version of OKVED (the Russian Classification of Economic Activities) which is in line with ISIC Rev.4
	
	There are a lot of codes tahta not match at 4 digits level. Work with 3 digits level
	...
	replace str_industry_adpted = "1300" if str_industry_adpted == "1320"
	replace str_industry_adpted = "1700" if str_industry_adpted == "1720"
	replace str_industry_adpted = "2000" if str_industry_adpted == "2040"
	replace str_industry_adpted = "2100" if str_industry_adpted == "2120"
	replace str_industry_adpted = "2300" if str_industry_adpted == "2330"
	replace str_industry_adpted = "2300" if str_industry_adpted == "2340"
	replace str_industry_adpted = "2300" if str_industry_adpted == "2350"
	replace str_industry_adpted = "2300" if str_industry_adpted == "2360"
	replace str_industry_adpted = "2300" if str_industry_adpted == "2370"
	replace str_industry_adpted = "2400" if str_industry_adpted == "2440"
	replace str_industry_adpted = "4100" if str_industry_adpted == "4110"
	replace str_industry_adpted = "4100" if str_industry_adpted == "4120"
	replace str_industry_adpted = "4600" if str_industry_adpted == "4670"
	replace str_industry_adpted = "4900" if str_industry_adpted == "4940"
	replace str_industry_adpted = "6800" if str_industry_adpted == "6830"
	replace str_industry_adpted = "8500" if str_industry_adpted == "8560"
