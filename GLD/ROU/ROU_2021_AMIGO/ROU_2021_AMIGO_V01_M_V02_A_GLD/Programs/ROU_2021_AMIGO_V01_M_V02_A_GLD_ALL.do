...
<_Program name_>				ROU_2021_AMIGO_V01_M_V02_A_GLD_ALL </_Program name_>
...
<_Sample size (HH)_> 				90,968 </_Sample size (HH)_>
<_Sample size (IND)_> 				213,982 </_Sample size (IND)_>
...
/*
import delimited "`path_in_other'/AMIGO_2021.csv", clear
save "`path_in_stata'/amigo_2021.dta",replace
*/

use "`path_in_stata'/amigo_2021.dta",clear
...
*<_migrated_binary_>
	gen migrated_binary = inrange(yearesid,0,81)
...
*<_lstatus_>
	...
	*absense more than 3 months; Seasonal worker in off-season, not regularly performing any job-related task
	replace lstatus = . if inlist(jattach,3,5,7,9) & wkstat == 2 & inlist(real(absreas),6,7,8,9,99,.)
...
*<_unempldur_l_>
	...
	recode unempldur_l (1 = 0) (2 = 6) (3 = 12) (4 = 24) (9 = .)
...
*<_unempldur_u_>
	...
	recode unempldur_u (1 = 5) (2 = 11) (3 = 23) (4 = .) (9 = .)
...
*<_whours_>
	...
	replace whours = hwusual/10 if inlist(hwactual,0,999)
...
*<_empstat_2_>
	...
	*Cannot differentiate between employers and self-employed; therefore, all cases are coded as self-employed, as this is the predominant category.
	recode empstat_2 (1 = 4) (3 = 1) (4 = 2) (9 = .)
