...
use "`path_in_stata'/ars2006.dta", clear
...
*<_ocusec_>
	gen byte ocusec= a7 if lstatus==1
...
*<_firmsize_l_>
	gen byte firmsize_l=a8 if lstatus == 1
...
*<_industrycat_isic_2_>
	gen industrycat_isic_2 = substr(string(a26), 1, 2) + "00" if !missing(industry_orig_2)
...
*<_whours_2_>
	gen whours_2 = a24s if !missing(empstat_2)
