...
| [ETH_2021_occup_isco](utilities/Additional%20Data/ETH_2021_occup_isco.dta)  | A code list containing the four-digit original occupation codes,`code_o`, and the harmonized four-digit codes, `code_h`. "Drop" means coding the original codes to missing values. |N/A|
