...
| :---------:	| :-------------: | :-----------: |   
| [ETH_zone_naming_1999](utilities/Additional%20Data/ETH_zone_naming_1999.dta) | A code list containing the codes and names of Ethiopia's second-level administrative division, zone. It was used for harmonizing the GLD variable "subnatid2" for 1999.| [LFS Annual Report 1999](utilities/ETH_1999_LFS_report.pdf)|    
