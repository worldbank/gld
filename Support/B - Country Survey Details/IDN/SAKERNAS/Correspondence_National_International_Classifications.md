...
The figure below, which is a time series plot of occupation of all years, shows discontinuity between 1999 and 2000 as well as 2006 and 2007 while years in between are generally coherent. Kindly note that these years in between, namely 2000-2006 are the years that have to be applied with the intra-Indonesian mapping approach for `occup`. Thus, the occupation distributions of these years deviate from other years due to different treatments. Among them, year 2000 is especially odd but with limited information we have, we are unable to explain or fix it. 
