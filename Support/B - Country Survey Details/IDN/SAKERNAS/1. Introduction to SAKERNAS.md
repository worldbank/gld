...
Accroding to the Indonesian statistics office, any casual workers are not defined as "employess" as they do not have a *stable*work contract (refer to the creenshot below). But meanwhile casual workers still work for payment, which makes them "paid employees" in our definition. In this sense, we coded as follows:

**Employer**:
- Employer assisted by temporary workers/unpaid workers
...
- casual employee in non-agriculture

**Self-employed**:
- Own-account workers

![casual_worker1](utilities/casual_worker1.png)
![casual_worker2](utilities/casual_worker2.png)
