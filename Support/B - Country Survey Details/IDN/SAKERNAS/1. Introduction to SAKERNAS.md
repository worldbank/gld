...
Occupational classification is even more difficult than industrial to be mapped to ISCO. 4 versions of Indonesian Standard Occupational Codes (KBJI) were involved – KBJI1982, KBJI2000, KBJI2002, KBJI2014. However, without instructions on each version of occupational codes and how they correspond to ISCO codes, it is hard to develop a corespondence table for the mapping for all years. Therefore, we only provided the one-digit occupational classfication for `occup` when KBJI2002 is available and the original occupational code with the most digits in the raw dataset.   
