...
### Weights
In most years, survey weights were constructed using WDI (World Development Indicators) population estimates. For the rationale and methodology, see page 2, which includes:
