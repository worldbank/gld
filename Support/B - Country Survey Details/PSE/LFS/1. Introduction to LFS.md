...
In the harmonized dataset for the year 1998, the variables of education had not been coded and this due to limited information about the construction of the raw variable `pr4`. In the year 1998 the variable pr4 contains less categories than in the rest of the years. Below there are two tables that show the differences. 
