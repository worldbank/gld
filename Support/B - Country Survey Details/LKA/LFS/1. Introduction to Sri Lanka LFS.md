...
As argued by the author, the urban sector was defined only by administration. Until 1987, Municipal Councils (MCs), Urban Councils (UCs) and Town Councils (TCs) comprised the urban sector. Meanwhile, rural and estate sectors were governed by the Pradesheeya Sabha (PS). But after the enactment of the 13th Amendament in 1987, administrative units were recalibrated and TCs were abolished and merged in to PS. This change significantely cut urban population and increased rural population simultaneously. The urban population was estimated above 20% but it dropped to 13.1% in 2001 mainly because 89 settlements previously defined as urban were classifed as rural. Based on the author's dynamic definition refined by population, population density, firewood and well water dependence, about 43.8% of total population are in urban area. 

![figure1](utilities/urban_rural_definition.png)

Our harmonized data show discontinuity between 1995 and 1996, indicating a change in the definition used in the survey. When using the data, kindly be advised to caution the inconsistent urban rural distribution and the deifnition applied.   
...
In several early years such as 1993-1996, coding household and individual indentification using the original survey ID information such as province, block, household number and personal serial number produces duplications. Below are two examples from year 1994 adn 1996 respectively. Therefore, we ordered people in descending order of their age within each household to assign new individual number which composes their individual indentifier.
