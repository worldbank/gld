...
All annual reports are available on Lanka Datta and can bt downloaded without any restrictions.
...
<ins>2019-2021</ins> Questionnaire in this stage is very similar to the last stage. Digital literacy was added, and employers and account owners were separated as a single category when asking income questions.
...
In several early years such as 1993-1996, coding household and individual identification using the original survey ID information such as province, block, household number and personal serial number produces duplications. Below are two examples from the year 1994 adn 1996 respectively. Therefore, we ordered people in descending order of their age within each household to assign new individual number which composes their individual identifier.

![1994](utilities/duplicates_1994.png)
![1996](utilities/duplicates_1996.png)
