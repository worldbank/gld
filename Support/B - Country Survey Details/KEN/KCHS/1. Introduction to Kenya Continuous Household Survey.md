...
For a detailed technical assessment of the expected duplication patterns and the empirical verification conducted using the microdata, see [Rotation Panel Issue](Utilities/Rotation%20panel%20issue.md).
