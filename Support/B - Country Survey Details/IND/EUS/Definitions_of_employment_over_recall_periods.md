# EUS labour market status definitions

This document gives an overview of the different labour market status definitions underlying the EUS and how this information was coded in the GLD harmonization.
