...
### Employed population 
The categories of paid employees and self-employment from the variable employment status (empstat) changed between 2007 and 2008. The figure below shows that the number of self-employed increased between 2007 and 2008 while the number of paid employees cut down. The change is in line with ILO numbers. In the ILO data, 36.2% of employed individuals reported working by their own account in 2007. In 2008, the number jumped to 40.7%, and it remained stable thereafter, with 41.8% in 2009. Please, visit [this](https://www.ilo.org/shinyapps/bulkexplorer53/?lang=en&id=EMP_TEMP_SEX_AGE_STE_NB_A) website for further details.

<br></br>
![](utilities/Picture2.png)
<br></br>
