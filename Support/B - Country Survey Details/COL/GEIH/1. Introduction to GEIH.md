...
2. For users interested in the method chosen for ensembling the data please visit the following link.
3. Additional information about the ISIC classification for this survey can be found here.
