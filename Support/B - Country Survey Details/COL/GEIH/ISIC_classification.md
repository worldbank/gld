...
The data from 2021 onwards use the same ISIC 4 Colombia version. If the user wants to compare it to the ISIC 4 international version, please use the same link from 2020.
