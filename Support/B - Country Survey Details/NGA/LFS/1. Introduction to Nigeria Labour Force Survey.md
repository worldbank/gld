...
The data covers a sample of urban and rural in all 36 states of Nigeria. The official quarterly reports detail estimates by urban/rural. On the other hand, the survey methodology note states that estimates can be reported at the state level, though not stated directly, we interpret this as possible only for the full year report. Since the raw datasets do not cover the full year, we set the representativeness at urban/rural, and potentially update it once the full year data becomes available. 
