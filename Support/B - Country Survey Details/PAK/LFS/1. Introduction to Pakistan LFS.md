...
| 2024  | 53,974        | 325,445      |  250,537,803 |  158,800 |
...
| 2024  | Punjab/Sindh/KP/Balochistan   | N/A |  
...
The year 2024 includes the change in the employment definitions. The PAK survey started to use the 19th ICLS (2013) replacing the 13th ICLS (1982) standards with three core changes:

1. Narrower employment definition — employment is now restricted to work for pay or profit only. Subsistence farming and unpaid own-use production are excluded.
2. Broader concept of "work" — a new framework recognises five forms of work (employment, own-use production, unpaid trainee work, volunteer work, and other activities), capturing paid and unpaid contributions that were previously invisible.
Expanded underutilisation indicators — beyond unemployment, the 19th ICLS adds time-related underemployment and a "potential labour force" measure covering discouraged workers.
3. Key implications: The new definitions tend to produce lower employment-to-population ratios, particularly in countries with high subsistence agriculture. Women and rural workers are disproportionately affected, as their unpaid work moves out of the employment category — but becomes more visible through the new work framework.
