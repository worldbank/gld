...
|------|-------------|------------|---------------------|------------------|
| 2002 | 19,361      | Cannot be determined | 1,839,842 | 1,829,462 |
| 2003 | 19,510      | 3,167      | 1,895,078 | 1,826,434 |
| 2004 | 19,904      | 3,192      | 1,810,127 | 1,822,773 |
| 2005 | 19,590      | 3,200      | 1,601,155 | 1,818,354 |
| 2008 | 24,470      | 4,000      | 1,795,878 | 1,800,858 |
| 2009 | 23,523      | 3,849      | 1,681,076 | 1,794,681 |
| 2012 | 56,762      | 9,682      | 1,807,126 | 1,807,126 |
| 2013 | 82,898      | 14,262     | 1,811,372 | 1,818,119 |
| 2014 | 87,617      | 15,265     | 1,811,521 | 1,812,788 |
| 2018 | 67,482      | 13,918     | 1,793,467 | 1,797,086 |
| 2019 | 76,683      | 15,406     | 1,796,376 | 1,788,891 |
| 2020 | 80,423      | 16,552     | 1,795,666 | 1,790,151 |
| 2021 | 71,084      | 14,901     | 1,798,188 | 1,786,079 |
| 2022 | 58,583      | 12,414     | 1,773,971 | 1,768,096 |
| 2023 | 59,412      | 12,665     | 1,762,220 | 1,756,374 |
| 2023 | 62,897      | 13,874     | 1,602,515 | Not available |
...
| Variable | 2002 | 2003 | 2004 | 2005 | 2008 | 2009 | 2012 | 2013 | 2014 | 2018 | 2019 | 2020 | 2021 | 2022 | 2023 | 2024 |
|-----------|------|------|------|------|------|------|------|------|------|------|------|------|------|------|------|------|
| Region (subnatid1) | ❌ | ❌ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ❌ | ❌ | ❌ | ❌ | ✅ | ❌ | ❌ |
| Urban | ✅ | ❌ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ |
...
### Unemployment definition and comparability  

Unemployment rates in the 2003 Kosovo LFS are unusually high compared with later years. This pattern can be attributed to a broader definition of unemployment used in that round. In 2002 and 2003, respondents were simply asked whether they had been looking for work, without any restriction on how recently they had searched. As a result, individuals who had looked for work at any time in the past were included, even if their search activity had occurred long before the reference period.  

In 2004, the questionnaire was revised to align more closely with international standards by introducing a time limit: individuals were considered unemployed only if they had been actively looking for work within the past four months. This change led to a sharp decline in the number of unemployed persons, from roughly 305,000 in 2003 to about 205,000 in 2004. The definitional difference explains the discontinuity in unemployment levels between these years and should be considered when analyzing trends over time.

<img src="Utilities/unemployment.png" width="600" height="400">
...
|-------------|-------------------------------|
| 2002–2014   | ISCO 1988  |
| 2018 onwards| ISCO 2008  |

### Educational attainment

Educational attainment is measured using the GLD variable `educat7`, which classifies individuals into seven education categories. The figure below presents the distribution of these categories across survey waves.

<br></br>

<img src="Utilities/XKX_educat7.png">


Starting in **2008**, the category *secondary incomplete* becomes explicitly identifiable. Prior to 2008, the underlying survey data did not allow a distinction between completed and incomplete secondary education. Consequently, individuals with secondary education before 2008 are classified as having *completed secondary education*. This decision is based on the fact that completed secondary education is the predominant category in the post-2008 period.

For the **2019 and 2020** survey waves, the share of individuals with *incomplete secondary education* is noticeably higher compared to other years. GLD does not have a definitive explanation for this pattern. GLD does not have a definitive explanation for this pattern. This variation is therefore reported as an observed difference in the distribution and should be taken into account when interpreting the results.
