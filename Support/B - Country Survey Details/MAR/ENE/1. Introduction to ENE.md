...
The Morocco Enquête Nationale sur l’Emploi (ENE) is an labor force survey conducted by the La Direction de la Statistique relevant du Haut Commissariat au plan (The Statistics Directorate of the High Commission for Planning of Morocco). The survey began in 1976 as an annual survey with an exclusively urban sample. It evolved to become a nationally representative survey in 1999, and began collecting quarterly information in 1996. While the survey goes a long way, the GLD only has data for each year between 2000 and 2018.  
...
While the survey started in 1976, the GLD only has data for each year between 2000 and 2018.  Sample size for each survey round are as follows:
