...
For 2010, the industries are classified using BSIC 2009, which is comparable with the ISIC rev. 4 at 2 digits. There is an additional two-digit code that is not in ISIC (see table below), but neither was it reported as an industry of any individual in the survey. 
...
| 2010 | ISCO 1988                | ISCO 1988               | First two digits          |
| 2013 | BSCO 2012                | ISCO 2008               | First two digits          |
...
Information on wages are collected based on different reference time periods. In 2010 and 2013, previous month wages were asked. Meanwhile, in 2005, the reference period for wages are distinguished between day laborers and wage workers. Day laborers' wages were reported on a weekly basis, while wage workers' wages were reported on a monthly basis. This information was not provided in the questionnaire, but the reported wage data in the [2005 survey report](Utilities/Labour%20Force%20Survey-2005-6.PDF) were replicated using this distinction. 
