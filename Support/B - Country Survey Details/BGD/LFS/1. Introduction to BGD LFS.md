...
For 2005, the correspondence is done at four digits based on [a PDF table](Utilities/BSIC_code.pdf), which

we converted into a `.dta` file that is read in the harmonization process. The [file is available here](Utilities/Additional%20Data/bsic_isic_mapping.dta).
