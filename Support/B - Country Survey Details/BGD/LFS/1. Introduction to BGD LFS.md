...
The 2010 round of the LFS series only covers one month of interviews (May 2010), and for this reason, the Bangladesh Bureau of Statistics recommends users **against** using this data for time series analysis. For more information on this round, refer to this document. 
