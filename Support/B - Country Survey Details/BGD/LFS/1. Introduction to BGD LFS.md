...
For 2010, the industries are classified using BSIC 2009, which is comparable with the ISIC rev. 4 at 2 digits. There is an additional two-digit code that is not in ISIC, but neither was it reported as an industry of any individual in the survey. 
