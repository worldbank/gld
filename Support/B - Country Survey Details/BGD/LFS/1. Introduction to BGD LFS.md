...
Information on wages are collected using different information. In 2010 and 2013, previous month wages were asked. Meanwhile, in 2005, the reference period for wages are distinguished between day laborers and wage workers. Day laborers' wages were reported on a weekly basis, while wage workers' wages were reported on a monthly basis. This information was not provided in the questionnaire, but the reported wage data in the [2005 survey report](Utilities/Labour Force Survey-2005-6.PDF) were replicated using this distinction. 
