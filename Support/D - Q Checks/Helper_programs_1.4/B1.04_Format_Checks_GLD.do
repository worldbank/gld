...
if _rc == 0 { // if isic version info exists, otherwise cannot know which ISIC version to compare to
	...
	* Preserve harmonization file to read in ISIC universe, save
	preserve
	set sslrelax on
	import delimited "https://raw.githubusercontent.com/worldbank/gld/main/Support/D%20-%20Q%20Checks/Helper_programs_1.4/isic_codes.txt", delimiter(comma) varnames(1) clear 
	set sslrelax off
...
if _rc == 0 { // if isic version info exists, otherwise cannot know which ISIC version to compare to
	...
	* Preserve harmonization file to read in ISIC universe, save
	preserve
	set sslrelax on
	import delimited "https://raw.githubusercontent.com/worldbank/gld/main/Support/D%20-%20Q%20Checks/Helper_programs_1.4/isco_codes.txt", delimiter(comma) varnames(1) clear 
	set sslrelax off
	* Reduce to only cases of said version
