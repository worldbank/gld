...
### ICLS Changes
Labour surveys or chapters in household surveys follow an international guidance that changes periodically in the Internaticonal Labour Statistics Conferences, to know more about this please visit this website. In the case of the Chilean CASEN the labour section follows the ICLS-13 and ICLS-19 question designs and uses the ISCO accepted classification for most of the years. The difference between both is about the activities performed by independent workers, in the ICLS-13 independent workers are classified in self-work activities while in the ICLS-19 their activities is broken down into other economic activities such as agriculture or commerce. 
