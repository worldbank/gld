...
df <- read_excel(path = paste0(path, "/SCIAN_18_ISIC_4.xlsx"), sheet = 1, skip = 2)
...
# There are 306 distinct 4 digit codes
n_distinct(df$SCIAN)
...
# Step_2 has matched 106 codes, hence 200 are left to match
...
# Step_3 has matched 63 codes, hence 137 are left to match
...
# Step_4 has matched 98 codes, hence 39 are left to match
...
# Step_4 has matched 8 codes, hence 31 are left to match
...
# Step_4 has matched 16 codes, hence 15 are left to match
...
write_dta(concord, paste0(path, "/SCIAN_18_ISIC_4.dta"))
