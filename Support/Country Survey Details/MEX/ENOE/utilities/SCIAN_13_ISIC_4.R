...
df <- read_excel(path = paste0(path, "/SCIAN_13_ISIC_4.xlsx"), sheet = 1, skip = 2)
...
# There are 302 distinct 4 digit codes
n_distinct(df$SCIAN)
...
# Step_2 has matched 107 codes, hence 196 are left to match
...
# Step_4 has matched 97 codes, hence 39 are left to match
...
write_dta(concord, paste0(path, "/SCIAN_13_ISIC_4.dta"))
