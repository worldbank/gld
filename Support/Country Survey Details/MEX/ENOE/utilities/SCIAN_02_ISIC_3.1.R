...
df <- read_excel(path = paste0(path, "/SCIAN_02_ISIC_3.1.xlsx"), sheet = 1, skip = 2)
...
# Step_2 has matched 108 codes, hence 201 are left to match
...
# Step_3 has matched 55 codes, hence 146 are left to match
...
# Step_4 has matched 84 codes, hence 61 are left to match
...
# Step_4 has matched 12 codes, hence 49 are left to match
...
# Step_4 has matched 31 codes, hence 18 are left to match
...
write_dta(concord, paste0(path, "/SCIAN_02_ISIC_3.1.dta"))
