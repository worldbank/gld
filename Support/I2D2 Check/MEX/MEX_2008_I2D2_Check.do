...
use "C:\Users\wb582018\OneDrive - WBG\Surveys\MEX\MEX_2008_LFS\MEX_2008_LFS_v01_M_v01_A_I2D2\Data\Harmonized\\`ccode'_`y'_I2D2_`type'.dta",clear
log using "C:\Users\wb582018\OneDrive - WBG\Surveys\MEX\MEX_2008_LFS\MEX_2008_LFS_v01_M_v01_A_I2D2\Work\\`ccode'_`y'_I2D2_ENOE.smcl", replace
...
su hhsize
scalar max=r(max)
*changed to max on 2018
if max>r(max){
di as error "There are obs with hhsize greater than the max"
restore
}
restore
...
di "Educ Level 1"
assert edulevel1==1 | edulevel1==2 | edulevel1==3 | edulevel1==4 | edulevel1==5 | edulevel1==6 | edulevel1==7 | edulevel1==.
...
local lb_var "empstat njobs ocusec industry occup firmsize_l firmsize_u whours wage unitwage healthins socialsec union"
