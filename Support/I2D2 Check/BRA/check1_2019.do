...
use "C:\Users\wb582018\OneDrive - WBG\Surveys\BRA\check_BRA\Current\BRA_2019_I2D2\\`ccode'_`y'_I2D2.dta",clear
log using "C:\Users\wb582018\OneDrive - WBG\Surveys\BRA\check_BRA\Current\BRA_2019_I2D2\\`ccode'_`y'_I2D2.smcl", replace
...
if max>23{
di as error "There are obs with hhsize greater than 23"
restore
}
restore
...
di "Ocusec"
assert ocusec==1 | ocusec==2 | ocusec==.
