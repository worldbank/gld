...
graph bar (sum) `attrition_rate' `attrition_rate_matches', over(`wave') over(`year') ///
 title("Attrition between waves") subtitle("") graphregion(color(white)) ylabel(, nogrid) ytitle("% attrition relative to previous wave") legend( label (1 "Full data") label (2 "Age and sex matches only") position(6))
...
graph bar (sum) `attrition_rate' `attrition_rate_matches', over(`wave') over(`year') ///
 title("Attrition rate: any subsequent wave") subtitle("") graphregion(color(white)) ylabel(, nogrid) ytitle("% attrition relative to first appearance") legend( label (1 "Full data") label (2 "Age and sex matches only") position(6))
...
graph bar (sum) `attrition_rate' `attrition_rate_matches', over(`wave') over(`year') ///
 title("Attrition rate: all subsequent waves") subtitle("") graphregion(color(white)) ylabel(, nogrid) ytitle("% attrition relative to first appearance") legend( label (1 "Full data") label (2 "Age and sex matches only") position(6))
